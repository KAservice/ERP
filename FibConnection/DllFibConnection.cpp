...
{
int result=0;
if (id_class==CLSID_TDMFibConnectionImpl)
	{
	TDMFibConnectionCF * ob=new TDMFibConnectionCF();
...
if (icom->kanAddClass(CLSID_TDMFibConnectionImpl,"Oberon.DMFibConnection.1","DllFibConnection.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - Oberon.DMFibConnection.1  !");
	}
