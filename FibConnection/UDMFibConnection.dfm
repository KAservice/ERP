object DMFibConnection: TDMFibConnection
  ...
  object UserInfo: TpFIBDataSet
    ...
    object UserInfoNAME_REM_SACTCATEGORY: TFIBWideStringField
      FieldName = 'NAME_REM_SACTCATEGORY'
      Size = 200
    end
    object UserInfoIDACTCATEGORY_SUSER: TFIBBCDField
  ...
  object ARMInfo: TpFIBDataSet
    ...
    object ARMInfoIDACTCATEGORY_SARM: TFIBLargeIntField
      FieldName = 'IDACTCATEGORY_SARM'
    end
    object ARMInfoNAME_REM_SACTCATEGORY: TFIBWideStringField
      FieldName = 'NAME_REM_SACTCATEGORY'
      Size = 200
    end
  end
