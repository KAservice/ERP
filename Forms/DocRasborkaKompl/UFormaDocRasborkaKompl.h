...
#ifndef UFormaDocRasborkaKomplH
#define UFormaDocRasborkaKomplH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocRasborkaKompl : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1KF_DRASBKOMPLT;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_DRASBKOMPLT;
	TcxGridDBColumn *cxGrid1DBTableView1RPRICE_DRASBKOMPLT;
	TcxGridDBColumn *cxGrid1DBTableView1RSUM_DRASBKOMPLT;
	TcxGridDBColumn *cxGrid1DBTableView1NAMENOM;
	TcxGridDBColumn *cxGrid1DBTableView1NAMEED;
	TcxGridDBColumn *cxGrid1DBTableView1RECNO;
	TcxGridDBColumn *cxGrid1DBTableView1KFSEB_DRASBKOMPLT;
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		IFormaElementaSprPart *FormaElementeSprPart;
	...
	enum  {ER_NoRekv,ER_InfBase, ER_Firm, ER_Sklad, ER_Klient,
					 ER_BusinessOper, ER_Project,ER_NomKomplekta,ER_EdKomplekta, ER_Nom,
...
public:		// User declarations
		__fastcall TFormaDocRasborkaKompl(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocRasborkaKompl *FormaDocRasborkaKompl;
//---------------------------------------------------------------------------
#endif
