...
#ifndef UREM_FormaDocKM1H
#define UREM_FormaDocKM1H
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocKM1 : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1NAMECOUNTER_REM_DKM1T;
	TcxGridDBColumn *cxGrid1DBTableView1BEFORE_REM_DKM1T;
	TcxGridDBColumn *cxGrid1DBTableView1AFTER_REM_DKM1T;
	TcxDBCalcEdit *NIcxDBCalcEdit;
	TcxLabel *cxLabel2;
	TAction *ActionClose;
	TAction *ActionOK;
	TAction *ActionDvReg;
...
public:		// User declarations
		__fastcall TREM_FormaDocKM1(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocKM1 *REM_FormaDocKM1;
//---------------------------------------------------------------------------
#endif
