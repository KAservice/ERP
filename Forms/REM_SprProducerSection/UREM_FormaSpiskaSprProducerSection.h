...
#ifndef UREM_FormaSpiskaSprProducerSectionH
#define UREM_FormaSpiskaSprProducerSectionH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprProducerSection : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1CODE_REM_SPRSECTION;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_ENG_REM_SPRSECTION;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_REM_SPRSECTION;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_SPRSECTION;
...
private:	// User declarations
		...
		IREM_FormaElementaSprProducerSectionGrp * FormaGrpElementa;
		...
		IREM_FormaElementaSprProducerSection * FormaElementa;
...
public:		// User declarations
		__fastcall TREM_FormaSpiskaSprProducerSection(TComponent* Owner);
		...
		IREM_DMSprProducerSection* DM;
		IREM_DMSprProducerSectionGrp* DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprProducerSection *REM_FormaSpiskaSprProducerSection;
//---------------------------------------------------------------------------
#endif
