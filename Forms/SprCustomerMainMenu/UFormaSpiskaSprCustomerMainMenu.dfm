object FormaSpiskaSprCustomerMainMenu: TFormaSpiskaSprCustomerMainMenu
  Left = 339
  Top = 240
  ...
  object Panel1: TPanel
    ...
    object NameGrpUsercxLookupComboBox: TcxLookupComboBox
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      Properties.KeyFieldNames = 'ID_CUST_USER_GRP'
    ...
    object NameAccountcxButtonEdit: TcxButtonEdit
      Left = 8
      Top = 79
      Properties.Buttons = <
        item
      ...
      Properties.OnButtonClick = NameAccountcxButtonEditPropertiesButtonClick
      TabOrder = 4
      Text = 'NameAccountcxButtonEdit'
      Width = 327
    end
  end
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1INDEX_CUST_MAINMENU: TcxGridDBColumn
        Caption = #1048#1085#1076#1077#1082#1089
        DataBinding.FieldName = 'INDEX_CUST_MAINMENU'
        Width = 40
      end
      object cxGrid1DBTableView1NAME_CUST_MAINMENU: TcxGridDBColumn
        Caption = #1053#1072#1080#1084#1077#1085#1086#1074#1072#1085#1080#1077
        DataBinding.FieldName = 'NAME_CUST_MAINMENU'
        Width = 79
      end
      ...
      object cxGrid1DBTableView1FL_OPEN_EL_CUST_MAINMENU: TcxGridDBColumn
        DataBinding.FieldName = 'FL_OPEN_EL_CUST_MAINMENU'
        PropertiesClassName = 'TcxCheckBoxProperties'
        Properties.ValueChecked = 1
        Properties.ValueUnchecked = 0
        Width = 20
      end
      object cxGrid1DBTableView1IDEL_CUST_MAINMENU: TcxGridDBColumn
        DataBinding.FieldName = 'IDEL_CUST_MAINMENU'
        Width = 34
      end
      object cxGrid1DBTableView1GUIDMOD_CUST_MAINMENU: TcxGridDBColumn
        DataBinding.FieldName = 'GUIDMOD_CUST_MAINMENU'
        Width = 63
      end
