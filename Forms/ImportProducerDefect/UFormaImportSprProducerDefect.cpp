...
//---------------------------------------------------------------------------
__fastcall TFormaImportSprProducerDefect::TFormaImportSprProducerDefect(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::FormCreate(TObject *Sender)
{
...
//-----------------------------------------------------------------------
bool TFormaImportSprProducerDefect::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TFormaImportSprProducerDefect::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerDefect::UpdateForm(void)
{


}
//---------------------------------------------------------------------------
int TFormaImportSprProducerDefect::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::FileNamecxButtonEditPropertiesButtonClick(
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerDefect::OpenFormSpiskaSprImportSet(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::EndViborImportSet(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::NameImportSetcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
OpenFormSpiskaSprImportSet();
}
//---------------------------------------------------------------------------
void TFormaImportSprProducerDefect::UpdateSetup(void)
{
...
//----------------------------------------------------------------------------
void TFormaImportSprProducerDefect::SaveSetup(void)
{
if (IdImportSet==0)
	{
...
void __fastcall TFormaImportSprProducerDefect::cxButtonSaveParamsClick(
      TObject *Sender)
{
SaveSetup();
}
...
void __fastcall TFormaImportSprProducerDefect::cxButtonImportClick(TObject *Sender)
{
...
try
	...
	dc->AppendRecord();
	dc->Values[number_string_table][cxGrid1BandedTableView1ID_REM_SPRDEFECT->Index] = "";
...
void TFormaImportSprProducerDefect::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TFormaImportSprProducerDefect::ViborFirm(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TFormaImportSprProducerDefect::ViborSklad(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::EndViborSklad(void)
{
...
//-----------------------------------------------------------------------------
//выбор поставщика
void TFormaImportSprProducerDefect::ViborKlient(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::EndViborKlient(void)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::NameInfBasecxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();	
}
...
void __fastcall TFormaImportSprProducerDefect::NameFirmcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborFirm();
}
...
void __fastcall TFormaImportSprProducerDefect::NameSkladcxButtonEditPropertiesButtonClick(
	  TObject *Sender, int AButtonIndex)
{
ViborSklad();
}
...
void __fastcall TFormaImportSprProducerDefect::NameKlientcxButtonEditPropertiesButtonClick(
	  TObject *Sender, int AButtonIndex)
{
ViborKlient();
}
...
void __fastcall TFormaImportSprProducerDefect::cxButtonUpdateSprClick(TObject *Sender)
{
...
IREM_DMSprProducerDefect *dm_producer_defect;
		InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMSprProducerDefect ,IID_IREM_DMSprProducerDefect,
													(void**)&dm_producer_defect);
		dm_producer_defect->Init(InterfaceMainObject,InterfaceImpl);
...
//			}
		...
		if (type_update == 1) //вставка
			{
			dm_producer_defect->NewElement(IdProducer,0);
			}

		if (type_update == 2)   //обновление
			{
			id_producer_defect=dc_upd->Values[i][TableUpdateID_REM_SPRDEFECT->Index];
			dm_producer_defect->OpenElement(id_producer_defect);
			}


		dm_producer_defect->Element->Edit();
			...
			if (StrToInt(NamecxSpinEdit->Text) > 0)
				...
				dm_producer_defect->ElementNAME_REM_SPRDEFECT->AsString=name;
				}
			...
			if (StrToInt(NameEngcxSpinEdit->Text) > 0)
				...
				if (name.Length() > 200) { name = name.SetLength(200);}
				dm_producer_defect->ElementNAME_ENG_REM_SPRDEFECT->AsString=name;
				}
			...
			if (StrToInt(ArtcxSpinEdit->Text) > 0   || cxCheckBoxVidelyatCod->Checked==true)
				...
				dm_producer_defect->ElementCODE_REM_SPRDEFECT->AsString=artikul;
				}

		dm_producer_defect->Element->Post();




				if (dm_producer_defect->SaveElement()==false)
					{
					text_error="Ошибка при записи новой номенклатуры: "+dm_producer_defect->TextError+"\n";
...
void __fastcall TFormaImportSprProducerDefect::cxButtonDelStringClick(TObject *Sender)
{
...
void __fastcall TFormaImportSprProducerDefect::ActionCloseExecute(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------
...
////---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::NameProducercxButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerDefect::OpenFormSpiskaSprProducer(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerDefect::ToolButtonSaveExcelClick(TObject *Sender)
...
void __fastcall TFormaImportSprProducerDefect::cxButtonProveritClick(TObject *Sender)
...
//			}
		...
		if(TypeSearchcxComboBox->ItemIndex == 2 )
			{  //поиск по артикулу
			id_producer_defect= dm_producer_defect->FindPoCodu(IdProducer,artikul);
			}

		if(TypeSearchcxComboBox->ItemIndex == 1 )            //1 поиск по наименованию
			{
			id_producer_defect= dm_producer_defect->FindPoName(IdProducer,name);
			}

		if(TypeSearchcxComboBox->ItemIndex == 3 )            //3 по англ наименованию
			{
			id_producer_defect= dm_producer_defect->FindPoNameEng(IdProducer,name_eng);
			}
		...
		if(id_producer_defect==0) //создаем новую номенклатуру
			{
			//*********************************************************************************
			dc_upd->AppendRecord();
			dc_upd->Values[number_string_table_upd][TableUpdateTypeUpdate->Index] = 1;
			dc_upd->Values[number_string_table_upd][TableUpdateID_REM_SPRDEFECT->Index] = "";
			...
			if (StrToInt(NamecxSpinEdit->Text) !=0)
				{
				if (dm_producer_defect->ElementNAME_REM_SPRDEFECT->AsString
								!= NAME )
					{
					fl_save=true;
					}
			...
			if (StrToInt(NameEngcxSpinEdit->Text) !=0)
				{
				if (dm_producer_defect->ElementNAME_ENG_REM_SPRDEFECT->AsString
								!= NAME_ENG )
					{
					fl_save=true;
					}
			...
			if (StrToInt(ArtcxSpinEdit->Text) !=0)
				{
				if (dm_producer_defect->ElementCODE_REM_SPRDEFECT->AsString
								!= ART )
					{
					fl_save=true;
					}
			...
			dc_upd->Values[number_string_table_upd][TableUpdateID_REM_SPRDEFECT->Index] = dm_producer_defect->ElementID_REM_SPRDEFECT->AsString;
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerDefect::VidelitCodIsNameRus(UnicodeString * out_name, UnicodeString * out_code, UnicodeString in_name)
{
