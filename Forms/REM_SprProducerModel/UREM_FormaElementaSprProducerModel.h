...
#ifndef UREM_FormaElementaSprProducerModelH
#define UREM_FormaElementaSprProducerModelH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaElementaSprProducerModel : public TForm
{
...
private:	// User declarations
		...
		IREM_FormaSpiskaSprProducerModelPropertiesValue * REM_FormaSpiskaSprProducerModelPropertiesValue;
		IREM_FormaSpiskaSprProducerModelInfBlock * REM_FormaSpiskaSprProducerModelInfBlock;
...
public:		// User declarations
		__fastcall TREM_FormaElementaSprProducerModel(TComponent* Owner);
		...
		//Текущий интерфейс
		IREM_DMSprProducerModel* DM;
		bool Vibor;                        //форма открыта для выбора
		int NumberProcVibor;               //какую процедуру использовать для обработки выбора во внешней форме

		UnicodeString NameGroupElement;
		__int64 IdGroupElement;     //группирующий элемент
		UnicodeString NameGroup;
		__int64 IdGrp;              //группа в которой находится элемент
		void UpdateForm(void);
		bool SaveElement;
};
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaElementaSprProducerModel *REM_FormaElementaSprProducerModel;
//---------------------------------------------------------------------------
#endif
