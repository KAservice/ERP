...
//---------------------------------------------------------------------------
__fastcall TFormaDocRegAdvCust::TFormaDocRegAdvCust(TComponent* Owner)
		: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TFormaDocRegAdvCust::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject("Oberon.DMDocRegAdvCust.1",IID_IDMDocRegAdvCust, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TFormaDocRegAdvCustImpl),false);
...
//----------------------------------------------------------------------------
int TFormaDocRegAdvCust::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void TFormaDocRegAdvCust::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TFormaDocRegAdvCust::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TFormaDocRegAdvCust::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TFormaDocRegAdvCust::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::EndViborFirm(void)
{

	DM->DocT->Edit();
	DM->DocTIDFIRM_DRG_ADVCUSTT->AsString=FormaSpiskaSprFirm->DM->ElementIDFIRM->AsString;
...
//выбор клиента
//----------------------------------------------------------------------------
void TFormaDocRegAdvCust::ViborKlient(void)
{
if(Prosmotr==true) return;
if (FormaSpiskaSprKlient==NULL)
		...
		FormaSpiskaSprKlient->IdKlient=glStrToInt64(DM->DocTIDKLIENT_DRG_ADVCUSTT->AsString);
		FormaSpiskaSprKlient->UpdateForm();
		}
}
//----------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::EndViborKlient(void)
{
                ...
                DM->DocT->Edit();
				DM->DocTIDKLIENT_DRG_ADVCUSTT->AsString=FormaSpiskaSprKlient->DM->ElementIDKLIENT->AsString;
...
//---------------------------------------------------------------------------
void TFormaDocRegAdvCust::OpenPrintForm(void)
{
...
//---------------------------------------------------------------------------
void TFormaDocRegAdvCust::OutputZagolovokReport(TSheetEditor *prForm)
{
...
cell->Text="Движения регистра Авансы №"+DM->DocAllNUMDOC->AsString+" от "
...
cell->Text="Основание: "+DM->DocDESCR_DRG_ADVCUST->AsString;
delete cell;
numRow++;
numRow++;
...
//------------------------------------------------------------------------------
void TFormaDocRegAdvCust::OutputString(TSheetEditor *prForm)
{
numRow ++;
...
cell = prForm->SS->ActiveSheet->GetCellObject(numCol, numRow);
cell->Text=DM->DocTTDV_DRG_ADVCUSTT->AsString;
//cell->Style->HorzTextAlign = haCENTER;
...
cell = prForm->SS->ActiveSheet->GetCellObject(numCol, numRow);
cell->Text=DM->DocTSUM_DRG_ADVCUSTT->AsString;
...
//------------------------------------------------------------------------------
void TFormaDocRegAdvCust::OutputPodavalReport(TSheetEditor *prForm)
{
numRow++;
numCol=2;
TcxSSCellObject *cell;
...
void __fastcall TFormaDocRegAdvCust::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TFormaDocRegAdvCust::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TFormaDocRegAdvCust::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TFormaDocRegAdvCust::ActionOpenHelpExecute(TObject *Sender)
{
Application->HelpJump("DocRegAdvCust");
}
//---------------------------------------------------------------------------



void __fastcall TFormaDocRegAdvCust::NameInfBasecxDBButtonEditPropertiesButtonClick(
...
void __fastcall TFormaDocRegAdvCust::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TFormaDocRegAdvCust::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TFormaDocRegAdvCust::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TFormaDocRegAdvCust::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TFormaDocRegAdvCust::PrimcxDBTextEditKeyDown(TObject *Sender,
	  WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void TFormaDocRegAdvCust::BeforeSaveDoc(void)
{
...
void __fastcall TFormaDocRegAdvCust::cxGrid1DBTableView1NAMEKLIENTPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if(Prosmotr==true) return;
ViborKlient();
...
void __fastcall TFormaDocRegAdvCust::cxGrid1DBTableView1NAMEFIRMPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if(Prosmotr==true) return;
ViborFirm();
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TFormaDocRegAdvCust::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TFormaDocRegAdvCust::RunExternalModule(__int64 id_module, int type_module)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::ActionCloseExecute(TObject *Sender)
{
...
void __fastcall TFormaDocRegAdvCust::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TFormaDocRegAdvCust::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TFormaDocRegAdvCust::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TFormaDocRegAdvCust::ActionPrintExecute(TObject *Sender)
{
OpenPrintForm();
}
//---------------------------------------------------------------------------
void TFormaDocRegAdvCust::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TFormaDocRegAdvCust::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaDocRegAdvCust::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TFormaDocRegAdvCust::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
