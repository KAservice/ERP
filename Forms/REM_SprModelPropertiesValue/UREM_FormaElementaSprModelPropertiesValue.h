...
#ifndef UREM_FormaElementaSprModelPropertiesValueH
#define UREM_FormaElementaSprModelPropertiesValueH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaElementaSprModelPropertiesValue : public TForm
{
...
public:		// User declarations
		__fastcall TREM_FormaElementaSprModelPropertiesValue(TComponent* Owner);
		...
		//Текущий интерфейс
		IREM_DMSprModelPropertiesValue * DM;
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaElementaSprModelPropertiesValue *REM_FormaElementaSprModelPropertiesValue;
//---------------------------------------------------------------------------
#endif
