object REM_FormaElementaSprModelPropertiesValue: TREM_FormaElementaSprModelPropertiesValue
  Left = 645
  Top = 0
  Caption = #1045#1083#1077#1084#1077#1085#1090' '#1089#1087#1088#1072#1074#1086#1095#1085#1080#1082#1072' "'#1057#1074#1086#1081#1089#1090#1074#1072' ('#1093#1072#1088#1072#1082#1090#1077#1088#1080#1089#1090#1080#1082#1080') '#1084#1086#1076#1077#1083#1080'"'
  ClientHeight = 372
  ClientWidth = 613
  Color = clBtnFace
  ...
  object ValueTextcxDBMemo: TcxDBMemo
    Left = 24
    Top = 151
    DataBinding.DataField = 'VALTEXT_REM_SMODEL_PROPVAL'
    TabOrder = 3
    Height = 89
    Width = 569
  end
