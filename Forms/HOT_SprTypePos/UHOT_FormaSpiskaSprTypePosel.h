...
#ifndef UHOT_FormaSpiskaSprTypePoselH
#define UHOT_FormaSpiskaSprTypePoselH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class THOT_FormaSpiskaSprTypePosel : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1KOLM_HOT_STYPEPOS;
	TcxGridDBColumn *cxGrid1DBTableView1ALL_HOT_STYPEPOS;
	TAction *ActionClose;
...
public:		// User declarations
		__fastcall THOT_FormaSpiskaSprTypePosel(TComponent* Owner);
		...
		//Текущий интерфейс
		IHOT_DMSprTypePosel * DM;
		bool Vibor;                        //форма открыта для выбора
		int NumberProcVibor;               //какую процедуру использовать для обработки выбора во внешней форме

};
//---------------------------------------------------------------------------
extern PACKAGE THOT_FormaSpiskaSprTypePosel *HOT_FormaSpiskaSprTypePosel;
//---------------------------------------------------------------------------
#endif
