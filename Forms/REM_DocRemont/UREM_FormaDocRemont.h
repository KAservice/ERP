...
#ifndef UREM_FormaDocRemontH
#define UREM_FormaDocRemontH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocRemont : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1DVREG_REM_DREMONTT;
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1KF_REM_DREMONTT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1KOL_REM_DREMONTT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1PRICE_REM_DREMONTT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1SUM_REM_DREMONTT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1IDHW_REM_DREMONTT;
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1IDHWOLD_REM_DREMONTT;
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1IDHW_DONOR_REM_DREMONTT;
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1DESCR_REM_DREMONTT;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall cxGrid1DBBandedTableView1NAMENOMPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
	void __fastcall cxGrid1DBBandedTableView1NAMEEDPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
...
public:		// User declarations
		__fastcall TREM_FormaDocRemont(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocRemont *REM_FormaDocRemont;
//---------------------------------------------------------------------------
#endif
