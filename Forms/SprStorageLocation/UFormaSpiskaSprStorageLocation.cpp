...
LabelNameGrp->Caption="Места хранения\\...";
HintLabel->Caption="";
...
cxTreeView1->Items->AddObject(NULL,"Места хранения",lpIDGrp);
...
//-------------------------------------------------------------------------------
int TFormaSpiskaSprStorageLocation::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
{
		UnicodeString V="Вы действительно хотите удалить "	+DM->TableNAME_SMHRAN->AsString+"?";
