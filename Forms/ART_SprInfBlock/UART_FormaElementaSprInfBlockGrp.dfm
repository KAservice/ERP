object ART_FormaElementaSprInfBlockGrp: TART_FormaElementaSprInfBlockGrp
  Left = 462
  Top = 235
  ...
  object NamecxDBTextEdit: TcxDBTextEdit
    ...
    Margins.Right = 4
    Margins.Bottom = 4
    DataBinding.DataField = 'NAME_ART_IB_GRP'
    TabOrder = 0
    Width = 458
  end
  ...
  object GUIDcxDBTextEdit: TcxDBTextEdit
    ...
    Margins.Right = 4
    Margins.Bottom = 4
    DataBinding.DataField = 'GUID_GRP_ART_IB_GRP'
    TabOrder = 1
