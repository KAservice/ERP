...
#ifndef UART_FormaSpiskaSprInfBlockSostavH
#define UART_FormaSpiskaSprInfBlockSostavH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TART_FormaSpiskaSprInfBlockSostav : public TForm
{
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
	   ...
	   IART_FormaSpiskaSprImage * FormaSpiskaSprImage;
...
public:		// User declarations
		__fastcall TART_FormaSpiskaSprInfBlockSostav(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TART_FormaSpiskaSprInfBlockSostav *ART_FormaSpiskaSprInfBlockSostav;
//---------------------------------------------------------------------------
#endif
