object FormaDocRegPaySale: TFormaDocRegPaySale
  Left = 290
  Top = 119
  Caption = #1044#1086#1082#1091#1084#1077#1085#1090' "'#1044#1074#1080#1078#1077#1085#1080#1103' '#1088#1077#1075#1080#1089#1090#1088#1072' '#1054#1087#1083#1072#1090#1072' '#1088#1077#1072#1083#1080#1079#1072#1094#1080#1080'"'
  ClientHeight = 619
  ClientWidth = 928
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      Caption = #1044#1074#1080#1078#1077#1085#1080#1103' '#1088#1077#1075#1080#1089#1090#1088#1072' '#1054#1087#1083#1072#1090#1072' '#1088#1077#1072#1083#1080#1079#1072#1094#1080#1080'  '#8470
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -23
      Font.Name = 'MS Sans Serif'
    ...
    object PrimcxDBTextEdit: TcxDBTextEdit
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      DataBinding.DataField = 'DESCR_DRG_PAYSALE'
      TabOrder = 6
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1TDV_DRG_PAYSALET: TcxGridDBColumn
        Caption = #1044#1074'.'
        DataBinding.FieldName = 'TDV_DRG_PAYSALET'
        Width = 45
      end
      object cxGrid1DBTableView1OPER_DRG_PAYSALET: TcxGridDBColumn
        Caption = #1054#1087#1077#1088#1072#1094#1080#1103
        DataBinding.FieldName = 'OPER_DRG_PAYSALET'
      end
      ...
      object cxGrid1DBTableView1IDDOCSALE_DRG_PAYSALET: TcxGridDBColumn
        Caption = #1044#1086#1082#1091#1084#1077#1085#1090
        DataBinding.FieldName = 'IDDOCSALE_DRG_PAYSALET'
        Width = 71
      end
      object cxGrid1DBTableView1DATE_DRG_PAYSALET: TcxGridDBColumn
        Caption = #1044#1072#1090#1072
        DataBinding.FieldName = 'DATE_DRG_PAYSALET'
        PropertiesClassName = 'TcxDateEditProperties'
        Width = 70
      end
      object cxGrid1DBTableView1SUM_DRG_PAYSALET: TcxGridDBColumn
        Caption = #1057#1091#1084#1084#1072
        DataBinding.FieldName = 'SUM_DRG_PAYSALET'
