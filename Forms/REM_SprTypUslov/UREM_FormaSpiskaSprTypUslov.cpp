...
LabelNameGrp->Caption="Типовые улы\\...";
HintLabel->Caption="";
...
cxTreeView1->Items->AddObject(NULL,"Тип. узлы",lpIDGrp);
...
//---------------------------------------------------------------------------------
//---------------------------------------------------------------------------
int TREM_FormaSpiskaSprTypUslov::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
