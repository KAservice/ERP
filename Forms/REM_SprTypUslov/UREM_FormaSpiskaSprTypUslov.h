...
#ifndef UREM_FormaSpiskaSprTypUslovH
#define UREM_FormaSpiskaSprTypUslovH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprTypUslov : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1DESCR_REM_STYPUSLOV;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_STYPUSLOV;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_ENG_REM_STYPUSLOV;
...
private:	// User declarations
		...
		IREM_FormaElementaSprTypUslovGrp * FormaGrpElementa;
		...
		IREM_FormaElementaSprTypUslov * FormaElementa;
...
public:		// User declarations
		__fastcall TREM_FormaSpiskaSprTypUslov(TComponent* Owner);
		...
		IREM_DMSprTypUslov* DM;
		IREM_DMSprGrpTypUslov* DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprTypUslov *REM_FormaSpiskaSprTypUslov;
//---------------------------------------------------------------------------
#endif
