#ifndef UREM_FormaDocPrihNaklImplH
#define UREM_FormaDocPrihNaklImplH
#include "IREM_FormaDocPrihNakl.h"
#include "UREM_FormaDocPrihNakl.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_FormaDocPrihNaklImpl)) TREM_FormaDocPrihNaklImpl : public IREM_FormaDocPrihNakl, IkanCallBack
{
public:
   TREM_FormaDocPrihNaklImpl();
   ~TREM_FormaDocPrihNaklImpl();
   TREM_FormaDocPrihNakl * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_FormaDocPrihNakl
   ...
   virtual IREM_DMDocPrihNakl * get_DM(void);
   virtual void set_DM(IREM_DMDocPrihNakl * DM);
...
#define CLSID_TREM_FormaDocPrihNaklImpl __uuidof(TREM_FormaDocPrihNaklImpl)
#endif
