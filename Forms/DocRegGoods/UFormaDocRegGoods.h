...
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1TDV_DRG_GOODST;
	TcxGridDBColumn *cxGrid1DBTableView1RPRICE_DRG_GOODST;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_DRG_GOODST;
	TcxGridDBColumn *cxGrid1DBTableView1OPER_DRG_GOODST;
	TcxGridDBColumn *cxGrid1DBTableView1TYPE_DRG_GOODST;
