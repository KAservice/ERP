...
#ifndef UFormaDocRegKassaH
#define UFormaDocRegKassaH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocRegKassa : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1TDV_DRG_KASSAT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_DRG_KASSAT;
	TcxGridDBColumn *cxGrid1DBTableView1OPER_DRG_KASSAT;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall cxGrid1DBTableView1NAMEKKMPropertiesButtonClick(
		  TObject *Sender, int AButtonIndex);
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		//выбор склада
		IFormaSpiskaSprKKM * FormaSpiskaSprKassa;
...
public:		// User declarations
		__fastcall TFormaDocRegKassa(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocRegKassa *FormaDocRegKassa;
//---------------------------------------------------------------------------
#endif
