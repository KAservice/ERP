object FormaElementaSprAddressKV: TFormaElementaSprAddressKV
  Left = 482
  Top = 263
  ...
  object DBTextNAME_SADR_DOM: TDBText
    Left = 209
    Top = 269
    Width = 200
    Height = 21
    ...
    Margins.Right = 4
    Margins.Bottom = 4
    DataField = 'NAME_SADR_DOM'
  end
  object DBTextNAME_SADR_STROEN: TDBText
    Left = 209
    Top = 317
    Width = 200
    Height = 21
  ...
  object cxDBTextEditNAME_SADR_KV: TcxDBTextEdit
    Left = 280
    Top = 380
    Margins.Left = 4
    Margins.Top = 4
