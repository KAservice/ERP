...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocZVid::TREM_FormaDocZVid(TComponent* Owner)
        : TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocZVid::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMDocZVid,IID_IREM_DMDocZVid, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocZVidImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocZVid::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocZVid::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocZVid::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocZVid::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocZVid::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocZVid::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocZVid::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocZVid::ViborRemZ(void)
{
if(Prosmotr==true) return;
if (FormaGurZ==NULL)
		{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::EndViborRemZ(void)
{
if (ActionOperation==aoAddNewString)
	...
	DM->DocT->Edit();
	DM->DocTIDZ_REM_DZVIDT->AsString=FormaGurZ->DM->TableID_REM_Z->AsString;
...
void __fastcall TREM_FormaDocZVid::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocZVid::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocZVid::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocZVid::ActionOpenHelpExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocZVid::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocZVid::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocZVid::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocZVid::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocZVid::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocZVid::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocZVid::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZVid::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZVid::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocZVid::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocZVid::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocZVid::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborRemZ();
}
...
void __fastcall TREM_FormaDocZVid::ActionCloseExecute(TObject *Sender)
{
TypeEvent=0;
...
void __fastcall TREM_FormaDocZVid::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
TypeEvent=1;
BeforeSaveDoc();
...
void __fastcall TREM_FormaDocZVid::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocZVid::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
BeforeSaveDoc();
if (DM->SaveDoc()==true)
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocZVid::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocZVid::RunExternalModule(__int64 id_module, int type_module)
{
...
module->SetInt64Variables("glIdString", glStrToInt64(DM->DocTID_REM_DZVIDT->AsString));
...
void TREM_FormaDocZVid::AfterSaveDoc(void)
{
//обновим дату выдачи и состояние в заявке  на Выдано Отремонтировано
UnicodeString V="Обновить флаг Выдано, состояние и дату выдачи в заявках?";
...
if (Application->MessageBox(V.c_str(),Z.c_str(),MB_YESNO)==IDYES)
	{
		...
		DMSetup->kanRelease();
			...
			while (!DM->DocT->Eof)
				...
				__int64 idz=glStrToInt64(DM->DocTIDZ_REM_DZVIDT->AsString);
				dm_z->OpenDoc(idz);
				dm_z->GurZ->Edit();
...
void __fastcall TREM_FormaDocZVid::NumDocKlientcxDBTextEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZVid::PosDocKlientcxDBDateEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZVid::cxGrid1DBTableView1NAME_REM_ZPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
ViborRemZ();
}
//---------------------------------------------------------------------------
void TREM_FormaDocZVid::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void  TREM_FormaDocZVid::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocZVid::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void TREM_FormaDocZVid::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZVid::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocZVid::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
