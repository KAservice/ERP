...
#ifndef UFormaDocVipBankaH
#define UFormaDocVipBankaH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocVipBanka : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1NUMPP_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1DATEPP_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1TEXTPP_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1PRIHOD_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1PRIHODNDS_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1PRIHODSUMNDS_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1RASHOD_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1RASHODNDS_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1RASHODSUMNDS_DVIPBANKT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1OPER_DVIPBANKT;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
	void __fastcall cxGrid1DBBandedTableView1NAMEKLIENTPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
	   ...
	   enum  {ER_NoRekv,ER_InfBase, ER_Firm, ER_Klient, ER_Sklad, ER_BankSchet, ER_BusinessOper, ER_Project, ER_NO} EditRekvisit;
		 __int64 VibKlientId;
...
public:		// User declarations
		__fastcall TFormaDocVipBanka(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocVipBanka *FormaDocVipBanka;
//---------------------------------------------------------------------------
#endif
