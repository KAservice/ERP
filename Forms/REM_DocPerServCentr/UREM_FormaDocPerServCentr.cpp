...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocPerServCentr::TREM_FormaDocPerServCentr(TComponent* Owner)
        : TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocPerServCentr::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMDocPerServCentr,IID_IREM_DMDocPerServCentr, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocPerServCentrImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocPerServCentr::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocPerServCentr::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocPerServCentr::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocPerServCentr::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocPerServCentr::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocPerServCentr::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocPerServCentr::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocPerServCentr::ViborRemZ(void)
{
if(Prosmotr==true) return;
if (FormaGurZ==NULL)
		{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::EndViborRemZ(void)
{
if (ActionOperation==aoAddNewString)
	...
	DM->DocT->Edit();
	DM->DocTIDZ_REM_DSCPERT->AsString=FormaGurZ->DM->TableID_REM_Z->AsString;
...
void __fastcall TREM_FormaDocPerServCentr::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocPerServCentr::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocPerServCentr::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocPerServCentr::ActionOpenHelpExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocPerServCentr::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocPerServCentr::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocPerServCentr::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocPerServCentr::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocPerServCentr::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocPerServCentr::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocPerServCentr::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPerServCentr::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPerServCentr::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocPerServCentr::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocPerServCentr::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocPerServCentr::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborRemZ();
}
...
void __fastcall TREM_FormaDocPerServCentr::ActionCloseExecute(TObject *Sender)
{
TypeEvent=0;
...
void __fastcall TREM_FormaDocPerServCentr::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
TypeEvent=1;
if (DM->SaveDoc()==true)
...
void __fastcall TREM_FormaDocPerServCentr::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocPerServCentr::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocPerServCentr::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocPerServCentr::RunExternalModule(__int64 id_module, int type_module)
{
...
void TREM_FormaDocPerServCentr::AfterSaveDoc(void)
{
...
void __fastcall TREM_FormaDocPerServCentr::NumDocKlientcxDBTextEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPerServCentr::PosDocKlientcxDBDateEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPerServCentr::cxGrid1DBTableView1NAME_REM_ZPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
ViborRemZ();
}
...
void TREM_FormaDocPerServCentr::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void  TREM_FormaDocPerServCentr::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocPerServCentr::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void TREM_FormaDocPerServCentr::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPerServCentr::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocPerServCentr::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
