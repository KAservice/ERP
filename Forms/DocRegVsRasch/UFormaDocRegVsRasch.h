...
#ifndef UFormaDocRegVsRaschH
#define UFormaDocRegVsRaschH
//---------------------------------------------------------------------------
...
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1TDV_DRG_VSRASCHT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_DRG_VSRASCHT;
	TcxGridDBColumn *cxGrid1DBTableView1NAMEFIRM;
	TcxGridDBColumn *cxGrid1DBTableView1NAMEKLIENT;
	TcxGridDBColumn *cxGrid1DBTableView1OPER_DRG_VSRASCHT;
