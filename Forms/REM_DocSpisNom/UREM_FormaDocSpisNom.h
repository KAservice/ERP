...
#ifndef UREM_FormaDocSpisNomH
#define UREM_FormaDocSpisNomH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocSpisNom : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DSPNT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_REM_DSPNT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICE_REM_DSPNT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_REM_DSPNT;
	...
	TToolButton *ToolButtonCreateDocAkt;
	...
	TcxGridDBColumn *cxGrid1DBTableView1DVREG_REM_DSPNT;
	TcxGridDBColumn *cxGrid1DBTableView1RPRICE_REM_DSPNT;
	TcxGridDBColumn *cxGrid1DBTableView1RSUM_REM_DSPNT;
	TcxLabel *cxLabel9;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall cxGrid1DBTableView1NAME_REM_SHARDWAREPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
	void __fastcall ToolButtonCreateDocAktClick(TObject *Sender);
...
public:		// User declarations
		__fastcall TREM_FormaDocSpisNom(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocSpisNom *REM_FormaDocSpisNom;
//---------------------------------------------------------------------------
#endif
