#ifndef UFormaSpiskaSprDepartmentImplH
#define UFormaSpiskaSprDepartmentImplH
#include "UFormaSpiskaSprDepartment.h"
#include "UGlobalConstant.h"
#include "IkasFormSpr.h"

//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TFormaSpiskaSprDepartmentImpl)) TFormaSpiskaSprDepartmentImpl : public IkasFormSpr, IkanCallBack
{
public:
   TFormaSpiskaSprDepartmentImpl();
   ~TFormaSpiskaSprDepartmentImpl();
   TFormaSpiskaSprDepartment * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TFormaSpiskaSprDepartmentImpl __uuidof(TFormaSpiskaSprDepartmentImpl)
#endif
