#ifndef UFormaElementaSprDepartmentImplH
#define UFormaElementaSprDepartmentImplH
#include "UFormaElementaSprDepartment.h"
#include "UGlobalConstant.h"
#include "IkasFormSpr.h"

//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TFormaElementaSprDepartmentImpl)) TFormaElementaSprDepartmentImpl : public IkasFormSpr, IkanCallBack
{
public:
   TFormaElementaSprDepartmentImpl();
   ~TFormaElementaSprDepartmentImpl();
   TFormaElementaSprDepartment * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TFormaElementaSprDepartmentImpl __uuidof(TFormaElementaSprDepartmentImpl)
#endif
