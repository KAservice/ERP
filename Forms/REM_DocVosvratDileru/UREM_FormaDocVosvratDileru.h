...
#ifndef UREM_FormaDocVosvratDileruH
#define UREM_FormaDocVosvratDileruH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocVosvratDileru : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DDILRETT;
	TcxLabel *cxLabel9;
	TcxDBButtonEdit *NameBusinessOpercxDBButtonEdit;
	TcxDBButtonEdit *NameProjectcxDBButtonEdit;
	TcxLabel *cxLabel4;
	TToolButton *ToolButtonUpdateVidano;
	TToolButton *ToolButtonAddAlZayavkiDiler;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
	void __fastcall ToolButtonUpdateVidanoClick(TObject *Sender);
	void __fastcall ToolButtonAddAlZayavkiDilerClick(TObject *Sender);
...
public:		// User declarations
		__fastcall TREM_FormaDocVosvratDileru(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocVosvratDileru *REM_FormaDocVosvratDileru;
//---------------------------------------------------------------------------
#endif
