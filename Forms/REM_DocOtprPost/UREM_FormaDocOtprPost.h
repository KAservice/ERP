...
#ifndef UREM_FormaDocOtprPostH
#define UREM_FormaDocOtprPostH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocOtprPost : public TForm
{
__published:	// IDE-managed Components
	...
	TcxDBDateEdit *cxDBDateEditPLANDOSTAVKI_REM_DOTPRPOST;
	...
	TcxLabel *cxLabel4;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_DOTPRPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1IDNOM_REM_DOTPRPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1IDED_REM_DOTPRPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DOTPRPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_REM_DOTPRPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICE_REM_DOTPRPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_REM_DOTPRPOSTT;
	...
	TcxDBTextEdit *cxDBTextEditTK_REM_DOTPRPOST;
	TcxLabel *cxLabel5;
	...
	void __fastcall cxDBDateEditPLANDOSTAVKI_REM_DOTPRPOSTKeyPress(TObject *Sender, char &Key);
...
public:		// User declarations
		__fastcall TREM_FormaDocOtprPost(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocOtprPost *REM_FormaDocOtprPost;
//---------------------------------------------------------------------------
#endif
