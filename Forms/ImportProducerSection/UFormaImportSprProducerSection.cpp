...
//---------------------------------------------------------------------------
__fastcall TFormaImportSprProducerSection::TFormaImportSprProducerSection(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::FormCreate(TObject *Sender)
{
...
//-----------------------------------------------------------------------
bool TFormaImportSprProducerSection::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TFormaImportSprProducerSection::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerSection::UpdateForm(void)
{


}
//---------------------------------------------------------------------------
int TFormaImportSprProducerSection::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::FileNamecxButtonEditPropertiesButtonClick(
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerSection::OpenFormSpiskaSprImportSet(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::EndViborImportSet(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::NameImportSetcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
OpenFormSpiskaSprImportSet();
}
//---------------------------------------------------------------------------
void TFormaImportSprProducerSection::UpdateSetup(void)
{
...
//----------------------------------------------------------------------------
void TFormaImportSprProducerSection::SaveSetup(void)
{
if (IdImportSet==0)
	{
...
void __fastcall TFormaImportSprProducerSection::cxButtonSaveParamsClick(
      TObject *Sender)
{
SaveSetup();
}
...
void __fastcall TFormaImportSprProducerSection::cxButtonImportClick(TObject *Sender)
{
...
try
	...
	dc->AppendRecord();
	dc->Values[number_string_table][cxGrid1BandedTableView1ID_REM_SPRSECTION->Index] = "";
...
void TFormaImportSprProducerSection::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TFormaImportSprProducerSection::ViborFirm(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TFormaImportSprProducerSection::ViborSklad(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::EndViborSklad(void)
{
...
//-----------------------------------------------------------------------------
//выбор поставщика
void TFormaImportSprProducerSection::ViborKlient(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::EndViborKlient(void)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::NameInfBasecxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();	
}
...
void __fastcall TFormaImportSprProducerSection::NameFirmcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborFirm();
}
...
void __fastcall TFormaImportSprProducerSection::NameSkladcxButtonEditPropertiesButtonClick(
	  TObject *Sender, int AButtonIndex)
{
ViborSklad();
}
...
void __fastcall TFormaImportSprProducerSection::NameKlientcxButtonEditPropertiesButtonClick(
	  TObject *Sender, int AButtonIndex)
{
ViborKlient();
}
...
void __fastcall TFormaImportSprProducerSection::cxButtonUpdateSprClick(TObject *Sender)
{
...
IREM_DMSprProducerSection *dm_producer_section;
		InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMSprProducerSection ,IID_IREM_DMSprProducerSection,
													(void**)&dm_producer_section);
		dm_producer_section->Init(InterfaceMainObject,InterfaceImpl);
...
//			}
		...
		if (type_update == 1) //вставка
			{
			dm_producer_section->NewElement(IdProducer,0);
			}

		if (type_update == 2)   //обновление
			{
			id_producer_section=dc_upd->Values[i][TableUpdateID_REM_SPRSECTION->Index];
			dm_producer_section->OpenElement(id_producer_section);
			}


		dm_producer_section->Element->Edit();
			...
			if (StrToInt(NamecxSpinEdit->Text) > 0)
				...
				dm_producer_section->ElementNAME_REM_SPRSECTION->AsString=name;
				}
			...
			if (StrToInt(NameEngcxSpinEdit->Text) > 0)
				...
				if (name.Length() > 200) { name = name.SetLength(200);}
				dm_producer_section->ElementNAME_ENG_REM_SPRSECTION->AsString=name;
				}
			...
			if (StrToInt(ArtcxSpinEdit->Text) > 0  || cxCheckBoxVidelyatCod->Checked==true)
				...
				dm_producer_section->ElementCODE_REM_SPRSECTION->AsString=artikul;
				}


		dm_producer_section->Element->Post();




				if (dm_producer_section->SaveElement()==false)
					{
					text_error="Ошибка при записи новой номенклатуры: "+dm_producer_section->TextError+"\n";
...
dm_producer_section->kanRelease();
...
void __fastcall TFormaImportSprProducerSection::cxButtonDelStringClick(TObject *Sender)
{
...
void __fastcall TFormaImportSprProducerSection::ActionCloseExecute(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------
...
////---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::NameProducercxButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerSection::OpenFormSpiskaSprProducer(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerSection::ToolButtonSaveExcelClick(TObject *Sender)
...
void __fastcall TFormaImportSprProducerSection::cxButtonProveritClick(TObject *Sender)
...
//			}
		...
		if(TypeSearchcxComboBox->ItemIndex == 2 )
			{  //поиск по артикулу
			id_producer_section= dm_producer_section->FindPoCodu(IdProducer,artikul);
			}

		if(TypeSearchcxComboBox->ItemIndex == 1 )            //1 поиск по наименованию
			{
			id_producer_section= dm_producer_section->FindPoName(IdProducer,name);
			}

		if(TypeSearchcxComboBox->ItemIndex == 3 )            //3 по англ наименованию
			{
			id_producer_section= dm_producer_section->FindPoNameEng(IdProducer,name_eng);
			}
		...
		if(id_producer_section==0) //создаем новую номенклатуру
			{
			//*********************************************************************************
			dc_upd->AppendRecord();
			dc_upd->Values[number_string_table_upd][TableUpdateTypeUpdate->Index] = 1;
			dc_upd->Values[number_string_table_upd][TableUpdateID_REM_SPRSECTION->Index] = "";
			...
			if (StrToInt(NamecxSpinEdit->Text) !=0)
				{
				if (dm_producer_section->ElementNAME_REM_SPRSECTION->AsString
								!= NAME )
					{
					fl_save=true;
					}
			...
			if (StrToInt(NameEngcxSpinEdit->Text) !=0)
				{
				if (dm_producer_section->ElementNAME_ENG_REM_SPRSECTION->AsString
								!= NAME_ENG )
					{
					fl_save=true;
					}
			...
			if (StrToInt(ArtcxSpinEdit->Text) !=0)
				{
				if (dm_producer_section->ElementCODE_REM_SPRSECTION->AsString
								!= ART )
					{
					fl_save=true;
					}
			...
			dc_upd->Values[number_string_table_upd][TableUpdateID_REM_SPRSECTION->Index] = dm_producer_section->ElementID_REM_SPRSECTION->AsString;
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerSection::VidelitCodIsNameRus(UnicodeString * out_name, UnicodeString * out_code, UnicodeString in_name)
{
