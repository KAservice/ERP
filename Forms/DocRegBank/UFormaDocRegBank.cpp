...
//---------------------------------------------------------------------------
int TFormaDocRegBank::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
if (FormaSpiskaSprBSchet==0)
	{
		...
		//FormaSpiskaSprBSchet->LabelFirma->Caption="Фирма: "+DM->DocTNAMEFIRM->AsString;
	}
}
//---------------------------------------------------------------------------
...
cell->Text="Движения регистра банк №"+DM->DocAllNUMDOC->AsString+" от "
...
cell->Text="Основание: "+DM->DocDESCR_DRG_BANK->AsString;
delete cell;
numRow++;
numRow++;
