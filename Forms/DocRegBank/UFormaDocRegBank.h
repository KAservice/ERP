...
#ifndef UFormaDocRegBankH
#define UFormaDocRegBankH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocRegBank : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1TDV_DRG_BANKT;
	TcxGridDBColumn *cxGrid1DBTableView1OPER_DRG_BANKT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_DRG_BANKT;
	TcxGridDBColumn *cxGrid1DBTableView1NAMEFIRM;
	TcxGridDBColumn *cxGrid1DBTableView1NAMEBSCHET;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall cxGrid1DBTableView1NAMEBSCHETPropertiesButtonClick(
		  TObject *Sender, int AButtonIndex);
...
public:		// User declarations
		__fastcall TFormaDocRegBank(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocRegBank *FormaDocRegBank;
//---------------------------------------------------------------------------
#endif
