...
#include "UFormaElementaSprNomPropertiesValue.h"
...
//---------------------------------------------------------------------------
__fastcall TFormaElementaSprNomPropertiesValue::TFormaElementaSprNomPropertiesValue(TComponent* Owner)
        : TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TFormaElementaSprNomPropertiesValue::Init(void)
{
bool result=false;
...
//----------------------------------------------------------------------------
int TFormaElementaSprNomPropertiesValue::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void TFormaElementaSprNomPropertiesValue::UpdateForm(void)
{

}
//---------------------------------------------------------------------------
void __fastcall TFormaElementaSprNomPropertiesValue::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
void __fastcall TFormaElementaSprNomPropertiesValue::ActionOpenHelpExecute(TObject *Sender)
{
...
void __fastcall TFormaElementaSprNomPropertiesValue::ActionCloseExecute(TObject *Sender)
{
TypeEvent=0;
Close();
}
...
void __fastcall TFormaElementaSprNomPropertiesValue::ActionOKExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
int TFormaElementaSprNomPropertiesValue::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TFormaElementaSprNomPropertiesValue::OpenFormaSpiskaSprProperties(void)
{
...
//-----------------------------------------------------------------------------
void TFormaElementaSprNomPropertiesValue::EndViborProperties(void)
{
DM->Element->Edit();
...
//-----------------------------------------------------------------------------
void TFormaElementaSprNomPropertiesValue::OpenFormaSpiskaSprPropertiesValuesList(void)
{
...
//-----------------------------------------------------------------------------
void TFormaElementaSprNomPropertiesValue::EndViborPropertiesValue(void)
{
DM->Element->Edit();
...
//-----------------------------------------------------------------------------
void __fastcall TFormaElementaSprNomPropertiesValue::NamePropcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
...
void __fastcall TFormaElementaSprNomPropertiesValue::NamePropValueListcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
