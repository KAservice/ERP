...
#ifndef UREM_FormaDocPostOtDileraH
#define UREM_FormaDocPostOtDileraH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocPostOtDilera : public TForm
{
__published:	// IDE-managed Components
	...
	TcxLabel *cxLabel4;
	TToolButton *ToolButtonAddAllDilera;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
	void __fastcall ToolButtonAddAllDileraClick(TObject *Sender);
...
public:		// User declarations
		__fastcall TREM_FormaDocPostOtDilera(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocPostOtDilera *REM_FormaDocPostOtDilera;
//---------------------------------------------------------------------------
#endif
