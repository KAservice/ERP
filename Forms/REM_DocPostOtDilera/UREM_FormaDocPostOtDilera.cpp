...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocPostOtDilera::TREM_FormaDocPostOtDilera(TComponent* Owner)
        : TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocPostOtDilera::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMDocPostOtDilera,IID_IREM_DMDocPostOtDilera, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocPostOtDileraImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocPostOtDilera::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocPostOtDilera::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocPostOtDilera::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocPostOtDilera::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocPostOtDilera::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocPostOtDilera::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocPostOtDilera::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocPostOtDilera::ViborRemZ(void)
{
if(Prosmotr==true) return;
if (FormaGurZ==NULL)
		{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::EndViborRemZ(void)
{
if (ActionOperation==aoAddNewString)
	...
	DM->DocT->Edit();
	DM->DocTIDZ_REM_DDILPOSTT->AsString=FormaGurZ->DM->TableID_REM_Z->AsString;
	...
	DM->DocTKOL_REM_DDILPOSTT->AsFloat=1;
	DM->DocT->Post();
...
void __fastcall TREM_FormaDocPostOtDilera::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocPostOtDilera::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocPostOtDilera::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocPostOtDilera::ActionOpenHelpExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocPostOtDilera::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocPostOtDilera::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocPostOtDilera::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocPostOtDilera::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocPostOtDilera::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocPostOtDilera::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocPostOtDilera::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPostOtDilera::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPostOtDilera::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocPostOtDilera::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocPostOtDilera::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocPostOtDilera::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborRemZ();
}
...
void __fastcall TREM_FormaDocPostOtDilera::ActionCloseExecute(TObject *Sender)
{
TypeEvent=0;
...
void __fastcall TREM_FormaDocPostOtDilera::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
TypeEvent=1;
if (DM->SaveDoc()==true)
...
void __fastcall TREM_FormaDocPostOtDilera::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocPostOtDilera::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocPostOtDilera::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocPostOtDilera::RunExternalModule(__int64 id_module, int type_module)
{
...
void TREM_FormaDocPostOtDilera::AfterSaveDoc(void)
{
...
void __fastcall TREM_FormaDocPostOtDilera::NumDocKlientcxDBTextEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPostOtDilera::PosDocKlientcxDBDateEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocPostOtDilera::cxGrid1DBTableView1NAME_REM_ZPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
ViborRemZ();
}
...
void TREM_FormaDocPostOtDilera::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void  TREM_FormaDocPostOtDilera::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocPostOtDilera::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void TREM_FormaDocPostOtDilera::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocPostOtDilera::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocPostOtDilera::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocPostOtDilera::ToolButtonAddAllDileraClick(TObject *Sender)
...
UnicodeString zapros="select rem_z.id_rem_z,                                  \
						...
						and (rem_z.OUT_REM_Z = 0 or rem_z.OUT_REM_Z is null)   \
						and rem_z.pos_rem_z > current_timestamp - 1";
...
while (!DM->pFIBQ->Eof)
	...
	DM->TableAppend();
	DM->DocT->Edit();
	DM->DocTIDZ_REM_DDILPOSTT->AsString=DM->pFIBQ->FieldByName("ID_REM_Z")->AsString;
