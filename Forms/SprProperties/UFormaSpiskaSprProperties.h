...
#ifndef UFormaSpiskaSprPropertiesH
#define UFormaSpiskaSprPropertiesH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprProperties : public TForm
{
__published:	// IDE-managed Components
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_SPROP;
	TcxGridDBColumn *cxGrid1DBTableView1RECNO;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_FOR_PRINT_SPROP;
...
public:		// User declarations
		__fastcall TFormaSpiskaSprProperties(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprProperties *FormaSpiskaSprProperties;
//---------------------------------------------------------------------------
#endif
