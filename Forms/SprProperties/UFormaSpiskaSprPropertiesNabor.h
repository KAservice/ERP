...
#ifndef UFormaSpiskaSprPropertiesNaborH
#define UFormaSpiskaSprPropertiesNaborH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprPropertiesNabor : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_SPROPNABOR;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_SPROPNABOR;
...
public:		// User declarations
		__fastcall TFormaSpiskaSprPropertiesNabor(TComponent* Owner);
		...
		//Текущий интерфейс
		IDMSprPropertiesNabor * DM;
		IDMSprPropertiesNaborGrp *DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprPropertiesNabor *FormaSpiskaSprPropertiesNabor;
//---------------------------------------------------------------------------
#endif
