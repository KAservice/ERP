...
#ifndef UFormaSpiskaSprEdH
#define UFormaSpiskaSprEdH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprEd : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1NEISPED;
	TcxGridDBColumn *cxGrid1DBTableView1RECNO;
	TcxButton *cxButtonClose;
	TcxGridDBColumn *cxGrid1DBTableView1KF2_SED;
...
public:		// User declarations
		__fastcall TFormaSpiskaSprEd(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprEd *FormaSpiskaSprEd;
//---------------------------------------------------------------------------
#endif
