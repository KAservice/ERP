#ifndef UFormaImportSprProducerConditionImplH
#define UFormaImportSprProducerConditionImplH
#include "IFormaImportSprProducerCondition.h"
#include "UFormaImportSprProducerCondition.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TFormaImportSprProducerConditionImpl)) TFormaImportSprProducerConditionImpl : public IFormaImportSprProducerCondition, IkanCallBack
{
public:
   TFormaImportSprProducerConditionImpl();
   ~TFormaImportSprProducerConditionImpl();
   TFormaImportSprProducerCondition * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TFormaImportSprProducerConditionImpl __uuidof(TFormaImportSprProducerConditionImpl)
#endif
