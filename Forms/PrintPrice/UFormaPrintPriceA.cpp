...
if (InterfaceGlobalCom->kanGetClassObject(InterfaceGlobalCom->kanGetCLSIDPoProgId("Oberon.FormaRunExternalModule.1"),
										...
										(void**)&i_cf)!=-1)
	{
	ShowMessage("Ошибка при получении интерфейса IID_IkanClassFactory объекта - Oberon.FormaRunExternalModule.1!");
	}

if (i_cf->kanCreateInstance(IID_IFormaRunExternalModule,(void**)&module)!=-1)
	{
	ShowMessage("Ошибка при получении интерфейса IID_IFormaRunExternalModule объекта - Oberon.FormaRunExternalModule.1!");
	}
i_cf->kanRelease();
