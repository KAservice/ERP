...
#ifndef UFormaDocVipuskProdH
#define UFormaDocVipuskProdH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocVipuskProd : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1KOL_DVIPPRODT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_DVIPPRODT;
	TcxGridDBColumn *cxGrid1DBTableView1RPRICE_DVIPPRODT;
	TcxGridDBColumn *cxGrid1DBTableView1RSUM_DVIPPRODT;
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		void __fastcall EndViborEd(void);
		 ...
		 enum  {ER_NoRekv,ER_InfBase, ER_Firm, ER_Sklad, ER_Nom, ER_Ed,ER_BusinessOper, ER_Project, ER_NO} EditRekvisit;
...
public:		// User declarations
		__fastcall TFormaDocVipuskProd(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocVipuskProd *FormaDocVipuskProd;
//---------------------------------------------------------------------------
#endif
