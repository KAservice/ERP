...
#ifndef UREM_FormaDocVidachaHWH
#define UREM_FormaDocVidachaHWH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaDocVidachaHW : public TForm
{
__published:	// IDE-managed Components
	...
	TcxLabel *cxLabel9;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_DVIDACHA_HWT;
	TcxGridDBColumn *cxGrid1DBTableView1IDHW_REM_DVIDACHA_HWT;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DVIDACHA_HWT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_REM_DVIDACHA_HWT;
	...
	TcxDBTextEdit *KlientPassportcxDBTextEdit;
	TLabel *Label9;
...
public:		// User declarations
		__fastcall TREM_FormaDocVidachaHW(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocVidachaHW *REM_FormaDocVidachaHW;
//---------------------------------------------------------------------------
#endif
