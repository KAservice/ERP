...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocVidachaHW::TREM_FormaDocVidachaHW(TComponent* Owner)
        : TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::FormCreate(TObject *Sender)
{
...
//--------------------------------------------------------------------------
bool TREM_FormaDocVidachaHW::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMDocVidachaHW,IID_IREM_DMDocVidachaHW, (void**)&DM);
...
KlientPassportcxDBTextEdit->DataBinding->DataSource=DM->DataSourceDoc;
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocVidachaHWImpl),false);
...
//--------------------------------------------------------------------------
int TREM_FormaDocVidachaHW::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocVidachaHW::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocVidachaHW::OpenFormSpiskaSprFirm(void)
{
...
//---------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::OpenFormSpiskaSprSklad(void)
{
if (Prosmotr==true) return;
if (SpisokSklad==NULL)
		{
...
//--------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::OpenFormSpiskaSprKlient(void)
{
if (Prosmotr==true) return;
...
void TREM_FormaDocVidachaHW::OpenFormSpiskaSprInfBase(void)
{
if (Prosmotr==true) return;
...
void __fastcall TREM_FormaDocVidachaHW::ViborBaseButtonClick(TObject *Sender)
{
...
void __fastcall TREM_FormaDocVidachaHW::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocVidachaHW::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if (Prosmotr==true) return;
...
void __fastcall TREM_FormaDocVidachaHW::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if (Prosmotr==true) return;
...
void __fastcall TREM_FormaDocVidachaHW::NumDoccxDBTextEditKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocVidachaHW::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocVidachaHW::OplNalcxDBCalcEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocVidachaHW::OplPCcxDBCalcEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocVidachaHW::NalCHKcxDBCalcEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocVidachaHW::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocVidachaHW::ActionInsertStringExecute(TObject *Sender)
{
if (Prosmotr==true) return;
...
void __fastcall TREM_FormaDocVidachaHW::ActionDeleteStringExecute(TObject *Sender)
{
if (Prosmotr==true) return;
DM->TableDelete();
}
...
//Внешние модули
void __fastcall TREM_FormaDocVidachaHW::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::RunExternalModule(__int64 id_module, int type_module)
{
...
void __fastcall TREM_FormaDocVidachaHW::ActionCloseExecute(TObject *Sender)
{
TypeEvent=0;
Close();
}
...
void __fastcall TREM_FormaDocVidachaHW::ActionOKExecute(TObject *Sender)
{
TypeEvent=1;
if (Prosmotr==true)
	{
...
void __fastcall TREM_FormaDocVidachaHW::ActionDvRegExecute(TObject *Sender)
{
if (Prosmotr==true)
	{
	 ShowMessage("Документ открыт только для просмотра!");
...
void __fastcall TREM_FormaDocVidachaHW::ActionSaveExecute(TObject *Sender)
{
if (Prosmotr==true)
	{
	 ShowMessage("Документ открыт только для просмотра!");
...
void TREM_FormaDocVidachaHW::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::NameProjectcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
switch (AButtonIndex)
	{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
...
//---------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::ViborHardware(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::EndViborHardware(void)
{
	...
	DM->DocT->Edit();
	DM->DocTIDHW_REM_DVIDACHA_HWT->AsString=FormaSpiskaSprHardware->DM->TableID_REM_SHARDWARE->AsString;
...
void __fastcall TREM_FormaDocVidachaHW::cxGrid1DBTableView1NAME_REM_SHARDWAREPropertiesButtonClick(TObject *Sender,
		  int AButtonIndex)
{
ViborHardware();
}
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::ReadShtrihCodEvent(int number, UnicodeString sh)
{
//*****************
if (Prosmotr==true)
	{
...
//---------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::FormActivate(TObject *Sender)
{
//зарегистрируем свой IAsyncExternalEvent в главном модуле для получения событий
if(InterfaceMainObject > 0)
	{
...
void __fastcall TREM_FormaDocVidachaHW::FormDeactivate(TObject *Sender)
{
//зарегистрируем свой IAsyncExternalEvent в главном модуле для получения событий
...
void TREM_FormaDocVidachaHW::ObrabotatReadBarCodeHardware(UnicodeString sh)
{
	...
	if (dm_hw->OpenElement(id_hw) > 0)
		{
					...
					DM->DocTIDHW_REM_DVIDACHA_HWT->AsString=id_hw;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::ActionChangeERBCExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocVidachaHW::ActionAddHWPoCoduExecute(TObject *Sender)
{
OpenFormInputCodeHW();
}
//---------------------------------------------------------------------------
//ввод кода номенклатуры
void TREM_FormaDocVidachaHW::OpenFormInputCodeHW(void)
{
if (Prosmotr==true)
	{
	ShowMessage("Документ открыт только для просмотра!");
...
//---------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::EndInputCodeHW(void)
{
__int64 id_hw=0;
int code=0;
...
//---------------------------------------------------------------------------
//ввод кода номенклатуры
void TREM_FormaDocVidachaHW::OpenFormInputIdHW(void)
{
if (Prosmotr==true)
	{
	ShowMessage("Документ открыт только для просмотра!");
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::ActionAddPoIdExecute(TObject *Sender)
{
OpenFormInputIdHW();
}
//---------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::EndInputIdHW(void)
{
...
//выбор заявки
void TREM_FormaDocVidachaHW::ViborRemZ(void)
{
if(Prosmotr==true) return;
if (FormaGurZ==NULL)
		{
...
//----------------------------------------------------------------------------
void TREM_FormaDocVidachaHW::EndViborRemZ(void)
{
	IREM_DMZayavka * dm_z;
	...
	DM->Doc->Edit();
	DM->DocIDZ_REM_DVIDACHA_HW->AsString=FormaGurZ->DM->TableID_REM_Z->AsString;
	...
	DM->DocKLIENT_NAME_REM_DVIDACHA_HW->AsString = dm_z->GurZKLIENT_NAME_REM_Z->AsString;
	DM->DocKLIENT_ADR_REM_DVIDACHA_HW->AsString = dm_z->GurZKLIENT_ADR_REM_Z->AsString;
	DM->DocKLIENT_PHONE_REM_DVIDACHA_HW->AsString = dm_z->GurZKLIENT_PHONE_REM_Z->AsString;
	DM->Doc->Post();
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocVidachaHW::NameZcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
	...
	case 1:
		...
		//NameNomEdit->Text="";
		DM->Doc->Edit();
		DM->DocIDZ_REM_DVIDACHA_HW->Clear();
		DM->Doc->Post();
		}break;
	}
}
