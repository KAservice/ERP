...
LabelNameGrp->Caption="Тип. работы\\...";
HintLabel->Caption="";
...
cxTreeView1->Items->AddObject(NULL,"Тип. работы",lpIDGrp);
...
//---------------------------------------------------------------------------------
//---------------------------------------------------------------------------
int TREM_FormaSpiskaSprTypRabot::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
