...
#ifndef UREM_FormaSpiskaSprTypRabotH
#define UREM_FormaSpiskaSprTypRabotH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprTypRabot : public TForm
{
__published:	// IDE-managed Components
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_STYPRABOT;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_ENG_REM_STYPRABOT;
...
private:	// User declarations
		...
		IREM_FormaElementaSprTypRabotGrp * FormaGrpElementa;
		...
		IREM_FormaElementaSprTypRabot * FormaElementa;
...
public:		// User declarations
		__fastcall TREM_FormaSpiskaSprTypRabot(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprTypRabot *REM_FormaSpiskaSprTypRabot;
//---------------------------------------------------------------------------
#endif
