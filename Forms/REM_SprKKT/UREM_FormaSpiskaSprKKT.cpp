...
cxTreeView1->Items->AddObject(NULL,"ККТ",lpIDGrp);
...
//--------------------------------------------------------------------------
int TREM_FormaSpiskaSprKKT::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
      ...
      TObject *Sender)
{
		...
		dv->UpdateForm();;
		dv->TextZayavka="ККТ: " +DM->TableNAME_REM_SKKT->AsString;
