...
//---------------------------------------------------------------------------
__fastcall THOT_FormaReportRasm::THOT_FormaReportRasm(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool THOT_FormaReportRasm::Init(void)
{
bool result=false;
...
DM=new THOT_DMReportRasm(Application);
...
//---------------------------------------------------------------------------
int THOT_FormaReportRasm::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall THOT_FormaReportRasm::FormClose(TObject *Sender,
      TCloseAction &Action)
{
delete DM;
Action=caFree;
...
//---------------------------------------------------------------------------
int THOT_FormaReportRasm::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
//----------------------------------------------------------------------------
void __fastcall THOT_FormaReportRasm::cxButtonCreateClick(TObject *Sender)
{
cxGrid1Level1->Caption="Размещение c " +DateTimeToStr(PosNachcxDateEdit->Date)
...
void THOT_FormaReportRasm::ViborFirm(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall THOT_FormaReportRasm::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
void __fastcall THOT_FormaReportRasm::NameFirmcxButtonEditPropertiesButtonClick(
...
void __fastcall THOT_FormaReportRasm::ActionCloseExecute(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------

void __fastcall THOT_FormaReportRasm::ActionPrintExecute(TObject *Sender)
{
