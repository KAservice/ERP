...
#ifndef UFormaSpiskaSprOborudH
#define UFormaSpiskaSprOborudH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprOborud : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1TYPE_OBORUD;
	TcxGridDBColumn *cxGrid1DBTableView1MODEL_OBORUD;
	TcxGridDBColumn *cxGrid1DBTableView1MODUL_SOBORUD;
	TcxGridDBColumn *cxGrid1DBTableView1RECNO;
	TcxGridDBColumn *cxGrid1DBTableViewON_START_SOBORUD;
...
public:		// User declarations
		__fastcall TFormaSpiskaSprOborud(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprOborud *FormaSpiskaSprOborud;
//---------------------------------------------------------------------------
#endif
