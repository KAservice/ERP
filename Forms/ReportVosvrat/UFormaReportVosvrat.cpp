...
//---------------------------------------------------------------------------
__fastcall TFormaReportVosvrat::TFormaReportVosvrat(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFormaReportVosvrat::FormCreate(TObject *Sender)
{
PosConcxDateEdit->Date=Date();
unsigned short Year;
unsigned short Month;
unsigned short Day;
PosConcxDateEdit->Date.DecodeDate(&Year,&Month,&Day);
PosNachcxDateEdit->Date=PosConcxDateEdit->Date-Day+1;
PosConcxDateEdit->Date=PosConcxDateEdit->Date+1;
...
void __fastcall TFormaReportVosvrat::FormClose(TObject *Sender,
      TCloseAction &Action)
{
delete DM;
Action=caFree;
...
void __fastcall TFormaReportVosvrat::cxButtonCreateClick(TObject *Sender)
{
DM->OpenReportNal(IdFirm,IdKassa, PosNachcxDateEdit->Date, PosConcxDateEdit->Date);
}
//---------------------------------------------------------------------------

void __fastcall TFormaReportVosvrat::cxButtonCloseClick(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------
...
void TFormaReportVosvrat::ViborKassa(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaReportVosvrat::EndViborKassa(TObject *Sender)
{
...
void __fastcall TFormaReportVosvrat::NameKassacxButtonEditPropertiesButtonClick(
...
void TFormaReportVosvrat::ViborFirm(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaReportVosvrat::EndViborFirm(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaReportVosvrat::NameFirmcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
switch (AButtonIndex)
	{
...
//---------------------------------------------------------------------------
void TFormaReportVosvrat::PrintKM3()
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaReportVosvrat::cxButtonPrintKM3Click(TObject *Sender)
{
PrintKM3();	
}
//---------------------------------------------------------------------------
void TFormaReportVosvrat::OutputZagolovokKM3(TSheetEditor *prForm)
{
...
//----------------------------------------------------------------------------
void TFormaReportVosvrat::OutputStringKM3(TSheetEditor *prForm)
{
TcxSSCellObject *cell;
TRect rect;
...
//-----------------------------------------------------------------------------
void TFormaReportVosvrat::OutputPodavalKM3(TSheetEditor *prForm)
{
TcxSSCellObject *cell;
TRect rect;
x=1;
