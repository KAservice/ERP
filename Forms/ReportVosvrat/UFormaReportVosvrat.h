...
#ifndef UFormaReportVosvratH
#define UFormaReportVosvratH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaReportVosvrat : public TForm
{
...
public:		// User declarations
	__fastcall TFormaReportVosvrat(TComponent* Owner);
        TDMReportVosvrat *DM;
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaReportVosvrat *FormaReportVosvrat;
//---------------------------------------------------------------------------
#endif
