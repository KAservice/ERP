...
//---------------------------------------------------------------------------
__fastcall TFormaDocOstVs::TFormaDocOstVs(TComponent* Owner)
		: TForm(Owner)
{
...
EditRekvisit=NO;
InterfaceGlobalCom->kanCreateObject("Oberon.DMDocOstVs.1",IID_IDMDocOstVs, (void**)&DM);
...
PrihodcxDBCalcEdit->DataBinding->DataSource=DM->DataSourceDoc;
RashodcxDBCalcEdit->DataBinding->DataSource=DM->DataSourceDoc;
DvRegPaySalecxDBCheckBox->DataBinding->DataSource=DM->DataSourceDoc;
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TFormaDocOstVsImpl),false);
...
//--------------------------------------------------------------------------
int TFormaDocOstVs::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void TFormaDocOstVs::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaDocOstVs::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
int TFormaDocOstVs::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TFormaDocOstVs::OpenFormSpiskaSprFirm(void)
{
...
//--------------------------------------------------------------------------
void TFormaDocOstVs::OpenFormSpiskaSprKlient(void)
{
if (Prosmotr==true) return;
...
void TFormaDocOstVs::OpenFormSpiskaSprInfBase(void)
{
if (Prosmotr==true) return;
...
void __fastcall TFormaDocOstVs::ActionOpenHelpExecute(TObject *Sender)
{
Application->HelpJump("DocOstVs");	
}
//---------------------------------------------------------------------------


void __fastcall TFormaDocOstVs::NameInfbasecxDBButtonEditPropertiesButtonClick(
...
void __fastcall TFormaDocOstVs::NameFirmcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if (Prosmotr==true) return;
...
void __fastcall TFormaDocOstVs::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TFormaDocOstVs::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if (Prosmotr==true) return;
...
void __fastcall TFormaDocOstVs::NumDoccxDBTextEditKeyDown(TObject *Sender,
...
void __fastcall TFormaDocOstVs::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TFormaDocOstVs::PrihodcxDBCalcEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TFormaDocOstVs::RashodcxDBCalcEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TFormaDocOstVs::DvRegPaySalecxDBCheckBoxKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TFormaDocOstVs::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TFormaDocOstVs::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TFormaDocOstVs::RunExternalModule(__int64 id_module, int type_module)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaDocOstVs::ActionCloseExecute(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------

void __fastcall TFormaDocOstVs::ActionOKExecute(TObject *Sender)
{
if (Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TFormaDocOstVs::ActionDvRegExecute(TObject *Sender)
{
if (Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TFormaDocOstVs::ActionSaveExecute(TObject *Sender)
{
if (Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
void TFormaDocOstVs::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TFormaDocOstVs::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TFormaDocOstVs::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TFormaDocOstVs::EndViborBusinessOper(void)
{
...
void __fastcall TFormaDocOstVs::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TFormaDocOstVs::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
