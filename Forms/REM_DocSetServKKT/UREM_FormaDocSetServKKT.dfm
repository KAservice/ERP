object REM_FormaDocSetServKKT: TREM_FormaDocSetServKKT
  Left = 290
  Top = 119
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      Caption = #1057#1077#1088#1074#1080#1089' '#1050#1050#1058'  '#8470
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -23
      Font.Name = 'MS Sans Serif'
    ...
    object PrimcxDBTextEdit: TcxDBTextEdit
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      DataBinding.DataField = 'PRIM_REM_DSETSERVKKT'
      DataBinding.DataSource = REM_DMDocSetServKKT.DataSourceDoc
      TabOrder = 5
    ...
    object OpercxDBImageComboBox: TcxDBImageComboBox
      ...
      DataBinding.DataField = 'TDOC_REM_DSETSERVKKT'
      DataBinding.DataSource = REM_DMDocSetServKKT.DataSourceDoc
      Properties.Items = <>
      TabOrder = 10
      Width = 267
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = REM_DMDocSetServKKT.DataSourceDocT
      ...
      object cxGrid1DBTableView1NAME_REM_SKKT: TcxGridDBColumn
        Caption = #1050#1050#1058
        DataBinding.FieldName = 'NAME_REM_SKKT'
        ...
        Properties.OnButtonClick = cxGrid1DBTableView1NAME_REM_SKKTPropertiesButtonClick
        Width = 467
      end
      object cxGrid1DBTableView1SUM_REM_DSETSERVKKTT: TcxGridDBColumn
        Caption = #1057#1091#1084#1084#1072
        DataBinding.FieldName = 'SUM_REM_DSETSERVKKTT'
        Width = 159
      end
    end
