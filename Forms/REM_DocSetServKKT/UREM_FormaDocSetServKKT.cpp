...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocSetServKKT::TREM_FormaDocSetServKKT(TComponent* Owner)
		: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocSetServKKT::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject("Oberon.REM_DMDocSetServKKT.1",IID_IREM_DMDocSetServKKT, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocSetServKKTImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocSetServKKT::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocSetServKKT::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServKKT::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocSetServKKT::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocSetServKKT::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServKKT::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocSetServKKT::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServKKT::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocSetServKKT::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServKKT::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocSetServKKT::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServKKT::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocSetServKKT::ViborKKT(void)
{
if(Prosmotr==true) return;
if (FormaSpiskaSprKKT==NULL)
		{
		InterfaceGlobalCom->kanCreateObject("Oberon.REM_FormaSpiskaSprKKT.1",IID_IREM_FormaSpiskaSprKKT,
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServKKT::EndViborKKT(void)
{
	...
	DM->DocT->Edit();
	DM->DocTIDKKT_REM_DSETSERVKKTT->AsString=FormaSpiskaSprKKT->DM->TableID_REM_SKKT->AsString;
	DM->DocTNAME_REM_SKKT->AsString=FormaSpiskaSprKKT->DM->TableNAME_REM_SKKT->AsString;
	DM->DocT->Post();
...
void __fastcall TREM_FormaDocSetServKKT::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocSetServKKT::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocSetServKKT::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocSetServKKT::ActionOpenHelpExecute(TObject *Sender)
{
Application->HelpJump("DocKM1");
}
//---------------------------------------------------------------------------

void __fastcall TREM_FormaDocSetServKKT::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocSetServKKT::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocSetServKKT::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocSetServKKT::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocSetServKKT::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocSetServKKT::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocSetServKKT::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocSetServKKT::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocSetServKKT::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocSetServKKT::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocSetServKKT::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocSetServKKT::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKKT();
}
...
void __fastcall TREM_FormaDocSetServKKT::cxGrid1DBTableView1NAME_REM_SKKTPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if(Prosmotr==true) return;
ActionOperation=aoNO;
...
void __fastcall TREM_FormaDocSetServKKT::ActionCloseExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocSetServKKT::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocSetServKKT::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocSetServKKT::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocSetServKKT::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocSetServKKT::RunExternalModule(__int64 id_module, int type_module)
{
