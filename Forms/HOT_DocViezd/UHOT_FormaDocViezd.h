...
#ifndef UHOT_FormaDocViezdH
#define UHOT_FormaDocViezdH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class THOT_FormaDocViezd : public TForm
{
...
private:	// User declarations
	   ...
	   void RunExternalModule(__int64 id_module, int type_module);
		...
		enum {ER_NoRekv,ER_Firm,ER_InfBase,
		ER_Plat,ER_Guest,
		ER_TableSost} EditRekvisit;

		int numRow;
		int numCol;
		int KolMest;
public:		// User declarations
		__fastcall THOT_FormaDocViezd(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE THOT_FormaDocViezd *HOT_FormaDocViezd;
//---------------------------------------------------------------------------
#endif
