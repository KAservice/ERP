...
//---------------------------------------------------------------------------
__fastcall THOT_FormaDocViezd::THOT_FormaDocViezd(TComponent* Owner)
		: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool THOT_FormaDocViezd::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject("Oberon.HOT_DMDocViezd.1",IID_IHOT_DMDocViezd, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_THOT_FormaDocViesdImpl),false);
...
//--------------------------------------------------------------------------
int THOT_FormaDocViezd::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void THOT_FormaDocViezd::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
void __fastcall THOT_FormaDocViezd::ActionOpenHelpExecute(TObject *Sender)
{
Application->HelpJump("Hotel/Doc/DocViezd");	
}
//---------------------------------------------------------------------------
int THOT_FormaDocViezd::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
if (number_procedure_end==ER_TableSost)
	{
...
//выбор фирмы
void THOT_FormaDocViezd::ViborFirm(void)
{
...
//--------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::EndViborFirm(void)
{
...
void THOT_FormaDocViezd::ViborInfBase(void)
{
if (Prosmotr==true) return;
...
//---------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::EndViborInfBase(void)
{
...
//--------------------------------------------------------------------------
//выбор плательщика
void THOT_FormaDocViezd::ViborPlat(void)
{
if (Prosmotr==true) return;
...
//---------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::EndViborPlat(void)
{
...
//---------------------------------------------------------------------------
//выбор гостя
void THOT_FormaDocViezd::ViborGuest(void)
{
if (Prosmotr==true) return;
if (FormaSpiskaSprKlient==NULL)
		{
...
//----------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::EndViborGuest(void)
{
...
//----------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::NameInfBasecxDBButtonEditPropertiesButtonClick(
...
void __fastcall THOT_FormaDocViezd::NameFirmcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborFirm();	
}
...
void __fastcall THOT_FormaDocViezd::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborPlat();	
}
//---------------------------------------------------------------------------
//выбор состояния НФ
void THOT_FormaDocViezd::AddSostNF(void)
{
if (Prosmotr==true) return;
if (HOT_FormaSpiskaTableSostNF==NULL)
		...
		HOT_FormaSpiskaTableSostNF->NumberProcVibor=ER_TableSost;
		HOT_FormaSpiskaTableSostNF->UpdateForm();
		}
}
//----------------------------------------------------------------------------
void __fastcall THOT_FormaDocViezd::EndAddSostNF(void)
{

	DM->AddString();
	DM->DocT->Edit();
	DM->DocTIDSOST_HOT_DVIESDT->AsString=HOT_FormaSpiskaTableSostNF->DM->TableID_HOT_SOSTNF->AsString;
...
void __fastcall THOT_FormaDocViezd::ActionAddStringExecute(TObject *Sender)
{
AddSostNF();	
}
//---------------------------------------------------------------------------

void __fastcall THOT_FormaDocViezd::ActionDeleteStringExecute(TObject *Sender)
{
if (Prosmotr==true) return;
DM->DeleteString();	
}
...
void __fastcall THOT_FormaDocViezd::NumbercxDBTextEditKeyDown(TObject *Sender,
...
void __fastcall THOT_FormaDocViezd::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall THOT_FormaDocViezd::DescrcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall THOT_FormaDocViezd::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void THOT_FormaDocViezd::RunExternalModule(__int64 id_module, int type_module)
{
...
void __fastcall THOT_FormaDocViezd::ActionCloseExecute(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------

void __fastcall THOT_FormaDocViezd::ActionOKExecute(TObject *Sender)
{
if (Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall THOT_FormaDocViezd::ActionDvRegExecute(TObject *Sender)
{
if (Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall THOT_FormaDocViezd::ActionSaveExecute(TObject *Sender)
{
if (Prosmotr==true)
	{
