...
#ifndef UHLP_FormaSpiskaSprInfBlockH
#define UHLP_FormaSpiskaSprInfBlockH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class THLP_FormaSpiskaSprInfBlock : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_HLP_PAGE;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_HLP_PAGE;
...
void RunExternalModule(__int64 id_module, int type_module);
	   ...
	   enum  {ER_NoRekv,ER_GrpForm, ER_ElementForm, ER_ShowPage} ER_Rekvisit;

public:		// User declarations
		__fastcall THLP_FormaSpiskaSprInfBlock(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE THLP_FormaSpiskaSprInfBlock *HLP_FormaSpiskaSprInfBlock;
//---------------------------------------------------------------------------
#endif
