...
#ifndef UHOT_FormaSpiskaSprSostNomH
#define UHOT_FormaSpiskaSprSostNomH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class THOT_FormaSpiskaSprSostNom : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1FLBRON_HOT_SSOSTNOM;
	TcxGridDBColumn *cxGrid1DBTableView1FLRASM_HOT_SSOSTNOM;
	TAction *ActionClose;
...
public:		// User declarations
		__fastcall THOT_FormaSpiskaSprSostNom(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE THOT_FormaSpiskaSprSostNom *HOT_FormaSpiskaSprSostNom;
//---------------------------------------------------------------------------
#endif
