...
#ifndef UREM_FormaDocVZipVosvratPostH
#define UREM_FormaDocVZipVosvratPostH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocVZipVosvratPost : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1NAME_REM_Z;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1NUM_REM_Z;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1POS_REM_Z;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1SERNUM_REM_Z;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1SERNUM2_REM_Z;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1KLIENT_NAME_REM_Z;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1MODEL_REM_Z;
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1NAME_REM_STVZIP;
	...
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1SERNUM2_REM_SHARDWARE;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1NAME_REM_SPRMODEL;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1KOL_REM_DVZVPOT;
	TcxGridDBBandedColumn *cxGrid1DBBandedTableView1NAME_SMHRAN;
	TToolButton *ToolButtonOpenAktPr;
	TcxButtonEdit *cxButtonEditViborGrpNom;
 ...
 //       void __fastcall DeleteStringClick(TObject *Sender);
	...
	void __fastcall cxGrid1DBBandedTableView1NAME_SMHRANPropertiesButtonClick(TObject *Sender,
          int AButtonIndex);
	void __fastcall ToolButtonOpenAktPrClick(TObject *Sender);
	void __fastcall cxButtonEditViborGrpNomPropertiesButtonClick(TObject *Sender, int AButtonIndex);
...
public:		// User declarations
		__fastcall TREM_FormaDocVZipVosvratPost(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocVZipVosvratPost *REM_FormaDocVZipVosvratPost;
//---------------------------------------------------------------------------
#endif
