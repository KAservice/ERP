...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocSetServHW::TREM_FormaDocSetServHW(TComponent* Owner)
		: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocSetServHW::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject("Oberon.REM_DMDocSetServHW.1",IID_IREM_DMDocSetServHW, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocSetServHWImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocSetServHW::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocSetServHW::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServHW::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
if(FormaSpiskaSprHW)FormaSpiskaSprHW->kanRelease();
...
//---------------------------------------------------------------------------
int TREM_FormaDocSetServHW::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocSetServHW::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServHW::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocSetServHW::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServHW::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocSetServHW::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServHW::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocSetServHW::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServHW::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocSetServHW::ViborHW(void)
{
if(Prosmotr==true) return;
if (FormaSpiskaSprHW==NULL)
		{
		InterfaceGlobalCom->kanCreateObject("Oberon.REM_FormaSpSprHardware.1",IID_IREM_FormaSpiskaSprHardware,
													(void**)&FormaSpiskaSprHW);
		FormaSpiskaSprHW->Init(InterfaceMainObject,InterfaceImpl);
		if (!FormaSpiskaSprHW) return;
		FormaSpiskaSprHW->Vibor=true;
		FormaSpiskaSprHW->NumberProcVibor=ER_Hardware;
		FormaSpiskaSprHW->UpdateForm();
		}

}
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocSetServHW::EndViborHW(void)
{
	...
	DM->DocT->Edit();
	DM->DocTIDHW_REM_DSETSERVHWT->AsString=FormaSpiskaSprHW->DM->TableID_REM_SHARDWARE->AsString;
	DM->DocTNAME_REM_SHARDWARE->AsString=FormaSpiskaSprHW->DM->TableNAME_REM_SHARDWARE->AsString;
	DM->DocT->Post();
...
void __fastcall TREM_FormaDocSetServHW::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocSetServHW::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocSetServHW::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocSetServHW::ActionOpenHelpExecute(TObject *Sender)
{
Application->HelpJump("DocKM1");
}
//---------------------------------------------------------------------------

void __fastcall TREM_FormaDocSetServHW::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocSetServHW::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocSetServHW::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocSetServHW::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocSetServHW::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocSetServHW::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocSetServHW::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocSetServHW::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocSetServHW::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocSetServHW::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocSetServHW::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocSetServHW::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborHW();
}
...
void __fastcall TREM_FormaDocSetServHW::cxGrid1DBTableView1NAME_REM_SKKTPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
if(Prosmotr==true) return;
ActionOperation=aoNO;
...
void __fastcall TREM_FormaDocSetServHW::ActionCloseExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocSetServHW::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocSetServHW::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocSetServHW::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocSetServHW::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocSetServHW::RunExternalModule(__int64 id_module, int type_module)
{
