...
#ifndef UREM_FormaDocSetServHWH
#define UREM_FormaDocSetServHWH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocSetServHW : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1SUM_REM_SETSERVHWT;
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		//выбор ККТ
		IREM_FormaSpiskaSprHardware* FormaSpiskaSprHW;
		void ViborHW(void);
		void __fastcall EndViborHW(void);


		enum  { aoNO,aoAddNewString} ActionOperation;
	   	enum {ER_NoRekv,ER_InfBase,ER_Firm,ER_Sklad,ER_Klient,ER_Hardware} EDitRekvisit;
        
		void BeforeSaveDoc(void);
public:		// User declarations
		__fastcall TREM_FormaDocSetServHW(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocSetServHW *REM_FormaDocSetServHW;
//---------------------------------------------------------------------------
#endif
