...
#ifndef UREM_FormaSpiskaSprProducerNeisprH
#define UREM_FormaSpiskaSprProducerNeisprH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprProducerNeispr : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1CODE_REM_SPRMODEL;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_SPRNEISPR;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_ENG_REM_SPRNEISPR;
...
private:	// User declarations
		...
		IREM_FormaElementaSprProducerNeisprGrp * FormaGrpElementa;
		...
		IREM_FormaElementaSprProducerNeispr * FormaElementa;
...
public:		// User declarations
		__fastcall TREM_FormaSpiskaSprProducerNeispr(TComponent* Owner);
		...
		IREM_DMSprProducerNeispr* DM;
		IREM_DMSprProducerNeisprGrp* DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprProducerNeispr *REM_FormaSpiskaSprProducerNeispr;
//---------------------------------------------------------------------------
#endif
