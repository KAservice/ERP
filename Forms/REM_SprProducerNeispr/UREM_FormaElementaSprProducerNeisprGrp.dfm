object REM_FormaElementaSprProducerNeisprGrp: TREM_FormaElementaSprProducerNeisprGrp
  Left = 454
  Top = 350
  Caption = #1043#1088#1091#1087#1087#1072' '#1085#1077#1080#1089#1087#1088#1072#1074#1085#1086#1089#1090#1077#1081' ('#1087#1088#1086#1080#1079#1074#1086#1076#1080#1090#1077#1083#1103')'
  ClientHeight = 208
  ClientWidth = 478
  Color = clBtnFace
  ...
  object IdcxDBLabel: TcxDBLabel
    ...
    Top = 8
    AutoSize = True
    DataBinding.DataField = 'ID_REM_SPRNEISPR_GRP'
  end
