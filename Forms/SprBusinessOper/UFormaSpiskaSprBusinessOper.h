...
#ifndef UFormaSpiskaSprBusinessOperH
#define UFormaSpiskaSprBusinessOperH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprBusinessOper : public TForm
{
...
public:		// User declarations
		__fastcall TFormaSpiskaSprBusinessOper(TComponent* Owner);
		...
		IDMSprBusinessOper* DM;
		IDMSprGrpBusinessOper *DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprBusinessOper *FormaSpiskaSprBusinessOper;
//---------------------------------------------------------------------------
#endif
