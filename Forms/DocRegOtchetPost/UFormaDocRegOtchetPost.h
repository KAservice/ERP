...
#ifndef UFormaDocRegOtchetPostH
#define UFormaDocRegOtchetPostH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocRegOtchetPost : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1TDV_DRG_OTCHPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_DRG_OTCHPOSTT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_DRG_OTCHPOSTT;
...
private:	// User declarations
	...
	void __fastcall EndViborProject(void);
		...
		enum  {ER_NoRekv,ER_InfBase, ER_Firm, ER_BankSchet,
					 ER_Sklad, ER_Klient, ER_Dogovor, ER_Kassa,
					 ER_BusinessOper, ER_Project, ER_Nom,
					  ER_Ed,ER_Part,ER_NO} EditRekvisit;
public:		// User declarations
		__fastcall TFormaDocRegOtchetPost(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocRegOtchetPost *FormaDocRegOtchetPost;
//---------------------------------------------------------------------------
#endif
