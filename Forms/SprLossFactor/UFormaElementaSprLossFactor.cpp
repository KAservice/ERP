...
int TFormaElementaSprLossFactor::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
if (DM->SaveElement()==true)
	...
	if (DMSprLossFactorValue->SaveIsmen()==true)
		...
		{
		ShowMessage("Ошибка при записи справочника цен! "+DMSprLossFactorValue->TextError);
		}
	}
else
	{
