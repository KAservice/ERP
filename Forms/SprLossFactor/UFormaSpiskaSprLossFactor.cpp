...
LabelNameGrp->Caption="Продукты (технология)\\...";
HintLabel->Caption="";
...
cxTreeView1->Items->AddObject(NULL,"Продукты (технология)",lpIDGrp);
...
//-------------------------------------------------------------------------------
int TFormaSpiskaSprLossFactor::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
