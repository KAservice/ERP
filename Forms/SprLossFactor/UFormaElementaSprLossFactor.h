...
#ifndef UFormaElementaSprLossFactorH
#define UFormaElementaSprLossFactorH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaElementaSprLossFactor : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1IDFACTOR_SLOSS_FACTOR_VAL;
...
public:		// User declarations
		__fastcall TFormaElementaSprLossFactor(TComponent* Owner);
		...
		//Текущий интерфейс
		IDMSprLossFactor * DM;
		IDMSprLossFactorValue * DMSprLossFactorValue;
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaElementaSprLossFactor *FormaElementaSprLossFactor;
//---------------------------------------------------------------------------
#endif
