...
#ifndef UFormaSpiskaSprLossFactorH
#define UFormaSpiskaSprLossFactorH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprLossFactor : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1CODE_SLOSS_FACTOR;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_SLOSS_FACTOR;
...
public:		// User declarations
		__fastcall TFormaSpiskaSprLossFactor(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprLossFactor *FormaSpiskaSprLossFactor;
//---------------------------------------------------------------------------
#endif
