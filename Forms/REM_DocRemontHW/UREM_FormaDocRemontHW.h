...
#ifndef UREM_FormaDocRemontHWH
#define UREM_FormaDocRemontHWH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocRemontHW : public TForm
{
__published:	// IDE-managed Components
	...
	TLabel *Label4;
	TLabel *Label7;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DREMONTHWT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_REM_DREMONTHWT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICE_REM_DREMONTHWT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_REM_DREMONTHWT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICEMEX_REM_DREMONTHWT;
	TcxGridDBColumn *cxGrid1DBTableView1SUMMEX_REM_DREMONTHWT;
	...
	TcxLabel *cxLabel4;
	TcxLabel *cxLabel9;
	TcxGridDBColumn *cxGrid1DBTableView1DVREG_REM_DREMONTHWT;
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		enum {ER_NoRekv,ER_InfBase,ER_Firm,ER_Sklad,ER_Klient,ER_Hardware,ER_Nom,ER_Ed,ER_BusinessOper, ER_Project} EDitRekvisit;
...
public:		// User declarations
		__fastcall TREM_FormaDocRemontHW(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocRemontHW *REM_FormaDocRemontHW;
//---------------------------------------------------------------------------
#endif
