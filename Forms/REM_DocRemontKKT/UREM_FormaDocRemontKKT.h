...
#ifndef UREM_FormaDocRemontKKTH
#define UREM_FormaDocRemontKKTH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocRemontKKT : public TForm
{
__published:	// IDE-managed Components
	...
	TcxDBButtonEdit *NameKKTcxDBButtonEdit;
	TLabel *Label4;
	TLabel *Label7;
	TcxGridDBColumn *cxGrid1DBTableView1RECNO;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DREMONTKKTT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_REM_DREMONTKKTT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICE_REM_DREMONTKKTT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_REM_DREMONTKKTT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICEMEX_REM_DREMONTKKTT;
	TcxGridDBColumn *cxGrid1DBTableView1SUMMEX_REM_DREMONTKKTT;
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
        ...
        enum {ER_NoRekv,ER_InfBase,ER_Firm,ER_Sklad,ER_Klient,ER_KKT,ER_Nom,ER_Ed} EDitRekvisit;
        
		IDMSprTypePrice *DMSprTypeRPrice;
		void BeforeSaveDoc(void);

public:		// User declarations
		__fastcall TREM_FormaDocRemontKKT(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocRemontKKT *REM_FormaDocRemontKKT;
//---------------------------------------------------------------------------
#endif
