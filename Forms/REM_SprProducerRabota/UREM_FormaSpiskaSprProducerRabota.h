...
#ifndef UREM_FormaSpiskaSprProducerRabotaH
#define UREM_FormaSpiskaSprProducerRabotaH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprProducerRabota : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1CODE_REM_SPRRABOTAL;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_SPRRABOTA;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_ENG_REM_SPRRABOTA;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_REM_SPRRABOTA;
	TcxGridDBColumn *cxGrid1DBTableView1LEVEL_STR_REM_SPRRABOTA;
...
private:	// User declarations
		...
		IREM_FormaElementaSprProducerRabotaGrp * FormaGrpElementa;
		...
		IREM_FormaElementaSprProducerRabota * FormaElementa;
...
public:		// User declarations
		__fastcall TREM_FormaSpiskaSprProducerRabota(TComponent* Owner);
		...
		IREM_DMSprProducerRabotaGrp* DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprProducerRabota *REM_FormaSpiskaSprProducerRabota;
//---------------------------------------------------------------------------
#endif
