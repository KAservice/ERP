...
#ifndef UFormaSpiskaSprCustomerUserH
#define UFormaSpiskaSprCustomerUserH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaSpiskaSprCustomerUser : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_CUST_USER;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_CUST_USER;
	TcxLabel *cxLabel2;
...
void RunExternalModule(__int64 id_module, int type_module);
	   ...
	   enum  {ER_NoRekv,ER_GrpForm, ER_ElementForm, ER_Account} ER_Rekvisit;
...
public:		// User declarations
		__fastcall TFormaSpiskaSprCustomerUser(TComponent* Owner);
		...
		//Текущий интерфейс
		IDMSprCustomerUser* DM;
		IDMSprCustomerUserGrp *DMGrp;

		bool Vibor;                        //форма открыта для выбора
		int NumberProcVibor;               //какую процедуру использовать для обработки выбора во внешней форме

		__int64 IdGrpElement;      //текущая группа
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaSpiskaSprCustomerUser *FormaSpiskaSprCustomerUser;
//---------------------------------------------------------------------------
#endif
