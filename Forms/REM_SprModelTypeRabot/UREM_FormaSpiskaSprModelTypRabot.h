...
#ifndef UREM_FormaSpiskaSprModelTypRabotH
#define UREM_FormaSpiskaSprModelTypRabotH
//---------------------------------------------------------------------------
...
#include "cxMemo.hpp"
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprModelTypRabot : public TForm
{
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		enum  {ER_NoRekv,ER_Element, NO} EditRekvisit;

public:		// User declarations
		__fastcall TREM_FormaSpiskaSprModelTypRabot(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprModelTypRabot *REM_FormaSpiskaSprModelTypRabot;
//---------------------------------------------------------------------------
#endif
