#ifndef UHOT_FormaGurAllDocImplH
#define UHOT_FormaGurAllDocImplH
#include "IHOT_FormaGurAllDoc.h"
#include "UHOT_FormaGurAllDoc.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_THOT_GurAllDocImpl)) THOT_FormaGurAllDocImpl : public IHOT_FormaGurAllDoc, IkanCallBack
{
public:
   THOT_FormaGurAllDocImpl();
   ~THOT_FormaGurAllDocImpl();
   THOT_FormaGurAllDoc * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IHOT_FormaGurAllDoc
   ...
   virtual IHOT_DMGurAllDoc * get_DM(void);
   virtual void set_DM(IHOT_DMGurAllDoc * DM);
...
#define CLSID_THOT_FormaGurAllDocImpl __uuidof(THOT_FormaGurAllDocImpl)
#endif
