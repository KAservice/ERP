#ifndef UREM_FormaDocZakazPostImplH
#define UREM_FormaDocZakazPostImplH
#include "IREM_FormaDocZakazPost.h"
#include "UREM_FormaDocZakazPost.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_FormaDocZakazPostImpl)) TREM_FormaDocZakazPostImpl : public IREM_FormaDocZakazPost, IkanCallBack
{
public:
   TREM_FormaDocZakazPostImpl();
   ~TREM_FormaDocZakazPostImpl();
   TREM_FormaDocZakazPost * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_FormaDocZakazPost
   ...
   virtual IREM_DMDocZakazPost * get_DM(void);
   virtual void set_DM(IREM_DMDocZakazPost * DM);
...
#define CLSID_TREM_FormaDocZakazPostImpl __uuidof(TREM_FormaDocZakazPostImpl)
#endif
