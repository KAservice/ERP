...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocZPer::TREM_FormaDocZPer(TComponent* Owner)
        : TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocZPer::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMDocZPer,IID_IREM_DMDocZPer, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocZPerImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocZPer::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocZPer::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocZPer::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocZPer::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocZPer::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocZPer::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocZPer::ViborSkladPol(void)
{
if(Prosmotr==true) return;
if (FormaSpiskaSprSklad==NULL)
		{
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::EndViborSkladPol(void)
{


	DM->Doc->Edit();
	DM->DocIDSKLADPOL_REM_DZPER->AsString=FormaSpiskaSprSklad->DM->ElementIDSKLAD->AsString;
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocZPer::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocZPer::ViborRemZ(void)
{
if(Prosmotr==true) return;
if (FormaGurZ==NULL)
		{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::EndViborRemZ(void)
{
if (ActionOperation==aoAddNewString)
	...
	DM->DocT->Edit();
	DM->DocTIDZ_REM_DZPERT->AsString=FormaGurZ->DM->TableID_REM_Z->AsString;
...
void __fastcall TREM_FormaDocZPer::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocZPer::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocZPer::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocZPer::ActionOpenHelpExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocZPer::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocZPer::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocZPer::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocZPer::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocZPer::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocZPer::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocZPer::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZPer::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZPer::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocZPer::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocZPer::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocZPer::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborRemZ();
}
...
void __fastcall TREM_FormaDocZPer::ActionCloseExecute(TObject *Sender)
{
TypeEvent=0;
...
void __fastcall TREM_FormaDocZPer::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
TypeEvent=1;
if (DM->SaveDoc()==true)
...
void __fastcall TREM_FormaDocZPer::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocZPer::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocZPer::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocZPer::RunExternalModule(__int64 id_module, int type_module)
{
...
void TREM_FormaDocZPer::AfterSaveDoc(void)
{
...
void __fastcall TREM_FormaDocZPer::NumDocKlientcxDBTextEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZPer::PosDocKlientcxDBDateEditKeyDown(TObject *Sender,
          WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocZPer::cxGrid1DBTableView1NAME_REM_ZPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
ViborRemZ();
}
...
void TREM_FormaDocZPer::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void  TREM_FormaDocZPer::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocZPer::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void TREM_FormaDocZPer::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocZPer::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocZPer::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocZPer::NameSkladPolcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
ViborSkladPol();
}
...
void __fastcall TREM_FormaDocZPer::ToolButtonCreatePostClick(TObject *Sender)
{
	   ...
	   //	doc->IdRodForm=Handle;
		...
		doc->DM->Doc->Edit();
		doc->DM->DocIDSKLADPOL_REM_DZPER->AsString=DM->DocIDSKLADPOL_REM_DZPER->AsString;
		doc->DM->DocNAMESKLAD->AsString=DM->DocNAMESKLAD->AsString;
		doc->DM->DocOPER_DOC_DZPER->AsString=3;  /*Получение*/
		doc->DM->Doc->Post();
		...
		while (!DM->DocT->Eof)
			...
			doc->DM->DocT->Append();
			doc->DM->DocT->Edit();
			doc->DM->DocTIDZ_REM_DZPERT->AsString=DM->DocTIDZ_REM_DZPERT->AsString;
