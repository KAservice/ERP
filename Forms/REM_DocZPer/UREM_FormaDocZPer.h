...
#ifndef UREM_FormaDocZPerH
#define UREM_FormaDocZPerH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocZPer : public TForm
{
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		enum {ER_NoRekv,ER_No, ER_InfBase,ER_Firm,ER_Sklad,ER_Klient,
						ER_Zayavka,ER_Nom,ER_Ed, ER_Hardware,ER_CreateCheck, ER_SkladPol,ER_BusinessOper, ER_Project} EDitRekvisit;
...
public:		// User declarations
		__fastcall TREM_FormaDocZPer(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocZPer *REM_FormaDocZPer;
//---------------------------------------------------------------------------
#endif
