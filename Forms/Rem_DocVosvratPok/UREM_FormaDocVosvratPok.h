...
#ifndef UREM_FormaDocVosvratPokH
#define UREM_FormaDocVosvratPokH
//---------------------------------------------------------------------------
#include "UDM.h"
...
//---------------------------------------------------------------------------
class TREM_FormaDocVosvratPok : public TForm
{
__published:	// IDE-managed Components
	...
	TcxLabel *cxLabel9;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1IDNOM_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1IDED_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1IDHW_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1KOL_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1KF_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1PRICE_REM_DVPOKT;
	TcxGridDBColumn *cxGrid1DBTableView1SUM_REM_DVPOKT;
	...
	TcxGridDBColumn *cxGrid1DBTableView1DVREG_REM_DVPOKT;
	...
	TToolButton *ToolButtonCreateDocVosvratPok;
	...
	void __fastcall ToolButtonCreateDocVosvratPokClick(TObject *Sender);
		...
		void __fastcall EndViborProject(void);
		 ...
		 enum  {ER_NoRekv,ER_InfBase, ER_Firm, ER_Sklad, ER_Klient, ER_Card,
					 ER_BusinessOper, ER_Project, ER_Nom, ER_PodborNom, ER_GrpNom,
					  ...
					  ER_ViborDocOsn, ER_NO} EditRekvisit;
...
public:		// User declarations
		__fastcall TREM_FormaDocVosvratPok(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocVosvratPok *REM_FormaDocVosvratPok;
//---------------------------------------------------------------------------
#endif
