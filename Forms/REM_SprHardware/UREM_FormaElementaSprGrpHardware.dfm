object REM_FormaElementaSprGrpHardware: TREM_FormaElementaSprGrpHardware
  Left = 462
  Top = 235
  ...
  object IdGnDBText: TDBText
    ...
    Margins.Right = 4
    Margins.Bottom = 4
    DataField = 'ID_REM_SGRP_HARDWARE'
    DataSource = REM_DMSprGrpHardware.DataSourceElement
  end
  ...
  object NamecxDBTextEdit: TcxDBTextEdit
    ...
    DataBinding.DataSource = REM_DMSprGrpHardware.DataSourceElement
    TabOrder = 0
