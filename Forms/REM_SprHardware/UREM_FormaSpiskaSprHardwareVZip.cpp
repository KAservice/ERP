...
LabelNameGrp->Caption="Оборудование\\...";
HintLabel->Caption="";
...
//---------------------------------------------------------------------------
int TREM_FormaSpiskaSprHardwareVZip::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
cxTreeView1->Items->AddObject(NULL,"Оборудование",lpIDGrp);
...
if (SerNumcxTextEdit->Focused()==true)
	...
	{//ищем по id оборудования
    ShowMessage("Процедура поиска по Ид не предусмотрена Ид:"+sh);
...
rep->NameHardware="Использование донора: "+DM->TableOUT_NAME_HW->AsString
