...
#ifndef UFormaDocKorrVSH
#define UFormaDocKorrVSH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaDocKorrVS : public TForm
{
...
private:	// User declarations
	...
	void RunExternalModule(__int64 id_module, int type_module);
		...
		void __fastcall EndViborKlient(void);
		 ...
		 enum  {ER_NoRekv,ER_InfBase, ER_Firm, ER_Klient,
...
public:		// User declarations
		__fastcall TFormaDocKorrVS(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaDocKorrVS *FormaDocKorrVS;
//---------------------------------------------------------------------------
#endif
