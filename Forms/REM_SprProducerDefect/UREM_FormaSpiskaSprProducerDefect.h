...
#ifndef UREM_FormaSpiskaSprProducerDefectH
#define UREM_FormaSpiskaSprProducerDefectH
//---------------------------------------------------------------------------
#include "UDM.h"
#include "IREM_DMSprProducerDefect.h"
#include "IREM_DMSprProducerDefectGrp.h"
#include "IDMSprProducer.h"
#include "IREM_FormaElementaSprProducerDefectGrp.h"
...
//---------------------------------------------------------------------------
class TREM_FormaSpiskaSprProducerDefect : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGrid *cxGrid1;
	TcxGridDBColumn *cxGrid1DBTableView1CODE_REM_SPRDEFECT;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_REM_SPRDEFECT;
	...
	TAction *ActionClose;
	TcxGridDBColumn *cxGrid1DBTableView1ID_REM_SPRDEFECT;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_ENG_REM_SPRDEFECT;
...
private:	// User declarations
		...
		IREM_FormaElementaSprProducerDefectGrp * FormaGrpElementa;
		...
		IREM_FormaElementaSprProducerDefect * FormaElementa;
...
public:		// User declarations
		__fastcall TREM_FormaSpiskaSprProducerDefect(TComponent* Owner);
		...
		IREM_DMSprProducerDefect* DM;
		IREM_DMSprProducerDefectGrp* DMGrp;
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaSpiskaSprProducerDefect *REM_FormaSpiskaSprProducerDefect;
//---------------------------------------------------------------------------
#endif
