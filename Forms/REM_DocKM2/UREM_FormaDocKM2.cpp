...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocKM2::TREM_FormaDocKM2(TComponent* Owner)
		: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocKM2::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject("Oberon.REM_DMDocKM2.1",IID_IREM_DMDocKM2, (void**)&DM);
...
NiAftercxDBCalcEdit->DataBinding->DataSource=DM->DataSourceDoc;
NIBeforecxDBCalcEdit->DataBinding->DataSource=DM->DataSourceDoc;
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocKM2Impl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocKM2::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocKM2::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocKM2::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocKM2::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocKM2::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocKM2::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocKM2::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocKM2::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocKM2::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocKM2::EndViborSklad(void)
{
...
//----------------------------------------------------------------------------
//выбор клиента
void TREM_FormaDocKM2::ViborKlient(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocKM2::EndViborKlient(void)
{
...
//----------------------------------------------------------------------------
//выбор заявки
void TREM_FormaDocKM2::ViborKKT(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocKM2::EndViborKKT(void)
{

	DM->Doc->Edit();
	DM->DocIDKKT_REM_DKM2->AsString=FormaSpiskaSprKKT->DM->TableID_REM_SKKT->AsString;
...
void __fastcall TREM_FormaDocKM2::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocKM2::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocKM2::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocKM2::ActionOpenHelpExecute(TObject *Sender)
{
Application->HelpJump("DocKM2");
}
//---------------------------------------------------------------------------

void __fastcall TREM_FormaDocKM2::PosDoccxDBDateEditPropertiesChange(
      TObject *Sender)
{
UpdateForm();	
}
...
void __fastcall TREM_FormaDocKM2::NameFirmcxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocKM2::NameInfBasecxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocKM2::NameSkladcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();
FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();	
...
void __fastcall TREM_FormaDocKM2::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableAppend();
}
...
void __fastcall TREM_FormaDocKM2::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocKM2::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocKM2::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocKM2::PrimcxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
//----------------------------------------------------------------------------
void TREM_FormaDocKM2::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocKM2::NameKlientcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKlient();	
}
...
void __fastcall TREM_FormaDocKM2::NameZcxDBButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborKKT();
}
...
void __fastcall TREM_FormaDocKM2::ActionCloseExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocKM2::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocKM2::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocKM2::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocKM2::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocKM2::RunExternalModule(__int64 id_module, int type_module)
{
