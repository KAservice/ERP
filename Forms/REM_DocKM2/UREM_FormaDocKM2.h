...
#ifndef UREM_FormaDocKM2H
#define UREM_FormaDocKM2H
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_FormaDocKM2 : public TForm
{
__published:	// IDE-managed Components
	...
	TLabel *Label4;
	TLabel *Label7;
	TcxDBCalcEdit *NIBeforecxDBCalcEdit;
	TcxLabel *cxLabel2;
	TcxDBCalcEdit *NiAftercxDBCalcEdit;
	TcxLabel *cxLabel3;
	TcxGridDBColumn *cxGrid1DBTableView1NAMECOUNTER_REM_DKM2T;
	TcxGridDBColumn *cxGrid1DBTableView1BEFORE_REM_DKM2T;
	TcxGridDBColumn *cxGrid1DBTableView1AFTER_REM_DKM2T;
...
public:		// User declarations
		__fastcall TREM_FormaDocKM2(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_FormaDocKM2 *REM_FormaDocKM2;
//---------------------------------------------------------------------------
#endif
