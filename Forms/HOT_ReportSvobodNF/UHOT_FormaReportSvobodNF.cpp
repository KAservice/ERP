...
//---------------------------------------------------------------------------
int THOT_FormaReportSvobodNF::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
cxGrid1Level1->Caption="Свободные номера c " +DateTimeToStr(PosNachcxDateEdit->Date)
