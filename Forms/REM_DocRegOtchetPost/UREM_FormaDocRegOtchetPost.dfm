object REM_FormaDocRegOtchetPost: TREM_FormaDocRegOtchetPost
  Left = 290
  Top = 119
  Caption = #1044#1086#1082#1091#1084#1077#1085#1090' "'#1044#1074#1080#1078#1077#1085#1080#1103' '#1088#1077#1075#1080#1089#1090#1088#1072' '#1054#1090#1095#1077#1090' '#1087#1086#1089#1090#1072#1074#1097#1080#1082#1091' ('#1088#1077#1084#1086#1085#1090')"'
  ClientHeight = 619
  ClientWidth = 958
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      Caption = #1044#1074#1080#1078#1077#1085#1080#1103' '#1088#1077#1075#1080#1089#1090#1088#1072' '#1054#1090#1095#1077#1090' '#1087#1086#1089#1090#1072#1074#1097#1080#1082#1091' ('#1088#1077#1084#1086#1085#1090') '#8470
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -23
      Font.Name = 'MS Sans Serif'
    ...
    object ToolBar2: TToolBar
      ...
      object ToolButtonSetAllPrihod: TToolButton
        Left = 265
        Top = 0
        Hint = #1059#1089#1090#1072#1085#1086#1074#1080#1090#1100' '#1074#1089#1077' '#1074' '#1056#1072#1089#1093#1086#1076
    ...
    object PrimcxDBTextEdit: TcxDBTextEdit
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      DataBinding.DataField = 'DESCR_REM_DRG_OTCHPOST'
      TabOrder = 6
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          ...
          Column = cxGrid1DBTableView1SUM_REM_DRG_OTCHPOSTT
        end
        item
          Kind = skSum
          FieldName = 'KOL_REM_DRG_OTCHPOSTT'
          Column = cxGrid1DBTableView1KOL_REM_DRG_OTCHPOSTT
        end>
      ...
      object cxGrid1DBTableView1TDV_REM_DRG_OTCHPOSTT: TcxGridDBColumn
        Caption = #1044#1074'.'
        DataBinding.FieldName = 'TDV_REM_DRG_OTCHPOSTT'
      ...
      object cxGrid1DBTableView1KOL_REM_DRG_OTCHPOSTT: TcxGridDBColumn
        Caption = #1050#1086#1083'.'
        DataBinding.FieldName = 'KOL_REM_DRG_OTCHPOSTT'
        PropertiesClassName = 'TcxCalcEditProperties'
        Width = 61
      end
      object cxGrid1DBTableView1SUM_REM_DRG_OTCHPOSTT: TcxGridDBColumn
        Caption = #1057#1091#1084#1084#1072
        DataBinding.FieldName = 'SUM_REM_DRG_OTCHPOSTT'
        PropertiesClassName = 'TcxCalcEditProperties'
        Width = 62
      end
    end
