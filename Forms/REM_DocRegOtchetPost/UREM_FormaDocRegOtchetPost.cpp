...
//---------------------------------------------------------------------------
__fastcall TREM_FormaDocRegOtchetPost::TREM_FormaDocRegOtchetPost(TComponent* Owner)
		: TForm(Owner)
{
...
//---------------------------------------------------------------------------
bool TREM_FormaDocRegOtchetPost::Init(void)
{
bool result=false;
...
InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMDocRegOtchetPost,IID_IREM_DMDocRegOtchetPost, (void**)&DM);
...
DMTableExtPrintForm->OpenTable(StringToGUID(Global_CLSID_TREM_FormaDocRegOtchetPostImpl),false);
...
//---------------------------------------------------------------------------
int TREM_FormaDocRegOtchetPost::Done(void)
{

return -1;
}
//----------------------------------------------------------------------------
void TREM_FormaDocRegOtchetPost::UpdateForm(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
int TREM_FormaDocRegOtchetPost::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
void TREM_FormaDocRegOtchetPost::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TREM_FormaDocRegOtchetPost::ViborFirm(void)
{
if(Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborFirm(void)
{
	...
	DM->DocT->Edit();
	DM->DocTIDFIRM_REM_DRG_OTCHPOSTT->AsString=FormaSpiskaSprFirm->DM->ElementIDFIRM->AsString;
...
//-----------------------------------------------------------------------------
//выбор склада
void TREM_FormaDocRegOtchetPost::ViborSklad(void)
{
if(Prosmotr==true) return;
...
//-----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborSklad(void)
{


	DM->DocT->Edit();
	DM->DocTIDSKLAD_REM_DRG_OTCHPOSTT->AsString=FormaSpiskaSprSklad->DM->ElementIDSKLAD->AsString;
...
//----------------------------------------------------------------------------
//выбор номенклатуры
void TREM_FormaDocRegOtchetPost::ViborNom(void)
{
if(Prosmotr==true) return;
...
//		+DM->DocAllNUMDOC->AsString+" от "+DM->DocAllPOSDOC->AsString;
		FormaSpiskaSprNom->IdNom=glStrToInt64(DM->DocTIDNOM_REM_DRG_OTCHPOSTT->AsString);
		FormaSpiskaSprNom->UpdateForm();
		}
}
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborNom(void)
{

				DM->DocT->Edit();
				DM->DocTIDNOM_REM_DRG_OTCHPOSTT->AsString=FormaSpiskaSprNom->DM->ElementIDNOM->AsString;
				...
				DM->DocTKOL_REM_DRG_OTCHPOSTT->AsInteger=1;
...
void __fastcall TREM_FormaDocRegOtchetPost::NumberDocKeyDown(TObject *Sender,
...
void __fastcall TREM_FormaDocRegOtchetPost::FDateDocKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocRegOtchetPost::PrimKeyDown(TObject *Sender, WORD &Key,
      TShiftState Shift)
{
if(Key==VK_RETURN) FindNextControl((TWinControl *) Sender,true,true,false)->SetFocus();
}
...
void __fastcall TREM_FormaDocRegOtchetPost::NameInfBasecxDBButtonEditPropertiesButtonClick(
...
void __fastcall TREM_FormaDocRegOtchetPost::ActionAddStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
...
void __fastcall TREM_FormaDocRegOtchetPost::ActionDeleteStringExecute(TObject *Sender)
{
if(Prosmotr==true) return;
DM->TableDelete();
}
...
void __fastcall TREM_FormaDocRegOtchetPost::NumDoccxDBTextEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocRegOtchetPost::PosDoccxDBDateEditKeyDown(TObject *Sender,
      WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void __fastcall TREM_FormaDocRegOtchetPost::PrimcxDBTextEditKeyDown(TObject *Sender,
	  WORD &Key, TShiftState Shift)
{
if(Key==VK_RETURN)
	{
...
void TREM_FormaDocRegOtchetPost::BeforeSaveDoc(void)
{
...
void __fastcall TREM_FormaDocRegOtchetPost::cxGrid1DBTableView1NAMEFIRMPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborFirm();	
}
...
void __fastcall TREM_FormaDocRegOtchetPost::cxGrid1DBTableView1NAMESKLADPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborSklad();	
}
...
void __fastcall TREM_FormaDocRegOtchetPost::cxGrid1DBTableView1NAMENOMPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborNom();	
}
...
//---------------------------------------------------------------------------
//Внешние модули
void __fastcall TREM_FormaDocRegOtchetPost::PopupMenuExtModuleClick(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocRegOtchetPost::RunExternalModule(__int64 id_module, int type_module)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::ActionCloseExecute(TObject *Sender)
{
...
void __fastcall TREM_FormaDocRegOtchetPost::ActionOKExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocRegOtchetPost::ActionDvRegExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void __fastcall TREM_FormaDocRegOtchetPost::ActionSaveExecute(TObject *Sender)
{
if(Prosmotr==true) return;
if (DM->SaveDoc()==true)
		{
...
void TREM_FormaDocRegOtchetPost::OpenFormSpiskaSprProject(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborProject(void)
{
...
//----------------------------------------------------------------------------
void TREM_FormaDocRegOtchetPost::OpenFormSpiskaSprBusinessOper(void)
{
if (Prosmotr==true) return;
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborBusinessOper(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::NameBusinessOpercxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
void __fastcall TREM_FormaDocRegOtchetPost::NameProjectcxDBButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
//---------------------------------------------------------------------------
//выбор номенклатуры
void TREM_FormaDocRegOtchetPost::ViborKlient(void)
{
if(Prosmotr==true) return;
...
//		FormaSpiskaSprNom->HintLabel->Caption="Выберите номенклатуру для документа Движения регистра Остатки товаров №"
//		+DM->DocAllNUMDOC->AsString+" от "+DM->DocAllPOSDOC->AsString;
		FormaSpiskaSprKlient->IdKlient=glStrToInt64(DM->DocTIDPOST_REM_DRG_OTCHPOSTT->AsString);
		FormaSpiskaSprKlient->UpdateForm();
		}
}
//----------------------------------------------------------------------------
void __fastcall TREM_FormaDocRegOtchetPost::EndViborKlient(void)
{

				DM->DocT->Edit();
				DM->DocTIDPOST_REM_DRG_OTCHPOSTT->AsString=FormaSpiskaSprKlient->DM->ElementIDKLIENT->AsString;
...
void __fastcall TREM_FormaDocRegOtchetPost::cxGrid1DBTableView1NAMEKLIENTPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
ViborKlient();
}
...
void __fastcall TREM_FormaDocRegOtchetPost::ToolButtonSetAllPrihodClick(TObject *Sender)
...
while (!DM->DocT->Eof)
	{
	DM->DocT->Edit();
	DM->DocTTDV_REM_DRG_OTCHPOSTT->AsInteger=0;
	DM->DocT->Post();
	DM->DocT->Next();
	}
}
...
void __fastcall TREM_FormaDocRegOtchetPost::ToolButtonSetAllRashodClick(TObject *Sender)
...
while (!DM->DocT->Eof)
	{
	DM->DocT->Edit();
	DM->DocTTDV_REM_DRG_OTCHPOSTT->AsInteger=1;
	DM->DocT->Post();
	DM->DocT->Next();
	}
}
