...
int THOT_DMSprPrOsnUslug_Dv::OpenElement(int Id)
{
Element->Active=false;
...
//---------------------------------------------------------------------------
bool THOT_DMSprPrOsnUslug_Dv::DeleteElement(int Id)
{
bool result=false;
Element->Active=false;
Element->ParamByName("PARAM_ID")->AsInteger=Id;
...
void __fastcall THOT_DMSprPrOsnUslug_Dv::ElementNewRecord(TDataSet *DataSet)
{
ElementGID_HOT_SNF->AsString=
		gl_prefiks_ib+IntToStr(ElementID_HOT_SNF->AsInteger);
}
//---------------------------------------------------------------------------
int THOT_DMSprPrOsnUslug_Dv::GetIndexElementaPoID(int id)
...
while(!Table->Eof)
	{
	if(TableID_HOT_SNF->AsInteger==id)
		{
		result=index+1;
		break;
		}
