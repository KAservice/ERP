...
//---------------------------------------------------------------------------
int TFormaDocRegCardBalance::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
//		FormaSpiskaSprFirm->HintLabel->Caption="Выберите фирму для документа Движения регистров №"
...
cell->Text="Движения регистра Средства на картах №"+DM->DocAllNUMDOC->AsString+" от "
...
cell->Text="Основание: "+DM->DocDESCR_DRG_CARD_BALANCE->AsString;
delete cell;
numRow++;
numRow++;
