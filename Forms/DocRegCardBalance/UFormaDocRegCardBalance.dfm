object FormaDocRegCardBalance: TFormaDocRegCardBalance
  Left = 290
  Top = 119
  Caption = #1044#1086#1082#1091#1084#1077#1085#1090' "'#1044#1074#1080#1078#1077#1085#1080#1103' '#1088#1077#1075#1080#1089#1090#1088#1072' '#1057#1088#1077#1076#1089#1090#1074#1072' '#1085#1072' '#1082#1072#1088#1090#1072#1093'"'
  ClientHeight = 619
  ClientWidth = 849
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      Caption = #1044#1074#1080#1078#1077#1085#1080#1103' '#1088#1077#1075#1080#1089#1090#1088#1072' '#1057#1088#1077#1076#1089#1090#1074#1072' '#1085#1072' '#1082#1072#1088#1090#1072#1093'  '#8470
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -23
      Font.Name = 'MS Sans Serif'
    ...
    object PrimcxDBTextEdit: TcxDBTextEdit
      ...
      Margins.Right = 4
      Margins.Bottom = 4
      DataBinding.DataField = 'DESCR_DRG_CARD_BALANCE'
      TabOrder = 6
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1TDV_DRG_CARD_BALANCET: TcxGridDBColumn
        Caption = #1058#1080#1087' '#1076#1074'.'
        DataBinding.FieldName = 'TDV_DRG_CARD_BALANCET'
        Width = 37
      end
      ...
      object cxGrid1DBTableView1SUM_DRG_CARD_BALANCET: TcxGridDBColumn
        Caption = #1057#1091#1084#1084#1072
        DataBinding.FieldName = 'SUM_DRG_CARD_BALANCET'
        Width = 104
      end
      object cxGrid1DBTableView1OPER_DRG_CARD_BALANCET: TcxGridDBColumn
        Caption = #1054#1087#1077#1088#1072#1094#1080#1103
        DataBinding.FieldName = 'OPER_DRG_CARD_BALANCET'
        Width = 106
      end
    end
