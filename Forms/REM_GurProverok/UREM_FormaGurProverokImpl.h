#ifndef UREM_FormaGurProverokImplH
#define UREM_FormaGurProverokImplH
#include "IREM_FormaGurProverok.h"
#include "UREM_FormaGurProverok.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_FormaGurProverokImpl)) TREM_FormaGurProverokImpl : public IREM_FormaGurProverok, IkanCallBack
{
public:
   TREM_FormaGurProverokImpl();
   ~TREM_FormaGurProverokImpl();
   TREM_FormaGurProverok * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_FormaGurProverok
   ...
   virtual IREM_DMGurProverok * get_DM(void);
   virtual void set_DM(IREM_DMGurProverok * DM);
...
#define CLSID_TREM_FormaGurProverokImpl __uuidof(TREM_FormaGurProverokImpl)
#endif
