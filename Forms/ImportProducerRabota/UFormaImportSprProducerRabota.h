...
#ifndef UFormaImportSprProducerRabotaH
#define UFormaImportSprProducerRabotaH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaImportSprProducerRabota : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridBandedColumn *cxGrid1BandedTableView1ID_REM_SPRRABOTA;
	...
	TcxGridBandedColumn *TableUpdateID_REM_SPRRABOTA;
	...
	TcxSpinEdit *LevelStrcxSpinEdit;
	TLabel *Label5;
	TcxGridBandedColumn *cxGrid1BandedTableView1LEVEL_STR;
	TcxGridBandedColumn *TableUpdateLEVEL_STR;
...
public:		// User declarations
	__fastcall TFormaImportSprProducerRabota(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaImportSprProducerRabota *FormaImportSprProducerRabota;
//---------------------------------------------------------------------------
#endif
