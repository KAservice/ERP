#ifndef UFormaImportSprProducerRabotaImplH
#define UFormaImportSprProducerRabotaImplH
#include "IFormaImportSprProducerRabota.h"
#include "UFormaImportSprProducerRabota.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TFormaImportSprProducerRabotaImpl)) TFormaImportSprProducerRabotaImpl : public IFormaImportSprProducerRabota, IkanCallBack
{
public:
   TFormaImportSprProducerRabotaImpl();
   ~TFormaImportSprProducerRabotaImpl();
   TFormaImportSprProducerRabota * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TFormaImportSprProducerRabotaImpl __uuidof(TFormaImportSprProducerRabotaImpl)
#endif
