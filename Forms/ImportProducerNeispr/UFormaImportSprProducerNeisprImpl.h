#ifndef UFormaImportSprProducerNeisprImplH
#define UFormaImportSprProducerNeisprImplH
#include "IFormaImportSprProducerNeispr.h"
#include "UFormaImportSprProducerNeispr.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TFormaImportSprProducerNeisprImpl)) TFormaImportSprProducerNeisprImpl : public IFormaImportSprProducerNeispr, IkanCallBack
{
public:
   TFormaImportSprProducerNeisprImpl();
   ~TFormaImportSprProducerNeisprImpl();
   TFormaImportSprProducerNeispr * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TFormaImportSprProducerNeisprImpl __uuidof(TFormaImportSprProducerNeisprImpl)
#endif
