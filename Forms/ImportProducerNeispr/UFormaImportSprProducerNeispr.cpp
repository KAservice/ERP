...
#include "UFormaImportSprProducerNeispr.h"
#include "UDM.h"
...
//---------------------------------------------------------------------------
__fastcall TFormaImportSprProducerNeispr::TFormaImportSprProducerNeispr(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::FormCreate(TObject *Sender)
{
...
//-----------------------------------------------------------------------
bool TFormaImportSprProducerNeispr::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TFormaImportSprProducerNeispr::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerNeispr::UpdateForm(void)
{


}
//---------------------------------------------------------------------------
int TFormaImportSprProducerNeispr::ExternalEvent(IkanUnknown * pUnk,   //интерфейс на дочерний объект
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::FileNamecxButtonEditPropertiesButtonClick(
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerNeispr::OpenFormSpiskaSprImportSet(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::EndViborImportSet(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::NameImportSetcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
OpenFormSpiskaSprImportSet();
}
//---------------------------------------------------------------------------
void TFormaImportSprProducerNeispr::UpdateSetup(void)
{
...
//----------------------------------------------------------------------------
void TFormaImportSprProducerNeispr::SaveSetup(void)
{
if (IdImportSet==0)
	{
...
void __fastcall TFormaImportSprProducerNeispr::cxButtonSaveParamsClick(
      TObject *Sender)
{
SaveSetup();
}
...
void __fastcall TFormaImportSprProducerNeispr::cxButtonImportClick(TObject *Sender)
{
...
try
	...
	dc->AppendRecord();
	dc->Values[number_string_table][cxGrid1BandedTableView1ID_REM_SPRNEISPR->Index] = "";
...
void TFormaImportSprProducerNeispr::ViborInfBase(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::EndViborInfBase(void)
{
...
//---------------------------------------------------------------------------
//выбор фирмы
void TFormaImportSprProducerNeispr::ViborFirm(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::EndViborFirm(void)
{
...
//----------------------------------------------------------------------------
//выбор склада
void TFormaImportSprProducerNeispr::ViborSklad(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::EndViborSklad(void)
{
...
//-----------------------------------------------------------------------------
//выбор поставщика
void TFormaImportSprProducerNeispr::ViborKlient(void)
{
...
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::EndViborKlient(void)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::NameInfBasecxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborInfBase();	
}
...
void __fastcall TFormaImportSprProducerNeispr::NameFirmcxButtonEditPropertiesButtonClick(
      TObject *Sender, int AButtonIndex)
{
ViborFirm();
}
...
void __fastcall TFormaImportSprProducerNeispr::NameSkladcxButtonEditPropertiesButtonClick(
	  TObject *Sender, int AButtonIndex)
{
ViborSklad();
}
...
void __fastcall TFormaImportSprProducerNeispr::NameKlientcxButtonEditPropertiesButtonClick(
	  TObject *Sender, int AButtonIndex)
{
ViborKlient();
}
...
void __fastcall TFormaImportSprProducerNeispr::cxButtonUpdateSprClick(TObject *Sender)
{
...
IREM_DMSprProducerNeispr *dm_producer_neispr;
		InterfaceGlobalCom->kanCreateObject(ProgId_REM_DMSprProducerNeispr ,IID_IREM_DMSprProducerNeispr,
													(void**)&dm_producer_neispr);
		dm_producer_neispr->Init(InterfaceMainObject,InterfaceImpl);
...
//			}
		...
		if (type_update == 1) //вставка
			{
			dm_producer_neispr->NewElement(IdProducer,0);
			}

		if (type_update == 2)   //обновление
			{
			id_producer_neispr=dc_upd->Values[i][TableUpdateID_REM_SPRNEISPR->Index];
			dm_producer_neispr->OpenElement(id_producer_neispr);
			}


		dm_producer_neispr->Element->Edit();
			...
			if (StrToInt(NamecxSpinEdit->Text) > 0)
				...
				dm_producer_neispr->ElementNAME_REM_SPRNEISPR->AsString=name;
				}
			...
			if (StrToInt(NameEngcxSpinEdit->Text) > 0)
				...
				if (name.Length() > 200) { name = name.SetLength(200);}
				dm_producer_neispr->ElementNAME_ENG_REM_SPRNEISPR->AsString=name;
				}
			...
			if (StrToInt(ArtcxSpinEdit->Text) > 0 || cxCheckBoxVidelyatCod->Checked==true)
				...
				dm_producer_neispr->ElementCODE_REM_SPRNEISPR->AsString=artikul;
				}

		dm_producer_neispr->Element->Post();




				if (dm_producer_neispr->SaveElement()==false)
					{
					text_error="Ошибка при записи новой номенклатуры: "+dm_producer_neispr->TextError+"\n";
...
void __fastcall TFormaImportSprProducerNeispr::cxButtonDelStringClick(TObject *Sender)
{
...
void __fastcall TFormaImportSprProducerNeispr::ActionCloseExecute(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------
...
////---------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::NameProducercxButtonEditPropertiesButtonClick(TObject *Sender,
          int AButtonIndex)
{
switch (AButtonIndex)
	{
...
//---------------------------------------------------------------------------
void TFormaImportSprProducerNeispr::OpenFormSpiskaSprProducer(void)
{
...
//----------------------------------------------------------------------------
void __fastcall TFormaImportSprProducerNeispr::ToolButtonSaveExcelClick(TObject *Sender)
...
void __fastcall TFormaImportSprProducerNeispr::cxButtonProveritClick(TObject *Sender)
...
//			}
		...
		if(TypeSearchcxComboBox->ItemIndex == 2 )
			{  //поиск по артикулу
			id_producer_neispr= dm_producer_neispr->FindPoCodu(IdProducer,artikul);
			}

		if(TypeSearchcxComboBox->ItemIndex == 1 )            //1 поиск по наименованию
			{
			id_producer_neispr= dm_producer_neispr->FindPoName(IdProducer,name);
			}

		if(TypeSearchcxComboBox->ItemIndex == 3 )            //3 по англ наименованию
			{
			id_producer_neispr= dm_producer_neispr->FindPoNameEng(IdProducer,name_eng);
			}
		...
		if(id_producer_neispr==0) //создаем новую номенклатуру
			{
			//*********************************************************************************
			dc_upd->AppendRecord();
			dc_upd->Values[number_string_table_upd][TableUpdateTypeUpdate->Index] = 1;
			dc_upd->Values[number_string_table_upd][TableUpdateID_REM_SPRNEISPR->Index] = "";
			...
			if (StrToInt(NamecxSpinEdit->Text) !=0)
				{
				if (dm_producer_neispr->ElementNAME_REM_SPRNEISPR->AsString
								!= NAME )
					{
					fl_save=true;
					}
			...
			if (StrToInt(NameEngcxSpinEdit->Text) !=0)
				{
				if (dm_producer_neispr->ElementNAME_ENG_REM_SPRNEISPR->AsString
								!= NAME_ENG )
					{
					fl_save=true;
					}
			...
			if (StrToInt(ArtcxSpinEdit->Text) !=0)
				{
				if (dm_producer_neispr->ElementCODE_REM_SPRNEISPR->AsString
								!= ART )
					{
					fl_save=true;
					}
			...
			dc_upd->Values[number_string_table_upd][TableUpdateID_REM_SPRNEISPR->Index] = dm_producer_neispr->ElementID_REM_SPRNEISPR->AsString;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
void TFormaImportSprProducerNeispr::VidelitCodIsNameRus(UnicodeString * out_name, UnicodeString * out_code, UnicodeString in_name)
{
