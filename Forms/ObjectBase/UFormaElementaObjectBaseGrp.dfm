object FormaElementaObjectBaseGrp: TFormaElementaObjectBaseGrp
  Left = 454
  Top = 350
  ...
  object NamecxDBTextEdit: TcxDBTextEdit
    ...
    Margins.Right = 4
    Margins.Bottom = 4
    DataBinding.DataField = 'NAME_OBJECT_BASE_GRP'
    DataBinding.DataSource = DMObjectBaseGrp.DataSourceElement
    TabOrder = 0
