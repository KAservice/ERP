...
#ifndef UHOT_FormaReportRasmK_SH
#define UHOT_FormaReportRasmK_SH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class THOT_FormaReportRasmK_S : public TForm
{
__published:	// IDE-managed Components
	...
	TcxGridDBColumn *cxGrid1DBTableView1NAME_SVIDKLIENT;
	...
	TcxGridDBColumn *cxGrid1DBTableView1KOL_K_S;
	TcxGridDBColumn *cxGrid1DBTableView1KOLSUTOK;
	TdxComponentPrinter *dxComponentPrinter1;
	TdxGridReportLink *dxComponentPrinter1Link1;
	TcxButton *cxButtonPrint;
	TcxGridDBColumn *cxGrid1DBTableView1NAME_HOT_SCELPR;
	TcxGridDBColumn *cxGrid1DBTableView1INTERVAL;
...
public:		// User declarations
	__fastcall THOT_FormaReportRasmK_S(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE THOT_FormaReportRasmK_S *HOT_FormaReportRasmK_S;
//---------------------------------------------------------------------------
#endif
