#ifndef UIFormaGurAllDocH
#define UIFormaGurAllDocH
#include "IMainInterface.h"
#include "IDMGurAllDoc.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaGurAllDoc)) IFormaGurAllDoc : public IMainInterface
{
public:
   ...
   __property IDMGurAllDoc * DM = {read = get_DM , write = set_DM};
   virtual IDMGurAllDoc * get_DM(void)=0;
   virtual void set_DM(IDMGurAllDoc * DM)=0;
   ...
   virtual void OpenFormDoc()=0;
   virtual void DeleteDoc(void)=0;
   virtual void DeleteAllDoc(void)=0;
   virtual void UpdateForm(void)=0;
};
#define IID_IFormaGurAllDoc __uuidof(IFormaGurAllDoc)
#endif
