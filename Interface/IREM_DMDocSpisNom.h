#ifndef UIREM_DMDocSpisNomH
#define UIREM_DMDocSpisNomH
...
class __declspec(uuid(Global_IID_IREM_DMDocSpisNom)) IREM_DMDocSpisNom : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DSPN = {read = get_DocID_REM_DSPN , write = set_DocID_REM_DSPN};
   virtual TFIBLargeIntField * get_DocID_REM_DSPN(void)=0;
   virtual void set_DocID_REM_DSPN(TFIBLargeIntField * DocID_REM_DSPN)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DSPN = {read = get_DocIDBASE_REM_DSPN , write = set_DocIDBASE_REM_DSPN};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSPN(void)=0;
   virtual void set_DocIDBASE_REM_DSPN(TFIBLargeIntField * DocIDBASE_REM_DSPN)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DSPN = {read = get_DocIDDOC_REM_DSPN , write = set_DocIDDOC_REM_DSPN};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSPN(void)=0;
   virtual void set_DocIDDOC_REM_DSPN(TFIBLargeIntField * DocIDDOC_REM_DSPN)=0;

   __property TFIBWideStringField * DocGID_REM_DSPN = {read = get_DocGID_REM_DSPN , write = set_DocGID_REM_DSPN};
   virtual TFIBWideStringField * get_DocGID_REM_DSPN(void)=0;
   virtual void set_DocGID_REM_DSPN(TFIBWideStringField * DocGID_REM_DSPN)=0;

   __property TFIBLargeIntField * DocIDRTPRICE_REM_DSPN = {read = get_DocIDRTPRICE_REM_DSPN , write = set_DocIDRTPRICE_REM_DSPN};
   virtual TFIBLargeIntField * get_DocIDRTPRICE_REM_DSPN(void)=0;
   virtual void set_DocIDRTPRICE_REM_DSPN(TFIBLargeIntField * DocIDRTPRICE_REM_DSPN)=0;

   __property TFIBBCDField * DocRSUM_REM_DSPN = {read = get_DocRSUM_REM_DSPN , write = set_DocRSUM_REM_DSPN};
   virtual TFIBBCDField * get_DocRSUM_REM_DSPN(void)=0;
   virtual void set_DocRSUM_REM_DSPN(TFIBBCDField * DocRSUM_REM_DSPN)=0;

   __property TFIBWideStringField * DocPRIM_REM_DSPN = {read = get_DocPRIM_REM_DSPN , write = set_DocPRIM_REM_DSPN};
   virtual TFIBWideStringField * get_DocPRIM_REM_DSPN(void)=0;
   virtual void set_DocPRIM_REM_DSPN(TFIBWideStringField * DocPRIM_REM_DSPN)=0;
   ...
   __property TFIBLargeIntField * DocTID_REM_DSPNT = {read = get_DocTID_REM_DSPNT , write = set_DocTID_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTID_REM_DSPNT(void)=0;
   virtual void set_DocTID_REM_DSPNT(TFIBLargeIntField * DocTID_REM_DSPNT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DSPNT = {read = get_DocTIDBASE_REM_DSPNT , write = set_DocTIDBASE_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSPNT(void)=0;
   virtual void set_DocTIDBASE_REM_DSPNT(TFIBLargeIntField * DocTIDBASE_REM_DSPNT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DSPNT = {read = get_DocTIDDOC_REM_DSPNT , write = set_DocTIDDOC_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSPNT(void)=0;
   virtual void set_DocTIDDOC_REM_DSPNT(TFIBLargeIntField * DocTIDDOC_REM_DSPNT)=0;

   __property TFIBWideStringField * DocTGID_REM_DSPNT = {read = get_DocTGID_REM_DSPNT , write = set_DocTGID_REM_DSPNT};
   virtual TFIBWideStringField * get_DocTGID_REM_DSPNT(void)=0;
   virtual void set_DocTGID_REM_DSPNT(TFIBWideStringField * DocTGID_REM_DSPNT)=0;

   __property TFIBLargeIntField * DocTIDNOM_REM_DSPNT = {read = get_DocTIDNOM_REM_DSPNT , write = set_DocTIDNOM_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DSPNT(void)=0;
   virtual void set_DocTIDNOM_REM_DSPNT(TFIBLargeIntField * DocTIDNOM_REM_DSPNT)=0;

   __property TFIBLargeIntField * DocTIDED_REM_DSPNT = {read = get_DocTIDED_REM_DSPNT , write = set_DocTIDED_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDED_REM_DSPNT(void)=0;
   virtual void set_DocTIDED_REM_DSPNT(TFIBLargeIntField * DocTIDED_REM_DSPNT)=0;

   __property TFIBLargeIntField * DocTIDHW_REM_DSPNT = {read = get_DocTIDHW_REM_DSPNT , write = set_DocTIDHW_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDHW_REM_DSPNT(void)=0;
   virtual void set_DocTIDHW_REM_DSPNT(TFIBLargeIntField * DocTIDHW_REM_DSPNT)=0;

   __property TFIBBCDField * DocTKOL_REM_DSPNT = {read = get_DocTKOL_REM_DSPNT , write = set_DocTKOL_REM_DSPNT};
   virtual TFIBBCDField * get_DocTKOL_REM_DSPNT(void)=0;
   virtual void set_DocTKOL_REM_DSPNT(TFIBBCDField * DocTKOL_REM_DSPNT)=0;

   __property TFIBBCDField * DocTKF_REM_DSPNT = {read = get_DocTKF_REM_DSPNT , write = set_DocTKF_REM_DSPNT};
   virtual TFIBBCDField * get_DocTKF_REM_DSPNT(void)=0;
   virtual void set_DocTKF_REM_DSPNT(TFIBBCDField * DocTKF_REM_DSPNT)=0;

   __property TFIBBCDField * DocTPRICE_REM_DSPNT = {read = get_DocTPRICE_REM_DSPNT , write = set_DocTPRICE_REM_DSPNT};
   virtual TFIBBCDField * get_DocTPRICE_REM_DSPNT(void)=0;
   virtual void set_DocTPRICE_REM_DSPNT(TFIBBCDField * DocTPRICE_REM_DSPNT)=0;

   __property TFIBBCDField * DocTSUM_REM_DSPNT = {read = get_DocTSUM_REM_DSPNT , write = set_DocTSUM_REM_DSPNT};
   virtual TFIBBCDField * get_DocTSUM_REM_DSPNT(void)=0;
   virtual void set_DocTSUM_REM_DSPNT(TFIBBCDField * DocTSUM_REM_DSPNT)=0;

   __property TFIBBCDField * DocTRPRICE_REM_DSPNT = {read = get_DocTRPRICE_REM_DSPNT , write = set_DocTRPRICE_REM_DSPNT};
   virtual TFIBBCDField * get_DocTRPRICE_REM_DSPNT(void)=0;
   virtual void set_DocTRPRICE_REM_DSPNT(TFIBBCDField * DocTRPRICE_REM_DSPNT)=0;

   __property TFIBBCDField * DocTRSUM_REM_DSPNT = {read = get_DocTRSUM_REM_DSPNT , write = set_DocTRSUM_REM_DSPNT};
   virtual TFIBBCDField * get_DocTRSUM_REM_DSPNT(void)=0;
   virtual void set_DocTRSUM_REM_DSPNT(TFIBBCDField * DocTRSUM_REM_DSPNT)=0;

   __property TFIBSmallIntField * DocTDVREG_REM_DSPNT = {read = get_DocTDVREG_REM_DSPNT , write = set_DocTDVREG_REM_DSPNT};
   virtual TFIBSmallIntField * get_DocTDVREG_REM_DSPNT(void)=0;
   virtual void set_DocTDVREG_REM_DSPNT(TFIBSmallIntField * DocTDVREG_REM_DSPNT)=0;
   ...
   __property TFIBLargeIntField * DocTIDTNOM_REM_DSPNT = {read = get_DocTIDTNOM_REM_DSPNT , write = set_DocTIDTNOM_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDTNOM_REM_DSPNT(void)=0;
   virtual void set_DocTIDTNOM_REM_DSPNT(TFIBLargeIntField * DocTIDTNOM_REM_DSPNT)=0;

   __property TFIBLargeIntField * DocTIDMHRAN_REM_DSPNT = {read = get_DocTIDMHRAN_REM_DSPNT , write = set_DocTIDMHRAN_REM_DSPNT};
   virtual TFIBLargeIntField * get_DocTIDMHRAN_REM_DSPNT(void)=0;
   virtual void set_DocTIDMHRAN_REM_DSPNT(TFIBLargeIntField * DocTIDMHRAN_REM_DSPNT)=0;
...
#define IID_IREM_DMDocSpisNom __uuidof(IREM_DMDocSpisNom)
#endif
