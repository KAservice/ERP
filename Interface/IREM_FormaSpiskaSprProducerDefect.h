#ifndef UIREM_FormaSpiskaSprProducerDefectH
#define UIREM_FormaSpiskaSprProducerDefectH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMSprProducerDefect.h"
#include "IREM_DMSprProducerDefectGrp.h"
class __declspec(uuid(Global_IID_IREM_FormaSpiskaSprProducerDefect)) IREM_FormaSpiskaSprProducerDefect : public IMainInterface
{
public:
   __property IREM_DMSprProducerDefect* DM = {read = get_DM , write = set_DM};
   virtual IREM_DMSprProducerDefect* get_DM(void)=0;
   virtual void set_DM(IREM_DMSprProducerDefect* DM)=0;

   __property IREM_DMSprProducerDefectGrp* DMGrp = {read = get_DMGrp , write = set_DMGrp};
   virtual IREM_DMSprProducerDefectGrp* get_DMGrp(void)=0;
   virtual void set_DMGrp(IREM_DMSprProducerDefectGrp* DMGrp)=0;
...
#define IID_IREM_FormaSpiskaSprProducerDefect __uuidof(IREM_FormaSpiskaSprProducerDefect)
#endif
