#ifndef UIREM_DMDocKM1H
#define UIREM_DMDocKM1H
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocKM1)) IREM_DMDocKM1 : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DKM1 = {read = get_DocID_REM_DKM1 , write = set_DocID_REM_DKM1};
   virtual TFIBLargeIntField * get_DocID_REM_DKM1(void)=0;
   virtual void set_DocID_REM_DKM1(TFIBLargeIntField * DocID_REM_DKM1)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DKM1 = {read = get_DocIDBASE_REM_DKM1 , write = set_DocIDBASE_REM_DKM1};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DKM1(void)=0;
   virtual void set_DocIDBASE_REM_DKM1(TFIBLargeIntField * DocIDBASE_REM_DKM1)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DKM1 = {read = get_DocIDDOC_REM_DKM1 , write = set_DocIDDOC_REM_DKM1};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DKM1(void)=0;
   virtual void set_DocIDDOC_REM_DKM1(TFIBLargeIntField * DocIDDOC_REM_DKM1)=0;

   __property TFIBLargeIntField * DocIDKKT_REM_DKM1 = {read = get_DocIDKKT_REM_DKM1 , write = set_DocIDKKT_REM_DKM1};
   virtual TFIBLargeIntField * get_DocIDKKT_REM_DKM1(void)=0;
   virtual void set_DocIDKKT_REM_DKM1(TFIBLargeIntField * DocIDKKT_REM_DKM1)=0;

   __property TFIBWideStringField * DocPRIM_REM_DKM1 = {read = get_DocPRIM_REM_DKM1 , write = set_DocPRIM_REM_DKM1};
   virtual TFIBWideStringField * get_DocPRIM_REM_DKM1(void)=0;
   virtual void set_DocPRIM_REM_DKM1(TFIBWideStringField * DocPRIM_REM_DKM1)=0;

   __property TFIBBCDField * DocNI_REM_DKM1 = {read = get_DocNI_REM_DKM1 , write = set_DocNI_REM_DKM1};
   virtual TFIBBCDField * get_DocNI_REM_DKM1(void)=0;
   virtual void set_DocNI_REM_DKM1(TFIBBCDField * DocNI_REM_DKM1)=0;
   ...
   __property TFIBLargeIntField * DocTID_REM_DKM1T = {read = get_DocTID_REM_DKM1T , write = set_DocTID_REM_DKM1T};
   virtual TFIBLargeIntField * get_DocTID_REM_DKM1T(void)=0;
   virtual void set_DocTID_REM_DKM1T(TFIBLargeIntField * DocTID_REM_DKM1T)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DKM1T = {read = get_DocTIDBASE_REM_DKM1T , write = set_DocTIDBASE_REM_DKM1T};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DKM1T(void)=0;
   virtual void set_DocTIDBASE_REM_DKM1T(TFIBLargeIntField * DocTIDBASE_REM_DKM1T)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DKM1T = {read = get_DocTIDDOC_REM_DKM1T , write = set_DocTIDDOC_REM_DKM1T};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DKM1T(void)=0;
   virtual void set_DocTIDDOC_REM_DKM1T(TFIBLargeIntField * DocTIDDOC_REM_DKM1T)=0;

   __property TFIBWideStringField * DocTNAMECOUNTER_REM_DKM1T = {read = get_DocTNAMECOUNTER_REM_DKM1T , write = set_DocTNAMECOUNTER_REM_DKM1T};
   virtual TFIBWideStringField * get_DocTNAMECOUNTER_REM_DKM1T(void)=0;
   virtual void set_DocTNAMECOUNTER_REM_DKM1T(TFIBWideStringField * DocTNAMECOUNTER_REM_DKM1T)=0;

   __property TFIBBCDField * DocTBEFORE_REM_DKM1T = {read = get_DocTBEFORE_REM_DKM1T , write = set_DocTBEFORE_REM_DKM1T};
   virtual TFIBBCDField * get_DocTBEFORE_REM_DKM1T(void)=0;
   virtual void set_DocTBEFORE_REM_DKM1T(TFIBBCDField * DocTBEFORE_REM_DKM1T)=0;

   __property TFIBBCDField * DocTAFTER_REM_DKM1T = {read = get_DocTAFTER_REM_DKM1T , write = set_DocTAFTER_REM_DKM1T};
   virtual TFIBBCDField * get_DocTAFTER_REM_DKM1T(void)=0;
   virtual void set_DocTAFTER_REM_DKM1T(TFIBBCDField * DocTAFTER_REM_DKM1T)=0;
...
#define IID_IREM_DMDocKM1 __uuidof(IREM_DMDocKM1)
#endif
