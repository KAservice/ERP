#ifndef UIFormaGurDocCheckKKMH
#define UIFormaGurDocCheckKKMH
#include "IMainInterface.h"
#include "IDMGurDocCheckKKM.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaGurDocCheckKKM)) IFormaGurDocCheckKKM : public IMainInterface
{
public:
   ...
   __property IDMGurDocCheckKKM * DM = {read = get_DM , write = set_DM};
   virtual IDMGurDocCheckKKM * get_DM(void)=0;
   virtual void set_DM(IDMGurDocCheckKKM * DM)=0;
...
#define IID_IFormaGurDocCheckKKM __uuidof(IFormaGurDocCheckKKM)
#endif
