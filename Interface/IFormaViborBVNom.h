#ifndef UIFormaViborBVNomH
#define UIFormaViborBVNomH
#include "IMainInterface.h"
#include "IDMSprBVNom.h"
#include "IDMSprGrpBVNom.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaViborSprBVNom)) IFormaViborBVNom : public IMainInterface
{
public:
   ...
   __property IDMSprGrpBVNom * DMGrp = {read = get_DMGrp , write = set_DMGrp};
   virtual IDMSprGrpBVNom * get_DMGrp(void)=0;
   virtual void set_DMGrp(IDMSprGrpBVNom * DMGrp)=0;
...
#define IID_IFormaViborBVNom __uuidof(IFormaViborBVNom)
#endif
