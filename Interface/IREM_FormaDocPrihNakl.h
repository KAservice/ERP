#ifndef UIREM_FormaDocPrihNaklH
#define UIREM_FormaDocPrihNaklH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocPrihNakl.h"
class __declspec(uuid(Global_IID_IREM_FormaDocPrihNakl)) IREM_FormaDocPrihNakl : public IMainInterface
{
public:
   ...
   __property IREM_DMDocPrihNakl * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocPrihNakl * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocPrihNakl * DM)=0;
...
#define IID_IREM_FormaDocPrihNakl __uuidof(IREM_FormaDocPrihNakl)
#endif
