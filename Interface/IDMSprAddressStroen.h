#ifndef UIDMSprAddressStroenH
#define UIDMSprAddressStroenH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMSprAddressStroen)) IDMSprAddressStroen : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * TableID_SADR_STROEN = {read = get_TableID_SADR_STROEN , write = set_TableID_SADR_STROEN};
   virtual TFIBLargeIntField * get_TableID_SADR_STROEN(void)=0;
   virtual void set_TableID_SADR_STROEN(TFIBLargeIntField * TableID_SADR_STROEN)=0;

   __property TFIBLargeIntField * TableIDBASE_SADR_STROEN = {read = get_TableIDBASE_SADR_STROEN , write = set_TableIDBASE_SADR_STROEN};
   virtual TFIBLargeIntField * get_TableIDBASE_SADR_STROEN(void)=0;
   virtual void set_TableIDBASE_SADR_STROEN(TFIBLargeIntField * TableIDBASE_SADR_STROEN)=0;

   __property TFIBWideStringField * TableNAME_SADR_STROEN = {read = get_TableNAME_SADR_STROEN , write = set_TableNAME_SADR_STROEN};
   virtual TFIBWideStringField * get_TableNAME_SADR_STROEN(void)=0;
   virtual void set_TableNAME_SADR_STROEN(TFIBWideStringField * TableNAME_SADR_STROEN)=0;

   __property TFIBLargeIntField * TableIDDOM_SADR_STROEN = {read = get_TableIDDOM_SADR_STROEN , write = set_TableIDDOM_SADR_STROEN};
   virtual TFIBLargeIntField * get_TableIDDOM_SADR_STROEN(void)=0;
   virtual void set_TableIDDOM_SADR_STROEN(TFIBLargeIntField * TableIDDOM_SADR_STROEN)=0;
...
#define IID_IDMSprAddressStroen __uuidof(IDMSprAddressStroen)
#endif
