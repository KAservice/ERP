#ifndef UIREM_DMDocZVosvrZapH
#define UIREM_DMDocZVosvrZapH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocZVosvrZap)) IREM_DMDocZVosvrZap : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DZVZAP = {read = get_DocID_REM_DZVZAP , write = set_DocID_REM_DZVZAP};
   virtual TFIBLargeIntField * get_DocID_REM_DZVZAP(void)=0;
   virtual void set_DocID_REM_DZVZAP(TFIBLargeIntField * DocID_REM_DZVZAP)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DZVZAP = {read = get_DocIDBASE_REM_DZVZAP , write = set_DocIDBASE_REM_DZVZAP};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZVZAP(void)=0;
   virtual void set_DocIDBASE_REM_DZVZAP(TFIBLargeIntField * DocIDBASE_REM_DZVZAP)=0;

   __property TFIBWideStringField * DocGID_REM_DZVZAP = {read = get_DocGID_REM_DZVZAP , write = set_DocGID_REM_DZVZAP};
   virtual TFIBWideStringField * get_DocGID_REM_DZVZAP(void)=0;
   virtual void set_DocGID_REM_DZVZAP(TFIBWideStringField * DocGID_REM_DZVZAP)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DZVZAP = {read = get_DocIDDOC_REM_DZVZAP , write = set_DocIDDOC_REM_DZVZAP};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZVZAP(void)=0;
   virtual void set_DocIDDOC_REM_DZVZAP(TFIBLargeIntField * DocIDDOC_REM_DZVZAP)=0;

   __property TFIBLargeIntField * DocIDZ_REM_DZVZAP = {read = get_DocIDZ_REM_DZVZAP , write = set_DocIDZ_REM_DZVZAP};
   virtual TFIBLargeIntField * get_DocIDZ_REM_DZVZAP(void)=0;
   virtual void set_DocIDZ_REM_DZVZAP(TFIBLargeIntField * DocIDZ_REM_DZVZAP)=0;

   __property TFIBLargeIntField * DocIDTPRICE_REM_DZVZAP = {read = get_DocIDTPRICE_REM_DZVZAP , write = set_DocIDTPRICE_REM_DZVZAP};
   virtual TFIBLargeIntField * get_DocIDTPRICE_REM_DZVZAP(void)=0;
   virtual void set_DocIDTPRICE_REM_DZVZAP(TFIBLargeIntField * DocIDTPRICE_REM_DZVZAP)=0;

   __property TFIBWideStringField * DocPRIM_REM_DZVZAP = {read = get_DocPRIM_REM_DZVZAP , write = set_DocPRIM_REM_DZVZAP};
   virtual TFIBWideStringField * get_DocPRIM_REM_DZVZAP(void)=0;
   virtual void set_DocPRIM_REM_DZVZAP(TFIBWideStringField * DocPRIM_REM_DZVZAP)=0;
   ...
   __property TFIBLargeIntField * DocTID_REM_DZVZAPT = {read = get_DocTID_REM_DZVZAPT , write = set_DocTID_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTID_REM_DZVZAPT(void)=0;
   virtual void set_DocTID_REM_DZVZAPT(TFIBLargeIntField * DocTID_REM_DZVZAPT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DZVZAPT = {read = get_DocTIDBASE_REM_DZVZAPT , write = set_DocTIDBASE_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDBASE_REM_DZVZAPT(TFIBLargeIntField * DocTIDBASE_REM_DZVZAPT)=0;

   __property TFIBWideStringField * DocTGID_REM_DZVZAPT = {read = get_DocTGID_REM_DZVZAPT , write = set_DocTGID_REM_DZVZAPT};
   virtual TFIBWideStringField * get_DocTGID_REM_DZVZAPT(void)=0;
   virtual void set_DocTGID_REM_DZVZAPT(TFIBWideStringField * DocTGID_REM_DZVZAPT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DZVZAPT = {read = get_DocTIDDOC_REM_DZVZAPT , write = set_DocTIDDOC_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDDOC_REM_DZVZAPT(TFIBLargeIntField * DocTIDDOC_REM_DZVZAPT)=0;

   __property TFIBLargeIntField * DocTIDNOM_REM_DZVZAPT = {read = get_DocTIDNOM_REM_DZVZAPT , write = set_DocTIDNOM_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDNOM_REM_DZVZAPT(TFIBLargeIntField * DocTIDNOM_REM_DZVZAPT)=0;

   __property TFIBLargeIntField * DocTIDED_REM_DZVZAPT = {read = get_DocTIDED_REM_DZVZAPT , write = set_DocTIDED_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDED_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDED_REM_DZVZAPT(TFIBLargeIntField * DocTIDED_REM_DZVZAPT)=0;

   __property TFIBLargeIntField * DocTIDHW_REM_DZVZAPT = {read = get_DocTIDHW_REM_DZVZAPT , write = set_DocTIDHW_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDHW_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDHW_REM_DZVZAPT(TFIBLargeIntField * DocTIDHW_REM_DZVZAPT)=0;

   __property TFIBBCDField * DocTKOL_REM_DZVZAPT = {read = get_DocTKOL_REM_DZVZAPT , write = set_DocTKOL_REM_DZVZAPT};
   virtual TFIBBCDField * get_DocTKOL_REM_DZVZAPT(void)=0;
   virtual void set_DocTKOL_REM_DZVZAPT(TFIBBCDField * DocTKOL_REM_DZVZAPT)=0;

   __property TFIBBCDField * DocTKF_REM_DZVZAPT = {read = get_DocTKF_REM_DZVZAPT , write = set_DocTKF_REM_DZVZAPT};
   virtual TFIBBCDField * get_DocTKF_REM_DZVZAPT(void)=0;
   virtual void set_DocTKF_REM_DZVZAPT(TFIBBCDField * DocTKF_REM_DZVZAPT)=0;

   __property TFIBBCDField * DocTPRICE_REM_DZVZAPT = {read = get_DocTPRICE_REM_DZVZAPT , write = set_DocTPRICE_REM_DZVZAPT};
   virtual TFIBBCDField * get_DocTPRICE_REM_DZVZAPT(void)=0;
   virtual void set_DocTPRICE_REM_DZVZAPT(TFIBBCDField * DocTPRICE_REM_DZVZAPT)=0;

   __property TFIBBCDField * DocTSUM_REM_DZVZAPT = {read = get_DocTSUM_REM_DZVZAPT , write = set_DocTSUM_REM_DZVZAPT};
   virtual TFIBBCDField * get_DocTSUM_REM_DZVZAPT(void)=0;
   virtual void set_DocTSUM_REM_DZVZAPT(TFIBBCDField * DocTSUM_REM_DZVZAPT)=0;

   __property TFIBSmallIntField * DocTDVREG_REM_DZVZAPT = {read = get_DocTDVREG_REM_DZVZAPT , write = set_DocTDVREG_REM_DZVZAPT};
   virtual TFIBSmallIntField * get_DocTDVREG_REM_DZVZAPT(void)=0;
   virtual void set_DocTDVREG_REM_DZVZAPT(TFIBSmallIntField * DocTDVREG_REM_DZVZAPT)=0;
   ...
   __property TFIBLargeIntField * DocTIDTNOM_REM_DZVZAPT = {read = get_DocTIDTNOM_REM_DZVZAPT , write = set_DocTIDTNOM_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDTNOM_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDTNOM_REM_DZVZAPT(TFIBLargeIntField * DocTIDTNOM_REM_DZVZAPT)=0;

   __property TStringField * DocTNAME_TYPE_NOM_LOOKUP = {read = get_DocTNAME_TYPE_NOM_LOOKUP , write = set_DocTNAME_TYPE_NOM_LOOKUP};
   virtual TStringField * get_DocTNAME_TYPE_NOM_LOOKUP(void)=0;
   virtual void set_DocTNAME_TYPE_NOM_LOOKUP(TStringField * DocTNAME_TYPE_NOM_LOOKUP)=0;

   __property TFIBLargeIntField * DocTIDTVZIP_REM_DZVZAPT = {read = get_DocTIDTVZIP_REM_DZVZAPT , write = set_DocTIDTVZIP_REM_DZVZAPT};
   virtual TFIBLargeIntField * get_DocTIDTVZIP_REM_DZVZAPT(void)=0;
   virtual void set_DocTIDTVZIP_REM_DZVZAPT(TFIBLargeIntField * DocTIDTVZIP_REM_DZVZAPT)=0;

   __property TFIBLargeIntField * DocTIDMHRAN_REM_DVZAPT = {read = get_DocTIDMHRAN_REM_DVZAPT , write = set_DocTIDMHRAN_REM_DVZAPT};
   virtual TFIBLargeIntField * get_DocTIDMHRAN_REM_DVZAPT(void)=0;
   virtual void set_DocTIDMHRAN_REM_DVZAPT(TFIBLargeIntField * DocTIDMHRAN_REM_DVZAPT)=0;
...
#define IID_IREM_DMDocZVosvrZap __uuidof(IREM_DMDocZVosvrZap)
#endif
