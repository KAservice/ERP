#ifndef UIDMDocRegBankH
#define UIDMDocRegBankH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocRegBank)) IDMDocRegBank : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTDV_DRG_BANKT = {read = get_DocTTDV_DRG_BANKT , write = set_DocTTDV_DRG_BANKT};
   virtual TFIBSmallIntField * get_DocTTDV_DRG_BANKT(void)=0;
   virtual void set_DocTTDV_DRG_BANKT(TFIBSmallIntField * DocTTDV_DRG_BANKT)=0;

   __property TFIBSmallIntField * DocTOPER_DRG_BANKT = {read = get_DocTOPER_DRG_BANKT , write = set_DocTOPER_DRG_BANKT};
   virtual TFIBSmallIntField * get_DocTOPER_DRG_BANKT(void)=0;
   virtual void set_DocTOPER_DRG_BANKT(TFIBSmallIntField * DocTOPER_DRG_BANKT)=0;

   __property TFIBBCDField * DocTSUM_DRG_BANKT = {read = get_DocTSUM_DRG_BANKT , write = set_DocTSUM_DRG_BANKT};
   virtual TFIBBCDField * get_DocTSUM_DRG_BANKT(void)=0;
   virtual void set_DocTSUM_DRG_BANKT(TFIBBCDField * DocTSUM_DRG_BANKT)=0;
   ...
   __property TFIBLargeIntField * DocID_DRG_BANK = {read = get_DocID_DRG_BANK , write = set_DocID_DRG_BANK};
   virtual TFIBLargeIntField * get_DocID_DRG_BANK(void)=0;
   virtual void set_DocID_DRG_BANK(TFIBLargeIntField * DocID_DRG_BANK)=0;

   __property TFIBLargeIntField * DocIDBASE_DRG_BANK = {read = get_DocIDBASE_DRG_BANK , write = set_DocIDBASE_DRG_BANK};
   virtual TFIBLargeIntField * get_DocIDBASE_DRG_BANK(void)=0;
   virtual void set_DocIDBASE_DRG_BANK(TFIBLargeIntField * DocIDBASE_DRG_BANK)=0;

   __property TFIBWideStringField * DocDESCR_DRG_BANK = {read = get_DocDESCR_DRG_BANK , write = set_DocDESCR_DRG_BANK};
   virtual TFIBWideStringField * get_DocDESCR_DRG_BANK(void)=0;
   virtual void set_DocDESCR_DRG_BANK(TFIBWideStringField * DocDESCR_DRG_BANK)=0;

   __property TFIBLargeIntField * DocIDDOC_DRG_BANK = {read = get_DocIDDOC_DRG_BANK , write = set_DocIDDOC_DRG_BANK};
   virtual TFIBLargeIntField * get_DocIDDOC_DRG_BANK(void)=0;
   virtual void set_DocIDDOC_DRG_BANK(TFIBLargeIntField * DocIDDOC_DRG_BANK)=0;

   __property TFIBLargeIntField * DocTID_DRG_BANKT = {read = get_DocTID_DRG_BANKT , write = set_DocTID_DRG_BANKT};
   virtual TFIBLargeIntField * get_DocTID_DRG_BANKT(void)=0;
   virtual void set_DocTID_DRG_BANKT(TFIBLargeIntField * DocTID_DRG_BANKT)=0;

   __property TFIBLargeIntField * DocTIDDOC_DRG_BANKT = {read = get_DocTIDDOC_DRG_BANKT , write = set_DocTIDDOC_DRG_BANKT};
   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_BANKT(void)=0;
   virtual void set_DocTIDDOC_DRG_BANKT(TFIBLargeIntField * DocTIDDOC_DRG_BANKT)=0;

   __property TFIBLargeIntField * DocTIDFIRM_DRG_BANKT = {read = get_DocTIDFIRM_DRG_BANKT , write = set_DocTIDFIRM_DRG_BANKT};
   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_BANKT(void)=0;
   virtual void set_DocTIDFIRM_DRG_BANKT(TFIBLargeIntField * DocTIDFIRM_DRG_BANKT)=0;

   __property TFIBLargeIntField * DocTIDBSCHET_DRG_BANKT = {read = get_DocTIDBSCHET_DRG_BANKT , write = set_DocTIDBSCHET_DRG_BANKT};
   virtual TFIBLargeIntField * get_DocTIDBSCHET_DRG_BANKT(void)=0;
   virtual void set_DocTIDBSCHET_DRG_BANKT(TFIBLargeIntField * DocTIDBSCHET_DRG_BANKT)=0;

   __property TFIBLargeIntField * DocTIDBASE_DRG_BANKT = {read = get_DocTIDBASE_DRG_BANKT , write = set_DocTIDBASE_DRG_BANKT};
   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_BANKT(void)=0;
   virtual void set_DocTIDBASE_DRG_BANKT(TFIBLargeIntField * DocTIDBASE_DRG_BANKT)=0;
   ...
   __property TFIBWideStringField * DocTNAMEBSCHET = {read = get_DocTNAMEBSCHET , write = set_DocTNAMEBSCHET};
   virtual TFIBWideStringField * get_DocTNAMEBSCHET(void)=0;
   virtual void set_DocTNAMEBSCHET(TFIBWideStringField * DocTNAMEBSCHET)=0;
...
#define IID_IDMDocRegBank __uuidof(IDMDocRegBank)
#endif
