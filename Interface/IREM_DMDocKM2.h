#ifndef UIREM_DMDocKM2H
#define UIREM_DMDocKM2H
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocKM2)) IREM_DMDocKM2 : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DKM2 = {read = get_DocID_REM_DKM2 , write = set_DocID_REM_DKM2};
   virtual TFIBLargeIntField * get_DocID_REM_DKM2(void)=0;
   virtual void set_DocID_REM_DKM2(TFIBLargeIntField * DocID_REM_DKM2)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DKM2 = {read = get_DocIDBASE_REM_DKM2 , write = set_DocIDBASE_REM_DKM2};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DKM2(void)=0;
   virtual void set_DocIDBASE_REM_DKM2(TFIBLargeIntField * DocIDBASE_REM_DKM2)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DKM2 = {read = get_DocIDDOC_REM_DKM2 , write = set_DocIDDOC_REM_DKM2};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DKM2(void)=0;
   virtual void set_DocIDDOC_REM_DKM2(TFIBLargeIntField * DocIDDOC_REM_DKM2)=0;

   __property TFIBLargeIntField * DocIDKKT_REM_DKM2 = {read = get_DocIDKKT_REM_DKM2 , write = set_DocIDKKT_REM_DKM2};
   virtual TFIBLargeIntField * get_DocIDKKT_REM_DKM2(void)=0;
   virtual void set_DocIDKKT_REM_DKM2(TFIBLargeIntField * DocIDKKT_REM_DKM2)=0;

   __property TFIBWideStringField * DocPRIM_REM_DKM2 = {read = get_DocPRIM_REM_DKM2 , write = set_DocPRIM_REM_DKM2};
   virtual TFIBWideStringField * get_DocPRIM_REM_DKM2(void)=0;
   virtual void set_DocPRIM_REM_DKM2(TFIBWideStringField * DocPRIM_REM_DKM2)=0;

   __property TFIBBCDField * DocNI_BEFORE_REM_DKM2 = {read = get_DocNI_BEFORE_REM_DKM2 , write = set_DocNI_BEFORE_REM_DKM2};
   virtual TFIBBCDField * get_DocNI_BEFORE_REM_DKM2(void)=0;
   virtual void set_DocNI_BEFORE_REM_DKM2(TFIBBCDField * DocNI_BEFORE_REM_DKM2)=0;

   __property TFIBBCDField * DocNI_AFTER_REM_DKM2 = {read = get_DocNI_AFTER_REM_DKM2 , write = set_DocNI_AFTER_REM_DKM2};
   virtual TFIBBCDField * get_DocNI_AFTER_REM_DKM2(void)=0;
   virtual void set_DocNI_AFTER_REM_DKM2(TFIBBCDField * DocNI_AFTER_REM_DKM2)=0;
   ...
   __property TFIBLargeIntField * DocTID_REM_DKM2T = {read = get_DocTID_REM_DKM2T , write = set_DocTID_REM_DKM2T};
   virtual TFIBLargeIntField * get_DocTID_REM_DKM2T(void)=0;
   virtual void set_DocTID_REM_DKM2T(TFIBLargeIntField * DocTID_REM_DKM2T)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DKM2T = {read = get_DocTIDBASE_REM_DKM2T , write = set_DocTIDBASE_REM_DKM2T};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DKM2T(void)=0;
   virtual void set_DocTIDBASE_REM_DKM2T(TFIBLargeIntField * DocTIDBASE_REM_DKM2T)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DKM2T = {read = get_DocTIDDOC_REM_DKM2T , write = set_DocTIDDOC_REM_DKM2T};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DKM2T(void)=0;
   virtual void set_DocTIDDOC_REM_DKM2T(TFIBLargeIntField * DocTIDDOC_REM_DKM2T)=0;

   __property TFIBWideStringField * DocTNAMECOUNTER_REM_DKM2T = {read = get_DocTNAMECOUNTER_REM_DKM2T , write = set_DocTNAMECOUNTER_REM_DKM2T};
   virtual TFIBWideStringField * get_DocTNAMECOUNTER_REM_DKM2T(void)=0;
   virtual void set_DocTNAMECOUNTER_REM_DKM2T(TFIBWideStringField * DocTNAMECOUNTER_REM_DKM2T)=0;

   __property TFIBBCDField * DocTBEFORE_REM_DKM2T = {read = get_DocTBEFORE_REM_DKM2T , write = set_DocTBEFORE_REM_DKM2T};
   virtual TFIBBCDField * get_DocTBEFORE_REM_DKM2T(void)=0;
   virtual void set_DocTBEFORE_REM_DKM2T(TFIBBCDField * DocTBEFORE_REM_DKM2T)=0;

   __property TFIBBCDField * DocTAFTER_REM_DKM2T = {read = get_DocTAFTER_REM_DKM2T , write = set_DocTAFTER_REM_DKM2T};
   virtual TFIBBCDField * get_DocTAFTER_REM_DKM2T(void)=0;
   virtual void set_DocTAFTER_REM_DKM2T(TFIBBCDField * DocTAFTER_REM_DKM2T)=0;
...
#define IID_IREM_DMDocKM2 __uuidof(IREM_DMDocKM2)
#endif
