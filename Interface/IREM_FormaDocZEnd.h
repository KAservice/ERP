#ifndef UIREM_FormaDocZEndH
#define UIREM_FormaDocZEndH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocZEnd.h"
class __declspec(uuid(Global_IID_IREM_FormaDocZEnd)) IREM_FormaDocZEnd : public IMainInterface
{
public:
   __property IREM_DMDocZEnd * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocZEnd * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocZEnd * DM)=0;
...
#define IID_IREM_FormaDocZEnd __uuidof(IREM_FormaDocZEnd)
#endif
