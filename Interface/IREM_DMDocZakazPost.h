#ifndef UIREM_DMDocZakazPostH
#define UIREM_DMDocZakazPostH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocZakazPost)) IREM_DMDocZakazPost : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DZAKPOST = {read = get_DocID_REM_DZAKPOST , write = set_DocID_REM_DZAKPOST};
   virtual TFIBLargeIntField * get_DocID_REM_DZAKPOST(void)=0;
   virtual void set_DocID_REM_DZAKPOST(TFIBLargeIntField * DocID_REM_DZAKPOST)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DZAKPOST = {read = get_DocIDBASE_REM_DZAKPOST , write = set_DocIDBASE_REM_DZAKPOST};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZAKPOST(void)=0;
   virtual void set_DocIDBASE_REM_DZAKPOST(TFIBLargeIntField * DocIDBASE_REM_DZAKPOST)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DZAKPOST = {read = get_DocIDDOC_REM_DZAKPOST , write = set_DocIDDOC_REM_DZAKPOST};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZAKPOST(void)=0;
   virtual void set_DocIDDOC_REM_DZAKPOST(TFIBLargeIntField * DocIDDOC_REM_DZAKPOST)=0;

   __property TFIBLargeIntField * DocIDTPRICE_REM_DZAKPOST = {read = get_DocIDTPRICE_REM_DZAKPOST , write = set_DocIDTPRICE_REM_DZAKPOST};
   virtual TFIBLargeIntField * get_DocIDTPRICE_REM_DZAKPOST(void)=0;
   virtual void set_DocIDTPRICE_REM_DZAKPOST(TFIBLargeIntField * DocIDTPRICE_REM_DZAKPOST)=0;

   __property TFIBWideStringField * DocNUMZAKPOST_REM_DZAKPOST = {read = get_DocNUMZAKPOST_REM_DZAKPOST , write = set_DocNUMZAKPOST_REM_DZAKPOST};
   virtual TFIBWideStringField * get_DocNUMZAKPOST_REM_DZAKPOST(void)=0;
   virtual void set_DocNUMZAKPOST_REM_DZAKPOST(TFIBWideStringField * DocNUMZAKPOST_REM_DZAKPOST)=0;

   __property TFIBDateTimeField * DocPOSZAKPOST_REM_DZAKPOST = {read = get_DocPOSZAKPOST_REM_DZAKPOST , write = set_DocPOSZAKPOST_REM_DZAKPOST};
   virtual TFIBDateTimeField * get_DocPOSZAKPOST_REM_DZAKPOST(void)=0;
   virtual void set_DocPOSZAKPOST_REM_DZAKPOST(TFIBDateTimeField * DocPOSZAKPOST_REM_DZAKPOST)=0;

   __property TFIBLargeIntField * DocTID_REM_DZAKPOSTT = {read = get_DocTID_REM_DZAKPOSTT , write = set_DocTID_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTID_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTID_REM_DZAKPOSTT(TFIBLargeIntField * DocTID_REM_DZAKPOSTT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DZAKPOSTT = {read = get_DocTIDBASE_REM_DZAKPOSTT , write = set_DocTIDBASE_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTIDBASE_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDBASE_REM_DZAKPOSTT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DZAKPOSTT = {read = get_DocTIDDOC_REM_DZAKPOSTT , write = set_DocTIDDOC_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTIDDOC_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDDOC_REM_DZAKPOSTT)=0;

   __property TFIBLargeIntField * DocTIDNOM_REM_DZAKPOSTT = {read = get_DocTIDNOM_REM_DZAKPOSTT , write = set_DocTIDNOM_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTIDNOM_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDNOM_REM_DZAKPOSTT)=0;

   __property TFIBLargeIntField * DocTIDED_REM_DZAKPOSTT = {read = get_DocTIDED_REM_DZAKPOSTT , write = set_DocTIDED_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTIDED_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTIDED_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDED_REM_DZAKPOSTT)=0;

   __property TFIBBCDField * DocTKOL_REM_DZAKPOSTT = {read = get_DocTKOL_REM_DZAKPOSTT , write = set_DocTKOL_REM_DZAKPOSTT};
   virtual TFIBBCDField * get_DocTKOL_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTKOL_REM_DZAKPOSTT(TFIBBCDField * DocTKOL_REM_DZAKPOSTT)=0;

   __property TFIBBCDField * DocTKF_REM_DZAKPOSTT = {read = get_DocTKF_REM_DZAKPOSTT , write = set_DocTKF_REM_DZAKPOSTT};
   virtual TFIBBCDField * get_DocTKF_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTKF_REM_DZAKPOSTT(TFIBBCDField * DocTKF_REM_DZAKPOSTT)=0;

   __property TFIBBCDField * DocTPRICE_REM_DZAKPOSTT = {read = get_DocTPRICE_REM_DZAKPOSTT , write = set_DocTPRICE_REM_DZAKPOSTT};
   virtual TFIBBCDField * get_DocTPRICE_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTPRICE_REM_DZAKPOSTT(TFIBBCDField * DocTPRICE_REM_DZAKPOSTT)=0;

   __property TFIBBCDField * DocTSUM_REM_DZAKPOSTT = {read = get_DocTSUM_REM_DZAKPOSTT , write = set_DocTSUM_REM_DZAKPOSTT};
   virtual TFIBBCDField * get_DocTSUM_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTSUM_REM_DZAKPOSTT(TFIBBCDField * DocTSUM_REM_DZAKPOSTT)=0;
   ...
   __property TFIBLargeIntField * DocIDBRAND_REM_DZAKPOST = {read = get_DocIDBRAND_REM_DZAKPOST , write = set_DocIDBRAND_REM_DZAKPOST};
   virtual TFIBLargeIntField * get_DocIDBRAND_REM_DZAKPOST(void)=0;
   virtual void set_DocIDBRAND_REM_DZAKPOST(TFIBLargeIntField * DocIDBRAND_REM_DZAKPOST)=0;

   __property TFIBLargeIntField * DocIDPRODUCER_REM_DZAKPOST = {read = get_DocIDPRODUCER_REM_DZAKPOST , write = set_DocIDPRODUCER_REM_DZAKPOST};
   virtual TFIBLargeIntField * get_DocIDPRODUCER_REM_DZAKPOST(void)=0;
   virtual void set_DocIDPRODUCER_REM_DZAKPOST(TFIBLargeIntField * DocIDPRODUCER_REM_DZAKPOST)=0;
   ...
   __property TFIBLargeIntField * DocTIDPRNOM_REM_DZAKPOSTT = {read = get_DocTIDPRNOM_REM_DZAKPOSTT , write = set_DocTIDPRNOM_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTIDPRNOM_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTIDPRNOM_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDPRNOM_REM_DZAKPOSTT)=0;
   ...
   __property TFIBLargeIntField * DocTIDCQT_REM_DZAKPOSTT = {read = get_DocTIDCQT_REM_DZAKPOSTT , write = set_DocTIDCQT_REM_DZAKPOSTT};
   virtual TFIBLargeIntField * get_DocTIDCQT_REM_DZAKPOSTT(void)=0;
   virtual void set_DocTIDCQT_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDCQT_REM_DZAKPOSTT)=0;
...
#define IID_IREM_DMDocZakazPost __uuidof(IREM_DMDocZakazPost)
#endif
