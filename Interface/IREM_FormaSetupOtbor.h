#ifndef UIREM_FormaSetupOtborH
#define UIREM_FormaSetupOtborH
#include "IMainInterface.h"
class __declspec(uuid("{7811BF95-8384-4D25-A157-43774B43EB23}")) IREM_FormaSetupOtbor : public IMainInterface
{
public:
   ...
   __property int IdKlient = {read = get_IdKlient , write = set_IdKlient};
   virtual int get_IdKlient(void)=0;
   virtual void set_IdKlient(int IdKlient)=0;
   ...
   __property int IdFirm = {read = get_IdFirm , write = set_IdFirm};
   virtual int get_IdFirm(void)=0;
   virtual void set_IdFirm(int IdFirm)=0;
...
#define IID_IREM_FormaSetupOtbor __uuidof(IREM_FormaSetupOtbor)
#endif
