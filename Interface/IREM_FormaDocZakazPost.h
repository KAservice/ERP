#ifndef UIREM_FormaDocZakazPostH
#define UIREM_FormaDocZakazPostH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocZakazPost.h"
class __declspec(uuid(Global_IID_IREM_FormaDocZakazPost)) IREM_FormaDocZakazPost : public IMainInterface
{
public:
   ...
   __property IREM_DMDocZakazPost * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocZakazPost * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocZakazPost * DM)=0;
...
#define IID_IREM_FormaDocZakazPost __uuidof(IREM_FormaDocZakazPost)
#endif
