#ifndef UIREM_FormaDocKM1H
#define UIREM_FormaDocKM1H
#include "IMainInterface.h"
#include "IREM_DMDocKM1.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IREM_FormaDocKM1)) IREM_FormaDocKM1 : public IMainInterface
{
public:
   ...
   __property IREM_DMDocKM1 * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocKM1 * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocKM1 * DM)=0;
...
#define IID_IREM_FormaDocKM1 __uuidof(IREM_FormaDocKM1)
#endif
