#ifndef UIFormaSetupOtborGurRoznDocH
#define UIFormaSetupOtborGurRoznDocH
#include "IMainInterface.h"
class __declspec(uuid("{EE5317F1-CE91-4F0C-96DC-EBEF6D9D6EE6}")) IFormaSetupOtborGurRoznDoc : public IMainInterface
{
public:
...
#define IID_IFormaSetupOtborGurRoznDoc __uuidof(IFormaSetupOtborGurRoznDoc)
#endif
