#ifndef UIREM_FormaDocZAktPrH
#define UIREM_FormaDocZAktPrH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocZAktPr.h"
class __declspec(uuid(Global_IID_IREM_FormaDocZAktPr)) IREM_FormaDocZAktPr : public IMainInterface
{
public:
   __property IREM_DMDocZAktPr * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocZAktPr * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocZAktPr * DM)=0;
...
#define IID_IREM_FormaDocZAktPr __uuidof(IREM_FormaDocZAktPr)
#endif
