...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocPKO)) IDMDocPKO : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocADDKDRPKO = {read = get_DocADDKDRPKO , write = set_DocADDKDRPKO};
   virtual TFIBSmallIntField * get_DocADDKDRPKO(void)=0;
   virtual void set_DocADDKDRPKO(TFIBSmallIntField * DocADDKDRPKO)=0;

   __property TFIBBCDField * DocSUMUSNPKO = {read = get_DocSUMUSNPKO , write = set_DocSUMUSNPKO};
   virtual TFIBBCDField * get_DocSUMUSNPKO(void)=0;
   virtual void set_DocSUMUSNPKO(TFIBBCDField * DocSUMUSNPKO)=0;
   ...
   __property TFIBIntegerField * DocNKLPKO = {read = get_DocNKLPKO , write = set_DocNKLPKO};
   virtual TFIBIntegerField * get_DocNKLPKO(void)=0;
   virtual void set_DocNKLPKO(TFIBIntegerField * DocNKLPKO)=0;

   __property TFIBIntegerField * DocNCHECKPKO = {read = get_DocNCHECKPKO , write = set_DocNCHECKPKO};
   virtual TFIBIntegerField * get_DocNCHECKPKO(void)=0;
   virtual void set_DocNCHECKPKO(TFIBIntegerField * DocNCHECKPKO)=0;
   ...
   __property TFIBIntegerField * DocNDS_DPKO = {read = get_DocNDS_DPKO , write = set_DocNDS_DPKO};
   virtual TFIBIntegerField * get_DocNDS_DPKO(void)=0;
   virtual void set_DocNDS_DPKO(TFIBIntegerField * DocNDS_DPKO)=0;

   __property TFIBBCDField * DocSUMNDS_DPKO = {read = get_DocSUMNDS_DPKO , write = set_DocSUMNDS_DPKO};
   virtual TFIBBCDField * get_DocSUMNDS_DPKO(void)=0;
   virtual void set_DocSUMNDS_DPKO(TFIBBCDField * DocSUMNDS_DPKO)=0;
   ...
   __property TFIBLargeIntField * DocIDPKO = {read = get_DocIDPKO , write = set_DocIDPKO};
   virtual TFIBLargeIntField * get_DocIDPKO(void)=0;
   virtual void set_DocIDPKO(TFIBLargeIntField * DocIDPKO)=0;

   __property TFIBLargeIntField * DocIDDOCPKO = {read = get_DocIDDOCPKO , write = set_DocIDDOCPKO};
   virtual TFIBLargeIntField * get_DocIDDOCPKO(void)=0;
   virtual void set_DocIDDOCPKO(TFIBLargeIntField * DocIDDOCPKO)=0;

   __property TFIBLargeIntField * DocIDKKMPKO = {read = get_DocIDKKMPKO , write = set_DocIDKKMPKO};
   virtual TFIBLargeIntField * get_DocIDKKMPKO(void)=0;
   virtual void set_DocIDKKMPKO(TFIBLargeIntField * DocIDKKMPKO)=0;

   __property TFIBLargeIntField * DocIDKLPKO = {read = get_DocIDKLPKO , write = set_DocIDKLPKO};
   virtual TFIBLargeIntField * get_DocIDKLPKO(void)=0;
   virtual void set_DocIDKLPKO(TFIBLargeIntField * DocIDKLPKO)=0;

   __property TFIBWideStringField * DocPROTPKO = {read = get_DocPROTPKO , write = set_DocPROTPKO};
   virtual TFIBWideStringField * get_DocPROTPKO(void)=0;
   virtual void set_DocPROTPKO(TFIBWideStringField * DocPROTPKO)=0;

   __property TFIBWideStringField * DocOSNPKO = {read = get_DocOSNPKO , write = set_DocOSNPKO};
   virtual TFIBWideStringField * get_DocOSNPKO(void)=0;
   virtual void set_DocOSNPKO(TFIBWideStringField * DocOSNPKO)=0;

   __property TFIBWideStringField * DocPRILPKO = {read = get_DocPRILPKO , write = set_DocPRILPKO};
   virtual TFIBWideStringField * get_DocPRILPKO(void)=0;
   virtual void set_DocPRILPKO(TFIBWideStringField * DocPRILPKO)=0;

   __property TFIBWideStringField * DocGID_DPKO = {read = get_DocGID_DPKO , write = set_DocGID_DPKO};
   virtual TFIBWideStringField * get_DocGID_DPKO(void)=0;
   virtual void set_DocGID_DPKO(TFIBWideStringField * DocGID_DPKO)=0;

   __property TFIBIntegerField * DocOPERATIONPKO = {read = get_DocOPERATIONPKO , write = set_DocOPERATIONPKO};
   virtual TFIBIntegerField * get_DocOPERATIONPKO(void)=0;
   virtual void set_DocOPERATIONPKO(TFIBIntegerField * DocOPERATIONPKO)=0;

   __property TFIBWideStringField * DocMODELPKO = {read = get_DocMODELPKO , write = set_DocMODELPKO};
   virtual TFIBWideStringField * get_DocMODELPKO(void)=0;
   virtual void set_DocMODELPKO(TFIBWideStringField * DocMODELPKO)=0;

   __property TFIBWideStringField * DocREGNUMPKO = {read = get_DocREGNUMPKO , write = set_DocREGNUMPKO};
   virtual TFIBWideStringField * get_DocREGNUMPKO(void)=0;
   virtual void set_DocREGNUMPKO(TFIBWideStringField * DocREGNUMPKO)=0;

   __property TFIBWideStringField * DocSAVNUMPKO = {read = get_DocSAVNUMPKO , write = set_DocSAVNUMPKO};
   virtual TFIBWideStringField * get_DocSAVNUMPKO(void)=0;
   virtual void set_DocSAVNUMPKO(TFIBWideStringField * DocSAVNUMPKO)=0;

   __property TFIBLargeIntField * DocIDBASE_DPKO = {read = get_DocIDBASE_DPKO , write = set_DocIDBASE_DPKO};
   virtual TFIBLargeIntField * get_DocIDBASE_DPKO(void)=0;
   virtual void set_DocIDBASE_DPKO(TFIBLargeIntField * DocIDBASE_DPKO)=0;
   ...
   __property TFIBWideStringField * DocKORRSCHET_DPKO = {read = get_DocKORRSCHET_DPKO , write = set_DocKORRSCHET_DPKO};
   virtual TFIBWideStringField * get_DocKORRSCHET_DPKO(void)=0;
   virtual void set_DocKORRSCHET_DPKO(TFIBWideStringField * DocKORRSCHET_DPKO)=0;
...
#define IID_IDMDocPKO __uuidof(IDMDocPKO)
#endif
