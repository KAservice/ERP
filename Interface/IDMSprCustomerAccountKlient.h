#ifndef UIDMSprCustomerAccountKLientH
#define UIDMSprCustomerAccountKLientH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IDMSprCustomerAccountKLient)) IDMSprCustomerAccountKLient : public IMainInterface
{
public:
...
#define IID_IDMSprCustomerAccountKLient __uuidof(IDMSprCustomerAccountKLient)
#endif
