#ifndef UIREM_DMDocVosvratDileruH
#define UIREM_DMDocVosvratDileruH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocVosvratDileru)) IREM_DMDocVosvratDileru : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DDILRET = {read = get_DocID_REM_DDILRET , write = set_DocID_REM_DDILRET};
   virtual TFIBLargeIntField * get_DocID_REM_DDILRET(void)=0;
   virtual void set_DocID_REM_DDILRET(TFIBLargeIntField * DocID_REM_DDILRET)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DDILRET = {read = get_DocIDBASE_REM_DDILRET , write = set_DocIDBASE_REM_DDILRET};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DDILRET(void)=0;
   virtual void set_DocIDBASE_REM_DDILRET(TFIBLargeIntField * DocIDBASE_REM_DDILRET)=0;

   __property TFIBWideStringField * DocGID_REM_DDILRET = {read = get_DocGID_REM_DDILRET , write = set_DocGID_REM_DDILRET};
   virtual TFIBWideStringField * get_DocGID_REM_DDILRET(void)=0;
   virtual void set_DocGID_REM_DDILRET(TFIBWideStringField * DocGID_REM_DDILRET)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DDILRET = {read = get_DocIDDOC_REM_DDILRET , write = set_DocIDDOC_REM_DDILRET};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DDILRET(void)=0;
   virtual void set_DocIDDOC_REM_DDILRET(TFIBLargeIntField * DocIDDOC_REM_DDILRET)=0;

   __property TFIBWideStringField * DocNUMDOCDIL_REM_DDILRET = {read = get_DocNUMDOCDIL_REM_DDILRET , write = set_DocNUMDOCDIL_REM_DDILRET};
   virtual TFIBWideStringField * get_DocNUMDOCDIL_REM_DDILRET(void)=0;
   virtual void set_DocNUMDOCDIL_REM_DDILRET(TFIBWideStringField * DocNUMDOCDIL_REM_DDILRET)=0;

   __property TFIBDateTimeField * DocPOSDOCDIL_REM_DDILRET = {read = get_DocPOSDOCDIL_REM_DDILRET , write = set_DocPOSDOCDIL_REM_DDILRET};
   virtual TFIBDateTimeField * get_DocPOSDOCDIL_REM_DDILRET(void)=0;
   virtual void set_DocPOSDOCDIL_REM_DDILRET(TFIBDateTimeField * DocPOSDOCDIL_REM_DDILRET)=0;

   __property TFIBWideStringField * DocPRIM_REM_DDILRET = {read = get_DocPRIM_REM_DDILRET , write = set_DocPRIM_REM_DDILRET};
   virtual TFIBWideStringField * get_DocPRIM_REM_DDILRET(void)=0;
   virtual void set_DocPRIM_REM_DDILRET(TFIBWideStringField * DocPRIM_REM_DDILRET)=0;

   __property TFIBLargeIntField * DocTID_REM_DDILRETT = {read = get_DocTID_REM_DDILRETT , write = set_DocTID_REM_DDILRETT};
   virtual TFIBLargeIntField * get_DocTID_REM_DDILRETT(void)=0;
   virtual void set_DocTID_REM_DDILRETT(TFIBLargeIntField * DocTID_REM_DDILRETT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DDILRETT = {read = get_DocTIDBASE_REM_DDILRETT , write = set_DocTIDBASE_REM_DDILRETT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DDILRETT(void)=0;
   virtual void set_DocTIDBASE_REM_DDILRETT(TFIBLargeIntField * DocTIDBASE_REM_DDILRETT)=0;

   __property TFIBWideStringField * DocTGID_REM_DDILRETT = {read = get_DocTGID_REM_DDILRETT , write = set_DocTGID_REM_DDILRETT};
   virtual TFIBWideStringField * get_DocTGID_REM_DDILRETT(void)=0;
   virtual void set_DocTGID_REM_DDILRETT(TFIBWideStringField * DocTGID_REM_DDILRETT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DDILRETT = {read = get_DocTIDDOC_REM_DDILRETT , write = set_DocTIDDOC_REM_DDILRETT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DDILRETT(void)=0;
   virtual void set_DocTIDDOC_REM_DDILRETT(TFIBLargeIntField * DocTIDDOC_REM_DDILRETT)=0;

   __property TFIBLargeIntField * DocTIDZ_REM_DDILRETT = {read = get_DocTIDZ_REM_DDILRETT , write = set_DocTIDZ_REM_DDILRETT};
   virtual TFIBLargeIntField * get_DocTIDZ_REM_DDILRETT(void)=0;
   virtual void set_DocTIDZ_REM_DDILRETT(TFIBLargeIntField * DocTIDZ_REM_DDILRETT)=0;

   __property TFIBBCDField * DocTKOL_REM_DDILRETT = {read = get_DocTKOL_REM_DDILRETT , write = set_DocTKOL_REM_DDILRETT};
   virtual TFIBBCDField * get_DocTKOL_REM_DDILRETT(void)=0;
   virtual void set_DocTKOL_REM_DDILRETT(TFIBBCDField * DocTKOL_REM_DDILRETT)=0;
...
#define IID_IREM_DMDocVosvratDileru __uuidof(IREM_DMDocVosvratDileru)
#endif
