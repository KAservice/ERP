#ifndef UIREM_FormaDocOtprPostH
#define UIREM_FormaDocOtprPostH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocOtprPost.h"
class __declspec(uuid(Global_IID_IREM_FormaDocOtprPost)) IREM_FormaDocOtprPost : public IMainInterface
{
public:
   ...
   __property IREM_DMDocOtprPost * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocOtprPost * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocOtprPost * DM)=0;
...
#define IID_IREM_FormaDocOtprPost __uuidof(IREM_FormaDocOtprPost)
#endif
