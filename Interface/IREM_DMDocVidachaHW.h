#ifndef UIREM_DMDocVidachaHWH
#define UIREM_DMDocVidachaHWH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocVidachaHW)) IREM_DMDocVidachaHW : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DVIDACHA_HW = {read = get_DocID_REM_DVIDACHA_HW , write = set_DocID_REM_DVIDACHA_HW};
   virtual TFIBLargeIntField * get_DocID_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocID_REM_DVIDACHA_HW(TFIBLargeIntField * DocID_REM_DVIDACHA_HW)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DVIDACHA_HW = {read = get_DocIDBASE_REM_DVIDACHA_HW , write = set_DocIDBASE_REM_DVIDACHA_HW};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocIDBASE_REM_DVIDACHA_HW(TFIBLargeIntField * DocIDBASE_REM_DVIDACHA_HW)=0;

   __property TFIBWideStringField * DocGID_REM_DVIDACHA_HW = {read = get_DocGID_REM_DVIDACHA_HW , write = set_DocGID_REM_DVIDACHA_HW};
   virtual TFIBWideStringField * get_DocGID_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocGID_REM_DVIDACHA_HW(TFIBWideStringField * DocGID_REM_DVIDACHA_HW)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DVIDACHA_HW = {read = get_DocIDDOC_REM_DVIDACHA_HW , write = set_DocIDDOC_REM_DVIDACHA_HW};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocIDDOC_REM_DVIDACHA_HW(TFIBLargeIntField * DocIDDOC_REM_DVIDACHA_HW)=0;

   __property TFIBWideStringField * DocKLIENT_NAME_REM_DVIDACHA_HW = {read = get_DocKLIENT_NAME_REM_DVIDACHA_HW , write = set_DocKLIENT_NAME_REM_DVIDACHA_HW};
   virtual TFIBWideStringField * get_DocKLIENT_NAME_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocKLIENT_NAME_REM_DVIDACHA_HW(TFIBWideStringField * DocKLIENT_NAME_REM_DVIDACHA_HW)=0;

   __property TFIBWideStringField * DocKLIENT_ADR_REM_DVIDACHA_HW = {read = get_DocKLIENT_ADR_REM_DVIDACHA_HW , write = set_DocKLIENT_ADR_REM_DVIDACHA_HW};
   virtual TFIBWideStringField * get_DocKLIENT_ADR_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocKLIENT_ADR_REM_DVIDACHA_HW(TFIBWideStringField * DocKLIENT_ADR_REM_DVIDACHA_HW)=0;

   __property TFIBWideStringField * DocKLIENT_PHONE_REM_DVIDACHA_HW = {read = get_DocKLIENT_PHONE_REM_DVIDACHA_HW , write = set_DocKLIENT_PHONE_REM_DVIDACHA_HW};
   virtual TFIBWideStringField * get_DocKLIENT_PHONE_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocKLIENT_PHONE_REM_DVIDACHA_HW(TFIBWideStringField * DocKLIENT_PHONE_REM_DVIDACHA_HW)=0;

   __property TFIBWideStringField * DocKLIENT_PASSPORT_REM_DVIDACHA_HW = {read = get_DocKLIENT_PASSPORT_REM_DVIDACHA_HW , write = set_DocKLIENT_PASSPORT_REM_DVIDACHA_HW};
   virtual TFIBWideStringField * get_DocKLIENT_PASSPORT_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocKLIENT_PASSPORT_REM_DVIDACHA_HW(TFIBWideStringField * DocKLIENT_PASSPORT_REM_DVIDACHA_HW)=0;

   __property TFIBWideStringField * DocPRIM_REM_DVIDACHA_HW = {read = get_DocPRIM_REM_DVIDACHA_HW , write = set_DocPRIM_REM_DVIDACHA_HW};
   virtual TFIBWideStringField * get_DocPRIM_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocPRIM_REM_DVIDACHA_HW(TFIBWideStringField * DocPRIM_REM_DVIDACHA_HW)=0;

   __property TFIBLargeIntField * DocIDZ_REM_DVIDACHA_HW = {read = get_DocIDZ_REM_DVIDACHA_HW , write = set_DocIDZ_REM_DVIDACHA_HW};
   virtual TFIBLargeIntField * get_DocIDZ_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocIDZ_REM_DVIDACHA_HW(TFIBLargeIntField * DocIDZ_REM_DVIDACHA_HW)=0;

   __property TFIBLargeIntField * DocIDHW_REM_DVIDACHA_HW = {read = get_DocIDHW_REM_DVIDACHA_HW , write = set_DocIDHW_REM_DVIDACHA_HW};
   virtual TFIBLargeIntField * get_DocIDHW_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocIDHW_REM_DVIDACHA_HW(TFIBLargeIntField * DocIDHW_REM_DVIDACHA_HW)=0;

   __property TFIBLargeIntField * DocIDKKT_REM_DVIDACHA_HW = {read = get_DocIDKKT_REM_DVIDACHA_HW , write = set_DocIDKKT_REM_DVIDACHA_HW};
   virtual TFIBLargeIntField * get_DocIDKKT_REM_DVIDACHA_HW(void)=0;
   virtual void set_DocIDKKT_REM_DVIDACHA_HW(TFIBLargeIntField * DocIDKKT_REM_DVIDACHA_HW)=0;
   ...
   __property TFIBLargeIntField * DocTID_REM_DVIDACHA_HWT = {read = get_DocTID_REM_DVIDACHA_HWT , write = set_DocTID_REM_DVIDACHA_HWT};
   virtual TFIBLargeIntField * get_DocTID_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTID_REM_DVIDACHA_HWT(TFIBLargeIntField * DocTID_REM_DVIDACHA_HWT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DVIDACHA_HWT = {read = get_DocTIDBASE_REM_DVIDACHA_HWT , write = set_DocTIDBASE_REM_DVIDACHA_HWT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTIDBASE_REM_DVIDACHA_HWT(TFIBLargeIntField * DocTIDBASE_REM_DVIDACHA_HWT)=0;

   __property TFIBWideStringField * DocTGID_REM_DVIDACHA_HWT = {read = get_DocTGID_REM_DVIDACHA_HWT , write = set_DocTGID_REM_DVIDACHA_HWT};
   virtual TFIBWideStringField * get_DocTGID_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTGID_REM_DVIDACHA_HWT(TFIBWideStringField * DocTGID_REM_DVIDACHA_HWT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DVIDACHA_HWT = {read = get_DocTIDDOC_REM_DVIDACHA_HWT , write = set_DocTIDDOC_REM_DVIDACHA_HWT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTIDDOC_REM_DVIDACHA_HWT(TFIBLargeIntField * DocTIDDOC_REM_DVIDACHA_HWT)=0;

   __property TFIBLargeIntField * DocTIDHW_REM_DVIDACHA_HWT = {read = get_DocTIDHW_REM_DVIDACHA_HWT , write = set_DocTIDHW_REM_DVIDACHA_HWT};
   virtual TFIBLargeIntField * get_DocTIDHW_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTIDHW_REM_DVIDACHA_HWT(TFIBLargeIntField * DocTIDHW_REM_DVIDACHA_HWT)=0;

   __property TFIBBCDField * DocTKF_REM_DVIDACHA_HWT = {read = get_DocTKF_REM_DVIDACHA_HWT , write = set_DocTKF_REM_DVIDACHA_HWT};
   virtual TFIBBCDField * get_DocTKF_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTKF_REM_DVIDACHA_HWT(TFIBBCDField * DocTKF_REM_DVIDACHA_HWT)=0;

   __property TFIBBCDField * DocTKOL_REM_DVIDACHA_HWT = {read = get_DocTKOL_REM_DVIDACHA_HWT , write = set_DocTKOL_REM_DVIDACHA_HWT};
   virtual TFIBBCDField * get_DocTKOL_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTKOL_REM_DVIDACHA_HWT(TFIBBCDField * DocTKOL_REM_DVIDACHA_HWT)=0;

   __property TFIBWideStringField * DocTPOVREGD_REM_DVIDACHA_HWT = {read = get_DocTPOVREGD_REM_DVIDACHA_HWT , write = set_DocTPOVREGD_REM_DVIDACHA_HWT};
   virtual TFIBWideStringField * get_DocTPOVREGD_REM_DVIDACHA_HWT(void)=0;
   virtual void set_DocTPOVREGD_REM_DVIDACHA_HWT(TFIBWideStringField * DocTPOVREGD_REM_DVIDACHA_HWT)=0;
...
#define IID_IREM_DMDocVidachaHW __uuidof(IREM_DMDocVidachaHW)
#endif
