#ifndef UIFormaImportSprProducerConditionH
#define UIFormaImportSprProducerConditionH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaImportSprProducerCondition)) IFormaImportSprProducerCondition : public IMainInterface
{
public:
...
#define IID_IFormaImportSprProducerCondition __uuidof(IFormaImportSprProducerCondition)
#endif
