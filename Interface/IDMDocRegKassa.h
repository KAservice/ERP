#ifndef UIDMDocRegKassaH
#define UIDMDocRegKassaH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocRegKassa)) IDMDocRegKassa : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTDV_DRG_KASSAT = {read = get_DocTTDV_DRG_KASSAT , write = set_DocTTDV_DRG_KASSAT};
   virtual TFIBSmallIntField * get_DocTTDV_DRG_KASSAT(void)=0;
   virtual void set_DocTTDV_DRG_KASSAT(TFIBSmallIntField * DocTTDV_DRG_KASSAT)=0;

   __property TFIBBCDField * DocTSUM_DRG_KASSAT = {read = get_DocTSUM_DRG_KASSAT , write = set_DocTSUM_DRG_KASSAT};
   virtual TFIBBCDField * get_DocTSUM_DRG_KASSAT(void)=0;
   virtual void set_DocTSUM_DRG_KASSAT(TFIBBCDField * DocTSUM_DRG_KASSAT)=0;

   __property TFIBSmallIntField * DocTOPER_DRG_KASSAT = {read = get_DocTOPER_DRG_KASSAT , write = set_DocTOPER_DRG_KASSAT};
   virtual TFIBSmallIntField * get_DocTOPER_DRG_KASSAT(void)=0;
   virtual void set_DocTOPER_DRG_KASSAT(TFIBSmallIntField * DocTOPER_DRG_KASSAT)=0;
   ...
   __property TFIBLargeIntField * DocID_DRG_KASSA = {read = get_DocID_DRG_KASSA , write = set_DocID_DRG_KASSA};
   virtual TFIBLargeIntField * get_DocID_DRG_KASSA(void)=0;
   virtual void set_DocID_DRG_KASSA(TFIBLargeIntField * DocID_DRG_KASSA)=0;

   __property TFIBLargeIntField * DocIDDOC_DRG_KASSA = {read = get_DocIDDOC_DRG_KASSA , write = set_DocIDDOC_DRG_KASSA};
   virtual TFIBLargeIntField * get_DocIDDOC_DRG_KASSA(void)=0;
   virtual void set_DocIDDOC_DRG_KASSA(TFIBLargeIntField * DocIDDOC_DRG_KASSA)=0;

   __property TFIBWideStringField * DocDESCR_DRG_KASSA = {read = get_DocDESCR_DRG_KASSA , write = set_DocDESCR_DRG_KASSA};
   virtual TFIBWideStringField * get_DocDESCR_DRG_KASSA(void)=0;
   virtual void set_DocDESCR_DRG_KASSA(TFIBWideStringField * DocDESCR_DRG_KASSA)=0;

   __property TFIBLargeIntField * DocIDBASE_DRG_KASSA = {read = get_DocIDBASE_DRG_KASSA , write = set_DocIDBASE_DRG_KASSA};
   virtual TFIBLargeIntField * get_DocIDBASE_DRG_KASSA(void)=0;
   virtual void set_DocIDBASE_DRG_KASSA(TFIBLargeIntField * DocIDBASE_DRG_KASSA)=0;

   __property TFIBLargeIntField * DocTID_DRG_KASSAT = {read = get_DocTID_DRG_KASSAT , write = set_DocTID_DRG_KASSAT};
   virtual TFIBLargeIntField * get_DocTID_DRG_KASSAT(void)=0;
   virtual void set_DocTID_DRG_KASSAT(TFIBLargeIntField * DocTID_DRG_KASSAT)=0;

   __property TFIBLargeIntField * DocTIDDOC_DRG_KASSAT = {read = get_DocTIDDOC_DRG_KASSAT , write = set_DocTIDDOC_DRG_KASSAT};
   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_KASSAT(void)=0;
   virtual void set_DocTIDDOC_DRG_KASSAT(TFIBLargeIntField * DocTIDDOC_DRG_KASSAT)=0;

   __property TFIBLargeIntField * DocTIDFIRM_DRG_KASSAT = {read = get_DocTIDFIRM_DRG_KASSAT , write = set_DocTIDFIRM_DRG_KASSAT};
   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_KASSAT(void)=0;
   virtual void set_DocTIDFIRM_DRG_KASSAT(TFIBLargeIntField * DocTIDFIRM_DRG_KASSAT)=0;

   __property TFIBLargeIntField * DocTIDKKM_DRG_KASSAT = {read = get_DocTIDKKM_DRG_KASSAT , write = set_DocTIDKKM_DRG_KASSAT};
   virtual TFIBLargeIntField * get_DocTIDKKM_DRG_KASSAT(void)=0;
   virtual void set_DocTIDKKM_DRG_KASSAT(TFIBLargeIntField * DocTIDKKM_DRG_KASSAT)=0;

   __property TFIBLargeIntField * DocTIDBASE_DRG_KASSAT = {read = get_DocTIDBASE_DRG_KASSAT , write = set_DocTIDBASE_DRG_KASSAT};
   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_KASSAT(void)=0;
   virtual void set_DocTIDBASE_DRG_KASSAT(TFIBLargeIntField * DocTIDBASE_DRG_KASSAT)=0;
   ...
   __property TFIBWideStringField * DocTNAMEKKM = {read = get_DocTNAMEKKM , write = set_DocTNAMEKKM};
   virtual TFIBWideStringField * get_DocTNAMEKKM(void)=0;
   virtual void set_DocTNAMEKKM(TFIBWideStringField * DocTNAMEKKM)=0;
...
#define IID_IDMDocRegKassa __uuidof(IDMDocRegKassa)
#endif
