#ifndef UIREM_FormaGurCustQueryDetalH
#define UIREM_FormaGurCustQueryDetalH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMGurCustQueryDetal.h"
class __declspec(uuid(Global_IID_IREM_FormaGurCustQueryDetal)) IREM_FormaGurCustQueryDetal : public IMainInterface
{
public:
   ...
   __property IREM_DMGurCustQueryDetal * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMGurCustQueryDetal * get_DM(void)=0;
   virtual void set_DM(IREM_DMGurCustQueryDetal * DM)=0;
...
#define IID_IREM_FormaGurCustQueryDetal __uuidof(IREM_FormaGurCustQueryDetal)
#endif
