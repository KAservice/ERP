#ifndef UIDMSprDiscountCardH
#define UIDMSprDiscountCardH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMSprDiscountCard)) IDMSprDiscountCard : public IMainInterface
{
public:
   ...
   virtual void OpenTable(__int64 id_klient)=0;
...
#define IID_IDMSprDiscountCard __uuidof(IDMSprDiscountCard)
#endif
