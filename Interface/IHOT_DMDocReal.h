#ifndef UIHOT_DMDocRealH
#define UIHOT_DMDocRealH
...
#include <Classes.hpp>
#include <DB.hpp>
class __declspec(uuid("{049F98B8-313E-471A-8742-3B85DCBA5B1F}")) IHOT_DMDocReal : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTUSL_HOT_DREALT = {read = get_DocTTUSL_HOT_DREALT , write = set_DocTTUSL_HOT_DREALT};
   virtual TFIBSmallIntField * get_DocTTUSL_HOT_DREALT(void)=0;
   virtual void set_DocTTUSL_HOT_DREALT(TFIBSmallIntField * DocTTUSL_HOT_DREALT)=0;

   __property TFIBBCDField * DocTKOL_HOT_DREALT = {read = get_DocTKOL_HOT_DREALT , write = set_DocTKOL_HOT_DREALT};
   virtual TFIBBCDField * get_DocTKOL_HOT_DREALT(void)=0;
   virtual void set_DocTKOL_HOT_DREALT(TFIBBCDField * DocTKOL_HOT_DREALT)=0;

   __property TFIBBCDField * DocTKF_HOT_DREALT = {read = get_DocTKF_HOT_DREALT , write = set_DocTKF_HOT_DREALT};
   virtual TFIBBCDField * get_DocTKF_HOT_DREALT(void)=0;
   virtual void set_DocTKF_HOT_DREALT(TFIBBCDField * DocTKF_HOT_DREALT)=0;

   __property TFIBBCDField * DocTPRICE_HOT_DREALT = {read = get_DocTPRICE_HOT_DREALT , write = set_DocTPRICE_HOT_DREALT};
   virtual TFIBBCDField * get_DocTPRICE_HOT_DREALT(void)=0;
   virtual void set_DocTPRICE_HOT_DREALT(TFIBBCDField * DocTPRICE_HOT_DREALT)=0;

   __property TFIBBCDField * DocTSUM_HOT_DREALT = {read = get_DocTSUM_HOT_DREALT , write = set_DocTSUM_HOT_DREALT};
   virtual TFIBBCDField * get_DocTSUM_HOT_DREALT(void)=0;
   virtual void set_DocTSUM_HOT_DREALT(TFIBBCDField * DocTSUM_HOT_DREALT)=0;
   ...
   __property TFIBDateTimeField * DocTPOSNACH_HOT_DREALT = {read = get_DocTPOSNACH_HOT_DREALT , write = set_DocTPOSNACH_HOT_DREALT};
   virtual TFIBDateTimeField * get_DocTPOSNACH_HOT_DREALT(void)=0;
   virtual void set_DocTPOSNACH_HOT_DREALT(TFIBDateTimeField * DocTPOSNACH_HOT_DREALT)=0;

   __property TFIBDateTimeField * DocTPOSCON_HOT_DREALT = {read = get_DocTPOSCON_HOT_DREALT , write = set_DocTPOSCON_HOT_DREALT};
   virtual TFIBDateTimeField * get_DocTPOSCON_HOT_DREALT(void)=0;
   virtual void set_DocTPOSCON_HOT_DREALT(TFIBDateTimeField * DocTPOSCON_HOT_DREALT)=0;
   ...
   __property TFIBWideStringField * DocPRIM_HOT_DREAL = {read = get_DocPRIM_HOT_DREAL , write = set_DocPRIM_HOT_DREAL};
   virtual TFIBWideStringField * get_DocPRIM_HOT_DREAL(void)=0;
   virtual void set_DocPRIM_HOT_DREAL(TFIBWideStringField * DocPRIM_HOT_DREAL)=0;

   __property TFIBWideStringField * DocNAMEKKM_HOT_DREAL = {read = get_DocNAMEKKM_HOT_DREAL , write = set_DocNAMEKKM_HOT_DREAL};
   virtual TFIBWideStringField * get_DocNAMEKKM_HOT_DREAL(void)=0;
   virtual void set_DocNAMEKKM_HOT_DREAL(TFIBWideStringField * DocNAMEKKM_HOT_DREAL)=0;

   __property TFIBWideStringField * DocZAVNUM_HOT_DREAL = {read = get_DocZAVNUM_HOT_DREAL , write = set_DocZAVNUM_HOT_DREAL};
   virtual TFIBWideStringField * get_DocZAVNUM_HOT_DREAL(void)=0;
   virtual void set_DocZAVNUM_HOT_DREAL(TFIBWideStringField * DocZAVNUM_HOT_DREAL)=0;

   __property TFIBWideStringField * DocREGNUM_HOT_DREAL = {read = get_DocREGNUM_HOT_DREAL , write = set_DocREGNUM_HOT_DREAL};
   virtual TFIBWideStringField * get_DocREGNUM_HOT_DREAL(void)=0;
   virtual void set_DocREGNUM_HOT_DREAL(TFIBWideStringField * DocREGNUM_HOT_DREAL)=0;

   __property TFIBWideStringField * DocNUMCHECK_HOT_DREAL = {read = get_DocNUMCHECK_HOT_DREAL , write = set_DocNUMCHECK_HOT_DREAL};
   virtual TFIBWideStringField * get_DocNUMCHECK_HOT_DREAL(void)=0;
   virtual void set_DocNUMCHECK_HOT_DREAL(TFIBWideStringField * DocNUMCHECK_HOT_DREAL)=0;

   __property TFIBWideStringField * DocNUMKL_HOT_DREAL = {read = get_DocNUMKL_HOT_DREAL , write = set_DocNUMKL_HOT_DREAL};
   virtual TFIBWideStringField * get_DocNUMKL_HOT_DREAL(void)=0;
   virtual void set_DocNUMKL_HOT_DREAL(TFIBWideStringField * DocNUMKL_HOT_DREAL)=0;
   ...
   __property TFIBLargeIntField * DocID_HOT_DREAL = {read = get_DocID_HOT_DREAL , write = set_DocID_HOT_DREAL};
   virtual TFIBLargeIntField * get_DocID_HOT_DREAL(void)=0;
   virtual void set_DocID_HOT_DREAL(TFIBLargeIntField * DocID_HOT_DREAL)=0;

   __property TFIBLargeIntField * DocIDDOCH_HOT_DREAL = {read = get_DocIDDOCH_HOT_DREAL , write = set_DocIDDOCH_HOT_DREAL};
   virtual TFIBLargeIntField * get_DocIDDOCH_HOT_DREAL(void)=0;
   virtual void set_DocIDDOCH_HOT_DREAL(TFIBLargeIntField * DocIDDOCH_HOT_DREAL)=0;

   __property TFIBLargeIntField * DocIDBASE_HOT_DREAL = {read = get_DocIDBASE_HOT_DREAL , write = set_DocIDBASE_HOT_DREAL};
   virtual TFIBLargeIntField * get_DocIDBASE_HOT_DREAL(void)=0;
   virtual void set_DocIDBASE_HOT_DREAL(TFIBLargeIntField * DocIDBASE_HOT_DREAL)=0;

   __property TFIBLargeIntField * DocIDTPRICE_HOT_DREAL = {read = get_DocIDTPRICE_HOT_DREAL , write = set_DocIDTPRICE_HOT_DREAL};
   virtual TFIBLargeIntField * get_DocIDTPRICE_HOT_DREAL(void)=0;
   virtual void set_DocIDTPRICE_HOT_DREAL(TFIBLargeIntField * DocIDTPRICE_HOT_DREAL)=0;

   __property TFIBLargeIntField * DocTID_HOT_DREALT = {read = get_DocTID_HOT_DREALT , write = set_DocTID_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTID_HOT_DREALT(void)=0;
   virtual void set_DocTID_HOT_DREALT(TFIBLargeIntField * DocTID_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDDOCH_HOT_DREALT = {read = get_DocTIDDOCH_HOT_DREALT , write = set_DocTIDDOCH_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_DREALT(void)=0;
   virtual void set_DocTIDDOCH_HOT_DREALT(TFIBLargeIntField * DocTIDDOCH_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDTPRICE_HOT_DREALT = {read = get_DocTIDTPRICE_HOT_DREALT , write = set_DocTIDTPRICE_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDTPRICE_HOT_DREALT(void)=0;
   virtual void set_DocTIDTPRICE_HOT_DREALT(TFIBLargeIntField * DocTIDTPRICE_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDNOM_HOT_DREALT = {read = get_DocTIDNOM_HOT_DREALT , write = set_DocTIDNOM_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDNOM_HOT_DREALT(void)=0;
   virtual void set_DocTIDNOM_HOT_DREALT(TFIBLargeIntField * DocTIDNOM_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDED_HOT_DREALT = {read = get_DocTIDED_HOT_DREALT , write = set_DocTIDED_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDED_HOT_DREALT(void)=0;
   virtual void set_DocTIDED_HOT_DREALT(TFIBLargeIntField * DocTIDED_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDNOMER_HOT_DREALT = {read = get_DocTIDNOMER_HOT_DREALT , write = set_DocTIDNOMER_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDNOMER_HOT_DREALT(void)=0;
   virtual void set_DocTIDNOMER_HOT_DREALT(TFIBLargeIntField * DocTIDNOMER_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDCAT_HOT_DREALT = {read = get_DocTIDCAT_HOT_DREALT , write = set_DocTIDCAT_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDCAT_HOT_DREALT(void)=0;
   virtual void set_DocTIDCAT_HOT_DREALT(TFIBLargeIntField * DocTIDCAT_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDGUEST_HOT_DREALT = {read = get_DocTIDGUEST_HOT_DREALT , write = set_DocTIDGUEST_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDGUEST_HOT_DREALT(void)=0;
   virtual void set_DocTIDGUEST_HOT_DREALT(TFIBLargeIntField * DocTIDGUEST_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDTPOS_HOT_DREALT = {read = get_DocTIDTPOS_HOT_DREALT , write = set_DocTIDTPOS_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDTPOS_HOT_DREALT(void)=0;
   virtual void set_DocTIDTPOS_HOT_DREALT(TFIBLargeIntField * DocTIDTPOS_HOT_DREALT)=0;

   __property TFIBLargeIntField * DocTIDBASE_HOT_DREALT = {read = get_DocTIDBASE_HOT_DREALT , write = set_DocTIDBASE_HOT_DREALT};
   virtual TFIBLargeIntField * get_DocTIDBASE_HOT_DREALT(void)=0;
   virtual void set_DocTIDBASE_HOT_DREALT(TFIBLargeIntField * DocTIDBASE_HOT_DREALT)=0;
...
#define IID_IHOT_DMDocReal __uuidof(IHOT_DMDocReal)
#endif
