#ifndef UIFormaImportSprProducerSectionH
#define UIFormaImportSprProducerSectionH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaImportSprProducerSection)) IFormaImportSprProducerSection : public IMainInterface
{
public:
...
#define IID_IFormaImportSprProducerSection __uuidof(IFormaImportSprProducerSection)
#endif
