#ifndef UIREM_DMDocPerServCentrH
#define UIREM_DMDocPerServCentrH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocPerServCentr)) IREM_DMDocPerServCentr : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DSCPER = {read = get_DocID_REM_DSCPER , write = set_DocID_REM_DSCPER};
   virtual TFIBLargeIntField * get_DocID_REM_DSCPER(void)=0;
   virtual void set_DocID_REM_DSCPER(TFIBLargeIntField * DocID_REM_DSCPER)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DSCPER = {read = get_DocIDBASE_REM_DSCPER , write = set_DocIDBASE_REM_DSCPER};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSCPER(void)=0;
   virtual void set_DocIDBASE_REM_DSCPER(TFIBLargeIntField * DocIDBASE_REM_DSCPER)=0;

   __property TFIBWideStringField * DocGID_REM_DSCPER = {read = get_DocGID_REM_DSCPER , write = set_DocGID_REM_DSCPER};
   virtual TFIBWideStringField * get_DocGID_REM_DSCPER(void)=0;
   virtual void set_DocGID_REM_DSCPER(TFIBWideStringField * DocGID_REM_DSCPER)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DSCPER = {read = get_DocIDDOC_REM_DSCPER , write = set_DocIDDOC_REM_DSCPER};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSCPER(void)=0;
   virtual void set_DocIDDOC_REM_DSCPER(TFIBLargeIntField * DocIDDOC_REM_DSCPER)=0;

   __property TFIBWideStringField * DocNUMDOCSC_REM_DSCPER = {read = get_DocNUMDOCSC_REM_DSCPER , write = set_DocNUMDOCSC_REM_DSCPER};
   virtual TFIBWideStringField * get_DocNUMDOCSC_REM_DSCPER(void)=0;
   virtual void set_DocNUMDOCSC_REM_DSCPER(TFIBWideStringField * DocNUMDOCSC_REM_DSCPER)=0;

   __property TFIBDateTimeField * DocPOSDOCSC_REM_DSCPER = {read = get_DocPOSDOCSC_REM_DSCPER , write = set_DocPOSDOCSC_REM_DSCPER};
   virtual TFIBDateTimeField * get_DocPOSDOCSC_REM_DSCPER(void)=0;
   virtual void set_DocPOSDOCSC_REM_DSCPER(TFIBDateTimeField * DocPOSDOCSC_REM_DSCPER)=0;

   __property TFIBWideStringField * DocPRIM_REM_DSCPER = {read = get_DocPRIM_REM_DSCPER , write = set_DocPRIM_REM_DSCPER};
   virtual TFIBWideStringField * get_DocPRIM_REM_DSCPER(void)=0;
   virtual void set_DocPRIM_REM_DSCPER(TFIBWideStringField * DocPRIM_REM_DSCPER)=0;

   __property TFIBLargeIntField * DocTID_REM_DSCPERT = {read = get_DocTID_REM_DSCPERT , write = set_DocTID_REM_DSCPERT};
   virtual TFIBLargeIntField * get_DocTID_REM_DSCPERT(void)=0;
   virtual void set_DocTID_REM_DSCPERT(TFIBLargeIntField * DocTID_REM_DSCPERT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DSCPERT = {read = get_DocTIDBASE_REM_DSCPERT , write = set_DocTIDBASE_REM_DSCPERT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSCPERT(void)=0;
   virtual void set_DocTIDBASE_REM_DSCPERT(TFIBLargeIntField * DocTIDBASE_REM_DSCPERT)=0;

   __property TFIBWideStringField * DocTGID_REM_DSCPERT = {read = get_DocTGID_REM_DSCPERT , write = set_DocTGID_REM_DSCPERT};
   virtual TFIBWideStringField * get_DocTGID_REM_DSCPERT(void)=0;
   virtual void set_DocTGID_REM_DSCPERT(TFIBWideStringField * DocTGID_REM_DSCPERT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DSCPERT = {read = get_DocTIDDOC_REM_DSCPERT , write = set_DocTIDDOC_REM_DSCPERT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSCPERT(void)=0;
   virtual void set_DocTIDDOC_REM_DSCPERT(TFIBLargeIntField * DocTIDDOC_REM_DSCPERT)=0;

   __property TFIBLargeIntField * DocTIDZ_REM_DSCPERT = {read = get_DocTIDZ_REM_DSCPERT , write = set_DocTIDZ_REM_DSCPERT};
   virtual TFIBLargeIntField * get_DocTIDZ_REM_DSCPERT(void)=0;
   virtual void set_DocTIDZ_REM_DSCPERT(TFIBLargeIntField * DocTIDZ_REM_DSCPERT)=0;

   __property TFIBBCDField * DocTKOL_REM_DSCPERT = {read = get_DocTKOL_REM_DSCPERT , write = set_DocTKOL_REM_DSCPERT};
   virtual TFIBBCDField * get_DocTKOL_REM_DSCPERT(void)=0;
   virtual void set_DocTKOL_REM_DSCPERT(TFIBBCDField * DocTKOL_REM_DSCPERT)=0;
...
#define IID_IREM_DMDocPerServCentr __uuidof(IREM_DMDocPerServCentr)
#endif
