#ifndef UIDMDocRegAdvCustH
#define UIDMDocRegAdvCustH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocRegAdvCust)) IDMDocRegAdvCust : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTDV_DRG_ADVCUSTT = {read = get_DocTTDV_DRG_ADVCUSTT , write = set_DocTTDV_DRG_ADVCUSTT};
   virtual TFIBSmallIntField * get_DocTTDV_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTTDV_DRG_ADVCUSTT(TFIBSmallIntField * DocTTDV_DRG_ADVCUSTT)=0;

   __property TFIBSmallIntField * DocTOPER_DRG_ADVCUSTT = {read = get_DocTOPER_DRG_ADVCUSTT , write = set_DocTOPER_DRG_ADVCUSTT};
   virtual TFIBSmallIntField * get_DocTOPER_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTOPER_DRG_ADVCUSTT(TFIBSmallIntField * DocTOPER_DRG_ADVCUSTT)=0;

   __property TFIBBCDField * DocTSUM_DRG_ADVCUSTT = {read = get_DocTSUM_DRG_ADVCUSTT , write = set_DocTSUM_DRG_ADVCUSTT};
   virtual TFIBBCDField * get_DocTSUM_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTSUM_DRG_ADVCUSTT(TFIBBCDField * DocTSUM_DRG_ADVCUSTT)=0;
   ...
   __property TFIBLargeIntField * DocID_DRG_ADVCUST = {read = get_DocID_DRG_ADVCUST , write = set_DocID_DRG_ADVCUST};
   virtual TFIBLargeIntField * get_DocID_DRG_ADVCUST(void)=0;
   virtual void set_DocID_DRG_ADVCUST(TFIBLargeIntField * DocID_DRG_ADVCUST)=0;

   __property TFIBLargeIntField * DocIDDOC_DRG_ADVCUST = {read = get_DocIDDOC_DRG_ADVCUST , write = set_DocIDDOC_DRG_ADVCUST};
   virtual TFIBLargeIntField * get_DocIDDOC_DRG_ADVCUST(void)=0;
   virtual void set_DocIDDOC_DRG_ADVCUST(TFIBLargeIntField * DocIDDOC_DRG_ADVCUST)=0;

   __property TFIBWideStringField * DocDESCR_DRG_ADVCUST = {read = get_DocDESCR_DRG_ADVCUST , write = set_DocDESCR_DRG_ADVCUST};
   virtual TFIBWideStringField * get_DocDESCR_DRG_ADVCUST(void)=0;
   virtual void set_DocDESCR_DRG_ADVCUST(TFIBWideStringField * DocDESCR_DRG_ADVCUST)=0;

   __property TFIBLargeIntField * DocIDBASE_DRG_ADVCUST = {read = get_DocIDBASE_DRG_ADVCUST , write = set_DocIDBASE_DRG_ADVCUST};
   virtual TFIBLargeIntField * get_DocIDBASE_DRG_ADVCUST(void)=0;
   virtual void set_DocIDBASE_DRG_ADVCUST(TFIBLargeIntField * DocIDBASE_DRG_ADVCUST)=0;

   __property TFIBLargeIntField * DocTID_DRG_ADVCUSTT = {read = get_DocTID_DRG_ADVCUSTT , write = set_DocTID_DRG_ADVCUSTT};
   virtual TFIBLargeIntField * get_DocTID_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTID_DRG_ADVCUSTT(TFIBLargeIntField * DocTID_DRG_ADVCUSTT)=0;

   __property TFIBLargeIntField * DocTIDDOC_DRG_ADVCUSTT = {read = get_DocTIDDOC_DRG_ADVCUSTT , write = set_DocTIDDOC_DRG_ADVCUSTT};
   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTIDDOC_DRG_ADVCUSTT(TFIBLargeIntField * DocTIDDOC_DRG_ADVCUSTT)=0;

   __property TFIBLargeIntField * DocTIDFIRM_DRG_ADVCUSTT = {read = get_DocTIDFIRM_DRG_ADVCUSTT , write = set_DocTIDFIRM_DRG_ADVCUSTT};
   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTIDFIRM_DRG_ADVCUSTT(TFIBLargeIntField * DocTIDFIRM_DRG_ADVCUSTT)=0;

   __property TFIBLargeIntField * DocTIDKLIENT_DRG_ADVCUSTT = {read = get_DocTIDKLIENT_DRG_ADVCUSTT , write = set_DocTIDKLIENT_DRG_ADVCUSTT};
   virtual TFIBLargeIntField * get_DocTIDKLIENT_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTIDKLIENT_DRG_ADVCUSTT(TFIBLargeIntField * DocTIDKLIENT_DRG_ADVCUSTT)=0;

   __property TFIBLargeIntField * DocTIDBASE_DRG_ADVCUSTT = {read = get_DocTIDBASE_DRG_ADVCUSTT , write = set_DocTIDBASE_DRG_ADVCUSTT};
   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_ADVCUSTT(void)=0;
   virtual void set_DocTIDBASE_DRG_ADVCUSTT(TFIBLargeIntField * DocTIDBASE_DRG_ADVCUSTT)=0;
...
#define IID_IDMDocRegAdvCust __uuidof(IDMDocRegAdvCust)
#endif
