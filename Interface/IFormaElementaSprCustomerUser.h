#ifndef UIFormaElementaSprCustomerUserH
#define UIFormaElementaSprCustomerUserH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IDMSprCustomerUser.h"
class __declspec(uuid(Global_IID_IFormaElementaSprCustomerUser)) IFormaElementaSprCustomerUser : public IMainInterface
{
public:
...
#define IID_IFormaElementaSprCustomerUser __uuidof(IFormaElementaSprCustomerUser)
#endif
