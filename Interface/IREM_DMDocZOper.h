#ifndef UIREM_DMDocZOperH
#define UIREM_DMDocZOperH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocZOper)) IREM_DMDocZOper : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DZOPER = {read = get_DocID_REM_DZOPER , write = set_DocID_REM_DZOPER};
   virtual TFIBLargeIntField * get_DocID_REM_DZOPER(void)=0;
   virtual void set_DocID_REM_DZOPER(TFIBLargeIntField * DocID_REM_DZOPER)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DZOPER = {read = get_DocIDBASE_REM_DZOPER , write = set_DocIDBASE_REM_DZOPER};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZOPER(void)=0;
   virtual void set_DocIDBASE_REM_DZOPER(TFIBLargeIntField * DocIDBASE_REM_DZOPER)=0;

   __property TFIBWideStringField * DocGID_REM_DZOPER = {read = get_DocGID_REM_DZOPER , write = set_DocGID_REM_DZOPER};
   virtual TFIBWideStringField * get_DocGID_REM_DZOPER(void)=0;
   virtual void set_DocGID_REM_DZOPER(TFIBWideStringField * DocGID_REM_DZOPER)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DZOPER = {read = get_DocIDDOC_REM_DZOPER , write = set_DocIDDOC_REM_DZOPER};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZOPER(void)=0;
   virtual void set_DocIDDOC_REM_DZOPER(TFIBLargeIntField * DocIDDOC_REM_DZOPER)=0;

   __property TFIBLargeIntField * DocIDZ_REM_DZOPER = {read = get_DocIDZ_REM_DZOPER , write = set_DocIDZ_REM_DZOPER};
   virtual TFIBLargeIntField * get_DocIDZ_REM_DZOPER(void)=0;
   virtual void set_DocIDZ_REM_DZOPER(TFIBLargeIntField * DocIDZ_REM_DZOPER)=0;

   __property TFIBLargeIntField * DocIDTPRICE_REM_DZOPER = {read = get_DocIDTPRICE_REM_DZOPER , write = set_DocIDTPRICE_REM_DZOPER};
   virtual TFIBLargeIntField * get_DocIDTPRICE_REM_DZOPER(void)=0;
   virtual void set_DocIDTPRICE_REM_DZOPER(TFIBLargeIntField * DocIDTPRICE_REM_DZOPER)=0;

   __property TFIBWideStringField * DocPRIM_REM_DZOPER = {read = get_DocPRIM_REM_DZOPER , write = set_DocPRIM_REM_DZOPER};
   virtual TFIBWideStringField * get_DocPRIM_REM_DZOPER(void)=0;
   virtual void set_DocPRIM_REM_DZOPER(TFIBWideStringField * DocPRIM_REM_DZOPER)=0;
   ...
   __property TFIBLargeIntField * DocTID_REM_DZOPERT = {read = get_DocTID_REM_DZOPERT , write = set_DocTID_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTID_REM_DZOPERT(void)=0;
   virtual void set_DocTID_REM_DZOPERT(TFIBLargeIntField * DocTID_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DZOPERT = {read = get_DocTIDBASE_REM_DZOPERT , write = set_DocTIDBASE_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZOPERT(void)=0;
   virtual void set_DocTIDBASE_REM_DZOPERT(TFIBLargeIntField * DocTIDBASE_REM_DZOPERT)=0;

   __property TFIBWideStringField * DocTGID_REM_DZOPERT = {read = get_DocTGID_REM_DZOPERT , write = set_DocTGID_REM_DZOPERT};
   virtual TFIBWideStringField * get_DocTGID_REM_DZOPERT(void)=0;
   virtual void set_DocTGID_REM_DZOPERT(TFIBWideStringField * DocTGID_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DZOPERT = {read = get_DocTIDDOC_REM_DZOPERT , write = set_DocTIDDOC_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZOPERT(void)=0;
   virtual void set_DocTIDDOC_REM_DZOPERT(TFIBLargeIntField * DocTIDDOC_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDNOM_REM_DZOPERT = {read = get_DocTIDNOM_REM_DZOPERT , write = set_DocTIDNOM_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DZOPERT(void)=0;
   virtual void set_DocTIDNOM_REM_DZOPERT(TFIBLargeIntField * DocTIDNOM_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDED_REM_DZOPERT = {read = get_DocTIDED_REM_DZOPERT , write = set_DocTIDED_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDED_REM_DZOPERT(void)=0;
   virtual void set_DocTIDED_REM_DZOPERT(TFIBLargeIntField * DocTIDED_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDHW_REM_DZOPERT = {read = get_DocTIDHW_REM_DZOPERT , write = set_DocTIDHW_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDHW_REM_DZOPERT(void)=0;
   virtual void set_DocTIDHW_REM_DZOPERT(TFIBLargeIntField * DocTIDHW_REM_DZOPERT)=0;

   __property TFIBBCDField * DocTKOL_REM_DZOPERT = {read = get_DocTKOL_REM_DZOPERT , write = set_DocTKOL_REM_DZOPERT};
   virtual TFIBBCDField * get_DocTKOL_REM_DZOPERT(void)=0;
   virtual void set_DocTKOL_REM_DZOPERT(TFIBBCDField * DocTKOL_REM_DZOPERT)=0;

   __property TFIBBCDField * DocTKF_REM_DZOPERT = {read = get_DocTKF_REM_DZOPERT , write = set_DocTKF_REM_DZOPERT};
   virtual TFIBBCDField * get_DocTKF_REM_DZOPERT(void)=0;
   virtual void set_DocTKF_REM_DZOPERT(TFIBBCDField * DocTKF_REM_DZOPERT)=0;

   __property TFIBBCDField * DocTPRICE_REM_DZOPERT = {read = get_DocTPRICE_REM_DZOPERT , write = set_DocTPRICE_REM_DZOPERT};
   virtual TFIBBCDField * get_DocTPRICE_REM_DZOPERT(void)=0;
   virtual void set_DocTPRICE_REM_DZOPERT(TFIBBCDField * DocTPRICE_REM_DZOPERT)=0;

   __property TFIBBCDField * DocTSUM_REM_DZOPERT = {read = get_DocTSUM_REM_DZOPERT , write = set_DocTSUM_REM_DZOPERT};
   virtual TFIBBCDField * get_DocTSUM_REM_DZOPERT(void)=0;
   virtual void set_DocTSUM_REM_DZOPERT(TFIBBCDField * DocTSUM_REM_DZOPERT)=0;

   __property TFIBSmallIntField * DocTDVREG_REM_DZOPERT = {read = get_DocTDVREG_REM_DZOPERT , write = set_DocTDVREG_REM_DZOPERT};
   virtual TFIBSmallIntField * get_DocTDVREG_REM_DZOPERT(void)=0;
   virtual void set_DocTDVREG_REM_DZOPERT(TFIBSmallIntField * DocTDVREG_REM_DZOPERT)=0;

   __property TFIBWideStringField * DocTSTR_NAMENOM_REM_DZOPERT = {read = get_DocTSTR_NAMENOM_REM_DZOPERT , write = set_DocTSTR_NAMENOM_REM_DZOPERT};
   virtual TFIBWideStringField * get_DocTSTR_NAMENOM_REM_DZOPERT(void)=0;
   virtual void set_DocTSTR_NAMENOM_REM_DZOPERT(TFIBWideStringField * DocTSTR_NAMENOM_REM_DZOPERT)=0;
   ...
   __property TFIBLargeIntField * DocTIDHWOLD_REM_DZOPERT = {read = get_DocTIDHWOLD_REM_DZOPERT , write = set_DocTIDHWOLD_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDHWOLD_REM_DZOPERT(void)=0;
   virtual void set_DocTIDHWOLD_REM_DZOPERT(TFIBLargeIntField * DocTIDHWOLD_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDTNOM_REM_DZOPERT = {read = get_DocTIDTNOM_REM_DZOPERT , write = set_DocTIDTNOM_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDTNOM_REM_DZOPERT(void)=0;
   virtual void set_DocTIDTNOM_REM_DZOPERT(TFIBLargeIntField * DocTIDTNOM_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDHW_DONOR_REM_DZOPERT = {read = get_DocTIDHW_DONOR_REM_DZOPERT , write = set_DocTIDHW_DONOR_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDHW_DONOR_REM_DZOPERT(void)=0;
   virtual void set_DocTIDHW_DONOR_REM_DZOPERT(TFIBLargeIntField * DocTIDHW_DONOR_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDTYP_USEL_REM_DZOPERT = {read = get_DocTIDTYP_USEL_REM_DZOPERT , write = set_DocTIDTYP_USEL_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDTYP_USEL_REM_DZOPERT(void)=0;
   virtual void set_DocTIDTYP_USEL_REM_DZOPERT(TFIBLargeIntField * DocTIDTYP_USEL_REM_DZOPERT)=0;

   __property TFIBLargeIntField * DocTIDMHRAN_REM_DZOPERT = {read = get_DocTIDMHRAN_REM_DZOPERT , write = set_DocTIDMHRAN_REM_DZOPERT};
   virtual TFIBLargeIntField * get_DocTIDMHRAN_REM_DZOPERT(void)=0;
   virtual void set_DocTIDMHRAN_REM_DZOPERT(TFIBLargeIntField * DocTIDMHRAN_REM_DZOPERT)=0;
...
#define IID_IREM_DMDocZOper __uuidof(IREM_DMDocZOper)
#endif
