#ifndef UIREM_FormaDocZVosvrZapH
#define UIREM_FormaDocZVosvrZapH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocZVosvrZap.h"
class __declspec(uuid(Global_IID_IREM_FormaDocZVosvrZap)) IREM_FormaDocZVosvrZap : public IMainInterface
{
public:
   __property IREM_DMDocZVosvrZap * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocZVosvrZap * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocZVosvrZap * DM)=0;
...
#define IID_IREM_FormaDocZVosvrZap __uuidof(IREM_FormaDocZVosvrZap)
#endif
