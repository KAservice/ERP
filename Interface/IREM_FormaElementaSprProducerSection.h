#ifndef UIREM_FormaElementaSprProducerSectionH
#define UIREM_FormaElementaSprProducerSectionH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMSprProducerSection.h"
class __declspec(uuid(Global_IID_IREM_FormaElementaSprProducerSection)) IREM_FormaElementaSprProducerSection : public IMainInterface
{
public:
...
#define IID_IREM_FormaElementaSprProducerSection __uuidof(IREM_FormaElementaSprProducerSection)
#endif
