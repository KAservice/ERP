#ifndef UIDMSprAddressRegionH
#define UIDMSprAddressRegionH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMSprAddressRegion)) IDMSprAddressRegion : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * TableID_SADR_REGION = {read = get_TableID_SADR_REGION , write = set_TableID_SADR_REGION};
   virtual TFIBLargeIntField * get_TableID_SADR_REGION(void)=0;
   virtual void set_TableID_SADR_REGION(TFIBLargeIntField * TableID_SADR_REGION)=0;

   __property TFIBLargeIntField * TableIDBASE_SADR_REGION = {read = get_TableIDBASE_SADR_REGION , write = set_TableIDBASE_SADR_REGION};
   virtual TFIBLargeIntField * get_TableIDBASE_SADR_REGION(void)=0;
   virtual void set_TableIDBASE_SADR_REGION(TFIBLargeIntField * TableIDBASE_SADR_REGION)=0;

   __property TFIBWideStringField * TableNAME_SADR_REGION = {read = get_TableNAME_SADR_REGION , write = set_TableNAME_SADR_REGION};
   virtual TFIBWideStringField * get_TableNAME_SADR_REGION(void)=0;
   virtual void set_TableNAME_SADR_REGION(TFIBWideStringField * TableNAME_SADR_REGION)=0;

   __property TFIBWideStringField * TableCODE_SADR_REGION = {read = get_TableCODE_SADR_REGION , write = set_TableCODE_SADR_REGION};
   virtual TFIBWideStringField * get_TableCODE_SADR_REGION(void)=0;
   virtual void set_TableCODE_SADR_REGION(TFIBWideStringField * TableCODE_SADR_REGION)=0;
...
#define IID_IDMSprAddressRegion __uuidof(IDMSprAddressRegion)
#endif
