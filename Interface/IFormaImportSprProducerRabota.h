#ifndef UIFormaImportSprProducerRabotaH
#define UIFormaImportSprProducerRabotaH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaImportSprProducerRabota)) IFormaImportSprProducerRabota : public IMainInterface
{
public:
...
#define IID_IFormaImportSprProducerRabota __uuidof(IFormaImportSprProducerRabota)
#endif
