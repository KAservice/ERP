#ifndef UIDMDocRegGoodsH
#define UIDMDocRegGoodsH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocRegGoods)) IDMDocRegGoods : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTDV_DRG_GOODST = {read = get_DocTTDV_DRG_GOODST , write = set_DocTTDV_DRG_GOODST};
   virtual TFIBSmallIntField * get_DocTTDV_DRG_GOODST(void)=0;
   virtual void set_DocTTDV_DRG_GOODST(TFIBSmallIntField * DocTTDV_DRG_GOODST)=0;

   __property TFIBBCDField * DocTRPRICE_DRG_GOODST = {read = get_DocTRPRICE_DRG_GOODST , write = set_DocTRPRICE_DRG_GOODST};
   virtual TFIBBCDField * get_DocTRPRICE_DRG_GOODST(void)=0;
   virtual void set_DocTRPRICE_DRG_GOODST(TFIBBCDField * DocTRPRICE_DRG_GOODST)=0;

   __property TFIBBCDField * DocTKOL_DRG_GOODST = {read = get_DocTKOL_DRG_GOODST , write = set_DocTKOL_DRG_GOODST};
   virtual TFIBBCDField * get_DocTKOL_DRG_GOODST(void)=0;
   virtual void set_DocTKOL_DRG_GOODST(TFIBBCDField * DocTKOL_DRG_GOODST)=0;

   __property TFIBIntegerField * DocTOPER_DRG_GOODST = {read = get_DocTOPER_DRG_GOODST , write = set_DocTOPER_DRG_GOODST};
   virtual TFIBIntegerField * get_DocTOPER_DRG_GOODST(void)=0;
   virtual void set_DocTOPER_DRG_GOODST(TFIBIntegerField * DocTOPER_DRG_GOODST)=0;

   __property TFIBIntegerField * DocTTYPE_DRG_GOODST = {read = get_DocTTYPE_DRG_GOODST , write = set_DocTTYPE_DRG_GOODST};
   virtual TFIBIntegerField * get_DocTTYPE_DRG_GOODST(void)=0;
   virtual void set_DocTTYPE_DRG_GOODST(TFIBIntegerField * DocTTYPE_DRG_GOODST)=0;
   ...
   __property TFIBLargeIntField * DocID_DRG_GOODS = {read = get_DocID_DRG_GOODS , write = set_DocID_DRG_GOODS};
   virtual TFIBLargeIntField * get_DocID_DRG_GOODS(void)=0;
   virtual void set_DocID_DRG_GOODS(TFIBLargeIntField * DocID_DRG_GOODS)=0;

   __property TFIBLargeIntField * DocIDBASE_DRG_GOODS = {read = get_DocIDBASE_DRG_GOODS , write = set_DocIDBASE_DRG_GOODS};
   virtual TFIBLargeIntField * get_DocIDBASE_DRG_GOODS(void)=0;
   virtual void set_DocIDBASE_DRG_GOODS(TFIBLargeIntField * DocIDBASE_DRG_GOODS)=0;

   __property TFIBLargeIntField * DocIDDOC_DRG_GOODS = {read = get_DocIDDOC_DRG_GOODS , write = set_DocIDDOC_DRG_GOODS};
   virtual TFIBLargeIntField * get_DocIDDOC_DRG_GOODS(void)=0;
   virtual void set_DocIDDOC_DRG_GOODS(TFIBLargeIntField * DocIDDOC_DRG_GOODS)=0;

   __property TFIBWideStringField * DocDESCR_DRG_GOODS = {read = get_DocDESCR_DRG_GOODS , write = set_DocDESCR_DRG_GOODS};
   virtual TFIBWideStringField * get_DocDESCR_DRG_GOODS(void)=0;
   virtual void set_DocDESCR_DRG_GOODS(TFIBWideStringField * DocDESCR_DRG_GOODS)=0;

   __property TFIBLargeIntField * DocTID_DRG_GOODST = {read = get_DocTID_DRG_GOODST , write = set_DocTID_DRG_GOODST};
   virtual TFIBLargeIntField * get_DocTID_DRG_GOODST(void)=0;
   virtual void set_DocTID_DRG_GOODST(TFIBLargeIntField * DocTID_DRG_GOODST)=0;

   __property TFIBLargeIntField * DocTIDBASE_DRG_GOODST = {read = get_DocTIDBASE_DRG_GOODST , write = set_DocTIDBASE_DRG_GOODST};
   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_GOODST(void)=0;
   virtual void set_DocTIDBASE_DRG_GOODST(TFIBLargeIntField * DocTIDBASE_DRG_GOODST)=0;

   __property TFIBLargeIntField * DocTIDDOC_DRG_GOODST = {read = get_DocTIDDOC_DRG_GOODST , write = set_DocTIDDOC_DRG_GOODST};
   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_GOODST(void)=0;
   virtual void set_DocTIDDOC_DRG_GOODST(TFIBLargeIntField * DocTIDDOC_DRG_GOODST)=0;

   __property TFIBLargeIntField * DocTIDFIRM_DRG_GOODST = {read = get_DocTIDFIRM_DRG_GOODST , write = set_DocTIDFIRM_DRG_GOODST};
   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_GOODST(void)=0;
   virtual void set_DocTIDFIRM_DRG_GOODST(TFIBLargeIntField * DocTIDFIRM_DRG_GOODST)=0;

   __property TFIBLargeIntField * DocTIDSKLAD_DRG_GOODST = {read = get_DocTIDSKLAD_DRG_GOODST , write = set_DocTIDSKLAD_DRG_GOODST};
   virtual TFIBLargeIntField * get_DocTIDSKLAD_DRG_GOODST(void)=0;
   virtual void set_DocTIDSKLAD_DRG_GOODST(TFIBLargeIntField * DocTIDSKLAD_DRG_GOODST)=0;

   __property TFIBLargeIntField * DocTIDNOM_DRG_GOODST = {read = get_DocTIDNOM_DRG_GOODST , write = set_DocTIDNOM_DRG_GOODST};
   virtual TFIBLargeIntField * get_DocTIDNOM_DRG_GOODST(void)=0;
   virtual void set_DocTIDNOM_DRG_GOODST(TFIBLargeIntField * DocTIDNOM_DRG_GOODST)=0;
...
#define IID_IDMDocRegGoods __uuidof(IDMDocRegGoods)
#endif
