#ifndef UIFormaImportSprProducerDefectH
#define UIFormaImportSprProducerDefectH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaImportSprProducerDefect)) IFormaImportSprProducerDefect : public IMainInterface
{
public:
...
#define IID_IFormaImportSprProducerDefect __uuidof(IFormaImportSprProducerDefect)
#endif
