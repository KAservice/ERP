#ifndef UIDMSprAddressDomH
#define UIDMSprAddressDomH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMSprAddressDom)) IDMSprAddressDom : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * TableID_SADR_DOM = {read = get_TableID_SADR_DOM , write = set_TableID_SADR_DOM};
   virtual TFIBLargeIntField * get_TableID_SADR_DOM(void)=0;
   virtual void set_TableID_SADR_DOM(TFIBLargeIntField * TableID_SADR_DOM)=0;

   __property TFIBLargeIntField * TableIDBASE_SADR_DOM = {read = get_TableIDBASE_SADR_DOM , write = set_TableIDBASE_SADR_DOM};
   virtual TFIBLargeIntField * get_TableIDBASE_SADR_DOM(void)=0;
   virtual void set_TableIDBASE_SADR_DOM(TFIBLargeIntField * TableIDBASE_SADR_DOM)=0;

   __property TFIBLargeIntField * TableIDSTREET_SADR_DOM = {read = get_TableIDSTREET_SADR_DOM , write = set_TableIDSTREET_SADR_DOM};
   virtual TFIBLargeIntField * get_TableIDSTREET_SADR_DOM(void)=0;
   virtual void set_TableIDSTREET_SADR_DOM(TFIBLargeIntField * TableIDSTREET_SADR_DOM)=0;

   __property TFIBWideStringField * TableNAME_SADR_DOM = {read = get_TableNAME_SADR_DOM , write = set_TableNAME_SADR_DOM};
   virtual TFIBWideStringField * get_TableNAME_SADR_DOM(void)=0;
   virtual void set_TableNAME_SADR_DOM(TFIBWideStringField * TableNAME_SADR_DOM)=0;
...
#define IID_IDMSprAddressDom __uuidof(IDMSprAddressDom)
#endif
