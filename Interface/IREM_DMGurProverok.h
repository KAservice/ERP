#ifndef UIREM_DMGurProverokH
#define UIREM_DMGurProverokH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMGurProverok)) IREM_DMGurProverok : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * TableIDBASE_REM_GUR_PROV = {read = get_TableIDBASE_REM_GUR_PROV , write = set_TableIDBASE_REM_GUR_PROV};
   virtual TFIBLargeIntField * get_TableIDBASE_REM_GUR_PROV(void)=0;
   virtual void set_TableIDBASE_REM_GUR_PROV(TFIBLargeIntField * TableIDBASE_REM_GUR_PROV)=0;

   __property TFIBDateTimeField * TablePOS_REM_GUR_PROV = {read = get_TablePOS_REM_GUR_PROV , write = set_TablePOS_REM_GUR_PROV};
   virtual TFIBDateTimeField * get_TablePOS_REM_GUR_PROV(void)=0;
   virtual void set_TablePOS_REM_GUR_PROV(TFIBDateTimeField * TablePOS_REM_GUR_PROV)=0;

   __property TFIBIntegerField * TableNUM_REM_GUR_PROV = {read = get_TableNUM_REM_GUR_PROV , write = set_TableNUM_REM_GUR_PROV};
   virtual TFIBIntegerField * get_TableNUM_REM_GUR_PROV(void)=0;
   virtual void set_TableNUM_REM_GUR_PROV(TFIBIntegerField * TableNUM_REM_GUR_PROV)=0;

   __property TFIBWideStringField * TableDESCR_REM_GUR_PROV = {read = get_TableDESCR_REM_GUR_PROV , write = set_TableDESCR_REM_GUR_PROV};
   virtual TFIBWideStringField * get_TableDESCR_REM_GUR_PROV(void)=0;
   virtual void set_TableDESCR_REM_GUR_PROV(TFIBWideStringField * TableDESCR_REM_GUR_PROV)=0;

   __property TFIBLargeIntField * TableIDDOC_REM_GUR_PROV = {read = get_TableIDDOC_REM_GUR_PROV , write = set_TableIDDOC_REM_GUR_PROV};
   virtual TFIBLargeIntField * get_TableIDDOC_REM_GUR_PROV(void)=0;
   virtual void set_TableIDDOC_REM_GUR_PROV(TFIBLargeIntField * TableIDDOC_REM_GUR_PROV)=0;

   __property TFIBLargeIntField * TableIDUSER_REM_GUR_PROV = {read = get_TableIDUSER_REM_GUR_PROV , write = set_TableIDUSER_REM_GUR_PROV};
   virtual TFIBLargeIntField * get_TableIDUSER_REM_GUR_PROV(void)=0;
   virtual void set_TableIDUSER_REM_GUR_PROV(TFIBLargeIntField * TableIDUSER_REM_GUR_PROV)=0;
   ...
   __property TFIBWideStringField * TableNAME_USER_DOC = {read = get_TableNAME_USER_DOC , write = set_TableNAME_USER_DOC};
   virtual TFIBWideStringField * get_TableNAME_USER_DOC(void)=0;
   virtual void set_TableNAME_USER_DOC(TFIBWideStringField * TableNAME_USER_DOC)=0;

   __property TFIBWideStringField * TableNAME_USER_PROV = {read = get_TableNAME_USER_PROV , write = set_TableNAME_USER_PROV};
   virtual TFIBWideStringField * get_TableNAME_USER_PROV(void)=0;
   virtual void set_TableNAME_USER_PROV(TFIBWideStringField * TableNAME_USER_PROV)=0;
...
#define IID_IREM_DMGurProverok __uuidof(IREM_DMGurProverok)
#endif
