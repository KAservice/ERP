#ifndef UIFormaImportSprProducerNeisprH
#define UIFormaImportSprProducerNeisprH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
class __declspec(uuid(Global_IID_IFormaImportSprProducerNeispr)) IFormaImportSprProducerNeispr : public IMainInterface
{
public:
...
#define IID_IFormaImportSprProducerNeispr __uuidof(IFormaImportSprProducerNeispr)
#endif
