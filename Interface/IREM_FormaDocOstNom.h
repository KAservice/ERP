#ifndef UIREM_FormaDocOstNomH
#define UIREM_FormaDocOstNomH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocOstNom.h"
class __declspec(uuid(Global_IID_IREM_FormaDocOstNom)) IREM_FormaDocOstNom : public IMainInterface
{
public:
   ...
   __property IREM_DMDocOstNom * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocOstNom * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocOstNom * DM)=0;
...
#define IID_IREM_FormaDocOstNom __uuidof(IREM_FormaDocOstNom)
#endif
