...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocReal)) IDMDocReal : public IMainInterface
{
public:
   ...
   __property TFIBBCDField * DocTKOLREAT = {read = get_DocTKOLREAT , write = set_DocTKOLREAT};
   virtual TFIBBCDField * get_DocTKOLREAT(void)=0;
   virtual void set_DocTKOLREAT(TFIBBCDField * DocTKOLREAT)=0;

   __property TFIBBCDField * DocTKFREAT = {read = get_DocTKFREAT , write = set_DocTKFREAT};
   virtual TFIBBCDField * get_DocTKFREAT(void)=0;
   virtual void set_DocTKFREAT(TFIBBCDField * DocTKFREAT)=0;

   __property TFIBBCDField * DocTPRICEREAT = {read = get_DocTPRICEREAT , write = set_DocTPRICEREAT};
   virtual TFIBBCDField * get_DocTPRICEREAT(void)=0;
   virtual void set_DocTPRICEREAT(TFIBBCDField * DocTPRICEREAT)=0;

   __property TFIBBCDField * DocTSUMREAT = {read = get_DocTSUMREAT , write = set_DocTSUMREAT};
   virtual TFIBBCDField * get_DocTSUMREAT(void)=0;
   virtual void set_DocTSUMREAT(TFIBBCDField * DocTSUMREAT)=0;
   ...
   __property TFIBLargeIntField * DocIDREA = {read = get_DocIDREA , write = set_DocIDREA};
   virtual TFIBLargeIntField * get_DocIDREA(void)=0;
   virtual void set_DocIDREA(TFIBLargeIntField * DocIDREA)=0;

   __property TFIBLargeIntField * DocIDDOCREA = {read = get_DocIDDOCREA , write = set_DocIDDOCREA};
   virtual TFIBLargeIntField * get_DocIDDOCREA(void)=0;
   virtual void set_DocIDDOCREA(TFIBLargeIntField * DocIDDOCREA)=0;

   __property TFIBWideStringField * DocPRIMREA = {read = get_DocPRIMREA , write = set_DocPRIMREA};
   virtual TFIBWideStringField * get_DocPRIMREA(void)=0;
   virtual void set_DocPRIMREA(TFIBWideStringField * DocPRIMREA)=0;

   __property TFIBWideStringField * DocGID_DREA = {read = get_DocGID_DREA , write = set_DocGID_DREA};
   virtual TFIBWideStringField * get_DocGID_DREA(void)=0;
   virtual void set_DocGID_DREA(TFIBWideStringField * DocGID_DREA)=0;

   __property TFIBLargeIntField * DocIDTPRICEREA = {read = get_DocIDTPRICEREA , write = set_DocIDTPRICEREA};
   virtual TFIBLargeIntField * get_DocIDTPRICEREA(void)=0;
   virtual void set_DocIDTPRICEREA(TFIBLargeIntField * DocIDTPRICEREA)=0;

   __property TFIBLargeIntField * DocIDGRPOLREA = {read = get_DocIDGRPOLREA , write = set_DocIDGRPOLREA};
   virtual TFIBLargeIntField * get_DocIDGRPOLREA(void)=0;
   virtual void set_DocIDGRPOLREA(TFIBLargeIntField * DocIDGRPOLREA)=0;

   __property TFIBLargeIntField * DocIDBSCHETREA = {read = get_DocIDBSCHETREA , write = set_DocIDBSCHETREA};
   virtual TFIBLargeIntField * get_DocIDBSCHETREA(void)=0;
   virtual void set_DocIDBSCHETREA(TFIBLargeIntField * DocIDBSCHETREA)=0;

   __property TFIBLargeIntField * DocIDBASE_DREA = {read = get_DocIDBASE_DREA , write = set_DocIDBASE_DREA};
   virtual TFIBLargeIntField * get_DocIDBASE_DREA(void)=0;
   virtual void set_DocIDBASE_DREA(TFIBLargeIntField * DocIDBASE_DREA)=0;
   ...
   __property TFIBLargeIntField * DocTIDREAT = {read = get_DocTIDREAT , write = set_DocTIDREAT};
   virtual TFIBLargeIntField * get_DocTIDREAT(void)=0;
   virtual void set_DocTIDREAT(TFIBLargeIntField * DocTIDREAT)=0;

   __property TFIBLargeIntField * DocTIDDOCREAT = {read = get_DocTIDDOCREAT , write = set_DocTIDDOCREAT};
   virtual TFIBLargeIntField * get_DocTIDDOCREAT(void)=0;
   virtual void set_DocTIDDOCREAT(TFIBLargeIntField * DocTIDDOCREAT)=0;

   __property TFIBLargeIntField * DocTIDNOMREAT = {read = get_DocTIDNOMREAT , write = set_DocTIDNOMREAT};
   virtual TFIBLargeIntField * get_DocTIDNOMREAT(void)=0;
   virtual void set_DocTIDNOMREAT(TFIBLargeIntField * DocTIDNOMREAT)=0;

   __property TFIBLargeIntField * DocTIDEDREAT = {read = get_DocTIDEDREAT , write = set_DocTIDEDREAT};
   virtual TFIBLargeIntField * get_DocTIDEDREAT(void)=0;
   virtual void set_DocTIDEDREAT(TFIBLargeIntField * DocTIDEDREAT)=0;

   __property TFIBWideStringField * DocTGID_DREAT = {read = get_DocTGID_DREAT , write = set_DocTGID_DREAT};
   virtual TFIBWideStringField * get_DocTGID_DREAT(void)=0;
   virtual void set_DocTGID_DREAT(TFIBWideStringField * DocTGID_DREAT)=0;

   __property TFIBLargeIntField * DocTIDBASE_DREAT = {read = get_DocTIDBASE_DREAT , write = set_DocTIDBASE_DREAT};
   virtual TFIBLargeIntField * get_DocTIDBASE_DREAT(void)=0;
   virtual void set_DocTIDBASE_DREAT(TFIBLargeIntField * DocTIDBASE_DREAT)=0;

   __property TFIBIntegerField * DocTNDS_DREAT = {read = get_DocTNDS_DREAT , write = set_DocTNDS_DREAT};
   virtual TFIBIntegerField * get_DocTNDS_DREAT(void)=0;
   virtual void set_DocTNDS_DREAT(TFIBIntegerField * DocTNDS_DREAT)=0;

   __property TFIBBCDField * DocTSUMNDS_DREAT = {read = get_DocTSUMNDS_DREAT , write = set_DocTSUMNDS_DREAT};
   virtual TFIBBCDField * get_DocTSUMNDS_DREAT(void)=0;
   virtual void set_DocTSUMNDS_DREAT(TFIBBCDField * DocTSUMNDS_DREAT)=0;
   ...
   __property TFIBLargeIntField * DocIDRSCHETKLIENT_DREA = {read = get_DocIDRSCHETKLIENT_DREA , write = set_DocIDRSCHETKLIENT_DREA};
   virtual TFIBLargeIntField * get_DocIDRSCHETKLIENT_DREA(void)=0;
   virtual void set_DocIDRSCHETKLIENT_DREA(TFIBLargeIntField * DocIDRSCHETKLIENT_DREA)=0;

   __property TFIBLargeIntField * DocIDRSCHETGRPOL_DREA = {read = get_DocIDRSCHETGRPOL_DREA , write = set_DocIDRSCHETGRPOL_DREA};
   virtual TFIBLargeIntField * get_DocIDRSCHETGRPOL_DREA(void)=0;
   virtual void set_DocIDRSCHETGRPOL_DREA(TFIBLargeIntField * DocIDRSCHETGRPOL_DREA)=0;
   ...
   __property TFIBBCDField * DocTSUMSK_DREAT = {read = get_DocTSUMSK_DREAT , write = set_DocTSUMSK_DREAT};
   virtual TFIBBCDField * get_DocTSUMSK_DREAT(void)=0;
   virtual void set_DocTSUMSK_DREAT(TFIBBCDField * DocTSUMSK_DREAT)=0;

   __property TFIBBCDField * DocTPRSK_CARD_DREAT = {read = get_DocTPRSK_CARD_DREAT , write = set_DocTPRSK_CARD_DREAT};
   virtual TFIBBCDField * get_DocTPRSK_CARD_DREAT(void)=0;
   virtual void set_DocTPRSK_CARD_DREAT(TFIBBCDField * DocTPRSK_CARD_DREAT)=0;

   __property TFIBBCDField * DocTPRSK_AUTO_DREAT = {read = get_DocTPRSK_AUTO_DREAT , write = set_DocTPRSK_AUTO_DREAT};
   virtual TFIBBCDField * get_DocTPRSK_AUTO_DREAT(void)=0;
   virtual void set_DocTPRSK_AUTO_DREAT(TFIBBCDField * DocTPRSK_AUTO_DREAT)=0;

   __property TFIBBCDField * DocTPRSK_HAND_DREAT = {read = get_DocTPRSK_HAND_DREAT , write = set_DocTPRSK_HAND_DREAT};
   virtual TFIBBCDField * get_DocTPRSK_HAND_DREAT(void)=0;
   virtual void set_DocTPRSK_HAND_DREAT(TFIBBCDField * DocTPRSK_HAND_DREAT)=0;

   __property TFIBBCDField * DocTPRSK_DREAT = {read = get_DocTPRSK_DREAT , write = set_DocTPRSK_DREAT};
   virtual TFIBBCDField * get_DocTPRSK_DREAT(void)=0;
   virtual void set_DocTPRSK_DREAT(TFIBBCDField * DocTPRSK_DREAT)=0;

   __property TFIBBCDField * DocTNO_SK_DREAT = {read = get_DocTNO_SK_DREAT , write = set_DocTNO_SK_DREAT};
   virtual TFIBBCDField * get_DocTNO_SK_DREAT(void)=0;
   virtual void set_DocTNO_SK_DREAT(TFIBBCDField * DocTNO_SK_DREAT)=0;
   ...
   __property double OldSummaStr = {read = get_OldSummaStr , write = set_OldSummaStr};
   virtual double get_OldSummaStr(void)=0;
   virtual void set_OldSummaStr(double OldSummaStr)=0;

   __property double NewSummaStr = {read = get_NewSummaStr , write = set_NewSummaStr};
   virtual double get_NewSummaStr(void)=0;
   virtual void set_NewSummaStr(double NewSummaStr)=0;
   ...
   virtual __int64 GetIDDocSchetFact(void)=0;
   virtual int GetNumberNewDoc(void)=0;
};
#define IID_IDMDocReal __uuidof(IDMDocReal)
#endif
