#ifndef UIREM_FormaDocSpisNomH
#define UIREM_FormaDocSpisNomH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMDocSpisNom.h"
class __declspec(uuid(Global_IID_IREM_FormaDocSpisNom)) IREM_FormaDocSpisNom : public IMainInterface
{
public:
   __property IREM_DMDocSpisNom * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMDocSpisNom * get_DM(void)=0;
   virtual void set_DM(IREM_DMDocSpisNom * DM)=0;
...
#define IID_IREM_FormaDocSpisNom __uuidof(IREM_FormaDocSpisNom)
#endif
