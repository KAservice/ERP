#ifndef UIREM_FormaSpiskaSprProducerConditionH
#define UIREM_FormaSpiskaSprProducerConditionH
#include "IMainInterface.h"
#include "UGlobalConstant.h"

#include "IREM_DMSprProducerCondition.h"
#include "IREM_DMSprProducerConditionGrp.h"
class __declspec(uuid(Global_IID_IREM_FormaSpiskaSprProducerCondition)) IREM_FormaSpiskaSprProducerCondition : public IMainInterface
{
public:
   ...
   __property IREM_DMSprProducerConditionGrp* DMGrp = {read = get_DMGrp , write = set_DMGrp};
   virtual IREM_DMSprProducerConditionGrp* get_DMGrp(void)=0;
   virtual void set_DMGrp(IREM_DMSprProducerConditionGrp* DMGrp)=0;
...
#define IID_IREM_FormaSpiskaSprProducerCondition __uuidof(IREM_FormaSpiskaSprProducerCondition)
#endif
