#ifndef UIDMSprAddressStreetH
#define UIDMSprAddressStreetH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMSprAddressStreet)) IDMSprAddressStreet : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * TableID_SADR_STREET = {read = get_TableID_SADR_STREET , write = set_TableID_SADR_STREET};
   virtual TFIBLargeIntField * get_TableID_SADR_STREET(void)=0;
   virtual void set_TableID_SADR_STREET(TFIBLargeIntField * TableID_SADR_STREET)=0;

   __property TFIBLargeIntField * TableIDBASE_SADR_STREET = {read = get_TableIDBASE_SADR_STREET , write = set_TableIDBASE_SADR_STREET};
   virtual TFIBLargeIntField * get_TableIDBASE_SADR_STREET(void)=0;
   virtual void set_TableIDBASE_SADR_STREET(TFIBLargeIntField * TableIDBASE_SADR_STREET)=0;

   __property TFIBWideStringField * TableNAME_SADR_STREET = {read = get_TableNAME_SADR_STREET , write = set_TableNAME_SADR_STREET};
   virtual TFIBWideStringField * get_TableNAME_SADR_STREET(void)=0;
   virtual void set_TableNAME_SADR_STREET(TFIBWideStringField * TableNAME_SADR_STREET)=0;

   __property TFIBWideStringField * TablePOSTCODE_SADR_STREET = {read = get_TablePOSTCODE_SADR_STREET , write = set_TablePOSTCODE_SADR_STREET};
   virtual TFIBWideStringField * get_TablePOSTCODE_SADR_STREET(void)=0;
   virtual void set_TablePOSTCODE_SADR_STREET(TFIBWideStringField * TablePOSTCODE_SADR_STREET)=0;

   __property TFIBLargeIntField * TableIDNASPUNKT_SADR_STREET = {read = get_TableIDNASPUNKT_SADR_STREET , write = set_TableIDNASPUNKT_SADR_STREET};
   virtual TFIBLargeIntField * get_TableIDNASPUNKT_SADR_STREET(void)=0;
   virtual void set_TableIDNASPUNKT_SADR_STREET(TFIBLargeIntField * TableIDNASPUNKT_SADR_STREET)=0;
...
#define IID_IDMSprAddressStreet __uuidof(IDMSprAddressStreet)
#endif
