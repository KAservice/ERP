#ifndef UIREM_FormaGurVigrusokH
#define UIREM_FormaGurVigrusokH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMGurVigrusok.h"
class __declspec(uuid(Global_IID_IREM_FormaGurVigrusok)) IREM_FormaGurVigrusok : public IMainInterface
{
public:
   ...
   __property IREM_DMGurVigrusok * DM = {read = get_DM , write = set_DM};
   virtual IREM_DMGurVigrusok * get_DM(void)=0;
   virtual void set_DM(IREM_DMGurVigrusok * DM)=0;
...
#define IID_IREM_FormaGurVigrusok __uuidof(IREM_FormaGurVigrusok)
#endif
