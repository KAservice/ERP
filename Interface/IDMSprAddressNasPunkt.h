#ifndef UIDMSprAddressNasPunktH
#define UIDMSprAddressNasPunktH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMSprAddressNasPunkt)) IDMSprAddressNasPunkt : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * TableID_SADR_NASPUNKT = {read = get_TableID_SADR_NASPUNKT , write = set_TableID_SADR_NASPUNKT};
   virtual TFIBLargeIntField * get_TableID_SADR_NASPUNKT(void)=0;
   virtual void set_TableID_SADR_NASPUNKT(TFIBLargeIntField * TableID_SADR_NASPUNKT)=0;

   __property TFIBLargeIntField * TableIDBASE_SADR_NASPUNKT = {read = get_TableIDBASE_SADR_NASPUNKT , write = set_TableIDBASE_SADR_NASPUNKT};
   virtual TFIBLargeIntField * get_TableIDBASE_SADR_NASPUNKT(void)=0;
   virtual void set_TableIDBASE_SADR_NASPUNKT(TFIBLargeIntField * TableIDBASE_SADR_NASPUNKT)=0;

   __property TFIBLargeIntField * TableIDRAYON_SADR_NASPUNKT = {read = get_TableIDRAYON_SADR_NASPUNKT , write = set_TableIDRAYON_SADR_NASPUNKT};
   virtual TFIBLargeIntField * get_TableIDRAYON_SADR_NASPUNKT(void)=0;
   virtual void set_TableIDRAYON_SADR_NASPUNKT(TFIBLargeIntField * TableIDRAYON_SADR_NASPUNKT)=0;

   __property TFIBWideStringField * TableNAME_SADR_NASPUNKT = {read = get_TableNAME_SADR_NASPUNKT , write = set_TableNAME_SADR_NASPUNKT};
   virtual TFIBWideStringField * get_TableNAME_SADR_NASPUNKT(void)=0;
   virtual void set_TableNAME_SADR_NASPUNKT(TFIBWideStringField * TableNAME_SADR_NASPUNKT)=0;

   __property TFIBIntegerField * TableFL_GOROD_SADR_NASPUNKT = {read = get_TableFL_GOROD_SADR_NASPUNKT , write = set_TableFL_GOROD_SADR_NASPUNKT};
   virtual TFIBIntegerField * get_TableFL_GOROD_SADR_NASPUNKT(void)=0;
   virtual void set_TableFL_GOROD_SADR_NASPUNKT(TFIBIntegerField * TableFL_GOROD_SADR_NASPUNKT)=0;
...
#define IID_IDMSprAddressNasPunkt __uuidof(IDMSprAddressNasPunkt)
#endif
