#ifndef UIDMDocRegPaySaleH
#define UIDMDocRegPaySaleH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocRegPaySale)) IDMDocRegPaySale : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTDV_DRG_PAYSALET = {read = get_DocTTDV_DRG_PAYSALET , write = set_DocTTDV_DRG_PAYSALET};
   virtual TFIBSmallIntField * get_DocTTDV_DRG_PAYSALET(void)=0;
   virtual void set_DocTTDV_DRG_PAYSALET(TFIBSmallIntField * DocTTDV_DRG_PAYSALET)=0;

   __property TFIBDateField * DocTDATE_DRG_PAYSALET = {read = get_DocTDATE_DRG_PAYSALET , write = set_DocTDATE_DRG_PAYSALET};
   virtual TFIBDateField * get_DocTDATE_DRG_PAYSALET(void)=0;
   virtual void set_DocTDATE_DRG_PAYSALET(TFIBDateField * DocTDATE_DRG_PAYSALET)=0;

   __property TFIBBCDField * DocTSUM_DRG_PAYSALET = {read = get_DocTSUM_DRG_PAYSALET , write = set_DocTSUM_DRG_PAYSALET};
   virtual TFIBBCDField * get_DocTSUM_DRG_PAYSALET(void)=0;
   virtual void set_DocTSUM_DRG_PAYSALET(TFIBBCDField * DocTSUM_DRG_PAYSALET)=0;
   ...
   __property TFIBLargeIntField * DocID_DRG_PAYSALE = {read = get_DocID_DRG_PAYSALE , write = set_DocID_DRG_PAYSALE};
   virtual TFIBLargeIntField * get_DocID_DRG_PAYSALE(void)=0;
   virtual void set_DocID_DRG_PAYSALE(TFIBLargeIntField * DocID_DRG_PAYSALE)=0;

   __property TFIBLargeIntField * DocIDDOC_DRG_PAYSALE = {read = get_DocIDDOC_DRG_PAYSALE , write = set_DocIDDOC_DRG_PAYSALE};
   virtual TFIBLargeIntField * get_DocIDDOC_DRG_PAYSALE(void)=0;
   virtual void set_DocIDDOC_DRG_PAYSALE(TFIBLargeIntField * DocIDDOC_DRG_PAYSALE)=0;

   __property TFIBWideStringField * DocDESCR_DRG_PAYSALE = {read = get_DocDESCR_DRG_PAYSALE , write = set_DocDESCR_DRG_PAYSALE};
   virtual TFIBWideStringField * get_DocDESCR_DRG_PAYSALE(void)=0;
   virtual void set_DocDESCR_DRG_PAYSALE(TFIBWideStringField * DocDESCR_DRG_PAYSALE)=0;

   __property TFIBLargeIntField * DocIDBASE_DRG_PAYSALE = {read = get_DocIDBASE_DRG_PAYSALE , write = set_DocIDBASE_DRG_PAYSALE};
   virtual TFIBLargeIntField * get_DocIDBASE_DRG_PAYSALE(void)=0;
   virtual void set_DocIDBASE_DRG_PAYSALE(TFIBLargeIntField * DocIDBASE_DRG_PAYSALE)=0;

   __property TFIBLargeIntField * DocTID_DRG_PAYSALET = {read = get_DocTID_DRG_PAYSALET , write = set_DocTID_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTID_DRG_PAYSALET(void)=0;
   virtual void set_DocTID_DRG_PAYSALET(TFIBLargeIntField * DocTID_DRG_PAYSALET)=0;

   __property TFIBLargeIntField * DocTIDDOC_DRG_PAYSALET = {read = get_DocTIDDOC_DRG_PAYSALET , write = set_DocTIDDOC_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_PAYSALET(void)=0;
   virtual void set_DocTIDDOC_DRG_PAYSALET(TFIBLargeIntField * DocTIDDOC_DRG_PAYSALET)=0;

   __property TFIBLargeIntField * DocTIDFIRM_DRG_PAYSALET = {read = get_DocTIDFIRM_DRG_PAYSALET , write = set_DocTIDFIRM_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_PAYSALET(void)=0;
   virtual void set_DocTIDFIRM_DRG_PAYSALET(TFIBLargeIntField * DocTIDFIRM_DRG_PAYSALET)=0;

   __property TFIBLargeIntField * DocTIDKLIENT_DRG_PAYSALET = {read = get_DocTIDKLIENT_DRG_PAYSALET , write = set_DocTIDKLIENT_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTIDKLIENT_DRG_PAYSALET(void)=0;
   virtual void set_DocTIDKLIENT_DRG_PAYSALET(TFIBLargeIntField * DocTIDKLIENT_DRG_PAYSALET)=0;

   __property TFIBLargeIntField * DocTIDDOG_DRG_PAYSALET = {read = get_DocTIDDOG_DRG_PAYSALET , write = set_DocTIDDOG_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTIDDOG_DRG_PAYSALET(void)=0;
   virtual void set_DocTIDDOG_DRG_PAYSALET(TFIBLargeIntField * DocTIDDOG_DRG_PAYSALET)=0;

   __property TFIBLargeIntField * DocTIDDOCSALE_DRG_PAYSALET = {read = get_DocTIDDOCSALE_DRG_PAYSALET , write = set_DocTIDDOCSALE_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTIDDOCSALE_DRG_PAYSALET(void)=0;
   virtual void set_DocTIDDOCSALE_DRG_PAYSALET(TFIBLargeIntField * DocTIDDOCSALE_DRG_PAYSALET)=0;

   __property TFIBLargeIntField * DocTIDBASE_DRG_PAYSALET = {read = get_DocTIDBASE_DRG_PAYSALET , write = set_DocTIDBASE_DRG_PAYSALET};
   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_PAYSALET(void)=0;
   virtual void set_DocTIDBASE_DRG_PAYSALET(TFIBLargeIntField * DocTIDBASE_DRG_PAYSALET)=0;

   __property TFIBIntegerField * DocTOPER_DRG_PAYSALET = {read = get_DocTOPER_DRG_PAYSALET , write = set_DocTOPER_DRG_PAYSALET};
   virtual TFIBIntegerField * get_DocTOPER_DRG_PAYSALET(void)=0;
   virtual void set_DocTOPER_DRG_PAYSALET(TFIBIntegerField * DocTOPER_DRG_PAYSALET)=0;
   ...
   __property TFIBWideStringField * DocTNAME_SDOG = {read = get_DocTNAME_SDOG , write = set_DocTNAME_SDOG};
   virtual TFIBWideStringField * get_DocTNAME_SDOG(void)=0;
   virtual void set_DocTNAME_SDOG(TFIBWideStringField * DocTNAME_SDOG)=0;

   __property TFIBWideStringField * DocTTDOC = {read = get_DocTTDOC , write = set_DocTTDOC};
   virtual TFIBWideStringField * get_DocTTDOC(void)=0;
   virtual void set_DocTTDOC(TFIBWideStringField * DocTTDOC)=0;
...
#define IID_IDMDocRegPaySale __uuidof(IDMDocRegPaySale)
#endif
