#ifndef UIREM_DMDocZVidH
#define UIREM_DMDocZVidH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocZVid)) IREM_DMDocZVid : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DZVID = {read = get_DocID_REM_DZVID , write = set_DocID_REM_DZVID};
   virtual TFIBLargeIntField * get_DocID_REM_DZVID(void)=0;
   virtual void set_DocID_REM_DZVID(TFIBLargeIntField * DocID_REM_DZVID)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DZVID = {read = get_DocIDBASE_REM_DZVID , write = set_DocIDBASE_REM_DZVID};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZVID(void)=0;
   virtual void set_DocIDBASE_REM_DZVID(TFIBLargeIntField * DocIDBASE_REM_DZVID)=0;

   __property TFIBWideStringField * DocGID_REM_DZVID = {read = get_DocGID_REM_DZVID , write = set_DocGID_REM_DZVID};
   virtual TFIBWideStringField * get_DocGID_REM_DZVID(void)=0;
   virtual void set_DocGID_REM_DZVID(TFIBWideStringField * DocGID_REM_DZVID)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DZVID = {read = get_DocIDDOC_REM_DZVID , write = set_DocIDDOC_REM_DZVID};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZVID(void)=0;
   virtual void set_DocIDDOC_REM_DZVID(TFIBLargeIntField * DocIDDOC_REM_DZVID)=0;

   __property TFIBWideStringField * DocPRIM_REM_DZVID = {read = get_DocPRIM_REM_DZVID , write = set_DocPRIM_REM_DZVID};
   virtual TFIBWideStringField * get_DocPRIM_REM_DZVID(void)=0;
   virtual void set_DocPRIM_REM_DZVID(TFIBWideStringField * DocPRIM_REM_DZVID)=0;

   __property TFIBLargeIntField * DocTID_REM_DZVIDT = {read = get_DocTID_REM_DZVIDT , write = set_DocTID_REM_DZVIDT};
   virtual TFIBLargeIntField * get_DocTID_REM_DZVIDT(void)=0;
   virtual void set_DocTID_REM_DZVIDT(TFIBLargeIntField * DocTID_REM_DZVIDT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DZVIDT = {read = get_DocTIDBASE_REM_DZVIDT , write = set_DocTIDBASE_REM_DZVIDT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZVIDT(void)=0;
   virtual void set_DocTIDBASE_REM_DZVIDT(TFIBLargeIntField * DocTIDBASE_REM_DZVIDT)=0;

   __property TFIBWideStringField * DocTGID_REM_DZVIDT = {read = get_DocTGID_REM_DZVIDT , write = set_DocTGID_REM_DZVIDT};
   virtual TFIBWideStringField * get_DocTGID_REM_DZVIDT(void)=0;
   virtual void set_DocTGID_REM_DZVIDT(TFIBWideStringField * DocTGID_REM_DZVIDT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DZVIDT = {read = get_DocTIDDOC_REM_DZVIDT , write = set_DocTIDDOC_REM_DZVIDT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZVIDT(void)=0;
   virtual void set_DocTIDDOC_REM_DZVIDT(TFIBLargeIntField * DocTIDDOC_REM_DZVIDT)=0;

   __property TFIBLargeIntField * DocTIDZ_REM_DZVIDT = {read = get_DocTIDZ_REM_DZVIDT , write = set_DocTIDZ_REM_DZVIDT};
   virtual TFIBLargeIntField * get_DocTIDZ_REM_DZVIDT(void)=0;
   virtual void set_DocTIDZ_REM_DZVIDT(TFIBLargeIntField * DocTIDZ_REM_DZVIDT)=0;

   __property TFIBBCDField * DocTKOL_REM_DZVIDT = {read = get_DocTKOL_REM_DZVIDT , write = set_DocTKOL_REM_DZVIDT};
   virtual TFIBBCDField * get_DocTKOL_REM_DZVIDT(void)=0;
   virtual void set_DocTKOL_REM_DZVIDT(TFIBBCDField * DocTKOL_REM_DZVIDT)=0;
...
#define IID_IREM_DMDocZVid __uuidof(IREM_DMDocZVid)
#endif
