#ifndef UIREM_DMDocPostOtDileraH
#define UIREM_DMDocPostOtDileraH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocPostOtDilera)) IREM_DMDocPostOtDilera : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DDILPOST = {read = get_DocID_REM_DDILPOST , write = set_DocID_REM_DDILPOST};
   virtual TFIBLargeIntField * get_DocID_REM_DDILPOST(void)=0;
   virtual void set_DocID_REM_DDILPOST(TFIBLargeIntField * DocID_REM_DDILPOST)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DDILPOST = {read = get_DocIDBASE_REM_DDILPOST , write = set_DocIDBASE_REM_DDILPOST};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DDILPOST(void)=0;
   virtual void set_DocIDBASE_REM_DDILPOST(TFIBLargeIntField * DocIDBASE_REM_DDILPOST)=0;

   __property TFIBWideStringField * DocGID_REM_DDILPOST = {read = get_DocGID_REM_DDILPOST , write = set_DocGID_REM_DDILPOST};
   virtual TFIBWideStringField * get_DocGID_REM_DDILPOST(void)=0;
   virtual void set_DocGID_REM_DDILPOST(TFIBWideStringField * DocGID_REM_DDILPOST)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DDILPOST = {read = get_DocIDDOC_REM_DDILPOST , write = set_DocIDDOC_REM_DDILPOST};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DDILPOST(void)=0;
   virtual void set_DocIDDOC_REM_DDILPOST(TFIBLargeIntField * DocIDDOC_REM_DDILPOST)=0;

   __property TFIBWideStringField * DocNUMDOCDIL_REM_DDILPOST = {read = get_DocNUMDOCDIL_REM_DDILPOST , write = set_DocNUMDOCDIL_REM_DDILPOST};
   virtual TFIBWideStringField * get_DocNUMDOCDIL_REM_DDILPOST(void)=0;
   virtual void set_DocNUMDOCDIL_REM_DDILPOST(TFIBWideStringField * DocNUMDOCDIL_REM_DDILPOST)=0;

   __property TFIBDateTimeField * DocPOSDOCDIL_REM_DDILPOST = {read = get_DocPOSDOCDIL_REM_DDILPOST , write = set_DocPOSDOCDIL_REM_DDILPOST};
   virtual TFIBDateTimeField * get_DocPOSDOCDIL_REM_DDILPOST(void)=0;
   virtual void set_DocPOSDOCDIL_REM_DDILPOST(TFIBDateTimeField * DocPOSDOCDIL_REM_DDILPOST)=0;

   __property TFIBWideStringField * DocPRIM_REM_DDILPOST = {read = get_DocPRIM_REM_DDILPOST , write = set_DocPRIM_REM_DDILPOST};
   virtual TFIBWideStringField * get_DocPRIM_REM_DDILPOST(void)=0;
   virtual void set_DocPRIM_REM_DDILPOST(TFIBWideStringField * DocPRIM_REM_DDILPOST)=0;

   __property TFIBLargeIntField * DocTID_REM_DDILPOSTT = {read = get_DocTID_REM_DDILPOSTT , write = set_DocTID_REM_DDILPOSTT};
   virtual TFIBLargeIntField * get_DocTID_REM_DDILPOSTT(void)=0;
   virtual void set_DocTID_REM_DDILPOSTT(TFIBLargeIntField * DocTID_REM_DDILPOSTT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DDILPOSTT = {read = get_DocTIDBASE_REM_DDILPOSTT , write = set_DocTIDBASE_REM_DDILPOSTT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DDILPOSTT(void)=0;
   virtual void set_DocTIDBASE_REM_DDILPOSTT(TFIBLargeIntField * DocTIDBASE_REM_DDILPOSTT)=0;

   __property TFIBWideStringField * DocTGID_REM_DDILPOSTT = {read = get_DocTGID_REM_DDILPOSTT , write = set_DocTGID_REM_DDILPOSTT};
   virtual TFIBWideStringField * get_DocTGID_REM_DDILPOSTT(void)=0;
   virtual void set_DocTGID_REM_DDILPOSTT(TFIBWideStringField * DocTGID_REM_DDILPOSTT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DDILPOSTT = {read = get_DocTIDDOC_REM_DDILPOSTT , write = set_DocTIDDOC_REM_DDILPOSTT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DDILPOSTT(void)=0;
   virtual void set_DocTIDDOC_REM_DDILPOSTT(TFIBLargeIntField * DocTIDDOC_REM_DDILPOSTT)=0;

   __property TFIBLargeIntField * DocTIDZ_REM_DDILPOSTT = {read = get_DocTIDZ_REM_DDILPOSTT , write = set_DocTIDZ_REM_DDILPOSTT};
   virtual TFIBLargeIntField * get_DocTIDZ_REM_DDILPOSTT(void)=0;
   virtual void set_DocTIDZ_REM_DDILPOSTT(TFIBLargeIntField * DocTIDZ_REM_DDILPOSTT)=0;

   __property TFIBBCDField * DocTKOL_REM_DDILPOSTT = {read = get_DocTKOL_REM_DDILPOSTT , write = set_DocTKOL_REM_DDILPOSTT};
   virtual TFIBBCDField * get_DocTKOL_REM_DDILPOSTT(void)=0;
   virtual void set_DocTKOL_REM_DDILPOSTT(TFIBBCDField * DocTKOL_REM_DDILPOSTT)=0;
...
#define IID_IREM_DMDocPostOtDilera __uuidof(IREM_DMDocPostOtDilera)
#endif
