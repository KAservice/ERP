#ifndef UIREM_FormaElementaSprTrebUslovH
#define UIREM_FormaElementaSprTrebUslovH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMSprTrebUslov.h"
class __declspec(uuid(Global_IID_IREM_FormaElementaSprTrebUslov)) IREM_FormaElementaSprTrebUslov : public IMainInterface
{
public:
...
#define IID_IREM_FormaElementaSprTrebUslov __uuidof(IREM_FormaElementaSprTrebUslov)
#endif
