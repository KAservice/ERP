#ifndef UIDMDocKorrVsH
#define UIDMDocKorrVsH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocKorrVs)) IDMDocKorrVs : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_DKORRVS = {read = get_DocID_DKORRVS , write = set_DocID_DKORRVS};
   virtual TFIBLargeIntField * get_DocID_DKORRVS(void)=0;
   virtual void set_DocID_DKORRVS(TFIBLargeIntField * DocID_DKORRVS)=0;

   __property TFIBLargeIntField * DocIDDOC_DKORRVS = {read = get_DocIDDOC_DKORRVS , write = set_DocIDDOC_DKORRVS};
   virtual TFIBLargeIntField * get_DocIDDOC_DKORRVS(void)=0;
   virtual void set_DocIDDOC_DKORRVS(TFIBLargeIntField * DocIDDOC_DKORRVS)=0;

   __property TFIBLargeIntField * DocIDBASE_DKORRVS = {read = get_DocIDBASE_DKORRVS , write = set_DocIDBASE_DKORRVS};
   virtual TFIBLargeIntField * get_DocIDBASE_DKORRVS(void)=0;
   virtual void set_DocIDBASE_DKORRVS(TFIBLargeIntField * DocIDBASE_DKORRVS)=0;

   __property TFIBWideStringField * DocPRIM_DKORRVS = {read = get_DocPRIM_DKORRVS , write = set_DocPRIM_DKORRVS};
   virtual TFIBWideStringField * get_DocPRIM_DKORRVS(void)=0;
   virtual void set_DocPRIM_DKORRVS(TFIBWideStringField * DocPRIM_DKORRVS)=0;

   __property TFIBLargeIntField * DocTID_DKORRVST = {read = get_DocTID_DKORRVST , write = set_DocTID_DKORRVST};
   virtual TFIBLargeIntField * get_DocTID_DKORRVST(void)=0;
   virtual void set_DocTID_DKORRVST(TFIBLargeIntField * DocTID_DKORRVST)=0;

   __property TFIBLargeIntField * DocTIDDOC_DKORRVST = {read = get_DocTIDDOC_DKORRVST , write = set_DocTIDDOC_DKORRVST};
   virtual TFIBLargeIntField * get_DocTIDDOC_DKORRVST(void)=0;
   virtual void set_DocTIDDOC_DKORRVST(TFIBLargeIntField * DocTIDDOC_DKORRVST)=0;

   __property TFIBLargeIntField * DocTIDBASE_DKORRVST = {read = get_DocTIDBASE_DKORRVST , write = set_DocTIDBASE_DKORRVST};
   virtual TFIBLargeIntField * get_DocTIDBASE_DKORRVST(void)=0;
   virtual void set_DocTIDBASE_DKORRVST(TFIBLargeIntField * DocTIDBASE_DKORRVST)=0;

   __property TFIBLargeIntField * DocTIDKLIENT_DKORRVST = {read = get_DocTIDKLIENT_DKORRVST , write = set_DocTIDKLIENT_DKORRVST};
   virtual TFIBLargeIntField * get_DocTIDKLIENT_DKORRVST(void)=0;
   virtual void set_DocTIDKLIENT_DKORRVST(TFIBLargeIntField * DocTIDKLIENT_DKORRVST)=0;

   __property TFIBBCDField * DocTPRIHOD_DKORRVST = {read = get_DocTPRIHOD_DKORRVST , write = set_DocTPRIHOD_DKORRVST};
   virtual TFIBBCDField * get_DocTPRIHOD_DKORRVST(void)=0;
   virtual void set_DocTPRIHOD_DKORRVST(TFIBBCDField * DocTPRIHOD_DKORRVST)=0;

   __property TFIBBCDField * DocTRASHOD_DKORRVST = {read = get_DocTRASHOD_DKORRVST , write = set_DocTRASHOD_DKORRVST};
   virtual TFIBBCDField * get_DocTRASHOD_DKORRVST(void)=0;
   virtual void set_DocTRASHOD_DKORRVST(TFIBBCDField * DocTRASHOD_DKORRVST)=0;

   __property TFIBIntegerField * DocTDVREGPAYSALE_DKORRVST = {read = get_DocTDVREGPAYSALE_DKORRVST , write = set_DocTDVREGPAYSALE_DKORRVST};
   virtual TFIBIntegerField * get_DocTDVREGPAYSALE_DKORRVST(void)=0;
   virtual void set_DocTDVREGPAYSALE_DKORRVST(TFIBIntegerField * DocTDVREGPAYSALE_DKORRVST)=0;
...
#define IID_IDMDocKorrVs __uuidof(IDMDocKorrVs)
#endif
