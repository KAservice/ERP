#ifndef UIHOT_DMDocBronH
#define UIHOT_DMDocBronH
...
#include <Classes.hpp>
#include <DB.hpp>
class __declspec(uuid("{0D052368-9879-4E36-AF84-92158062A3A0}")) IHOT_DMDocBron : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_HOT_DBRON = {read = get_DocID_HOT_DBRON , write = set_DocID_HOT_DBRON};
   virtual TFIBLargeIntField * get_DocID_HOT_DBRON(void)=0;
   virtual void set_DocID_HOT_DBRON(TFIBLargeIntField * DocID_HOT_DBRON)=0;

   __property TFIBLargeIntField * DocIDDOCH_HOT_DBRON = {read = get_DocIDDOCH_HOT_DBRON , write = set_DocIDDOCH_HOT_DBRON};
   virtual TFIBLargeIntField * get_DocIDDOCH_HOT_DBRON(void)=0;
   virtual void set_DocIDDOCH_HOT_DBRON(TFIBLargeIntField * DocIDDOCH_HOT_DBRON)=0;

   __property TFIBWideStringField * DocDESCR_HOT_DBRON = {read = get_DocDESCR_HOT_DBRON , write = set_DocDESCR_HOT_DBRON};
   virtual TFIBWideStringField * get_DocDESCR_HOT_DBRON(void)=0;
   virtual void set_DocDESCR_HOT_DBRON(TFIBWideStringField * DocDESCR_HOT_DBRON)=0;

   __property TFIBLargeIntField * DocIDBASE_HOT_DBRON = {read = get_DocIDBASE_HOT_DBRON , write = set_DocIDBASE_HOT_DBRON};
   virtual TFIBLargeIntField * get_DocIDBASE_HOT_DBRON(void)=0;
   virtual void set_DocIDBASE_HOT_DBRON(TFIBLargeIntField * DocIDBASE_HOT_DBRON)=0;

   __property TFIBLargeIntField * DocIDTPRICE_HOT_DBRON = {read = get_DocIDTPRICE_HOT_DBRON , write = set_DocIDTPRICE_HOT_DBRON};
   virtual TFIBLargeIntField * get_DocIDTPRICE_HOT_DBRON(void)=0;
   virtual void set_DocIDTPRICE_HOT_DBRON(TFIBLargeIntField * DocIDTPRICE_HOT_DBRON)=0;

   __property TFIBLargeIntField * DocTID_HOT_DBRONT = {read = get_DocTID_HOT_DBRONT , write = set_DocTID_HOT_DBRONT};
   virtual TFIBLargeIntField * get_DocTID_HOT_DBRONT(void)=0;
   virtual void set_DocTID_HOT_DBRONT(TFIBLargeIntField * DocTID_HOT_DBRONT)=0;

   __property TFIBLargeIntField * DocTIDDOCH_HOT_DBRONT = {read = get_DocTIDDOCH_HOT_DBRONT , write = set_DocTIDDOCH_HOT_DBRONT};
   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_DBRONT(void)=0;
   virtual void set_DocTIDDOCH_HOT_DBRONT(TFIBLargeIntField * DocTIDDOCH_HOT_DBRONT)=0;

   __property TFIBLargeIntField * DocTIDSOST_HOT_DBRONT = {read = get_DocTIDSOST_HOT_DBRONT , write = set_DocTIDSOST_HOT_DBRONT};
   virtual TFIBLargeIntField * get_DocTIDSOST_HOT_DBRONT(void)=0;
   virtual void set_DocTIDSOST_HOT_DBRONT(TFIBLargeIntField * DocTIDSOST_HOT_DBRONT)=0;

   __property TFIBLargeIntField * DocTIDBASE_HOT_DBRONT = {read = get_DocTIDBASE_HOT_DBRONT , write = set_DocTIDBASE_HOT_DBRONT};
   virtual TFIBLargeIntField * get_DocTIDBASE_HOT_DBRONT(void)=0;
   virtual void set_DocTIDBASE_HOT_DBRONT(TFIBLargeIntField * DocTIDBASE_HOT_DBRONT)=0;

   __property TFIBLargeIntField * DocTID_HOT_SOSTNF = {read = get_DocTID_HOT_SOSTNF , write = set_DocTID_HOT_SOSTNF};
   virtual TFIBLargeIntField * get_DocTID_HOT_SOSTNF(void)=0;
   virtual void set_DocTID_HOT_SOSTNF(TFIBLargeIntField * DocTID_HOT_SOSTNF)=0;
   ...
   __property TFIBLargeIntField * DocTIDDOCH_HOT_SOSTNF = {read = get_DocTIDDOCH_HOT_SOSTNF , write = set_DocTIDDOCH_HOT_SOSTNF};
   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_SOSTNF(void)=0;
   virtual void set_DocTIDDOCH_HOT_SOSTNF(TFIBLargeIntField * DocTIDDOCH_HOT_SOSTNF)=0;
...
#define IID_IHOT_DMDocBron __uuidof(IHOT_DMDocBron)
#endif
