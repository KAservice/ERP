#ifndef UIFormaSpiskaSprStorageLocationH
#define UIFormaSpiskaSprStorageLocationH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IDMSprStorageLocation.h"
#include "IDMSprStorageLocationGrp.h"
class __declspec(uuid(Global_IID_IFormaSpiskaSprStorageLocation)) IFormaSpiskaSprStorageLocation : public IMainInterface
{
public:
   ...
   __property IDMSprStorageLocationGrp * DMGrp = {read = get_DMGrp , write = set_DMGrp};
   virtual IDMSprStorageLocationGrp * get_DMGrp(void)=0;
   virtual void set_DMGrp(IDMSprStorageLocationGrp * DMGrp)=0;
...
#define IID_IFormaSpiskaSprStorageLocation __uuidof(IFormaSpiskaSprStorageLocation)
#endif
