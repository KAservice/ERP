#ifndef UIDMDocRegVsRaschH
#define UIDMDocRegVsRaschH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocRegVsRasch)) IDMDocRegVsRasch : public IMainInterface
{
public:
   ...
   __property TFIBSmallIntField * DocTTDV_DRG_VSRASCHT = {read = get_DocTTDV_DRG_VSRASCHT , write = set_DocTTDV_DRG_VSRASCHT};
   virtual TFIBSmallIntField * get_DocTTDV_DRG_VSRASCHT(void)=0;
   virtual void set_DocTTDV_DRG_VSRASCHT(TFIBSmallIntField * DocTTDV_DRG_VSRASCHT)=0;

   __property TFIBBCDField * DocTSUM_DRG_VSRASCHT = {read = get_DocTSUM_DRG_VSRASCHT , write = set_DocTSUM_DRG_VSRASCHT};
   virtual TFIBBCDField * get_DocTSUM_DRG_VSRASCHT(void)=0;
   virtual void set_DocTSUM_DRG_VSRASCHT(TFIBBCDField * DocTSUM_DRG_VSRASCHT)=0;

   __property TFIBIntegerField * DocTOPER_DRG_VSRASCHT = {read = get_DocTOPER_DRG_VSRASCHT , write = set_DocTOPER_DRG_VSRASCHT};
   virtual TFIBIntegerField * get_DocTOPER_DRG_VSRASCHT(void)=0;
   virtual void set_DocTOPER_DRG_VSRASCHT(TFIBIntegerField * DocTOPER_DRG_VSRASCHT)=0;
   ...
   __property TFIBLargeIntField * DocID_DRG_VSRASCH = {read = get_DocID_DRG_VSRASCH , write = set_DocID_DRG_VSRASCH};
   virtual TFIBLargeIntField * get_DocID_DRG_VSRASCH(void)=0;
   virtual void set_DocID_DRG_VSRASCH(TFIBLargeIntField * DocID_DRG_VSRASCH)=0;

   __property TFIBLargeIntField * DocIDDOC_DRG_VSRASCH = {read = get_DocIDDOC_DRG_VSRASCH , write = set_DocIDDOC_DRG_VSRASCH};
   virtual TFIBLargeIntField * get_DocIDDOC_DRG_VSRASCH(void)=0;
   virtual void set_DocIDDOC_DRG_VSRASCH(TFIBLargeIntField * DocIDDOC_DRG_VSRASCH)=0;

   __property TFIBWideStringField * DocDESCR_DRG_VSRASCH = {read = get_DocDESCR_DRG_VSRASCH , write = set_DocDESCR_DRG_VSRASCH};
   virtual TFIBWideStringField * get_DocDESCR_DRG_VSRASCH(void)=0;
   virtual void set_DocDESCR_DRG_VSRASCH(TFIBWideStringField * DocDESCR_DRG_VSRASCH)=0;

   __property TFIBLargeIntField * DocIDBASE_DRG_VSRASCH = {read = get_DocIDBASE_DRG_VSRASCH , write = set_DocIDBASE_DRG_VSRASCH};
   virtual TFIBLargeIntField * get_DocIDBASE_DRG_VSRASCH(void)=0;
   virtual void set_DocIDBASE_DRG_VSRASCH(TFIBLargeIntField * DocIDBASE_DRG_VSRASCH)=0;

   __property TFIBLargeIntField * DocTID_DRG_VSRASCHT = {read = get_DocTID_DRG_VSRASCHT , write = set_DocTID_DRG_VSRASCHT};
   virtual TFIBLargeIntField * get_DocTID_DRG_VSRASCHT(void)=0;
   virtual void set_DocTID_DRG_VSRASCHT(TFIBLargeIntField * DocTID_DRG_VSRASCHT)=0;

   __property TFIBLargeIntField * DocTIDDOC_DRG_VSRASCHT = {read = get_DocTIDDOC_DRG_VSRASCHT , write = set_DocTIDDOC_DRG_VSRASCHT};
   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_VSRASCHT(void)=0;
   virtual void set_DocTIDDOC_DRG_VSRASCHT(TFIBLargeIntField * DocTIDDOC_DRG_VSRASCHT)=0;

   __property TFIBLargeIntField * DocTIDFIRM_DRG_VSRASCHT = {read = get_DocTIDFIRM_DRG_VSRASCHT , write = set_DocTIDFIRM_DRG_VSRASCHT};
   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_VSRASCHT(void)=0;
   virtual void set_DocTIDFIRM_DRG_VSRASCHT(TFIBLargeIntField * DocTIDFIRM_DRG_VSRASCHT)=0;

   __property TFIBLargeIntField * DocTIDKLIENT_DRG_VSRASCHT = {read = get_DocTIDKLIENT_DRG_VSRASCHT , write = set_DocTIDKLIENT_DRG_VSRASCHT};
   virtual TFIBLargeIntField * get_DocTIDKLIENT_DRG_VSRASCHT(void)=0;
   virtual void set_DocTIDKLIENT_DRG_VSRASCHT(TFIBLargeIntField * DocTIDKLIENT_DRG_VSRASCHT)=0;

   __property TFIBLargeIntField * DocTIDBASE_DRG_VSRASCHT = {read = get_DocTIDBASE_DRG_VSRASCHT , write = set_DocTIDBASE_DRG_VSRASCHT};
   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_VSRASCHT(void)=0;
   virtual void set_DocTIDBASE_DRG_VSRASCHT(TFIBLargeIntField * DocTIDBASE_DRG_VSRASCHT)=0;
...
#define IID_IDMDocRegVsRasch __uuidof(IDMDocRegVsRasch)
#endif
