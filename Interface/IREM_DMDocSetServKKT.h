#ifndef UIREM_DMDocSetServKKTH
#define UIREM_DMDocSetServKKTH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocSetServKKT)) IREM_DMDocSetServKKT : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DSETSERVKKT = {read = get_DocID_REM_DSETSERVKKT , write = set_DocID_REM_DSETSERVKKT};
   virtual TFIBLargeIntField * get_DocID_REM_DSETSERVKKT(void)=0;
   virtual void set_DocID_REM_DSETSERVKKT(TFIBLargeIntField * DocID_REM_DSETSERVKKT)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DSETSERVKKT = {read = get_DocIDBASE_REM_DSETSERVKKT , write = set_DocIDBASE_REM_DSETSERVKKT};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSETSERVKKT(void)=0;
   virtual void set_DocIDBASE_REM_DSETSERVKKT(TFIBLargeIntField * DocIDBASE_REM_DSETSERVKKT)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DSETSERVKKT = {read = get_DocIDDOC_REM_DSETSERVKKT , write = set_DocIDDOC_REM_DSETSERVKKT};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSETSERVKKT(void)=0;
   virtual void set_DocIDDOC_REM_DSETSERVKKT(TFIBLargeIntField * DocIDDOC_REM_DSETSERVKKT)=0;

   __property TFIBIntegerField * DocTDOC_REM_DSETSERVKKT = {read = get_DocTDOC_REM_DSETSERVKKT , write = set_DocTDOC_REM_DSETSERVKKT};
   virtual TFIBIntegerField * get_DocTDOC_REM_DSETSERVKKT(void)=0;
   virtual void set_DocTDOC_REM_DSETSERVKKT(TFIBIntegerField * DocTDOC_REM_DSETSERVKKT)=0;

   __property TFIBWideStringField * DocPRIM_REM_DSETSERVKKT = {read = get_DocPRIM_REM_DSETSERVKKT , write = set_DocPRIM_REM_DSETSERVKKT};
   virtual TFIBWideStringField * get_DocPRIM_REM_DSETSERVKKT(void)=0;
   virtual void set_DocPRIM_REM_DSETSERVKKT(TFIBWideStringField * DocPRIM_REM_DSETSERVKKT)=0;

   __property TFIBLargeIntField * DocTID_REM_DSETSERVKKTT = {read = get_DocTID_REM_DSETSERVKKTT , write = set_DocTID_REM_DSETSERVKKTT};
   virtual TFIBLargeIntField * get_DocTID_REM_DSETSERVKKTT(void)=0;
   virtual void set_DocTID_REM_DSETSERVKKTT(TFIBLargeIntField * DocTID_REM_DSETSERVKKTT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DSETSERVKKTT = {read = get_DocTIDBASE_REM_DSETSERVKKTT , write = set_DocTIDBASE_REM_DSETSERVKKTT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSETSERVKKTT(void)=0;
   virtual void set_DocTIDBASE_REM_DSETSERVKKTT(TFIBLargeIntField * DocTIDBASE_REM_DSETSERVKKTT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DSETSERVKKTT = {read = get_DocTIDDOC_REM_DSETSERVKKTT , write = set_DocTIDDOC_REM_DSETSERVKKTT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSETSERVKKTT(void)=0;
   virtual void set_DocTIDDOC_REM_DSETSERVKKTT(TFIBLargeIntField * DocTIDDOC_REM_DSETSERVKKTT)=0;

   __property TFIBLargeIntField * DocTIDKKT_REM_DSETSERVKKTT = {read = get_DocTIDKKT_REM_DSETSERVKKTT , write = set_DocTIDKKT_REM_DSETSERVKKTT};
   virtual TFIBLargeIntField * get_DocTIDKKT_REM_DSETSERVKKTT(void)=0;
   virtual void set_DocTIDKKT_REM_DSETSERVKKTT(TFIBLargeIntField * DocTIDKKT_REM_DSETSERVKKTT)=0;

   __property TFIBBCDField * DocTSUM_REM_DSETSERVKKTT = {read = get_DocTSUM_REM_DSETSERVKKTT , write = set_DocTSUM_REM_DSETSERVKKTT};
   virtual TFIBBCDField * get_DocTSUM_REM_DSETSERVKKTT(void)=0;
   virtual void set_DocTSUM_REM_DSETSERVKKTT(TFIBBCDField * DocTSUM_REM_DSETSERVKKTT)=0;

   __property TFIBWideStringField * DocTNAME_REM_SKKT = {read = get_DocTNAME_REM_SKKT , write = set_DocTNAME_REM_SKKT};
   virtual TFIBWideStringField * get_DocTNAME_REM_SKKT(void)=0;
   virtual void set_DocTNAME_REM_SKKT(TFIBWideStringField * DocTNAME_REM_SKKT)=0;
...
#define IID_IREM_DMDocSetServKKT __uuidof(IREM_DMDocSetServKKT)
#endif
