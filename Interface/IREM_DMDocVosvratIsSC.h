#ifndef UIREM_DMDocVosvratIsSCH
#define UIREM_DMDocVosvratIsSCH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocVosvratIsSC)) IREM_DMDocVosvratIsSC : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DSCRET = {read = get_DocID_REM_DSCRET , write = set_DocID_REM_DSCRET};
   virtual TFIBLargeIntField * get_DocID_REM_DSCRET(void)=0;
   virtual void set_DocID_REM_DSCRET(TFIBLargeIntField * DocID_REM_DSCRET)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DSCRET = {read = get_DocIDBASE_REM_DSCRET , write = set_DocIDBASE_REM_DSCRET};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSCRET(void)=0;
   virtual void set_DocIDBASE_REM_DSCRET(TFIBLargeIntField * DocIDBASE_REM_DSCRET)=0;

   __property TFIBWideStringField * DocGID_REM_DSCRET = {read = get_DocGID_REM_DSCRET , write = set_DocGID_REM_DSCRET};
   virtual TFIBWideStringField * get_DocGID_REM_DSCRET(void)=0;
   virtual void set_DocGID_REM_DSCRET(TFIBWideStringField * DocGID_REM_DSCRET)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DSCRET = {read = get_DocIDDOC_REM_DSCRET , write = set_DocIDDOC_REM_DSCRET};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSCRET(void)=0;
   virtual void set_DocIDDOC_REM_DSCRET(TFIBLargeIntField * DocIDDOC_REM_DSCRET)=0;

   __property TFIBWideStringField * DocNUMDOCSC_REM_DSCRET = {read = get_DocNUMDOCSC_REM_DSCRET , write = set_DocNUMDOCSC_REM_DSCRET};
   virtual TFIBWideStringField * get_DocNUMDOCSC_REM_DSCRET(void)=0;
   virtual void set_DocNUMDOCSC_REM_DSCRET(TFIBWideStringField * DocNUMDOCSC_REM_DSCRET)=0;

   __property TFIBDateTimeField * DocPOSDOCSC_REM_DSCRET = {read = get_DocPOSDOCSC_REM_DSCRET , write = set_DocPOSDOCSC_REM_DSCRET};
   virtual TFIBDateTimeField * get_DocPOSDOCSC_REM_DSCRET(void)=0;
   virtual void set_DocPOSDOCSC_REM_DSCRET(TFIBDateTimeField * DocPOSDOCSC_REM_DSCRET)=0;

   __property TFIBWideStringField * DocPRIM_REM_DSCRET = {read = get_DocPRIM_REM_DSCRET , write = set_DocPRIM_REM_DSCRET};
   virtual TFIBWideStringField * get_DocPRIM_REM_DSCRET(void)=0;
   virtual void set_DocPRIM_REM_DSCRET(TFIBWideStringField * DocPRIM_REM_DSCRET)=0;

   __property TFIBLargeIntField * DocTID_REM_DSCRETT = {read = get_DocTID_REM_DSCRETT , write = set_DocTID_REM_DSCRETT};
   virtual TFIBLargeIntField * get_DocTID_REM_DSCRETT(void)=0;
   virtual void set_DocTID_REM_DSCRETT(TFIBLargeIntField * DocTID_REM_DSCRETT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DSCRETT = {read = get_DocTIDBASE_REM_DSCRETT , write = set_DocTIDBASE_REM_DSCRETT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSCRETT(void)=0;
   virtual void set_DocTIDBASE_REM_DSCRETT(TFIBLargeIntField * DocTIDBASE_REM_DSCRETT)=0;

   __property TFIBWideStringField * DocTGID_REM_DSCRETT = {read = get_DocTGID_REM_DSCRETT , write = set_DocTGID_REM_DSCRETT};
   virtual TFIBWideStringField * get_DocTGID_REM_DSCRETT(void)=0;
   virtual void set_DocTGID_REM_DSCRETT(TFIBWideStringField * DocTGID_REM_DSCRETT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DSCRETT = {read = get_DocTIDDOC_REM_DSCRETT , write = set_DocTIDDOC_REM_DSCRETT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSCRETT(void)=0;
   virtual void set_DocTIDDOC_REM_DSCRETT(TFIBLargeIntField * DocTIDDOC_REM_DSCRETT)=0;

   __property TFIBLargeIntField * DocTIDZ_REM_DSCRETT = {read = get_DocTIDZ_REM_DSCRETT , write = set_DocTIDZ_REM_DSCRETT};
   virtual TFIBLargeIntField * get_DocTIDZ_REM_DSCRETT(void)=0;
   virtual void set_DocTIDZ_REM_DSCRETT(TFIBLargeIntField * DocTIDZ_REM_DSCRETT)=0;

   __property TFIBBCDField * DocTKOL_REM_DSCRETT = {read = get_DocTKOL_REM_DSCRETT , write = set_DocTKOL_REM_DSCRETT};
   virtual TFIBBCDField * get_DocTKOL_REM_DSCRETT(void)=0;
   virtual void set_DocTKOL_REM_DSCRETT(TFIBBCDField * DocTKOL_REM_DSCRETT)=0;
...
#define IID_IREM_DMDocVosvratIsSC __uuidof(IREM_DMDocVosvratIsSC)
#endif
