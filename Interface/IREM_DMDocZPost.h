#ifndef UIREM_DMDocZPostH
#define UIREM_DMDocZPostH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IREM_DMDocZPost)) IREM_DMDocZPost : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_REM_DZPOST = {read = get_DocID_REM_DZPOST , write = set_DocID_REM_DZPOST};
   virtual TFIBLargeIntField * get_DocID_REM_DZPOST(void)=0;
   virtual void set_DocID_REM_DZPOST(TFIBLargeIntField * DocID_REM_DZPOST)=0;

   __property TFIBLargeIntField * DocIDBASE_REM_DZPOST = {read = get_DocIDBASE_REM_DZPOST , write = set_DocIDBASE_REM_DZPOST};
   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZPOST(void)=0;
   virtual void set_DocIDBASE_REM_DZPOST(TFIBLargeIntField * DocIDBASE_REM_DZPOST)=0;

   __property TFIBWideStringField * DocGID_REM_DZPOST = {read = get_DocGID_REM_DZPOST , write = set_DocGID_REM_DZPOST};
   virtual TFIBWideStringField * get_DocGID_REM_DZPOST(void)=0;
   virtual void set_DocGID_REM_DZPOST(TFIBWideStringField * DocGID_REM_DZPOST)=0;

   __property TFIBLargeIntField * DocIDDOC_REM_DZPOST = {read = get_DocIDDOC_REM_DZPOST , write = set_DocIDDOC_REM_DZPOST};
   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZPOST(void)=0;
   virtual void set_DocIDDOC_REM_DZPOST(TFIBLargeIntField * DocIDDOC_REM_DZPOST)=0;

   __property TFIBWideStringField * DocPRIM_REM_DZPOST = {read = get_DocPRIM_REM_DZPOST , write = set_DocPRIM_REM_DZPOST};
   virtual TFIBWideStringField * get_DocPRIM_REM_DZPOST(void)=0;
   virtual void set_DocPRIM_REM_DZPOST(TFIBWideStringField * DocPRIM_REM_DZPOST)=0;

   __property TFIBLargeIntField * DocTID_REM_DZPOSTT = {read = get_DocTID_REM_DZPOSTT , write = set_DocTID_REM_DZPOSTT};
   virtual TFIBLargeIntField * get_DocTID_REM_DZPOSTT(void)=0;
   virtual void set_DocTID_REM_DZPOSTT(TFIBLargeIntField * DocTID_REM_DZPOSTT)=0;

   __property TFIBLargeIntField * DocTIDBASE_REM_DZPOSTT = {read = get_DocTIDBASE_REM_DZPOSTT , write = set_DocTIDBASE_REM_DZPOSTT};
   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZPOSTT(void)=0;
   virtual void set_DocTIDBASE_REM_DZPOSTT(TFIBLargeIntField * DocTIDBASE_REM_DZPOSTT)=0;

   __property TFIBWideStringField * DocTGID_REM_DZPOSTT = {read = get_DocTGID_REM_DZPOSTT , write = set_DocTGID_REM_DZPOSTT};
   virtual TFIBWideStringField * get_DocTGID_REM_DZPOSTT(void)=0;
   virtual void set_DocTGID_REM_DZPOSTT(TFIBWideStringField * DocTGID_REM_DZPOSTT)=0;

   __property TFIBLargeIntField * DocTIDDOC_REM_DZPOSTT = {read = get_DocTIDDOC_REM_DZPOSTT , write = set_DocTIDDOC_REM_DZPOSTT};
   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZPOSTT(void)=0;
   virtual void set_DocTIDDOC_REM_DZPOSTT(TFIBLargeIntField * DocTIDDOC_REM_DZPOSTT)=0;

   __property TFIBLargeIntField * DocTIDZ_REM_DZPOSTT = {read = get_DocTIDZ_REM_DZPOSTT , write = set_DocTIDZ_REM_DZPOSTT};
   virtual TFIBLargeIntField * get_DocTIDZ_REM_DZPOSTT(void)=0;
   virtual void set_DocTIDZ_REM_DZPOSTT(TFIBLargeIntField * DocTIDZ_REM_DZPOSTT)=0;

   __property TFIBBCDField * DocTKOL_REM_DZPOSTT = {read = get_DocTKOL_REM_DZPOSTT , write = set_DocTKOL_REM_DZPOSTT};
   virtual TFIBBCDField * get_DocTKOL_REM_DZPOSTT(void)=0;
   virtual void set_DocTKOL_REM_DZPOSTT(TFIBBCDField * DocTKOL_REM_DZPOSTT)=0;
...
#define IID_IREM_DMDocZPost __uuidof(IREM_DMDocZPost)
#endif
