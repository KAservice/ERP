#ifndef UIHLP_FormaSpiskaSprNaborInfBlockSostavH
#define UIHLP_FormaSpiskaSprNaborInfBlockSostavH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IHLP_DMSprNaborInfBlockSostav.h"
class __declspec(uuid(Global_IID_IHLP_FormaSpiskaSprNaborInfBlockSostav)) IHLP_FormaSpiskaSprNaborInfBlockSostav : public IMainInterface
{
public:
   __property IHLP_DMSprNaborInfBlockSostav* DM = {read = get_DM , write = set_DM};
   virtual IHLP_DMSprNaborInfBlockSostav* get_DM(void)=0;
   virtual void set_DM(IHLP_DMSprNaborInfBlockSostav* DM)=0;
...
#define IID_IHLP_FormaSpiskaSprNaborInfBlockSostav __uuidof(IHLP_FormaSpiskaSprNaborInfBlockSostav)
#endif
