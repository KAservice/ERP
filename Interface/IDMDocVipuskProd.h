#ifndef UIDMDocVipuskProdH
#define UIDMDocVipuskProdH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocVipuskProd)) IDMDocVipuskProd : public IMainInterface
{
public:
   ...
   __property TFIBLargeIntField * DocID_DVIPPROD = {read = get_DocID_DVIPPROD , write = set_DocID_DVIPPROD};
   virtual TFIBLargeIntField * get_DocID_DVIPPROD(void)=0;
   virtual void set_DocID_DVIPPROD(TFIBLargeIntField * DocID_DVIPPROD)=0;

   __property TFIBLargeIntField * DocIDDOC_DVIPPROD = {read = get_DocIDDOC_DVIPPROD , write = set_DocIDDOC_DVIPPROD};
   virtual TFIBLargeIntField * get_DocIDDOC_DVIPPROD(void)=0;
   virtual void set_DocIDDOC_DVIPPROD(TFIBLargeIntField * DocIDDOC_DVIPPROD)=0;

   __property TFIBLargeIntField * DocIDBASE_DVIPPROD = {read = get_DocIDBASE_DVIPPROD , write = set_DocIDBASE_DVIPPROD};
   virtual TFIBLargeIntField * get_DocIDBASE_DVIPPROD(void)=0;
   virtual void set_DocIDBASE_DVIPPROD(TFIBLargeIntField * DocIDBASE_DVIPPROD)=0;

   __property TFIBWideStringField * DocPRIM_DVIPPROD = {read = get_DocPRIM_DVIPPROD , write = set_DocPRIM_DVIPPROD};
   virtual TFIBWideStringField * get_DocPRIM_DVIPPROD(void)=0;
   virtual void set_DocPRIM_DVIPPROD(TFIBWideStringField * DocPRIM_DVIPPROD)=0;

   __property TFIBLargeIntField * DocIDRTPRICE_DVIPPROD = {read = get_DocIDRTPRICE_DVIPPROD , write = set_DocIDRTPRICE_DVIPPROD};
   virtual TFIBLargeIntField * get_DocIDRTPRICE_DVIPPROD(void)=0;
   virtual void set_DocIDRTPRICE_DVIPPROD(TFIBLargeIntField * DocIDRTPRICE_DVIPPROD)=0;

   __property TFIBLargeIntField * DocTID_DVIPPRODT = {read = get_DocTID_DVIPPRODT , write = set_DocTID_DVIPPRODT};
   virtual TFIBLargeIntField * get_DocTID_DVIPPRODT(void)=0;
   virtual void set_DocTID_DVIPPRODT(TFIBLargeIntField * DocTID_DVIPPRODT)=0;

   __property TFIBLargeIntField * DocTIDDOC_DVIPPRODT = {read = get_DocTIDDOC_DVIPPRODT , write = set_DocTIDDOC_DVIPPRODT};
   virtual TFIBLargeIntField * get_DocTIDDOC_DVIPPRODT(void)=0;
   virtual void set_DocTIDDOC_DVIPPRODT(TFIBLargeIntField * DocTIDDOC_DVIPPRODT)=0;

   __property TFIBLargeIntField * DocTIDBASE_DVIPPRODT = {read = get_DocTIDBASE_DVIPPRODT , write = set_DocTIDBASE_DVIPPRODT};
   virtual TFIBLargeIntField * get_DocTIDBASE_DVIPPRODT(void)=0;
   virtual void set_DocTIDBASE_DVIPPRODT(TFIBLargeIntField * DocTIDBASE_DVIPPRODT)=0;

   __property TFIBLargeIntField * DocTIDNOM_DVIPPRODT = {read = get_DocTIDNOM_DVIPPRODT , write = set_DocTIDNOM_DVIPPRODT};
   virtual TFIBLargeIntField * get_DocTIDNOM_DVIPPRODT(void)=0;
   virtual void set_DocTIDNOM_DVIPPRODT(TFIBLargeIntField * DocTIDNOM_DVIPPRODT)=0;

   __property TFIBLargeIntField * DocTIDED_DVIPPRODT = {read = get_DocTIDED_DVIPPRODT , write = set_DocTIDED_DVIPPRODT};
   virtual TFIBLargeIntField * get_DocTIDED_DVIPPRODT(void)=0;
   virtual void set_DocTIDED_DVIPPRODT(TFIBLargeIntField * DocTIDED_DVIPPRODT)=0;

   __property TFIBLargeIntField * DocTIDPART_DVIPPRODT = {read = get_DocTIDPART_DVIPPRODT , write = set_DocTIDPART_DVIPPRODT};
   virtual TFIBLargeIntField * get_DocTIDPART_DVIPPRODT(void)=0;
   virtual void set_DocTIDPART_DVIPPRODT(TFIBLargeIntField * DocTIDPART_DVIPPRODT)=0;

   __property TFIBBCDField * DocTKOL_DVIPPRODT = {read = get_DocTKOL_DVIPPRODT , write = set_DocTKOL_DVIPPRODT};
   virtual TFIBBCDField * get_DocTKOL_DVIPPRODT(void)=0;
   virtual void set_DocTKOL_DVIPPRODT(TFIBBCDField * DocTKOL_DVIPPRODT)=0;

   __property TFIBBCDField * DocTKF_DVIPPRODT = {read = get_DocTKF_DVIPPRODT , write = set_DocTKF_DVIPPRODT};
   virtual TFIBBCDField * get_DocTKF_DVIPPRODT(void)=0;
   virtual void set_DocTKF_DVIPPRODT(TFIBBCDField * DocTKF_DVIPPRODT)=0;

   __property TFIBBCDField * DocTRPRICE_DVIPPRODT = {read = get_DocTRPRICE_DVIPPRODT , write = set_DocTRPRICE_DVIPPRODT};
   virtual TFIBBCDField * get_DocTRPRICE_DVIPPRODT(void)=0;
   virtual void set_DocTRPRICE_DVIPPRODT(TFIBBCDField * DocTRPRICE_DVIPPRODT)=0;

   __property TFIBBCDField * DocTRSUM_DVIPPRODT = {read = get_DocTRSUM_DVIPPRODT , write = set_DocTRSUM_DVIPPRODT};
   virtual TFIBBCDField * get_DocTRSUM_DVIPPRODT(void)=0;
   virtual void set_DocTRSUM_DVIPPRODT(TFIBBCDField * DocTRSUM_DVIPPRODT)=0;
...
#define IID_IDMDocVipuskProd __uuidof(IDMDocVipuskProd)
#endif
