#ifndef UIHOT_DMDocOtmenaBronH
#define UIHOT_DMDocOtmenaBronH
...
#include <Classes.hpp>
#include <DB.hpp>
class __declspec(uuid("{B8172C77-8236-457C-8AD7-5B3165AB7F4D}")) IHOT_DMDocOtmenaBron : public IMainInterface
{
public:
   ...
   __property TFIBWideStringField * DocGID_HOT_DOTMBRON = {read = get_DocGID_HOT_DOTMBRON , write = set_DocGID_HOT_DOTMBRON};
   virtual TFIBWideStringField * get_DocGID_HOT_DOTMBRON(void)=0;
   virtual void set_DocGID_HOT_DOTMBRON(TFIBWideStringField * DocGID_HOT_DOTMBRON)=0;
   ...
   __property TFIBLargeIntField * DocID_HOT_DOTMBRON = {read = get_DocID_HOT_DOTMBRON , write = set_DocID_HOT_DOTMBRON};
   virtual TFIBLargeIntField * get_DocID_HOT_DOTMBRON(void)=0;
   virtual void set_DocID_HOT_DOTMBRON(TFIBLargeIntField * DocID_HOT_DOTMBRON)=0;

   __property TFIBLargeIntField * DocIDDOCH_HOT_DOTMBRON = {read = get_DocIDDOCH_HOT_DOTMBRON , write = set_DocIDDOCH_HOT_DOTMBRON};
   virtual TFIBLargeIntField * get_DocIDDOCH_HOT_DOTMBRON(void)=0;
   virtual void set_DocIDDOCH_HOT_DOTMBRON(TFIBLargeIntField * DocIDDOCH_HOT_DOTMBRON)=0;

   __property TFIBWideStringField * DocDESCR_HOT_DOTMBRON = {read = get_DocDESCR_HOT_DOTMBRON , write = set_DocDESCR_HOT_DOTMBRON};
   virtual TFIBWideStringField * get_DocDESCR_HOT_DOTMBRON(void)=0;
   virtual void set_DocDESCR_HOT_DOTMBRON(TFIBWideStringField * DocDESCR_HOT_DOTMBRON)=0;

   __property TFIBLargeIntField * DocIDBASE_HOT_DOTMBRON = {read = get_DocIDBASE_HOT_DOTMBRON , write = set_DocIDBASE_HOT_DOTMBRON};
   virtual TFIBLargeIntField * get_DocIDBASE_HOT_DOTMBRON(void)=0;
   virtual void set_DocIDBASE_HOT_DOTMBRON(TFIBLargeIntField * DocIDBASE_HOT_DOTMBRON)=0;

   __property TFIBLargeIntField * DocTID_HOT_DOTMBRONT = {read = get_DocTID_HOT_DOTMBRONT , write = set_DocTID_HOT_DOTMBRONT};
   virtual TFIBLargeIntField * get_DocTID_HOT_DOTMBRONT(void)=0;
   virtual void set_DocTID_HOT_DOTMBRONT(TFIBLargeIntField * DocTID_HOT_DOTMBRONT)=0;

   __property TFIBLargeIntField * DocTIDDOCH_HOT_DOTMBRONT = {read = get_DocTIDDOCH_HOT_DOTMBRONT , write = set_DocTIDDOCH_HOT_DOTMBRONT};
   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_DOTMBRONT(void)=0;
   virtual void set_DocTIDDOCH_HOT_DOTMBRONT(TFIBLargeIntField * DocTIDDOCH_HOT_DOTMBRONT)=0;

   __property TFIBLargeIntField * DocTIDSOST_HOT_DOTMBRONT = {read = get_DocTIDSOST_HOT_DOTMBRONT , write = set_DocTIDSOST_HOT_DOTMBRONT};
   virtual TFIBLargeIntField * get_DocTIDSOST_HOT_DOTMBRONT(void)=0;
   virtual void set_DocTIDSOST_HOT_DOTMBRONT(TFIBLargeIntField * DocTIDSOST_HOT_DOTMBRONT)=0;

   __property TFIBLargeIntField * DocTIDBASE_HOT_DOTMBRONT = {read = get_DocTIDBASE_HOT_DOTMBRONT , write = set_DocTIDBASE_HOT_DOTMBRONT};
   virtual TFIBLargeIntField * get_DocTIDBASE_HOT_DOTMBRONT(void)=0;
   virtual void set_DocTIDBASE_HOT_DOTMBRONT(TFIBLargeIntField * DocTIDBASE_HOT_DOTMBRONT)=0;
...
#define IID_IHOT_DMDocOtmenaBron __uuidof(IHOT_DMDocOtmenaBron)
#endif
