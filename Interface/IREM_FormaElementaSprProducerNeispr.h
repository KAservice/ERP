#ifndef UIREM_FormaElementaSprProducerNeisprH
#define UIREM_FormaElementaSprProducerNeisprH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IREM_DMSprProducerNeispr.h"
class __declspec(uuid(Global_IID_IREM_FormaElementaSprProducerNeispr)) IREM_FormaElementaSprProducerNeispr : public IMainInterface
{
public:
...
#define IID_IREM_FormaElementaSprProducerNeispr __uuidof(IREM_FormaElementaSprProducerNeispr)
#endif
