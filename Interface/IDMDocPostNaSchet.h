#ifndef UIDMDocPostNaSchetH
#define UIDMDocPostNaSchetH
...
#include <Classes.hpp>
class __declspec(uuid(Global_IID_IDMDocPostNaSchet)) IDMDocPostNaSchet : public IMainInterface
{
public:
   ...
   __property TFIBDateField * DocDATEPNS = {read = get_DocDATEPNS , write = set_DocDATEPNS};
   virtual TFIBDateField * get_DocDATEPNS(void)=0;
   virtual void set_DocDATEPNS(TFIBDateField * DocDATEPNS)=0;

   __property TFIBSmallIntField * DocOPERATIONPNS = {read = get_DocOPERATIONPNS , write = set_DocOPERATIONPNS};
   virtual TFIBSmallIntField * get_DocOPERATIONPNS(void)=0;
   virtual void set_DocOPERATIONPNS(TFIBSmallIntField * DocOPERATIONPNS)=0;

   __property TFIBBCDField * DocSUMUSNPNS = {read = get_DocSUMUSNPNS , write = set_DocSUMUSNPNS};
   virtual TFIBBCDField * get_DocSUMUSNPNS(void)=0;
   virtual void set_DocSUMUSNPNS(TFIBBCDField * DocSUMUSNPNS)=0;
   ...
   __property TFIBIntegerField * DocNDS_DPNS = {read = get_DocNDS_DPNS , write = set_DocNDS_DPNS};
   virtual TFIBIntegerField * get_DocNDS_DPNS(void)=0;
   virtual void set_DocNDS_DPNS(TFIBIntegerField * DocNDS_DPNS)=0;

   __property TFIBBCDField * DocSUMNDS_DPNS = {read = get_DocSUMNDS_DPNS , write = set_DocSUMNDS_DPNS};
   virtual TFIBBCDField * get_DocSUMNDS_DPNS(void)=0;
   virtual void set_DocSUMNDS_DPNS(TFIBBCDField * DocSUMNDS_DPNS)=0;
   ...
   __property TFIBLargeIntField * DocIDPNS = {read = get_DocIDPNS , write = set_DocIDPNS};
   virtual TFIBLargeIntField * get_DocIDPNS(void)=0;
   virtual void set_DocIDPNS(TFIBLargeIntField * DocIDPNS)=0;

   __property TFIBLargeIntField * DocIDDOCPNS = {read = get_DocIDDOCPNS , write = set_DocIDDOCPNS};
   virtual TFIBLargeIntField * get_DocIDDOCPNS(void)=0;
   virtual void set_DocIDDOCPNS(TFIBLargeIntField * DocIDDOCPNS)=0;

   __property TFIBLargeIntField * DocIDBSCHPNS = {read = get_DocIDBSCHPNS , write = set_DocIDBSCHPNS};
   virtual TFIBLargeIntField * get_DocIDBSCHPNS(void)=0;
   virtual void set_DocIDBSCHPNS(TFIBLargeIntField * DocIDBSCHPNS)=0;

   __property TFIBLargeIntField * DocIDRSCHPNS = {read = get_DocIDRSCHPNS , write = set_DocIDRSCHPNS};
   virtual TFIBLargeIntField * get_DocIDRSCHPNS(void)=0;
   virtual void set_DocIDRSCHPNS(TFIBLargeIntField * DocIDRSCHPNS)=0;

   __property TFIBWideStringField * DocNASNPNS = {read = get_DocNASNPNS , write = set_DocNASNPNS};
   virtual TFIBWideStringField * get_DocNASNPNS(void)=0;
   virtual void set_DocNASNPNS(TFIBWideStringField * DocNASNPNS)=0;

   __property TFIBWideStringField * DocGID_DPNS = {read = get_DocGID_DPNS , write = set_DocGID_DPNS};
   virtual TFIBWideStringField * get_DocGID_DPNS(void)=0;
   virtual void set_DocGID_DPNS(TFIBWideStringField * DocGID_DPNS)=0;

   __property TFIBIntegerField * DocADDKDRPNS = {read = get_DocADDKDRPNS , write = set_DocADDKDRPNS};
   virtual TFIBIntegerField * get_DocADDKDRPNS(void)=0;
   virtual void set_DocADDKDRPNS(TFIBIntegerField * DocADDKDRPNS)=0;

   __property TFIBLargeIntField * DocIDBASE_DPNS = {read = get_DocIDBASE_DPNS , write = set_DocIDBASE_DPNS};
   virtual TFIBLargeIntField * get_DocIDBASE_DPNS(void)=0;
   virtual void set_DocIDBASE_DPNS(TFIBLargeIntField * DocIDBASE_DPNS)=0;
   ...
   __property TFIBWideStringField * DocNUMPNS = {read = get_DocNUMPNS , write = set_DocNUMPNS};
   virtual TFIBWideStringField * get_DocNUMPNS(void)=0;
   virtual void set_DocNUMPNS(TFIBWideStringField * DocNUMPNS)=0;
...
#define IID_IDMDocPostNaSchet __uuidof(IDMDocPostNaSchet)
#endif
