#ifndef UIART_FormaElementaSprImageH
#define UIART_FormaElementaSprImageH
#include "IMainInterface.h"
#include "UGlobalConstant.h"
#include "IART_DMSprImage.h"
class __declspec(uuid(Global_IID_IART_FormaElementaSprImage)) IART_FormaElementaSprImage : public IMainInterface
{
public:
...
#define IID_IART_FormaElementaSprImage __uuidof(IART_FormaElementaSprImage)
#endif
