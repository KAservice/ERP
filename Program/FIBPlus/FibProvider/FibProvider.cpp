...
USEFORM("UDMConnection.cpp", DMConnection); /* TDataModule: File Type */
USEFORM("UDMQueryUpdate.cpp", DMQueryUpdate); /* TDataModule: File Type */
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_QueryRead, TQueryReadImpl)
  OBJECT_ENTRY(CLSID_QueryUpdate, TQueryUpdateImpl)
  OBJECT_ENTRY(CLSID_DMConnectionImpl, TDMConnectionImpl)
END_OBJECT_MAP()
