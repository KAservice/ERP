...
__published:	// IDE-managed Components
	...
	TFIBBCDField *GurAllDocID_REM_GALLDOC;
	TFIBDateTimeField *GurAllDocPOS_REM_GALLDOC;
	TFIBIntegerField *GurAllDocNUM_REM_GALLDOC;
	TFIBSmallIntField *GurAllDocPR_REM_GALLDOC;
	TFIBWideStringField *GurAllDocTDOC_REM_GALLDOC;
