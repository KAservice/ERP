#ifndef UREM_DMDocZakazPostImplH
#define UREM_DMDocZakazPostImplH
#include "IREM_DMDocZakazPost.h"
#include "UREM_DMDocZakazPost.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocZakazPostImpl)) TREM_DMDocZakazPostImpl : public IREM_DMDocZakazPost
{
public:
   TREM_DMDocZakazPostImpl();
   ~TREM_DMDocZakazPostImpl();
   TREM_DMDocZakazPost * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocZakazPost
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DZAKPOST(void);
   virtual void set_DocID_REM_DZAKPOST(TFIBLargeIntField * DocID_REM_DZAKPOST);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZAKPOST(void);
   virtual void set_DocIDBASE_REM_DZAKPOST(TFIBLargeIntField * DocIDBASE_REM_DZAKPOST);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZAKPOST(void);
   virtual void set_DocIDDOC_REM_DZAKPOST(TFIBLargeIntField * DocIDDOC_REM_DZAKPOST);

   virtual TFIBLargeIntField * get_DocIDTPRICE_REM_DZAKPOST(void);
   virtual void set_DocIDTPRICE_REM_DZAKPOST(TFIBLargeIntField * DocIDTPRICE_REM_DZAKPOST);

   virtual TFIBWideStringField * get_DocNUMZAKPOST_REM_DZAKPOST(void);
   virtual void set_DocNUMZAKPOST_REM_DZAKPOST(TFIBWideStringField * DocNUMZAKPOST_REM_DZAKPOST);

   virtual TFIBDateTimeField * get_DocPOSZAKPOST_REM_DZAKPOST(void);
   virtual void set_DocPOSZAKPOST_REM_DZAKPOST(TFIBDateTimeField * DocPOSZAKPOST_REM_DZAKPOST);

   virtual TFIBLargeIntField * get_DocTID_REM_DZAKPOSTT(void);
   virtual void set_DocTID_REM_DZAKPOSTT(TFIBLargeIntField * DocTID_REM_DZAKPOSTT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZAKPOSTT(void);
   virtual void set_DocTIDBASE_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDBASE_REM_DZAKPOSTT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZAKPOSTT(void);
   virtual void set_DocTIDDOC_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDDOC_REM_DZAKPOSTT);

   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DZAKPOSTT(void);
   virtual void set_DocTIDNOM_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDNOM_REM_DZAKPOSTT);

   virtual TFIBLargeIntField * get_DocTIDED_REM_DZAKPOSTT(void);
   virtual void set_DocTIDED_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDED_REM_DZAKPOSTT);

   virtual TFIBBCDField * get_DocTKOL_REM_DZAKPOSTT(void);
   virtual void set_DocTKOL_REM_DZAKPOSTT(TFIBBCDField * DocTKOL_REM_DZAKPOSTT);

   virtual TFIBBCDField * get_DocTKF_REM_DZAKPOSTT(void);
   virtual void set_DocTKF_REM_DZAKPOSTT(TFIBBCDField * DocTKF_REM_DZAKPOSTT);

   virtual TFIBBCDField * get_DocTPRICE_REM_DZAKPOSTT(void);
   virtual void set_DocTPRICE_REM_DZAKPOSTT(TFIBBCDField * DocTPRICE_REM_DZAKPOSTT);

   virtual TFIBBCDField * get_DocTSUM_REM_DZAKPOSTT(void);
   virtual void set_DocTSUM_REM_DZAKPOSTT(TFIBBCDField * DocTSUM_REM_DZAKPOSTT);
   ...
   virtual TFIBLargeIntField * get_DocIDBRAND_REM_DZAKPOST(void);
   virtual void set_DocIDBRAND_REM_DZAKPOST(TFIBLargeIntField * DocIDBRAND_REM_DZAKPOST);

   virtual TFIBLargeIntField * get_DocIDPRODUCER_REM_DZAKPOST(void);
   virtual void set_DocIDPRODUCER_REM_DZAKPOST(TFIBLargeIntField * DocIDPRODUCER_REM_DZAKPOST);
   ...
   virtual TFIBLargeIntField * get_DocTIDPRNOM_REM_DZAKPOSTT(void);
   virtual void set_DocTIDPRNOM_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDPRNOM_REM_DZAKPOSTT);
   ...
   virtual TFIBLargeIntField * get_DocTIDCQT_REM_DZAKPOSTT(void);
   virtual void set_DocTIDCQT_REM_DZAKPOSTT(TFIBLargeIntField * DocTIDCQT_REM_DZAKPOSTT);
...
#define CLSID_TREM_DMDocZakazPostImpl __uuidof(TREM_DMDocZakazPostImpl)
#endif
