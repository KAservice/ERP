#ifndef UREM_DMDocZPostImplH
#define UREM_DMDocZPostImplH
#include "IREM_DMDocZPost.h"
#include "UREM_DMDocZPost.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocZPostImpl)) TREM_DMDocZPostImpl : public IREM_DMDocZPost
{
public:
   TREM_DMDocZPostImpl();
   ~TREM_DMDocZPostImpl();
   TREM_DMDocZPost * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocZPost
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DZPOST(void);
   virtual void set_DocID_REM_DZPOST(TFIBLargeIntField * DocID_REM_DZPOST);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZPOST(void);
   virtual void set_DocIDBASE_REM_DZPOST(TFIBLargeIntField * DocIDBASE_REM_DZPOST);

   virtual TFIBWideStringField * get_DocGID_REM_DZPOST(void);
   virtual void set_DocGID_REM_DZPOST(TFIBWideStringField * DocGID_REM_DZPOST);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZPOST(void);
   virtual void set_DocIDDOC_REM_DZPOST(TFIBLargeIntField * DocIDDOC_REM_DZPOST);

   virtual TFIBWideStringField * get_DocPRIM_REM_DZPOST(void);
   virtual void set_DocPRIM_REM_DZPOST(TFIBWideStringField * DocPRIM_REM_DZPOST);

   virtual TFIBLargeIntField * get_DocTID_REM_DZPOSTT(void);
   virtual void set_DocTID_REM_DZPOSTT(TFIBLargeIntField * DocTID_REM_DZPOSTT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZPOSTT(void);
   virtual void set_DocTIDBASE_REM_DZPOSTT(TFIBLargeIntField * DocTIDBASE_REM_DZPOSTT);

   virtual TFIBWideStringField * get_DocTGID_REM_DZPOSTT(void);
   virtual void set_DocTGID_REM_DZPOSTT(TFIBWideStringField * DocTGID_REM_DZPOSTT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZPOSTT(void);
   virtual void set_DocTIDDOC_REM_DZPOSTT(TFIBLargeIntField * DocTIDDOC_REM_DZPOSTT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DZPOSTT(void);
   virtual void set_DocTIDZ_REM_DZPOSTT(TFIBLargeIntField * DocTIDZ_REM_DZPOSTT);

   virtual TFIBBCDField * get_DocTKOL_REM_DZPOSTT(void);
   virtual void set_DocTKOL_REM_DZPOSTT(TFIBBCDField * DocTKOL_REM_DZPOSTT);
...
#define CLSID_TREM_DMDocZPostImpl __uuidof(TREM_DMDocZPostImpl)
#endif
