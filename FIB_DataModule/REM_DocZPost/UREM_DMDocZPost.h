...
#ifndef UREM_DMDocZPostH
#define UREM_DMDocZPostH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_DMDocZPost : public TDataModule
{
__published:	// IDE-managed Components
	...
	TFIBLargeIntField *DocID_REM_DZPOST;
	TFIBLargeIntField *DocIDBASE_REM_DZPOST;
	TFIBWideStringField *DocGID_REM_DZPOST;
	TFIBLargeIntField *DocIDDOC_REM_DZPOST;
	TFIBWideStringField *DocPRIM_REM_DZPOST;
	TFIBLargeIntField *DocTID_REM_DZPOSTT;
	TFIBLargeIntField *DocTIDBASE_REM_DZPOSTT;
	TFIBWideStringField *DocTGID_REM_DZPOSTT;
	TFIBLargeIntField *DocTIDDOC_REM_DZPOSTT;
	TFIBLargeIntField *DocTIDZ_REM_DZPOSTT;
	TFIBBCDField *DocTKOL_REM_DZPOSTT;
...
public:		// User declarations
		__fastcall TREM_DMDocZPost(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_DMDocZPost *REM_DMDocZPost;
//---------------------------------------------------------------------------
#endif
