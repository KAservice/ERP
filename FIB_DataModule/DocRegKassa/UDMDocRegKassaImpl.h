#ifndef UDMDocRegKassaImplH
#define UDMDocRegKassaImplH
#include "IDMDocRegKassa.h"
#include "UDMDocRegKassa.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMDocRegKassaImpl)) TDMDocRegKassaImpl : public IDMDocRegKassa
{
public:
   TDMDocRegKassaImpl();
   ~TDMDocRegKassaImpl();
   TDMDocRegKassa * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMDocRegKassa
   ...
   virtual TFIBSmallIntField * get_DocTTDV_DRG_KASSAT(void);
   virtual void set_DocTTDV_DRG_KASSAT(TFIBSmallIntField * DocTTDV_DRG_KASSAT);

   virtual TFIBBCDField * get_DocTSUM_DRG_KASSAT(void);
   virtual void set_DocTSUM_DRG_KASSAT(TFIBBCDField * DocTSUM_DRG_KASSAT);

   virtual TFIBSmallIntField * get_DocTOPER_DRG_KASSAT(void);
   virtual void set_DocTOPER_DRG_KASSAT(TFIBSmallIntField * DocTOPER_DRG_KASSAT);
   ...
   virtual TFIBLargeIntField * get_DocID_DRG_KASSA(void);
   virtual void set_DocID_DRG_KASSA(TFIBLargeIntField * DocID_DRG_KASSA);

   virtual TFIBLargeIntField * get_DocIDDOC_DRG_KASSA(void);
   virtual void set_DocIDDOC_DRG_KASSA(TFIBLargeIntField * DocIDDOC_DRG_KASSA);

   virtual TFIBWideStringField * get_DocDESCR_DRG_KASSA(void);
   virtual void set_DocDESCR_DRG_KASSA(TFIBWideStringField * DocDESCR_DRG_KASSA);

   virtual TFIBLargeIntField * get_DocIDBASE_DRG_KASSA(void);
   virtual void set_DocIDBASE_DRG_KASSA(TFIBLargeIntField * DocIDBASE_DRG_KASSA);

   virtual TFIBLargeIntField * get_DocTID_DRG_KASSAT(void);
   virtual void set_DocTID_DRG_KASSAT(TFIBLargeIntField * DocTID_DRG_KASSAT);

   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_KASSAT(void);
   virtual void set_DocTIDDOC_DRG_KASSAT(TFIBLargeIntField * DocTIDDOC_DRG_KASSAT);

   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_KASSAT(void);
   virtual void set_DocTIDFIRM_DRG_KASSAT(TFIBLargeIntField * DocTIDFIRM_DRG_KASSAT);

   virtual TFIBLargeIntField * get_DocTIDKKM_DRG_KASSAT(void);
   virtual void set_DocTIDKKM_DRG_KASSAT(TFIBLargeIntField * DocTIDKKM_DRG_KASSAT);

   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_KASSAT(void);
   virtual void set_DocTIDBASE_DRG_KASSAT(TFIBLargeIntField * DocTIDBASE_DRG_KASSAT);

   virtual TFIBWideStringField * get_DocTNAMEFIRM(void);
   virtual void set_DocTNAMEFIRM(TFIBWideStringField * DocTNAMEFIRM);

   virtual TFIBWideStringField * get_DocTNAMEKKM(void);
   virtual void set_DocTNAMEKKM(TFIBWideStringField * DocTNAMEKKM);
...
#define CLSID_TDMDocRegKassaImpl __uuidof(TDMDocRegKassaImpl)
#endif
