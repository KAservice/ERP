...
#ifndef UREM_DMDocVosvratHWH
#define UREM_DMDocVosvratHWH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_DMDocVosvratHW : public TDataModule
{
__published:	// IDE-managed Components
	...
	TFIBLargeIntField *DocID_REM_DVOSVRAT_HW;
	TFIBLargeIntField *DocIDBASE_REM_DVOSVRAT_HW;
	TFIBWideStringField *DocGID_REM_DVOSVRAT_HW;
	TFIBLargeIntField *DocIDDOC_REM_DVOSVRAT_HW;
	TFIBWideStringField *DocPRIM_REM_DVOSVRAT_HW;
	TFIBLargeIntField *DocIDZ_REM_DVOSVRAT_HW;
	TFIBLargeIntField *DocIDHW_REM_DVOSVRAT_HW;
	TFIBLargeIntField *DocIDKKT_REM_DVOSVRAT_HW;
	...
	TFIBLargeIntField *DocTID_REM_DVOSVRAT_HWT;
	TFIBLargeIntField *DocTIDBASE_REM_DVOSVRAT_HWT;
	TFIBWideStringField *DocTGID_REM_DVOSVRAT_HWT;
	TFIBLargeIntField *DocTIDDOC_REM_DVOSVRAT_HWT;
	TFIBLargeIntField *DocTIDHW_REM_DVOSVRAT_HWT;
	TFIBBCDField *DocTKF_REM_DVOSVRAT_HWT;
	TFIBBCDField *DocTKOL_REM_DVOSVRAT_HWT;
...
public:		// User declarations
		__fastcall TREM_DMDocVosvratHW(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_DMDocVosvratHW *REM_DMDocVosvratHW;
//---------------------------------------------------------------------------
#endif
