#ifndef UREM_DMDocVosvratHWImplH
#define UREM_DMDocVosvratHWImplH
#include "IREM_DMDocVosvratHW.h"
#include "UREM_DMDocVosvratHW.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocVosvratHWImpl)) TREM_DMDocVosvratHWImpl : public IREM_DMDocVosvratHW
{
public:
   TREM_DMDocVosvratHWImpl();
   ~TREM_DMDocVosvratHWImpl();
   TREM_DMDocVosvratHW * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocVosvratHW
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DVOSVRAT_HW(void);
   virtual void set_DocID_REM_DVOSVRAT_HW(TFIBLargeIntField * DocID_REM_DVOSVRAT_HW);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DVOSVRAT_HW(void);
   virtual void set_DocIDBASE_REM_DVOSVRAT_HW(TFIBLargeIntField * DocIDBASE_REM_DVOSVRAT_HW);

   virtual TFIBWideStringField * get_DocGID_REM_DVOSVRAT_HW(void);
   virtual void set_DocGID_REM_DVOSVRAT_HW(TFIBWideStringField * DocGID_REM_DVOSVRAT_HW);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DVOSVRAT_HW(void);
   virtual void set_DocIDDOC_REM_DVOSVRAT_HW(TFIBLargeIntField * DocIDDOC_REM_DVOSVRAT_HW);

   virtual TFIBWideStringField * get_DocPRIM_REM_DVOSVRAT_HW(void);
   virtual void set_DocPRIM_REM_DVOSVRAT_HW(TFIBWideStringField * DocPRIM_REM_DVOSVRAT_HW);

   virtual TFIBLargeIntField * get_DocIDZ_REM_DVOSVRAT_HW(void);
   virtual void set_DocIDZ_REM_DVOSVRAT_HW(TFIBLargeIntField * DocIDZ_REM_DVOSVRAT_HW);

   virtual TFIBLargeIntField * get_DocIDHW_REM_DVOSVRAT_HW(void);
   virtual void set_DocIDHW_REM_DVOSVRAT_HW(TFIBLargeIntField * DocIDHW_REM_DVOSVRAT_HW);

   virtual TFIBLargeIntField * get_DocIDKKT_REM_DVOSVRAT_HW(void);
   virtual void set_DocIDKKT_REM_DVOSVRAT_HW(TFIBLargeIntField * DocIDKKT_REM_DVOSVRAT_HW);
   ...
   virtual TFIBLargeIntField * get_DocTID_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTID_REM_DVOSVRAT_HWT(TFIBLargeIntField * DocTID_REM_DVOSVRAT_HWT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTIDBASE_REM_DVOSVRAT_HWT(TFIBLargeIntField * DocTIDBASE_REM_DVOSVRAT_HWT);

   virtual TFIBWideStringField * get_DocTGID_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTGID_REM_DVOSVRAT_HWT(TFIBWideStringField * DocTGID_REM_DVOSVRAT_HWT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTIDDOC_REM_DVOSVRAT_HWT(TFIBLargeIntField * DocTIDDOC_REM_DVOSVRAT_HWT);

   virtual TFIBLargeIntField * get_DocTIDHW_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTIDHW_REM_DVOSVRAT_HWT(TFIBLargeIntField * DocTIDHW_REM_DVOSVRAT_HWT);

   virtual TFIBBCDField * get_DocTKF_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTKF_REM_DVOSVRAT_HWT(TFIBBCDField * DocTKF_REM_DVOSVRAT_HWT);

   virtual TFIBBCDField * get_DocTKOL_REM_DVOSVRAT_HWT(void);
   virtual void set_DocTKOL_REM_DVOSVRAT_HWT(TFIBBCDField * DocTKOL_REM_DVOSVRAT_HWT);
...
#define CLSID_TREM_DMDocVosvratHWImpl __uuidof(TREM_DMDocVosvratHWImpl)
#endif
