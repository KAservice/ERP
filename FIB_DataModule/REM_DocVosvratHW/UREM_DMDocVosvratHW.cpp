...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocVosvratHW::TREM_DMDocVosvratHW(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocVosvratHW::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocVosvratHW::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocVosvratHW::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocVosvratHW::NewDoc(void)
{
bool result=false;
...
try
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REM_VOSVRAT_HW");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REM_VOSVRAT_HW";
...
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratHW::OpenDoc(__int64 id)
{
bool result=false;
try
	{
...
//-----------------------------------------------------------------------------
void TREM_DMDocVosvratHW::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocVosvratHW::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratHW::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratHW::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratHW::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocVosvratHW::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocVosvratHW::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DVOSVRAT_HW->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DVOSVRAT_HW->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocVosvratHW::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DVOSVRAT_HWT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DVOSVRAT_HWT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocVosvratHW::DocTCalcFields(TDataSet *DataSet)
{
...
void __fastcall TREM_DMDocVosvratHW::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocVosvratHW::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
