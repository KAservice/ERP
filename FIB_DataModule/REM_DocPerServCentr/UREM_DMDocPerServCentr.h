...
#ifndef UREM_DMDocPerServCentrH
#define UREM_DMDocPerServCentrH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_DMDocPerServCentr : public TDataModule
{
__published:	// IDE-managed Components
	...
	TFIBLargeIntField *DocID_REM_DSCPER;
	TFIBLargeIntField *DocIDBASE_REM_DSCPER;
	TFIBWideStringField *DocGID_REM_DSCPER;
	TFIBLargeIntField *DocIDDOC_REM_DSCPER;
	TFIBWideStringField *DocNUMDOCSC_REM_DSCPER;
	TFIBDateTimeField *DocPOSDOCSC_REM_DSCPER;
	TFIBWideStringField *DocPRIM_REM_DSCPER;
	TFIBLargeIntField *DocTID_REM_DSCPERT;
	TFIBLargeIntField *DocTIDBASE_REM_DSCPERT;
	TFIBWideStringField *DocTGID_REM_DSCPERT;
	TFIBLargeIntField *DocTIDDOC_REM_DSCPERT;
	TFIBLargeIntField *DocTIDZ_REM_DSCPERT;
	TFIBBCDField *DocTKOL_REM_DSCPERT;
...
public:		// User declarations
		__fastcall TREM_DMDocPerServCentr(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_DMDocPerServCentr *REM_DMDocPerServCentr;
//---------------------------------------------------------------------------
#endif
