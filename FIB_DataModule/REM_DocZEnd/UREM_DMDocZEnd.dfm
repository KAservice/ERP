object REM_DMDocZEnd: TREM_DMDocZEnd
  ...
  object Doc: TpFIBDataSet
    ...
    UpdateSQL.Strings = (
      'UPDATE REM_DZEND'
      'SET '
      '    IDBASE_REM_DZEND = :IDBASE_REM_DZEND,'
      '    GID_REM_DZEND = :GID_REM_DZEND,'
      '    IDDOC_REM_DZEND = :IDDOC_REM_DZEND,'
      '    IDZ_REM_DZEND = :IDZ_REM_DZEND,'
      '    PRIM_REM_DZEND = :PRIM_REM_DZEND,'
      '    POPOSLE_REM_DZEND = :POPOSLE_REM_DZEND,'
      '    IDDFCPR_REM_DZEND = :IDDFCPR_REM_DZEND,'
      '    IDPRDEFECT_REM_DZEND = :IDPRDEFECT_REM_DZEND'
      'WHERE'
      '    ID_REM_DZEND = :OLD_ID_REM_DZEND'
      '    ')
    DeleteSQL.Strings = (
      'DELETE FROM'
      '    REM_DZEND'
    ...
    RefreshSQL.Strings = (
      ...
      'from  rem_dzend'
      'left outer join rem_z on rem_dzend.idz_rem_dzend=rem_z.id_rem_z'
      
        'left outer join rem_smodel on rem_z.idmodel_rem_z=rem_smodel.id_' +
        'rem_smodel'
      
        'left outer join rem_sprneispr on rem_dzend.iddfcpr_rem_dzend=rem' +
        '_sprneispr.id_rem_sprneispr'
      
        'left outer join rem_sprdefect on rem_dzend.idprdefect_rem_dzend=' +
        'rem_sprdefect.id_rem_sprdefect'
      'where(  rem_dzend.iddoc_rem_dzend=:PARAM_IDDOC'
      '     ) and (     REM_DZEND.ID_REM_DZEND = :OLD_ID_REM_DZEND'
      '     )'
      '    ')
    SelectSQL.Strings = (
      'select rem_dzend.*,'
    ...
    Top = 64
    poUseLargeIntField = True
    object DocID_REM_DZEND: TFIBLargeIntField
      FieldName = 'ID_REM_DZEND'
    end
    object DocIDBASE_REM_DZEND: TFIBLargeIntField
      FieldName = 'IDBASE_REM_DZEND'
    end
    object DocGID_REM_DZEND: TFIBWideStringField
      FieldName = 'GID_REM_DZEND'
      Size = 10
    end
    object DocIDDOC_REM_DZEND: TFIBLargeIntField
      FieldName = 'IDDOC_REM_DZEND'
    end
    object DocIDZ_REM_DZEND: TFIBLargeIntField
      FieldName = 'IDZ_REM_DZEND'
    end
    object DocPRIM_REM_DZEND: TFIBWideStringField
      FieldName = 'PRIM_REM_DZEND'
      Size = 100
    end
    ...
    object DocPOPOSLE_REM_DZEND: TFIBWideStringField
      FieldName = 'POPOSLE_REM_DZEND'
      Size = 40
    end
    object DocIDDFCPR_REM_DZEND: TFIBLargeIntField
      FieldName = 'IDDFCPR_REM_DZEND'
    end
    object DocIDPRDEFECT_REM_DZEND: TFIBLargeIntField
      FieldName = 'IDPRDEFECT_REM_DZEND'
    end
    ...
    object DocCODE_REM_SPRDEFECT: TFIBWideStringField
      FieldName = 'CODE_REM_SPRDEFECT'
    end
    object DocNAME_REM_SPRDEFECT: TFIBWideStringField
  ...
  object NumDoc: TpFIBDataSet
    SelectSQL.Strings = (
      'select max(NUM_REM_GALLDOC) AS MAXNUMBER from  REM_GALLDOC'
        ...
        'where TDOC_REM_GALLDOC='#39'REMZEND'#39' and POS_REM_GALLDOC > :PARAM_PO' +
        'S')
    Transaction = IBTr
    Left = 296
    Top = 16
  ...
  object QueryCancelDvReg: TpFIBQuery
    ...
    SQL.Strings = (
      'EXECUTE PROCEDURE REM_DOC_ZEND_CANCEL_DVREG(:PARAM_IDDOC,0,0,0)')
    Left = 96
    Top = 304
    qoStartTransaction = True
  end
  object QueryDvReg: TpFIBQuery
    Transaction = IBTrDvReg
    SQL.Strings = (
      'EXECUTE PROCEDURE REM_DOC_ZEND_DVREG (:PARAM_IDDOC,0,0,0)')
    Left = 96
    Top = 240
    qoStartTransaction = True
  end
