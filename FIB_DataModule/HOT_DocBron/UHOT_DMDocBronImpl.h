#ifndef UHOT_DMDocBronImplH
#define UHOT_DMDocBronImplH
#include "IHOT_DMDocBron.h"
#include "UHOT_DMDocBron.h"
//---------------------------------------------------------------
class __declspec(uuid("{EB887B78-AF99-4B3D-817D-D38B24F2AA44}")) THOT_DMDocBronImpl : public IHOT_DMDocBron
{
public:
   THOT_DMDocBronImpl();
   ~THOT_DMDocBronImpl();
   THOT_DMDocBron * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IHOT_DMDocBron
   ...
   virtual TFIBLargeIntField * get_DocID_HOT_DBRON(void);
   virtual void set_DocID_HOT_DBRON(TFIBLargeIntField * DocID_HOT_DBRON);

   virtual TFIBLargeIntField * get_DocIDDOCH_HOT_DBRON(void);
   virtual void set_DocIDDOCH_HOT_DBRON(TFIBLargeIntField * DocIDDOCH_HOT_DBRON);

   virtual TFIBWideStringField * get_DocDESCR_HOT_DBRON(void);
   virtual void set_DocDESCR_HOT_DBRON(TFIBWideStringField * DocDESCR_HOT_DBRON);

   virtual TFIBLargeIntField * get_DocIDBASE_HOT_DBRON(void);
   virtual void set_DocIDBASE_HOT_DBRON(TFIBLargeIntField * DocIDBASE_HOT_DBRON);

   virtual TFIBLargeIntField * get_DocIDTPRICE_HOT_DBRON(void);
   virtual void set_DocIDTPRICE_HOT_DBRON(TFIBLargeIntField * DocIDTPRICE_HOT_DBRON);

   virtual TFIBLargeIntField * get_DocTID_HOT_DBRONT(void);
   virtual void set_DocTID_HOT_DBRONT(TFIBLargeIntField * DocTID_HOT_DBRONT);

   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_DBRONT(void);
   virtual void set_DocTIDDOCH_HOT_DBRONT(TFIBLargeIntField * DocTIDDOCH_HOT_DBRONT);

   virtual TFIBLargeIntField * get_DocTIDSOST_HOT_DBRONT(void);
   virtual void set_DocTIDSOST_HOT_DBRONT(TFIBLargeIntField * DocTIDSOST_HOT_DBRONT);

   virtual TFIBLargeIntField * get_DocTIDBASE_HOT_DBRONT(void);
   virtual void set_DocTIDBASE_HOT_DBRONT(TFIBLargeIntField * DocTIDBASE_HOT_DBRONT);

   virtual TFIBLargeIntField * get_DocTID_HOT_SOSTNF(void);
   virtual void set_DocTID_HOT_SOSTNF(TFIBLargeIntField * DocTID_HOT_SOSTNF);
   ...
   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_SOSTNF(void);
   virtual void set_DocTIDDOCH_HOT_SOSTNF(TFIBLargeIntField * DocTIDDOCH_HOT_SOSTNF);
...
#define CLSID_THOT_DMDocBronImpl __uuidof(THOT_DMDocBronImpl)
#endif
