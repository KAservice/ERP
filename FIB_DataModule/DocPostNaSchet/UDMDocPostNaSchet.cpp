...
//---------------------------------------------------------------------------
__fastcall TDMDocPostNaSchet::TDMDocPostNaSchet(TComponent* Owner)
        : TDataModule(Owner)
{
...
void __fastcall TDMDocPostNaSchet::DataModuleCreate(TObject *Sender)
{
flGetNumberDoc=true;
...
bool TDMDocPostNaSchet::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TDMDocPostNaSchet::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TDMDocPostNaSchet::DataModuleDestroy(TObject *Sender)
{
...
//----------------------------------------------------------------------------
void TDMDocPostNaSchet::NewDoc(void)
{
...
Doc->Edit();
DocIDDOCPNS->AsString=IdDoc;
DocDATEPNS->AsVariant=Date();
DocADDKDRPNS->AsInteger=1;
DocOPERATIONPNS->AsInteger=1;
Doc->Post();
...
//----------------------------------------------------------------------------
int TDMDocPostNaSchet::GetNumberNewDoc(void)
{
int result=0;
...
NumDoc->ParamByName("PARAM_IDBSCHET")->AsString=DocIDBSCHPNS->AsString;
...
//----------------------------------------------------------------------------
void TDMDocPostNaSchet::OpenDoc(__int64 Id)
{
...
//----------------------------------------------------------------------------
void TDMDocPostNaSchet::CloseDoc(void)
{
        DocAll->CancelUpdates();
        Doc->CancelUpdates();
}
//----------------------------------------------------------------------------
bool TDMDocPostNaSchet::SaveDoc(void)
{
bool result=false;
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
...
//----------------------------------------------------------------------------
bool TDMDocPostNaSchet::DvRegDoc(void)
{
bool result=false;
...
//        if (CancelDvRegDoc()==true)
//                {
//				if(DocOPERATIONPNS->AsInteger==1)
//                        {
...
//                DMRegBank->IdBSchet=DocIDBSCHPNS->AsInteger;
//				DMRegBank->Operation =DocOPERATIONPNS->AsInteger;
//                DMRegBank->Sum=DocAllSUMDOC->AsFloat;
//                DMRegBank->AddRecordPrihod();
//
//                Doc2->Active=false;
...
//-----------------------------------------------------------------------------
bool TDMDocPostNaSchet::CancelDvRegDoc(void)
{
bool result=false;
...
void __fastcall TDMDocPostNaSchet::DocAllPOSDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TDMDocPostNaSchet::DocNewRecord(TDataSet *DataSet)
{
DocIDDOCPNS->AsString=DocAllIDDOC->AsString;
if (glStrToInt64(DocAllIDBASE_GALLDOC->AsString)!=0)
	{
	DocIDBASE_DPNS->AsString=DocAllIDBASE_GALLDOC->AsString;
	}
}
//---------------------------------------------------------------------------

void __fastcall TDMDocPostNaSchet::DocAllIDBASE_GALLDOCChange(TField *Sender)
{
if (glStrToInt64(DocAllIDBASE_GALLDOC->AsString)!=0)
	{
	Doc->Edit();
...
//---------------------------------------------------------------------------
bool TDMDocPostNaSchet::DeleteDoc(__int64 id)
{
bool res=false;
...
//-----------------------------------------------------------------------------
void __fastcall TDMDocPostNaSchet::DocIDBSCHPNSChange(TField *Sender)
{
DocAll->Edit();
GetNumberNewDoc();
DocAll->Post();
...
void __fastcall TDMDocPostNaSchet::DocAllIDFIRMDOCChange(TField *Sender)
{
GetNumberNewDoc();
}
//---------------------------------------------------------------------------
