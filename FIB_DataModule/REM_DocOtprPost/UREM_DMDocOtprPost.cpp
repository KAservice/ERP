...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocOtprPost::TREM_DMDocOtprPost(TComponent* Owner)
        : TDataModule(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocOtprPost::DataModuleCreate(TObject *Sender)
{
Prosmotr=false;
flGetNumberDoc=true;
}
...
bool TREM_DMDocOtprPost::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocOtprPost::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocOtprPost::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocOtprPost::NewDoc(void)
{
bool result=true;
...
DocAllTDOC_REM_GALLDOC->AsString="REM_OTPRPOST";
...
if (Trim(DMSetup->ElementVALUE_SETUP->AsString)!="")
		...
		if (glStrToInt64(DMSetup->ElementVALUE_SETUP->AsString)!=0)
			{
			DocIDTPRICE_REM_DOTPRPOST->AsString=glStrToInt64(DMSetup->ElementVALUE_SETUP->AsString);
			}
		}
else
		{
		if (glStrToInt64(DM_Connection->UserInfoIDTPRICE_USER->AsString)!=0)
			{
			DocIDTPRICE_REM_DOTPRPOST->AsString=glStrToInt64(DM_Connection->UserInfoIDTPRICE_USER->AsString);
			}
		}
DMSetup->kanRelease();
...
//---------------------------------------------------------------------------
int TREM_DMDocOtprPost::GetNumberNewDoc(void)
{
int result=0;
...
//----------------------------------------------------------------------------
bool TREM_DMDocOtprPost::OpenDoc(__int64 id)
{
bool result=true;
IdDoc=id;
DocAll->Active=false;
...
//-----------------------------------------------------------------------------
bool TREM_DMDocOtprPost::TableAppend()
{
bool result=true;
DocT->Append();
return result;
...
//---------------------------------------------------------------------------
bool TREM_DMDocOtprPost::TableDelete(void)
{
bool result=true;
DocT->Delete();
return result;
...
//---------------------------------------------------------------------------
bool TREM_DMDocOtprPost::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocOtprPost::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocOtprPost::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocOtprPost::DeleteDoc(__int64 id)
{
bool res=false;
...
__int64 TREM_DMDocOtprPost::GetIDDocPoNomeruDoc(int number_doc, TDate date_doc)
{
__int64 res=0;
...
void __fastcall TREM_DMDocOtprPost::DocTAfterDelete(TDataSet *DataSet)
{
NewSummaStr=0;
NewRSummaStr=0;
...
void __fastcall TREM_DMDocOtprPost::DocTBeforeDelete(TDataSet *DataSet)
{
OldSummaStr=DocTSUM_REM_DOTPRPOSTT->AsFloat;

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocOtprPost::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DOTPRPOSTT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DOTPRPOSTT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}
...
void __fastcall TREM_DMDocOtprPost::DocTCalcFields(TDataSet *DataSet)
{
...
void __fastcall TREM_DMDocOtprPost::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DOTPRPOST->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DOTPRPOST->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	} 
}
//---------------------------------------------------------------------------
...
void __fastcall TREM_DMDocOtprPost::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocOtprPost::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
...
void __fastcall TREM_DMDocOtprPost::DocTNAME_REM_CQUERYGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
Text=DocTNUM_REM_CQUERY->AsString+" от "+DocTPOS_REM_CQUERY->AsString+
...
void __fastcall TREM_DMDocOtprPost::DocTNAME_REM_ZGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
Text=DocTPREFIKS_NUM_REM_Z->AsString+DocTNUM_REM_Z->AsString+
			" от "+DocTPOS_REM_Z->AsString+
...
void __fastcall TREM_DMDocOtprPost::DocTKOL_REM_DOTPRPOSTTChange(TField *Sender)
{
if (IsmSum==true)
		{
OldSummaStr=DocTSUM_REM_DOTPRPOSTT->AsFloat;

DocTSUM_REM_DOTPRPOSTT->AsFloat=NewSummaStr=DocTKOL_REM_DOTPRPOSTT->AsFloat*DocTPRICE_REM_DOTPRPOSTT->AsFloat;
DocAll->Edit();
DocAllSUM_REM_GALLDOC->AsFloat=DocAllSUM_REM_GALLDOC->AsFloat-OldSummaStr+NewSummaStr;
DocAll->Post();
...
void __fastcall TREM_DMDocOtprPost::DocTPRICE_REM_DOTPRPOSTTChange(TField *Sender)
