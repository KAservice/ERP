#ifndef UREM_DMDocVosvratIsSCImplH
#define UREM_DMDocVosvratIsSCImplH
#include "IREM_DMDocVosvratIsSC.h"
#include "UREM_DMDocVosvratIsSC.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocVosvratIsSCImpl)) TREM_DMDocVosvratIsSCImpl : public IREM_DMDocVosvratIsSC
{
public:
   TREM_DMDocVosvratIsSCImpl();
   ~TREM_DMDocVosvratIsSCImpl();
   TREM_DMDocVosvratIsSC * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocVosvratIsSC
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DSCRET(void);
   virtual void set_DocID_REM_DSCRET(TFIBLargeIntField * DocID_REM_DSCRET);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSCRET(void);
   virtual void set_DocIDBASE_REM_DSCRET(TFIBLargeIntField * DocIDBASE_REM_DSCRET);

   virtual TFIBWideStringField * get_DocGID_REM_DSCRET(void);
   virtual void set_DocGID_REM_DSCRET(TFIBWideStringField * DocGID_REM_DSCRET);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSCRET(void);
   virtual void set_DocIDDOC_REM_DSCRET(TFIBLargeIntField * DocIDDOC_REM_DSCRET);

   virtual TFIBWideStringField * get_DocNUMDOCSC_REM_DSCRET(void);
   virtual void set_DocNUMDOCSC_REM_DSCRET(TFIBWideStringField * DocNUMDOCSC_REM_DSCRET);

   virtual TFIBDateTimeField * get_DocPOSDOCSC_REM_DSCRET(void);
   virtual void set_DocPOSDOCSC_REM_DSCRET(TFIBDateTimeField * DocPOSDOCSC_REM_DSCRET);

   virtual TFIBWideStringField * get_DocPRIM_REM_DSCRET(void);
   virtual void set_DocPRIM_REM_DSCRET(TFIBWideStringField * DocPRIM_REM_DSCRET);

   virtual TFIBLargeIntField * get_DocTID_REM_DSCRETT(void);
   virtual void set_DocTID_REM_DSCRETT(TFIBLargeIntField * DocTID_REM_DSCRETT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSCRETT(void);
   virtual void set_DocTIDBASE_REM_DSCRETT(TFIBLargeIntField * DocTIDBASE_REM_DSCRETT);

   virtual TFIBWideStringField * get_DocTGID_REM_DSCRETT(void);
   virtual void set_DocTGID_REM_DSCRETT(TFIBWideStringField * DocTGID_REM_DSCRETT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSCRETT(void);
   virtual void set_DocTIDDOC_REM_DSCRETT(TFIBLargeIntField * DocTIDDOC_REM_DSCRETT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DSCRETT(void);
   virtual void set_DocTIDZ_REM_DSCRETT(TFIBLargeIntField * DocTIDZ_REM_DSCRETT);

   virtual TFIBBCDField * get_DocTKOL_REM_DSCRETT(void);
   virtual void set_DocTKOL_REM_DSCRETT(TFIBBCDField * DocTKOL_REM_DSCRETT);
...
#define CLSID_TREM_DMDocVosvratIsSCImpl __uuidof(TREM_DMDocVosvratIsSCImpl)
#endif
