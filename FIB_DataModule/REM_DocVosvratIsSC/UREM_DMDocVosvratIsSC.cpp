...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocVosvratIsSC::TREM_DMDocVosvratIsSC(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocVosvratIsSC::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocVosvratIsSC::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocVosvratIsSC::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocVosvratIsSC::NewDoc(void)
{
bool result=false;
try
	{
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("VOSVISSC");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="VOSVISSC";
...
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratIsSC::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TREM_DMDocVosvratIsSC::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocVosvratIsSC::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratIsSC::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratIsSC::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocVosvratIsSC::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocVosvratIsSC::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocVosvratIsSC::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DSCRET->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DSCRET->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocVosvratIsSC::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DSCRETT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DSCRETT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocVosvratIsSC::DocTCalcFields(TDataSet *DataSet)
{
...
void __fastcall TREM_DMDocVosvratIsSC::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocVosvratIsSC::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
