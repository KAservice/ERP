...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocSetServHW::TREM_DMDocSetServHW(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocSetServHW::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocSetServHW::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocSetServHW::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocSetServHW::NewDoc(void)
{
bool result=false;
...
try
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("SETSERVHW");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="SETSERVHW";
...
//---------------------------------------------------------------------------
bool TREM_DMDocSetServHW::OpenDoc(__int64 id)
{
bool result=false;
try
	{
...
//-----------------------------------------------------------------------------
void TREM_DMDocSetServHW::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocSetServHW::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocSetServHW::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocSetServHW::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocSetServHW::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocSetServHW::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocSetServHW::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DSETSERVHW->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DSETSERVHW->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocSetServHW::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DSETSERVHWT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DSETSERVHWT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocSetServHW::DocTCalcFields(TDataSet *DataSet)
{
...
void __fastcall TREM_DMDocSetServHW::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocSetServHW::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
