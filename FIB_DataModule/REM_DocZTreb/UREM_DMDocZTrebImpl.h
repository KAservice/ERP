#ifndef UREM_DMDocZTrebImplH
#define UREM_DMDocZTrebImplH
#include "IREM_DMDocZTreb.h"
#include "UREM_DMDocZTreb.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocZTrebImpl)) TREM_DMDocZTrebImpl : public IREM_DMDocZTreb
{
public:
   TREM_DMDocZTrebImpl();
   ~TREM_DMDocZTrebImpl();
   TREM_DMDocZTreb * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocZTreb
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DZTREB(void);
   virtual void set_DocID_REM_DZTREB(TFIBLargeIntField * DocID_REM_DZTREB);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZTREB(void);
   virtual void set_DocIDBASE_REM_DZTREB(TFIBLargeIntField * DocIDBASE_REM_DZTREB);

   virtual TFIBWideStringField * get_DocGID_REM_DZTREB(void);
   virtual void set_DocGID_REM_DZTREB(TFIBWideStringField * DocGID_REM_DZTREB);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZTREB(void);
   virtual void set_DocIDDOC_REM_DZTREB(TFIBLargeIntField * DocIDDOC_REM_DZTREB);

   virtual TFIBLargeIntField * get_DocIDZ_REM_DZTREB(void);
   virtual void set_DocIDZ_REM_DZTREB(TFIBLargeIntField * DocIDZ_REM_DZTREB);

   virtual TFIBWideStringField * get_DocPRIM_REM_DZTREB(void);
   virtual void set_DocPRIM_REM_DZTREB(TFIBWideStringField * DocPRIM_REM_DZTREB);
   ...
   virtual TFIBLargeIntField * get_DocTID_REM_DZTREBT(void);
   virtual void set_DocTID_REM_DZTREBT(TFIBLargeIntField * DocTID_REM_DZTREBT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZTREBT(void);
   virtual void set_DocTIDBASE_REM_DZTREBT(TFIBLargeIntField * DocTIDBASE_REM_DZTREBT);

   virtual TFIBWideStringField * get_DocTGID_REM_DZTREBT(void);
   virtual void set_DocTGID_REM_DZTREBT(TFIBWideStringField * DocTGID_REM_DZTREBT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZTREBT(void);
   virtual void set_DocTIDDOC_REM_DZTREBT(TFIBLargeIntField * DocTIDDOC_REM_DZTREBT);

   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DZTREBT(void);
   virtual void set_DocTIDNOM_REM_DZTREBT(TFIBLargeIntField * DocTIDNOM_REM_DZTREBT);

   virtual TFIBLargeIntField * get_DocTIDED_REM_DZTREBT(void);
   virtual void set_DocTIDED_REM_DZTREBT(TFIBLargeIntField * DocTIDED_REM_DZTREBT);

   virtual TFIBBCDField * get_DocTKOL_REM_DZTREBT(void);
   virtual void set_DocTKOL_REM_DZTREBT(TFIBBCDField * DocTKOL_REM_DZTREBT);

   virtual TFIBBCDField * get_DocTKF_REM_DZTREBT(void);
   virtual void set_DocTKF_REM_DZTREBT(TFIBBCDField * DocTKF_REM_DZTREBT);

   virtual TFIBBCDField * get_DocTPRICE_REM_DZTREBT(void);
   virtual void set_DocTPRICE_REM_DZTREBT(TFIBBCDField * DocTPRICE_REM_DZTREBT);

   virtual TFIBBCDField * get_DocTSUM_REM_DZTREBT(void);
   virtual void set_DocTSUM_REM_DZTREBT(TFIBBCDField * DocTSUM_REM_DZTREBT);

   virtual TFIBSmallIntField * get_DocTDVREG_REM_DZTREBT(void);
   virtual void set_DocTDVREG_REM_DZTREBT(TFIBSmallIntField * DocTDVREG_REM_DZTREBT);

   virtual TFIBWideStringField * get_DocTSTR_NAMENOM_REM_DZTREBT(void);
   virtual void set_DocTSTR_NAMENOM_REM_DZTREBT(TFIBWideStringField * DocTSTR_NAMENOM_REM_DZTREBT);
...
#define CLSID_TREM_DMDocZTrebImpl __uuidof(TREM_DMDocZTrebImpl)
#endif
