...
#ifndef UDMDocRegAdvCustH
#define UDMDocRegAdvCustH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TDMDocRegAdvCust : public TDataModule
{
__published:	// IDE-managed Components
	...
	TFIBSmallIntField *DocTTDV_DRG_ADVCUSTT;
	TFIBSmallIntField *DocTOPER_DRG_ADVCUSTT;
	TFIBBCDField *DocTSUM_DRG_ADVCUSTT;
	...
	TFIBLargeIntField *DocID_DRG_ADVCUST;
	TFIBLargeIntField *DocIDDOC_DRG_ADVCUST;
	TFIBWideStringField *DocDESCR_DRG_ADVCUST;
	TFIBLargeIntField *DocIDBASE_DRG_ADVCUST;
	TFIBLargeIntField *DocTID_DRG_ADVCUSTT;
	TFIBLargeIntField *DocTIDDOC_DRG_ADVCUSTT;
	TFIBLargeIntField *DocTIDFIRM_DRG_ADVCUSTT;
	TFIBLargeIntField *DocTIDKLIENT_DRG_ADVCUSTT;
	TFIBLargeIntField *DocTIDBASE_DRG_ADVCUSTT;
...
public:		// User declarations
        __fastcall TDMDocRegAdvCust(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TDMDocRegAdvCust *DMDocRegAdvCust;
//---------------------------------------------------------------------------
#endif
