...
#pragma resource "*.dfm"
//---------------------------------------------------------------------------
__fastcall TDMGurDocPrihNakl::TDMGurDocPrihNakl(TComponent* Owner)
        : TDataModule(Owner)
{
...
//---------------------------------------------------------------------------
bool TDMGurDocPrihNakl::Init(void)
{
bool result=false;
...
//--------------------------------------------------------------------------
int TDMGurDocPrihNakl::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TDMGurDocPrihNakl::DataModuleDestroy(TObject *Sender)
{
Table->Active=false;
...
//---------------------------------------------------------------------------
void TDMGurDocPrihNakl::OpenTable()
{
Table->Active=false;
...
//---------------------------------------------------------------------------
void TDMGurDocPrihNakl::UpdateTable(void)
{
