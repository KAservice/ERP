#ifndef UDMSprDepartmentImplH
#define UDMSprDepartmentImplH
#include "UDMSprDepartment.h"
#include "UGlobalConstant.h"
#include "IkasDMSpr.h"
#include "IkasDMDataSet.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMSprDepartmentImpl)) TDMSprDepartmentImpl : public IkasDMSpr, IkasDMDataSet
{
public:
   TDMSprDepartmentImpl();
   ~TDMSprDepartmentImpl();
   TDMSprDepartment * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TDMSprDepartmentImpl __uuidof(TDMSprDepartmentImpl)
#endif
