...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocVidachaHW::TREM_DMDocVidachaHW(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocVidachaHW::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocVidachaHW::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocVidachaHW::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocVidachaHW::NewDoc(void)
{
bool result=false;
...
try
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REM_VIDACHA_HW");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REM_VIDACHA_HW";
...
//---------------------------------------------------------------------------
bool TREM_DMDocVidachaHW::OpenDoc(__int64 id)
{
bool result=false;
try
	{
...
//-----------------------------------------------------------------------------
void TREM_DMDocVidachaHW::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocVidachaHW::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocVidachaHW::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocVidachaHW::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocVidachaHW::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocVidachaHW::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocVidachaHW::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DVIDACHA_HW->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DVIDACHA_HW->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocVidachaHW::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DVIDACHA_HWT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DVIDACHA_HWT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocVidachaHW::DocTCalcFields(TDataSet *DataSet)
{
...
void __fastcall TREM_DMDocVidachaHW::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocVidachaHW::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
