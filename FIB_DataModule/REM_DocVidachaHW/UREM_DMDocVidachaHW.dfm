object REM_DMDocVidachaHW: TREM_DMDocVidachaHW
  ...
  object Doc: TpFIBDataSet
    CachedUpdates = True
    UpdateSQL.Strings = (
      'UPDATE REM_DVIDACHA_HW'
      'SET '
      '    IDBASE_REM_DVIDACHA_HW = :IDBASE_REM_DVIDACHA_HW,'
      '    GID_REM_DVIDACHA_HW = :GID_REM_DVIDACHA_HW,'
      '    IDDOC_REM_DVIDACHA_HW = :IDDOC_REM_DVIDACHA_HW,'
      '    KLIENT_NAME_REM_DVIDACHA_HW = :KLIENT_NAME_REM_DVIDACHA_HW,'
      '    KLIENT_ADR_REM_DVIDACHA_HW = :KLIENT_ADR_REM_DVIDACHA_HW,'
      
        '    KLIENT_PHONE_REM_DVIDACHA_HW = :KLIENT_PHONE_REM_DVIDACHA_HW' +
        ','
      
        '    KLIENT_PASSPORT_REM_DVIDACHA_HW = :KLIENT_PASSPORT_REM_DVIDA' +
        'CHA_HW,'
      '    PRIM_REM_DVIDACHA_HW = :PRIM_REM_DVIDACHA_HW,'
      '    IDZ_REM_DVIDACHA_HW = :IDZ_REM_DVIDACHA_HW,'
      '    IDHW_REM_DVIDACHA_HW = :IDHW_REM_DVIDACHA_HW,'
      '    IDKKT_REM_DVIDACHA_HW = :IDKKT_REM_DVIDACHA_HW'
      'WHERE'
      '    ID_REM_DVIDACHA_HW = :OLD_ID_REM_DVIDACHA_HW'
      '    ')
    DeleteSQL.Strings = (
      'DELETE FROM'
      '    REM_DVIDACHA_HW'
      ...
      '    ')
    InsertSQL.Strings = (
      'INSERT INTO REM_DVIDACHA_HW('
      '    ID_REM_DVIDACHA_HW,'
      '    IDBASE_REM_DVIDACHA_HW,'
      '    GID_REM_DVIDACHA_HW,'
      '    IDDOC_REM_DVIDACHA_HW,'
      '    KLIENT_NAME_REM_DVIDACHA_HW,'
      '    KLIENT_ADR_REM_DVIDACHA_HW,'
      '    KLIENT_PHONE_REM_DVIDACHA_HW,'
      '    KLIENT_PASSPORT_REM_DVIDACHA_HW,'
      '    PRIM_REM_DVIDACHA_HW,'
      '    IDZ_REM_DVIDACHA_HW,'
      '    IDHW_REM_DVIDACHA_HW,'
      '    IDKKT_REM_DVIDACHA_HW'
      ')'
      'VALUES('
      '    :ID_REM_DVIDACHA_HW,'
      '    :IDBASE_REM_DVIDACHA_HW,'
    ...
    RefreshSQL.Strings = (
      ...
      'from  rem_dvidacha_hw'
        ...
        'left outer join rem_z on rem_z.id_rem_z=rem_dvidacha_hw.idz_rem_' +
        'dvidacha_hw'
      'where(  rem_dvidacha_hw.iddoc_rem_dvidacha_hw=:PARAM_IDDOC'
      
        '     ) and (     REM_DVIDACHA_HW.ID_REM_DVIDACHA_HW = :OLD_ID_RE' +
        'M_DVIDACHA_HW'
      '     )'
      '    '
      '')
    SelectSQL.Strings = (
      ...
      'where rem_dvidacha_hw.iddoc_rem_dvidacha_hw=:PARAM_IDDOC'
      '')
    AutoUpdateOptions.UpdateTableName = 'REM_DVIDACHA_HW'
    AutoUpdateOptions.KeyFields = 'ID_REM_DVIDACHA_HW'
    AutoUpdateOptions.GeneratorName = 'GEN_REM_DVIDACHA_HW_ID'
    AutoUpdateOptions.WhenGetGenID = wgOnNewRecord
    ...
    Top = 64
    poUseLargeIntField = True
    object DocID_REM_DVIDACHA_HW: TFIBLargeIntField
      FieldName = 'ID_REM_DVIDACHA_HW'
    end
    object DocIDBASE_REM_DVIDACHA_HW: TFIBLargeIntField
      FieldName = 'IDBASE_REM_DVIDACHA_HW'
    end
    object DocGID_REM_DVIDACHA_HW: TFIBWideStringField
      FieldName = 'GID_REM_DVIDACHA_HW'
      Size = 10
    end
    object DocIDDOC_REM_DVIDACHA_HW: TFIBLargeIntField
      FieldName = 'IDDOC_REM_DVIDACHA_HW'
    end
    object DocKLIENT_NAME_REM_DVIDACHA_HW: TFIBWideStringField
      FieldName = 'KLIENT_NAME_REM_DVIDACHA_HW'
      Size = 200
    end
    object DocKLIENT_ADR_REM_DVIDACHA_HW: TFIBWideStringField
      FieldName = 'KLIENT_ADR_REM_DVIDACHA_HW'
      Size = 200
    end
    object DocKLIENT_PHONE_REM_DVIDACHA_HW: TFIBWideStringField
      FieldName = 'KLIENT_PHONE_REM_DVIDACHA_HW'
      Size = 200
    end
    object DocKLIENT_PASSPORT_REM_DVIDACHA_HW: TFIBWideStringField
      FieldName = 'KLIENT_PASSPORT_REM_DVIDACHA_HW'
      Size = 200
    end
    object DocPRIM_REM_DVIDACHA_HW: TFIBWideStringField
      FieldName = 'PRIM_REM_DVIDACHA_HW'
      Size = 100
    end
    object DocIDZ_REM_DVIDACHA_HW: TFIBLargeIntField
      FieldName = 'IDZ_REM_DVIDACHA_HW'
    end
    object DocIDHW_REM_DVIDACHA_HW: TFIBLargeIntField
      FieldName = 'IDHW_REM_DVIDACHA_HW'
    end
    object DocIDKKT_REM_DVIDACHA_HW: TFIBLargeIntField
      FieldName = 'IDKKT_REM_DVIDACHA_HW'
    end
  ...
  object DocT: TpFIBDataSet
    CachedUpdates = True
    UpdateSQL.Strings = (
      'UPDATE REM_DVIDACHA_HWT'
      'SET '
      '    IDBASE_REM_DVIDACHA_HWT = :IDBASE_REM_DVIDACHA_HWT,'
      '    GID_REM_DVIDACHA_HWT = :GID_REM_DVIDACHA_HWT,'
      '    IDDOC_REM_DVIDACHA_HWT = :IDDOC_REM_DVIDACHA_HWT,'
      '    IDHW_REM_DVIDACHA_HWT = :IDHW_REM_DVIDACHA_HWT,'
      '    KF_REM_DVIDACHA_HWT = :KF_REM_DVIDACHA_HWT,'
      '    KOL_REM_DVIDACHA_HWT = :KOL_REM_DVIDACHA_HWT,'
      '    POVREGD_REM_DVIDACHA_HWT = :POVREGD_REM_DVIDACHA_HWT'
      'WHERE'
      '    ID_REM_DVIDACHA_HWT = :OLD_ID_REM_DVIDACHA_HWT'
      '    ')
    DeleteSQL.Strings = (
      'DELETE FROM'
      '    REM_DVIDACHA_HWT'
      ...
      '    ')
    InsertSQL.Strings = (
      'INSERT INTO REM_DVIDACHA_HWT('
      '    ID_REM_DVIDACHA_HWT,'
      '    IDBASE_REM_DVIDACHA_HWT,'
      '    GID_REM_DVIDACHA_HWT,'
      '    IDDOC_REM_DVIDACHA_HWT,'
      '    IDHW_REM_DVIDACHA_HWT,'
      '    KF_REM_DVIDACHA_HWT,'
      '    KOL_REM_DVIDACHA_HWT,'
      '    POVREGD_REM_DVIDACHA_HWT'
      ')'
      'VALUES('
      '    :ID_REM_DVIDACHA_HWT,'
      '    :IDBASE_REM_DVIDACHA_HWT,'
    ...
    RefreshSQL.Strings = (
      ...
      '        rem_sprmodel.code_rem_sprmodel,'
      '        rem_sprmodel.name_rem_sprmodel'
      'from  rem_dvidacha_hwt'
      
        'left outer join rem_shardware on rem_shardware.id_rem_shardware=' +
        'rem_dvidacha_hwt.idhw_rem_dvidacha_hwt'
        ...
        '_shardware.idprmodel_rem_shardware'
      ''
      'where(  rem_dvidacha_hwt.iddoc_rem_dvidacha_hwt=:PARAM_IDDOC'
      
        '     ) and (     REM_DVIDACHA_HWT.ID_REM_DVIDACHA_HWT = :OLD_ID_' +
        'REM_DVIDACHA_HWT'
      '     )'
      '    ')
    SelectSQL.Strings = (
      ...
      ''
      'where rem_dvidacha_hwt.iddoc_rem_dvidacha_hwt=:PARAM_IDDOC')
    AutoUpdateOptions.UpdateTableName = 'REM_DVIDACHA_HWT'
    AutoUpdateOptions.KeyFields = 'ID_REM_DVIDACHA_HWT'
    AutoUpdateOptions.GeneratorName = 'GEN_REM_DVIDACHA_HWT_ID'
    AutoUpdateOptions.WhenGetGenID = wgOnNewRecord
    ...
    object DocTID_REM_DVIDACHA_HWT: TFIBLargeIntField
      FieldName = 'ID_REM_DVIDACHA_HWT'
    end
    object DocTIDBASE_REM_DVIDACHA_HWT: TFIBLargeIntField
      FieldName = 'IDBASE_REM_DVIDACHA_HWT'
    end
    object DocTGID_REM_DVIDACHA_HWT: TFIBWideStringField
      FieldName = 'GID_REM_DVIDACHA_HWT'
      Size = 10
    end
    object DocTIDDOC_REM_DVIDACHA_HWT: TFIBLargeIntField
      FieldName = 'IDDOC_REM_DVIDACHA_HWT'
    end
    object DocTIDHW_REM_DVIDACHA_HWT: TFIBLargeIntField
      FieldName = 'IDHW_REM_DVIDACHA_HWT'
    end
    object DocTKF_REM_DVIDACHA_HWT: TFIBBCDField
      FieldName = 'KF_REM_DVIDACHA_HWT'
      Size = 3
      RoundByScale = True
    end
    object DocTKOL_REM_DVIDACHA_HWT: TFIBBCDField
      FieldName = 'KOL_REM_DVIDACHA_HWT'
      Size = 3
      RoundByScale = True
    end
    object DocTPOVREGD_REM_DVIDACHA_HWT: TFIBWideStringField
      FieldName = 'POVREGD_REM_DVIDACHA_HWT'
      Size = 200
    end
  ...
  object NumDoc: TpFIBDataSet
    SelectSQL.Strings = (
      'select max(NUM_REM_GALLDOC) AS MAXNUMBER from  REM_GALLDOC'
        ...
        'where TDOC_REM_GALLDOC='#39'REM_VIDACHA_HW'#39' and POS_REM_GALLDOC > :P' +
        'ARAM_POS')
    Transaction = IBTr
    Left = 296
    Top = 16
  ...
  object QueryCancelDvReg: TpFIBQuery
    ...
    SQL.Strings = (
        ...
        'EXECUTE PROCEDURE REM_DOC_VIDACHA_HW_CANCEL_DVREG(:PARAM_IDDOC,0' +
        ',0,0)')
    Left = 96
    Top = 304
    qoStartTransaction = True
  ...
  object QueryDvReg: TpFIBQuery
    Transaction = IBTrDvReg
    SQL.Strings = (
      'EXECUTE PROCEDURE REM_DOC_VIDACHA_HW_DVREG (:PARAM_IDDOC,0,0,0)')
    Left = 96
    Top = 240
    qoStartTransaction = True
  end
