#ifndef UDMSprDiscountCard_1ImplH
#define UDMSprDiscountCard_1ImplH
#include "IDMSprDiscountCard_1.h"
#include "UDMSprDiscountCard_1.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMSprDiscountCard_1Impl)) TDMSprDiscountCard_1Impl : public IDMSprDiscountCard_1
{
public:
   TDMSprDiscountCard_1Impl();
   ~TDMSprDiscountCard_1Impl();
   TDMSprDiscountCard_1 * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMSprDiscountCard_1
   ...
   virtual __int64 GetIdGrpKlient(__int64 id_discount_card);
...
#define CLSID_TDMSprDiscountCard_1Impl __uuidof(TDMSprDiscountCard_1Impl)
#endif
