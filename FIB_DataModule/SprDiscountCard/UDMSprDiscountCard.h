...
#ifndef UDMSprDiscountCardH
#define UDMSprDiscountCardH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TDMSprDiscountCard : public TDataModule
{
...
public:		// User declarations
		__fastcall TDMSprDiscountCard(TComponent* Owner);
	...
	GUID ClsIdImpl;				 //GUID класса реализации
		...
		void OpenTable(__int64 id_klient);
...
//---------------------------------------------------------------------------
extern PACKAGE TDMSprDiscountCard *DMSprDiscountCard;
//---------------------------------------------------------------------------
#endif
