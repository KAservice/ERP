#ifndef UREM_DMDocKM1ImplH
#define UREM_DMDocKM1ImplH
#include "IREM_DMDocKM1.h"
#include "UREM_DMDocKM1.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocKM1Impl)) TREM_DMDocKM1Impl : public IREM_DMDocKM1
{
public:
   TREM_DMDocKM1Impl();
   ~TREM_DMDocKM1Impl();
   TREM_DMDocKM1 * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocKM1
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DKM1(void);
   virtual void set_DocID_REM_DKM1(TFIBLargeIntField * DocID_REM_DKM1);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DKM1(void);
   virtual void set_DocIDBASE_REM_DKM1(TFIBLargeIntField * DocIDBASE_REM_DKM1);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DKM1(void);
   virtual void set_DocIDDOC_REM_DKM1(TFIBLargeIntField * DocIDDOC_REM_DKM1);

   virtual TFIBLargeIntField * get_DocIDKKT_REM_DKM1(void);
   virtual void set_DocIDKKT_REM_DKM1(TFIBLargeIntField * DocIDKKT_REM_DKM1);

   virtual TFIBWideStringField * get_DocPRIM_REM_DKM1(void);
   virtual void set_DocPRIM_REM_DKM1(TFIBWideStringField * DocPRIM_REM_DKM1);

   virtual TFIBBCDField * get_DocNI_REM_DKM1(void);
   virtual void set_DocNI_REM_DKM1(TFIBBCDField * DocNI_REM_DKM1);
   ...
   virtual TFIBLargeIntField * get_DocTID_REM_DKM1T(void);
   virtual void set_DocTID_REM_DKM1T(TFIBLargeIntField * DocTID_REM_DKM1T);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DKM1T(void);
   virtual void set_DocTIDBASE_REM_DKM1T(TFIBLargeIntField * DocTIDBASE_REM_DKM1T);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DKM1T(void);
   virtual void set_DocTIDDOC_REM_DKM1T(TFIBLargeIntField * DocTIDDOC_REM_DKM1T);

   virtual TFIBWideStringField * get_DocTNAMECOUNTER_REM_DKM1T(void);
   virtual void set_DocTNAMECOUNTER_REM_DKM1T(TFIBWideStringField * DocTNAMECOUNTER_REM_DKM1T);

   virtual TFIBBCDField * get_DocTBEFORE_REM_DKM1T(void);
   virtual void set_DocTBEFORE_REM_DKM1T(TFIBBCDField * DocTBEFORE_REM_DKM1T);

   virtual TFIBBCDField * get_DocTAFTER_REM_DKM1T(void);
   virtual void set_DocTAFTER_REM_DKM1T(TFIBBCDField * DocTAFTER_REM_DKM1T);
...
#define CLSID_TREM_DMDocKM1Impl __uuidof(TREM_DMDocKM1Impl)
#endif
