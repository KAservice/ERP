...
#ifndef UREM_DMDocKM1H
#define UREM_DMDocKM1H
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_DMDocKM1 : public TDataModule
{
__published:	// IDE-managed Components
	...
	TFIBLargeIntField *DocID_REM_DKM1;
	TFIBLargeIntField *DocIDBASE_REM_DKM1;
	TFIBLargeIntField *DocIDDOC_REM_DKM1;
	TFIBLargeIntField *DocIDKKT_REM_DKM1;
	TFIBWideStringField *DocPRIM_REM_DKM1;
	TFIBBCDField *DocNI_REM_DKM1;
	TFIBWideStringField *DocNAME_REM_SKKT;
	TFIBLargeIntField *DocTID_REM_DKM1T;
	TFIBLargeIntField *DocTIDBASE_REM_DKM1T;
	TFIBLargeIntField *DocTIDDOC_REM_DKM1T;
	TFIBWideStringField *DocTNAMECOUNTER_REM_DKM1T;
	TFIBBCDField *DocTBEFORE_REM_DKM1T;
	TFIBBCDField *DocTAFTER_REM_DKM1T;
...
public:		// User declarations
		__fastcall TREM_DMDocKM1(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_DMDocKM1 *REM_DMDocKM1;
//---------------------------------------------------------------------------
#endif
