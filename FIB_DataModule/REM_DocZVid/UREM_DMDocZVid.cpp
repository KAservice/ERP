...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocZVid::TREM_DMDocZVid(TComponent* Owner)
        : TDataModule(Owner)
{
...
//---------------------------------------------------------------------------
int TREM_DMDocZVid::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocZVid::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocZVid::NewDoc(void)
{
bool result=false;
try
	{
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REMZVID");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REMZVID";
...
//---------------------------------------------------------------------------
bool TREM_DMDocZVid::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TREM_DMDocZVid::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocZVid::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocZVid::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocZVid::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocZVid::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocZVid::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocZVid::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DZVID->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DZVID->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocZVid::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DZVIDT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DZVIDT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocZVid::DocTCalcFields(TDataSet *DataSet)
{
...
void __fastcall TREM_DMDocZVid::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocZVid::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
