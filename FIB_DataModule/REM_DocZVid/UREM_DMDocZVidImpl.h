#ifndef UREM_DMDocZVidImplH
#define UREM_DMDocZVidImplH
#include "IREM_DMDocZVid.h"
#include "UREM_DMDocZVid.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocZVidImpl)) TREM_DMDocZVidImpl : public IREM_DMDocZVid
{
public:
   TREM_DMDocZVidImpl();
   ~TREM_DMDocZVidImpl();
   TREM_DMDocZVid * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocZVid
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DZVID(void);
   virtual void set_DocID_REM_DZVID(TFIBLargeIntField * DocID_REM_DZVID);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DZVID(void);
   virtual void set_DocIDBASE_REM_DZVID(TFIBLargeIntField * DocIDBASE_REM_DZVID);

   virtual TFIBWideStringField * get_DocGID_REM_DZVID(void);
   virtual void set_DocGID_REM_DZVID(TFIBWideStringField * DocGID_REM_DZVID);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DZVID(void);
   virtual void set_DocIDDOC_REM_DZVID(TFIBLargeIntField * DocIDDOC_REM_DZVID);

   virtual TFIBWideStringField * get_DocPRIM_REM_DZVID(void);
   virtual void set_DocPRIM_REM_DZVID(TFIBWideStringField * DocPRIM_REM_DZVID);

   virtual TFIBLargeIntField * get_DocTID_REM_DZVIDT(void);
   virtual void set_DocTID_REM_DZVIDT(TFIBLargeIntField * DocTID_REM_DZVIDT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DZVIDT(void);
   virtual void set_DocTIDBASE_REM_DZVIDT(TFIBLargeIntField * DocTIDBASE_REM_DZVIDT);

   virtual TFIBWideStringField * get_DocTGID_REM_DZVIDT(void);
   virtual void set_DocTGID_REM_DZVIDT(TFIBWideStringField * DocTGID_REM_DZVIDT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DZVIDT(void);
   virtual void set_DocTIDDOC_REM_DZVIDT(TFIBLargeIntField * DocTIDDOC_REM_DZVIDT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DZVIDT(void);
   virtual void set_DocTIDZ_REM_DZVIDT(TFIBLargeIntField * DocTIDZ_REM_DZVIDT);

   virtual TFIBBCDField * get_DocTKOL_REM_DZVIDT(void);
   virtual void set_DocTKOL_REM_DZVIDT(TFIBBCDField * DocTKOL_REM_DZVIDT);
...
#define CLSID_TREM_DMDocZVidImpl __uuidof(TREM_DMDocZVidImpl)
#endif
