...
#ifndef UREM_DMDocPostOtDileraH
#define UREM_DMDocPostOtDileraH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TREM_DMDocPostOtDilera : public TDataModule
{
__published:	// IDE-managed Components
	...
	TFIBLargeIntField *DocID_REM_DDILPOST;
	TFIBLargeIntField *DocIDBASE_REM_DDILPOST;
	TFIBWideStringField *DocGID_REM_DDILPOST;
	TFIBLargeIntField *DocIDDOC_REM_DDILPOST;
	TFIBWideStringField *DocNUMDOCDIL_REM_DDILPOST;
	TFIBDateTimeField *DocPOSDOCDIL_REM_DDILPOST;
	TFIBWideStringField *DocPRIM_REM_DDILPOST;
	TFIBLargeIntField *DocTID_REM_DDILPOSTT;
	TFIBLargeIntField *DocTIDBASE_REM_DDILPOSTT;
	TFIBWideStringField *DocTGID_REM_DDILPOSTT;
	TFIBLargeIntField *DocTIDDOC_REM_DDILPOSTT;
	TFIBLargeIntField *DocTIDZ_REM_DDILPOSTT;
	TFIBBCDField *DocTKOL_REM_DDILPOSTT;
...
public:		// User declarations
		__fastcall TREM_DMDocPostOtDilera(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TREM_DMDocPostOtDilera *REM_DMDocPostOtDilera;
//---------------------------------------------------------------------------
#endif
