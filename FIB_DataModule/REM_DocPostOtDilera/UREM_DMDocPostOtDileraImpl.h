#ifndef UREM_DMDocPostOtDileraImplH
#define UREM_DMDocPostOtDileraImplH
#include "IREM_DMDocPostOtDilera.h"
#include "UREM_DMDocPostOtDilera.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocPostOtDileraImpl)) TREM_DMDocPostOtDileraImpl : public IREM_DMDocPostOtDilera
{
public:
   TREM_DMDocPostOtDileraImpl();
   ~TREM_DMDocPostOtDileraImpl();
   TREM_DMDocPostOtDilera * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocPostOtDilera
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DDILPOST(void);
   virtual void set_DocID_REM_DDILPOST(TFIBLargeIntField * DocID_REM_DDILPOST);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DDILPOST(void);
   virtual void set_DocIDBASE_REM_DDILPOST(TFIBLargeIntField * DocIDBASE_REM_DDILPOST);

   virtual TFIBWideStringField * get_DocGID_REM_DDILPOST(void);
   virtual void set_DocGID_REM_DDILPOST(TFIBWideStringField * DocGID_REM_DDILPOST);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DDILPOST(void);
   virtual void set_DocIDDOC_REM_DDILPOST(TFIBLargeIntField * DocIDDOC_REM_DDILPOST);

   virtual TFIBWideStringField * get_DocNUMDOCDIL_REM_DDILPOST(void);
   virtual void set_DocNUMDOCDIL_REM_DDILPOST(TFIBWideStringField * DocNUMDOCDIL_REM_DDILPOST);

   virtual TFIBDateTimeField * get_DocPOSDOCDIL_REM_DDILPOST(void);
   virtual void set_DocPOSDOCDIL_REM_DDILPOST(TFIBDateTimeField * DocPOSDOCDIL_REM_DDILPOST);

   virtual TFIBWideStringField * get_DocPRIM_REM_DDILPOST(void);
   virtual void set_DocPRIM_REM_DDILPOST(TFIBWideStringField * DocPRIM_REM_DDILPOST);

   virtual TFIBLargeIntField * get_DocTID_REM_DDILPOSTT(void);
   virtual void set_DocTID_REM_DDILPOSTT(TFIBLargeIntField * DocTID_REM_DDILPOSTT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DDILPOSTT(void);
   virtual void set_DocTIDBASE_REM_DDILPOSTT(TFIBLargeIntField * DocTIDBASE_REM_DDILPOSTT);

   virtual TFIBWideStringField * get_DocTGID_REM_DDILPOSTT(void);
   virtual void set_DocTGID_REM_DDILPOSTT(TFIBWideStringField * DocTGID_REM_DDILPOSTT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DDILPOSTT(void);
   virtual void set_DocTIDDOC_REM_DDILPOSTT(TFIBLargeIntField * DocTIDDOC_REM_DDILPOSTT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DDILPOSTT(void);
   virtual void set_DocTIDZ_REM_DDILPOSTT(TFIBLargeIntField * DocTIDZ_REM_DDILPOSTT);

   virtual TFIBBCDField * get_DocTKOL_REM_DDILPOSTT(void);
   virtual void set_DocTKOL_REM_DDILPOSTT(TFIBBCDField * DocTKOL_REM_DDILPOSTT);
...
#define CLSID_TREM_DMDocPostOtDileraImpl __uuidof(TREM_DMDocPostOtDileraImpl)
#endif
