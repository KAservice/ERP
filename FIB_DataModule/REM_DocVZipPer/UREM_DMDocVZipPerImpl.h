#ifndef UREM_DMDocVZipPerImplH
#define UREM_DMDocVZipPerImplH
#include "IREM_DMDocVZipPer.h"
#include "UREM_DMDocVZipPer.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocVZipPerImpl)) TREM_DMDocVZipPerImpl : public IREM_DMDocVZipPer
{
public:
   TREM_DMDocVZipPerImpl();
   ~TREM_DMDocVZipPerImpl();
   TREM_DMDocVZipPer * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocVZipPer
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DVZPER(void);
   virtual void set_DocID_REM_DVZPER(TFIBLargeIntField * DocID_REM_DVZPER);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DVZPER(void);
   virtual void set_DocIDBASE_REM_DVZPER(TFIBLargeIntField * DocIDBASE_REM_DVZPER);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DVZPER(void);
   virtual void set_DocIDDOC_REM_DVZPER(TFIBLargeIntField * DocIDDOC_REM_DVZPER);

   virtual TFIBLargeIntField * get_DocIDSKLADPOL_REM_DVZPER(void);
   virtual void set_DocIDSKLADPOL_REM_DVZPER(TFIBLargeIntField * DocIDSKLADPOL_REM_DVZPER);

   virtual TFIBWideStringField * get_DocPRIM_REM_DVZPER(void);
   virtual void set_DocPRIM_REM_DVZPER(TFIBWideStringField * DocPRIM_REM_DVZPER);

   virtual TFIBIntegerField * get_DocOPER_REM_DVZPER(void);
   virtual void set_DocOPER_REM_DVZPER(TFIBIntegerField * DocOPER_REM_DVZPER);

   virtual TFIBWideStringField * get_DocNAMESKLAD(void);
   virtual void set_DocNAMESKLAD(TFIBWideStringField * DocNAMESKLAD);

   virtual TFIBLargeIntField * get_DocTID_REM_DVZPERT(void);
   virtual void set_DocTID_REM_DVZPERT(TFIBLargeIntField * DocTID_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DVZPERT(void);
   virtual void set_DocTIDBASE_REM_DVZPERT(TFIBLargeIntField * DocTIDBASE_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DVZPERT(void);
   virtual void set_DocTIDDOC_REM_DVZPERT(TFIBLargeIntField * DocTIDDOC_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDKLIENT_REM_DVZPERT(void);
   virtual void set_DocTIDKLIENT_REM_DVZPERT(TFIBLargeIntField * DocTIDKLIENT_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDTNOM_REM_DVZPERT(void);
   virtual void set_DocTIDTNOM_REM_DVZPERT(TFIBLargeIntField * DocTIDTNOM_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DVZPERT(void);
   virtual void set_DocTIDNOM_REM_DVZPERT(TFIBLargeIntField * DocTIDNOM_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DVZPERT(void);
   virtual void set_DocTIDZ_REM_DVZPERT(TFIBLargeIntField * DocTIDZ_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDHW_REM_DVZPERT(void);
   virtual void set_DocTIDHW_REM_DVZPERT(TFIBLargeIntField * DocTIDHW_REM_DVZPERT);

   virtual TFIBBCDField * get_DocTKOL_REM_DVZPERT(void);
   virtual void set_DocTKOL_REM_DVZPERT(TFIBBCDField * DocTKOL_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDTVZIP_REM_DVZPERT(void);
   virtual void set_DocTIDTVZIP_REM_DVZPERT(TFIBLargeIntField * DocTIDTVZIP_REM_DVZPERT);
   ...
   virtual TFIBLargeIntField * get_DocTIDMHRAN_OTPR_REM_DVZPERT(void);
   virtual void set_DocTIDMHRAN_OTPR_REM_DVZPERT(TFIBLargeIntField * DocTIDMHRAN_OTPR_REM_DVZPERT);

   virtual TFIBLargeIntField * get_DocTIDMHRAN_POL_REM_DVZPERT(void);
   virtual void set_DocTIDMHRAN_POL_REM_DVZPERT(TFIBLargeIntField * DocTIDMHRAN_POL_REM_DVZPERT);
...
#define CLSID_TREM_DMDocVZipPerImpl __uuidof(TREM_DMDocVZipPerImpl)
#endif
