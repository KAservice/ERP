#ifndef UREM_DMDocRemontKKTImplH
#define UREM_DMDocRemontKKTImplH
#include "IREM_DMDocRemontKKT.h"
#include "UREM_DMDocRemontKKT.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocRemontKKTImpl)) TREM_DMDocRemontKKTImpl : public IREM_DMDocRemontKKT
{
public:
   TREM_DMDocRemontKKTImpl();
   ~TREM_DMDocRemontKKTImpl();
   TREM_DMDocRemontKKT * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocRemontKKT
   ...
   virtual TFIBBCDField * get_DocTKOL_REM_DREMONTKKTT(void);
   virtual void set_DocTKOL_REM_DREMONTKKTT(TFIBBCDField * DocTKOL_REM_DREMONTKKTT);

   virtual TFIBBCDField * get_DocTKF_REM_DREMONTKKTT(void);
   virtual void set_DocTKF_REM_DREMONTKKTT(TFIBBCDField * DocTKF_REM_DREMONTKKTT);

   virtual TFIBBCDField * get_DocTPRICE_REM_DREMONTKKTT(void);
   virtual void set_DocTPRICE_REM_DREMONTKKTT(TFIBBCDField * DocTPRICE_REM_DREMONTKKTT);

   virtual TFIBBCDField * get_DocTSUM_REM_DREMONTKKTT(void);
   virtual void set_DocTSUM_REM_DREMONTKKTT(TFIBBCDField * DocTSUM_REM_DREMONTKKTT);

   virtual TFIBBCDField * get_DocTPRICEMEX_REM_DREMONTKKTT(void);
   virtual void set_DocTPRICEMEX_REM_DREMONTKKTT(TFIBBCDField * DocTPRICEMEX_REM_DREMONTKKTT);

   virtual TFIBBCDField * get_DocTSUMMEX_REM_DREMONTKKTT(void);
   virtual void set_DocTSUMMEX_REM_DREMONTKKTT(TFIBBCDField * DocTSUMMEX_REM_DREMONTKKTT);
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DREMONTKKT(void);
   virtual void set_DocID_REM_DREMONTKKT(TFIBLargeIntField * DocID_REM_DREMONTKKT);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DREMONTKKT(void);
   virtual void set_DocIDBASE_REM_DREMONTKKT(TFIBLargeIntField * DocIDBASE_REM_DREMONTKKT);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DREMONTKKT(void);
   virtual void set_DocIDDOC_REM_DREMONTKKT(TFIBLargeIntField * DocIDDOC_REM_DREMONTKKT);

   virtual TFIBLargeIntField * get_DocIDKKT_REM_DREMONTKKT(void);
   virtual void set_DocIDKKT_REM_DREMONTKKT(TFIBLargeIntField * DocIDKKT_REM_DREMONTKKT);

   virtual TFIBLargeIntField * get_DocIDTPRICE_REM_DREMONTKKT(void);
   virtual void set_DocIDTPRICE_REM_DREMONTKKT(TFIBLargeIntField * DocIDTPRICE_REM_DREMONTKKT);

   virtual TFIBWideStringField * get_DocPRIM_REM_DREMONTKKT(void);
   virtual void set_DocPRIM_REM_DREMONTKKT(TFIBWideStringField * DocPRIM_REM_DREMONTKKT);
   ...
   virtual TFIBLargeIntField * get_DocTID_REM_DREMONTKKTT(void);
   virtual void set_DocTID_REM_DREMONTKKTT(TFIBLargeIntField * DocTID_REM_DREMONTKKTT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DREMONTKKTT(void);
   virtual void set_DocTIDBASE_REM_DREMONTKKTT(TFIBLargeIntField * DocTIDBASE_REM_DREMONTKKTT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DREMONTKKTT(void);
   virtual void set_DocTIDDOC_REM_DREMONTKKTT(TFIBLargeIntField * DocTIDDOC_REM_DREMONTKKTT);

   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DREMONTKKTT(void);
   virtual void set_DocTIDNOM_REM_DREMONTKKTT(TFIBLargeIntField * DocTIDNOM_REM_DREMONTKKTT);

   virtual TFIBLargeIntField * get_DocTIDED_REM_DREMONTKKTT(void);
   virtual void set_DocTIDED_REM_DREMONTKKTT(TFIBLargeIntField * DocTIDED_REM_DREMONTKKTT);
...
#define CLSID_TREM_DMDocRemontKKTImpl __uuidof(TREM_DMDocRemontKKTImpl)
#endif
