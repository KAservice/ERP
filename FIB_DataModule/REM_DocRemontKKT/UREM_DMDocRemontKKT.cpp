...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocRemontKKT::TREM_DMDocRemontKKT(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocRemontKKT::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocRemontKKT::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocRemontKKT::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocRemontKKT::NewDoc(void)
{
bool result=false;
...
try
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REMONTKKT");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REMONTKKT";
	...
	if (glStrToInt64(DM_Connection->UserInfoIDTPRICE_USER->AsString)!=0)
		{
		DocIDTPRICE_REM_DREMONTKKT->AsString=DM_Connection->UserInfoIDTPRICE_USER->AsString;
		}
	Doc->Post();
...
//---------------------------------------------------------------------------
bool TREM_DMDocRemontKKT::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TREM_DMDocRemontKKT::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocRemontKKT::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocRemontKKT::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocRemontKKT::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocRemontKKT::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocRemontKKT::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocRemontKKT::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DREMONTKKT->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DREMONTKKT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocRemontKKT::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DREMONTKKTT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DREMONTKKTT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocRemontKKT::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocRemontKKT::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocRemontKKT::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
...
void __fastcall TREM_DMDocRemontKKT::DocTAfterDelete(TDataSet *DataSet)
{
NewSummaStr=0;
NewSummaStr=0;
NewSummaMexStr=0;
...
void __fastcall TREM_DMDocRemontKKT::DocTBeforeDelete(TDataSet *DataSet)
{
OldSummaStr=DocTSUM_REM_DREMONTKKTT->AsFloat;
}
//---------------------------------------------------------------------------



void __fastcall TREM_DMDocRemontKKT::DocTKOL_REM_DREMONTKKTTChange(
      TField *Sender)
{
OldSummaStr=DocTSUM_REM_DREMONTKKTT->AsFloat;

DocTSUM_REM_DREMONTKKTT->AsFloat=NewSummaStr=DocTKOL_REM_DREMONTKKTT->AsFloat*
											DocTPRICE_REM_DREMONTKKTT->AsFloat;
...
void __fastcall TREM_DMDocRemontKKT::DocTPRICE_REM_DREMONTKKTTChange(
      TField *Sender)
{
OldSummaStr=DocTSUM_REM_DREMONTKKTT->AsFloat;
