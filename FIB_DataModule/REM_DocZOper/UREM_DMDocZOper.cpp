...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocZOper::TREM_DMDocZOper(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocZOper::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocZOper::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocZOper::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocZOper::NewDoc(void)
{
bool result=false;
try
	{
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REMZOPER");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REMZOPER";
	...
	if (glStrToInt64(DM_Connection->UserInfoIDTPRICE_USER->AsString)!=0)
		{
		DocIDTPRICE_REM_DZOPER->AsString=DM_Connection->UserInfoIDTPRICE_USER->AsString;
		}
	Doc->Post();
...
//---------------------------------------------------------------------------
bool TREM_DMDocZOper::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TREM_DMDocZOper::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocZOper::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocZOper::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocZOper::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocZOper::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocZOper::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocZOper::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DZOPER->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DZOPER->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocZOper::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DZOPERT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DZOPERT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocZOper::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocZOper::DocTAfterDelete(TDataSet *DataSet)
{
NewSummaStr=0;
NewSummaStr=0;
NewSummaMexStr=0;
...
void __fastcall TREM_DMDocZOper::DocTBeforeDelete(TDataSet *DataSet)
{
OldSummaStr=DocTSUM_REM_DZOPERT->AsFloat;
}
//---------------------------------------------------------------------------


void __fastcall TREM_DMDocZOper::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocZOper::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
...
void __fastcall TREM_DMDocZOper::DocTKOL_REM_DZOPERTChange(TField *Sender)
{
OldSummaStr=DocTSUM_REM_DZOPERT->AsFloat;

DocTSUM_REM_DZOPERT->AsFloat=NewSummaStr=DocTKOL_REM_DZOPERT->AsFloat*
											DocTPRICE_REM_DZOPERT->AsFloat;
...
void __fastcall TREM_DMDocZOper::DocTPRICE_REM_DZOPERTChange(TField *Sender)
{
OldSummaStr=DocTSUM_REM_DZOPERT->AsFloat;
