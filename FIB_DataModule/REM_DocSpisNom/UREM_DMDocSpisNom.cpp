...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocSpisNom::TREM_DMDocSpisNom(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocSpisNom::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocSpisNom::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocSpisNom::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocSpisNom::NewDoc(void)
{
bool result=false;
try
	{
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REMSPN");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REMSPN";
	...
	if (glStrToInt64(DM_Connection->UserInfoIDTPRICE_USER->AsString)!=0)
		{
		DocIDRTPRICE_REM_DSPN->AsString=DM_Connection->UserInfoIDTPRICE_USER->AsString;
		}
	Doc->Post();
...
//---------------------------------------------------------------------------
bool TREM_DMDocSpisNom::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TREM_DMDocSpisNom::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocSpisNom::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocSpisNom::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocSpisNom::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocSpisNom::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocSpisNom::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocSpisNom::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DSPN->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DSPN->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocSpisNom::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DSPNT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DSPNT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocSpisNom::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocSpisNom::DocTAfterDelete(TDataSet *DataSet)
{
NewRSummaStr=0;


Doc->Edit();
DocRSUM_REM_DSPN->AsFloat=DocRSUM_REM_DSPN->AsFloat-OldRSummaStr+NewRSummaStr;
Doc->Post();
}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocSpisNom::DocTBeforeDelete(TDataSet *DataSet)
{
OldRSummaStr=DocTRSUM_REM_DSPNT->AsFloat;
}
//---------------------------------------------------------------------------


void __fastcall TREM_DMDocSpisNom::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocSpisNom::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
...
void __fastcall TREM_DMDocSpisNom::DocTKOL_REM_DSPNTChange(TField *Sender)
{
OldRSummaStr=DocTRSUM_REM_DSPNT->AsFloat;

DocTRSUM_REM_DSPNT->AsFloat=NewRSummaStr=DocTKOL_REM_DSPNT->AsFloat*
											DocTRPRICE_REM_DSPNT->AsFloat;
...
void __fastcall TREM_DMDocSpisNom::DocTRPRICE_REM_DSPNTChange(TField *Sender)
{
OldRSummaStr=DocTRSUM_REM_DSPNT->AsFloat;
