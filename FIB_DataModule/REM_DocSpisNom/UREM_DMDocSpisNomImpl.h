#ifndef UREM_DMDocSpisNomImplH
#define UREM_DMDocSpisNomImplH
#include "IREM_DMDocSpisNom.h"
#include "UREM_DMDocSpisNom.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocSpisNomImpl)) TREM_DMDocSpisNomImpl : public IREM_DMDocSpisNom
{
public:
   TREM_DMDocSpisNomImpl();
   ~TREM_DMDocSpisNomImpl();
   TREM_DMDocSpisNom * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocSpisNom
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DSPN(void);
   virtual void set_DocID_REM_DSPN(TFIBLargeIntField * DocID_REM_DSPN);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSPN(void);
   virtual void set_DocIDBASE_REM_DSPN(TFIBLargeIntField * DocIDBASE_REM_DSPN);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSPN(void);
   virtual void set_DocIDDOC_REM_DSPN(TFIBLargeIntField * DocIDDOC_REM_DSPN);

   virtual TFIBWideStringField * get_DocGID_REM_DSPN(void);
   virtual void set_DocGID_REM_DSPN(TFIBWideStringField * DocGID_REM_DSPN);

   virtual TFIBLargeIntField * get_DocIDRTPRICE_REM_DSPN(void);
   virtual void set_DocIDRTPRICE_REM_DSPN(TFIBLargeIntField * DocIDRTPRICE_REM_DSPN);

   virtual TFIBBCDField * get_DocRSUM_REM_DSPN(void);
   virtual void set_DocRSUM_REM_DSPN(TFIBBCDField * DocRSUM_REM_DSPN);

   virtual TFIBWideStringField * get_DocPRIM_REM_DSPN(void);
   virtual void set_DocPRIM_REM_DSPN(TFIBWideStringField * DocPRIM_REM_DSPN);

   virtual TFIBWideStringField * get_DocNAME_TPRICE(void);
   virtual void set_DocNAME_TPRICE(TFIBWideStringField * DocNAME_TPRICE);

   virtual TFIBLargeIntField * get_DocTID_REM_DSPNT(void);
   virtual void set_DocTID_REM_DSPNT(TFIBLargeIntField * DocTID_REM_DSPNT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSPNT(void);
   virtual void set_DocTIDBASE_REM_DSPNT(TFIBLargeIntField * DocTIDBASE_REM_DSPNT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSPNT(void);
   virtual void set_DocTIDDOC_REM_DSPNT(TFIBLargeIntField * DocTIDDOC_REM_DSPNT);

   virtual TFIBWideStringField * get_DocTGID_REM_DSPNT(void);
   virtual void set_DocTGID_REM_DSPNT(TFIBWideStringField * DocTGID_REM_DSPNT);

   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DSPNT(void);
   virtual void set_DocTIDNOM_REM_DSPNT(TFIBLargeIntField * DocTIDNOM_REM_DSPNT);

   virtual TFIBLargeIntField * get_DocTIDED_REM_DSPNT(void);
   virtual void set_DocTIDED_REM_DSPNT(TFIBLargeIntField * DocTIDED_REM_DSPNT);

   virtual TFIBLargeIntField * get_DocTIDHW_REM_DSPNT(void);
   virtual void set_DocTIDHW_REM_DSPNT(TFIBLargeIntField * DocTIDHW_REM_DSPNT);

   virtual TFIBBCDField * get_DocTKOL_REM_DSPNT(void);
   virtual void set_DocTKOL_REM_DSPNT(TFIBBCDField * DocTKOL_REM_DSPNT);

   virtual TFIBBCDField * get_DocTKF_REM_DSPNT(void);
   virtual void set_DocTKF_REM_DSPNT(TFIBBCDField * DocTKF_REM_DSPNT);

   virtual TFIBBCDField * get_DocTPRICE_REM_DSPNT(void);
   virtual void set_DocTPRICE_REM_DSPNT(TFIBBCDField * DocTPRICE_REM_DSPNT);

   virtual TFIBBCDField * get_DocTSUM_REM_DSPNT(void);
   virtual void set_DocTSUM_REM_DSPNT(TFIBBCDField * DocTSUM_REM_DSPNT);

   virtual TFIBBCDField * get_DocTRPRICE_REM_DSPNT(void);
   virtual void set_DocTRPRICE_REM_DSPNT(TFIBBCDField * DocTRPRICE_REM_DSPNT);

   virtual TFIBBCDField * get_DocTRSUM_REM_DSPNT(void);
   virtual void set_DocTRSUM_REM_DSPNT(TFIBBCDField * DocTRSUM_REM_DSPNT);

   virtual TFIBSmallIntField * get_DocTDVREG_REM_DSPNT(void);
   virtual void set_DocTDVREG_REM_DSPNT(TFIBSmallIntField * DocTDVREG_REM_DSPNT);
   ...
   virtual TFIBLargeIntField * get_DocTIDTNOM_REM_DSPNT(void);
   virtual void set_DocTIDTNOM_REM_DSPNT(TFIBLargeIntField * DocTIDTNOM_REM_DSPNT);

   virtual TFIBLargeIntField * get_DocTIDMHRAN_REM_DSPNT(void);
   virtual void set_DocTIDMHRAN_REM_DSPNT(TFIBLargeIntField * DocTIDMHRAN_REM_DSPNT);
...
#define CLSID_TREM_DMDocSpisNomImpl __uuidof(TREM_DMDocSpisNomImpl)
#endif
