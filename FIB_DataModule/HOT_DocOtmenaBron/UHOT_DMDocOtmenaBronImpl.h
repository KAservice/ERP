#ifndef UHOT_DMDocOtmenaBronImplH
#define UHOT_DMDocOtmenaBronImplH
#include "IHOT_DMDocOtmenaBron.h"
#include "UHOT_DMDocOtmenaBron.h"
//---------------------------------------------------------------
class __declspec(uuid("{5227C719-111A-4230-A2AA-68A1FD566656}")) THOT_DMDocOtmenaBronImpl : public IHOT_DMDocOtmenaBron
{
public:
   THOT_DMDocOtmenaBronImpl();
   ~THOT_DMDocOtmenaBronImpl();
   THOT_DMDocOtmenaBron * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IHOT_DMDocOtmenaBron
   ...
   virtual TFIBWideStringField * get_DocGID_HOT_DOTMBRON(void);
   virtual void set_DocGID_HOT_DOTMBRON(TFIBWideStringField * DocGID_HOT_DOTMBRON);
   ...
   virtual TFIBLargeIntField * get_DocID_HOT_DOTMBRON(void);
   virtual void set_DocID_HOT_DOTMBRON(TFIBLargeIntField * DocID_HOT_DOTMBRON);

   virtual TFIBLargeIntField * get_DocIDDOCH_HOT_DOTMBRON(void);
   virtual void set_DocIDDOCH_HOT_DOTMBRON(TFIBLargeIntField * DocIDDOCH_HOT_DOTMBRON);

   virtual TFIBWideStringField * get_DocDESCR_HOT_DOTMBRON(void);
   virtual void set_DocDESCR_HOT_DOTMBRON(TFIBWideStringField * DocDESCR_HOT_DOTMBRON);

   virtual TFIBLargeIntField * get_DocIDBASE_HOT_DOTMBRON(void);
   virtual void set_DocIDBASE_HOT_DOTMBRON(TFIBLargeIntField * DocIDBASE_HOT_DOTMBRON);

   virtual TFIBLargeIntField * get_DocTID_HOT_DOTMBRONT(void);
   virtual void set_DocTID_HOT_DOTMBRONT(TFIBLargeIntField * DocTID_HOT_DOTMBRONT);

   virtual TFIBLargeIntField * get_DocTIDDOCH_HOT_DOTMBRONT(void);
   virtual void set_DocTIDDOCH_HOT_DOTMBRONT(TFIBLargeIntField * DocTIDDOCH_HOT_DOTMBRONT);

   virtual TFIBLargeIntField * get_DocTIDSOST_HOT_DOTMBRONT(void);
   virtual void set_DocTIDSOST_HOT_DOTMBRONT(TFIBLargeIntField * DocTIDSOST_HOT_DOTMBRONT);

   virtual TFIBLargeIntField * get_DocTIDBASE_HOT_DOTMBRONT(void);
   virtual void set_DocTIDBASE_HOT_DOTMBRONT(TFIBLargeIntField * DocTIDBASE_HOT_DOTMBRONT);
...
#define CLSID_THOT_DMDocOtmenaBronImpl __uuidof(THOT_DMDocOtmenaBronImpl)
#endif
