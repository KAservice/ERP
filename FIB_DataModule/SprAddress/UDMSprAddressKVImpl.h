#ifndef UDMSprAddressKVImplH
#define UDMSprAddressKVImplH
#include "IDMSprAddressKV.h"
#include "UDMSprAddressKV.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMSprAddressKVImpl)) TDMSprAddressKVImpl : public IDMSprAddressKV
{
public:
   TDMSprAddressKVImpl();
   ~TDMSprAddressKVImpl();
   TDMSprAddressKV * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMSprAddressKV
   ...
   virtual TFIBLargeIntField * get_TableID_SADR_KV(void);
   virtual void set_TableID_SADR_KV(TFIBLargeIntField * TableID_SADR_KV);

   virtual TFIBLargeIntField * get_TableIDBASE_SADR_KV(void);
   virtual void set_TableIDBASE_SADR_KV(TFIBLargeIntField * TableIDBASE_SADR_KV);

   virtual TFIBWideStringField * get_TableNAME_SADR_KV(void);
   virtual void set_TableNAME_SADR_KV(TFIBWideStringField * TableNAME_SADR_KV);

   virtual TFIBLargeIntField * get_TableIDSTROEN_SADR_KV(void);
   virtual void set_TableIDSTROEN_SADR_KV(TFIBLargeIntField * TableIDSTROEN_SADR_KV);

   virtual TFIBLargeIntField * get_ElementID_SADR_KV(void);
   virtual void set_ElementID_SADR_KV(TFIBLargeIntField * ElementID_SADR_KV);

   virtual TFIBLargeIntField * get_ElementIDBASE_SADR_KV(void);
   virtual void set_ElementIDBASE_SADR_KV(TFIBLargeIntField * ElementIDBASE_SADR_KV);

   virtual TFIBWideStringField * get_ElementNAME_SADR_KV(void);
   virtual void set_ElementNAME_SADR_KV(TFIBWideStringField * ElementNAME_SADR_KV);

   virtual TFIBLargeIntField * get_ElementIDSTROEN_SADR_KV(void);
   virtual void set_ElementIDSTROEN_SADR_KV(TFIBLargeIntField * ElementIDSTROEN_SADR_KV);
...
#define CLSID_TDMSprAddressKVImpl __uuidof(TDMSprAddressKVImpl)
#endif
