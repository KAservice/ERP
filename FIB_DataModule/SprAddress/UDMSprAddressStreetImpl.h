#ifndef UDMSprAddressStreetImplH
#define UDMSprAddressStreetImplH
#include "IDMSprAddressStreet.h"
#include "UDMSprAddressStreet.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMSprAddressStreetImpl)) TDMSprAddressStreetImpl : public IDMSprAddressStreet
{
public:
   TDMSprAddressStreetImpl();
   ~TDMSprAddressStreetImpl();
   TDMSprAddressStreet * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMSprAddressStreet
   ...
   virtual TFIBLargeIntField * get_TableID_SADR_STREET(void);
   virtual void set_TableID_SADR_STREET(TFIBLargeIntField * TableID_SADR_STREET);

   virtual TFIBLargeIntField * get_TableIDBASE_SADR_STREET(void);
   virtual void set_TableIDBASE_SADR_STREET(TFIBLargeIntField * TableIDBASE_SADR_STREET);

   virtual TFIBWideStringField * get_TableNAME_SADR_STREET(void);
   virtual void set_TableNAME_SADR_STREET(TFIBWideStringField * TableNAME_SADR_STREET);

   virtual TFIBWideStringField * get_TablePOSTCODE_SADR_STREET(void);
   virtual void set_TablePOSTCODE_SADR_STREET(TFIBWideStringField * TablePOSTCODE_SADR_STREET);

   virtual TFIBLargeIntField * get_TableIDNASPUNKT_SADR_STREET(void);
   virtual void set_TableIDNASPUNKT_SADR_STREET(TFIBLargeIntField * TableIDNASPUNKT_SADR_STREET);
...
#define CLSID_TDMSprAddressStreetImpl __uuidof(TDMSprAddressStreetImpl)
#endif
