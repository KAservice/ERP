...
#ifndef UDMSprAddressNasPunktH
#define UDMSprAddressNasPunktH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TDMSprAddressNasPunkt : public TDataModule
{
__published:	// IDE-managed Components
	...
	TpFIBQuery *Query;
	TFIBLargeIntField *TableID_SADR_NASPUNKT;
	TFIBLargeIntField *TableIDBASE_SADR_NASPUNKT;
	TFIBLargeIntField *TableIDRAYON_SADR_NASPUNKT;
	TFIBWideStringField *TableNAME_SADR_NASPUNKT;
	TFIBIntegerField *TableFL_GOROD_SADR_NASPUNKT;
...
public:		// User declarations
		__fastcall TDMSprAddressNasPunkt(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TDMSprAddressNasPunkt *DMSprAddressNasPunkt;
//---------------------------------------------------------------------------
#endif
