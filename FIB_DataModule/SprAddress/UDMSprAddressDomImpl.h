#ifndef UDMSprAddressDomImplH
#define UDMSprAddressDomImplH
#include "IDMSprAddressDom.h"
#include "UDMSprAddressDom.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMSprAddressDomImpl)) TDMSprAddressDomImpl : public IDMSprAddressDom
{
public:
   TDMSprAddressDomImpl();
   ~TDMSprAddressDomImpl();
   TDMSprAddressDom * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMSprAddressDom
   ...
   virtual TFIBLargeIntField * get_TableID_SADR_DOM(void);
   virtual void set_TableID_SADR_DOM(TFIBLargeIntField * TableID_SADR_DOM);

   virtual TFIBLargeIntField * get_TableIDBASE_SADR_DOM(void);
   virtual void set_TableIDBASE_SADR_DOM(TFIBLargeIntField * TableIDBASE_SADR_DOM);

   virtual TFIBLargeIntField * get_TableIDSTREET_SADR_DOM(void);
   virtual void set_TableIDSTREET_SADR_DOM(TFIBLargeIntField * TableIDSTREET_SADR_DOM);

   virtual TFIBWideStringField * get_TableNAME_SADR_DOM(void);
   virtual void set_TableNAME_SADR_DOM(TFIBWideStringField * TableNAME_SADR_DOM);
...
#define CLSID_TDMSprAddressDomImpl __uuidof(TDMSprAddressDomImpl)
#endif
