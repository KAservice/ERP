object DMSprAddressStroen: TDMSprAddressStroen
  ...
  object Table: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ' select *'
      'from sadr_stroen'
      'where sadr_stroen.iddom_sadr_stroen=:PARAM_IDOWNER'
      'order by sadr_stroen.name_sadr_stroen')
    ...
    object TableID_SADR_STROEN: TFIBLargeIntField
      FieldName = 'ID_SADR_STROEN'
    end
    object TableIDBASE_SADR_STROEN: TFIBLargeIntField
      FieldName = 'IDBASE_SADR_STROEN'
    end
    object TableNAME_SADR_STROEN: TFIBWideStringField
      FieldName = 'NAME_SADR_STROEN'
      Size = 40
    end
    object TableIDDOM_SADR_STROEN: TFIBLargeIntField
  ...
  object Element: TpFIBDataSet
    ...
    UpdateSQL.Strings = (
      'UPDATE SADR_STROEN'
      'SET '
      '    IDBASE_SADR_STROEN = :IDBASE_SADR_STROEN,'
      '    NAME_SADR_STROEN = :NAME_SADR_STROEN,'
      '    IDDOM_SADR_STROEN = :IDDOM_SADR_STROEN'
      'WHERE'
      '    ID_SADR_STROEN = :OLD_ID_SADR_STROEN'
      '    ')
    DeleteSQL.Strings = (
      'DELETE FROM'
      '    SADR_STROEN'
    ...
    RefreshSQL.Strings = (
      ...
      'where(  sadr_rayon.id_sadr_rayon=:PARAM_ID'
        ...
        '     ) and (     SADR_STROEN.ID_SADR_STROEN = :OLD_ID_SADR_STROE' +
        'N'
      '     )'
      '    ')
    SelectSQL.Strings = (
      ...
      'from sadr_stroen'
        ...
        'dr_region.id_sadr_region'
      'where sadr_rayon.id_sadr_rayon=:PARAM_ID')
    AutoUpdateOptions.UpdateTableName = 'SADR_STROEN'
    AutoUpdateOptions.KeyFields = 'ID_SADR_STROEN'
    AutoUpdateOptions.GeneratorName = 'GEN_SADR_STROEN_ID'
    AutoUpdateOptions.WhenGetGenID = wgOnNewRecord
    Transaction = IBTr
