...
#ifndef UDMSprAddressKVH
#define UDMSprAddressKVH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TDMSprAddressKV : public TDataModule
{
__published:	// IDE-managed Components
	...
	TpFIBQuery *Query;
	TFIBLargeIntField *TableID_SADR_KV;
	TFIBLargeIntField *TableIDBASE_SADR_KV;
	TFIBWideStringField *TableNAME_SADR_KV;
	TFIBLargeIntField *TableIDSTROEN_SADR_KV;
	TFIBLargeIntField *ElementID_SADR_KV;
	TFIBLargeIntField *ElementIDBASE_SADR_KV;
	TFIBWideStringField *ElementNAME_SADR_KV;
	TFIBLargeIntField *ElementIDSTROEN_SADR_KV;
	TFIBLargeIntField *ElementID_SADR_STROEN;
	TFIBLargeIntField *ElementIDBASE_SADR_STROEN;
	TFIBWideStringField *ElementNAME_SADR_STROEN;
	TFIBLargeIntField *ElementIDDOM_SADR_STROEN;
...
public:		// User declarations
		__fastcall TDMSprAddressKV(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TDMSprAddressKV *DMSprAddressKV;
//---------------------------------------------------------------------------
#endif
