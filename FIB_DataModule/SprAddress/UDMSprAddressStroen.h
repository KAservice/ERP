...
#ifndef UDMSprAddressStroenH
#define UDMSprAddressStroenH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TDMSprAddressStroen : public TDataModule
{
__published:	// IDE-managed Components
	...
	TpFIBQuery *Query;
	TFIBLargeIntField *TableID_SADR_STROEN;
	TFIBLargeIntField *TableIDBASE_SADR_STROEN;
	TFIBWideStringField *TableNAME_SADR_STROEN;
	TFIBLargeIntField *TableIDDOM_SADR_STROEN;
...
public:		// User declarations
		__fastcall TDMSprAddressStroen(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TDMSprAddressStroen *DMSprAddressStroen;
//---------------------------------------------------------------------------
#endif
