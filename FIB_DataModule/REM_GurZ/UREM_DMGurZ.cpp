...
//---------------------------------------------------------------------------
__fastcall TREM_DMGurZ::TREM_DMGurZ(TComponent* Owner)
        : TDataModule(Owner)
{
...
//---------------------------------------------------------------------------
int TREM_DMGurZ::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMGurZ::DataModuleDestroy(TObject *Sender)
{
Table->Active=false;
...
//---------------------------------------------------------------------------
void TREM_DMGurZ::UpdateTable(void)
{
IdZ=glStrToInt64(TableID_REM_Z->AsString);
DataSourceTable->Enabled=false;

OpenTable();
TLocateOptions Opt;
Opt<<loCaseInsensitive;
Table->Locate("ID_REM_Z",IntToStr(IdZ),Opt);

DataSourceTable->Enabled=true;
}
//-----------------------------------------------------------------------
UnicodeString TREM_DMGurZ::GetNachaloZapros(void)
{
...
//-----------------------------------------------------------------------
void TREM_DMGurZ::PoiskPoSerNum1(UnicodeString ser_num)
{
...
//------------------------------------------------------------------------
void TREM_DMGurZ::PoiskPoSerNum2(UnicodeString ser_num)
{
UnicodeString text_query;
...
//-------------------------------------------------------------------------
void TREM_DMGurZ::PoiskPoKlient(UnicodeString value)
{
UnicodeString text_query;
...
//-------------------------------------------------------------------------
void TREM_DMGurZ::PoiskPoModel(UnicodeString value)
{
UnicodeString text_query;
...
//-------------------------------------------------------------------------
void TREM_DMGurZ::PoiskPoIdHardware(__int64 id_hw)
{
UnicodeString text_query;
...
//-------------------------------------------------------------------------
void TREM_DMGurZ::PoiskPoNumGarDoc(UnicodeString num_gar_doc)
{
UnicodeString text_query;
...
//-------------------------------------------------------------------------
void __fastcall TREM_DMGurZ::TableCalcFields(TDataSet *DataSet)
{
if (TablePOSREMONT_REM_Z->AsDateTime > StrToDateTime("01.01.2000"))
	{
	TableSROK_REMONTA->AsInteger=TablePOSREMONT_REM_Z->AsDateTime - TablePOS_REM_Z->AsDateTime+1;
	}
TableSROK_REMONTA_NOW->AsInteger=Now() - TablePOS_REM_Z->AsDateTime+1;
}
//---------------------------------------------------------------------------
void TREM_DMGurZ::OpenTableOtbor(TDateTime pos_start,TDateTime pos_end,int poisk,UnicodeString str_value,__int64 int64_value)
{
UnicodeString text_query;
