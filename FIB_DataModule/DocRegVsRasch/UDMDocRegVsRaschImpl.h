#ifndef UDMDocRegVsRaschImplH
#define UDMDocRegVsRaschImplH
#include "IDMDocRegVsRasch.h"
#include "UDMDocRegVsRasch.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMDocRegVsRaschImpl)) TDMDocRegVsRaschImpl : public IDMDocRegVsRasch
{
public:
   TDMDocRegVsRaschImpl();
   ~TDMDocRegVsRaschImpl();
   TDMDocRegVsRasch * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMDocRegVsRasch
   ...
   virtual TFIBSmallIntField * get_DocTTDV_DRG_VSRASCHT(void);
   virtual void set_DocTTDV_DRG_VSRASCHT(TFIBSmallIntField * DocTTDV_DRG_VSRASCHT);

   virtual TFIBBCDField * get_DocTSUM_DRG_VSRASCHT(void);
   virtual void set_DocTSUM_DRG_VSRASCHT(TFIBBCDField * DocTSUM_DRG_VSRASCHT);

   virtual TFIBIntegerField * get_DocTOPER_DRG_VSRASCHT(void);
   virtual void set_DocTOPER_DRG_VSRASCHT(TFIBIntegerField * DocTOPER_DRG_VSRASCHT);
   ...
   virtual TFIBLargeIntField * get_DocID_DRG_VSRASCH(void);
   virtual void set_DocID_DRG_VSRASCH(TFIBLargeIntField * DocID_DRG_VSRASCH);

   virtual TFIBLargeIntField * get_DocIDDOC_DRG_VSRASCH(void);
   virtual void set_DocIDDOC_DRG_VSRASCH(TFIBLargeIntField * DocIDDOC_DRG_VSRASCH);

   virtual TFIBWideStringField * get_DocDESCR_DRG_VSRASCH(void);
   virtual void set_DocDESCR_DRG_VSRASCH(TFIBWideStringField * DocDESCR_DRG_VSRASCH);

   virtual TFIBLargeIntField * get_DocIDBASE_DRG_VSRASCH(void);
   virtual void set_DocIDBASE_DRG_VSRASCH(TFIBLargeIntField * DocIDBASE_DRG_VSRASCH);

   virtual TFIBLargeIntField * get_DocTID_DRG_VSRASCHT(void);
   virtual void set_DocTID_DRG_VSRASCHT(TFIBLargeIntField * DocTID_DRG_VSRASCHT);

   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_VSRASCHT(void);
   virtual void set_DocTIDDOC_DRG_VSRASCHT(TFIBLargeIntField * DocTIDDOC_DRG_VSRASCHT);

   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_VSRASCHT(void);
   virtual void set_DocTIDFIRM_DRG_VSRASCHT(TFIBLargeIntField * DocTIDFIRM_DRG_VSRASCHT);

   virtual TFIBLargeIntField * get_DocTIDKLIENT_DRG_VSRASCHT(void);
   virtual void set_DocTIDKLIENT_DRG_VSRASCHT(TFIBLargeIntField * DocTIDKLIENT_DRG_VSRASCHT);

   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_VSRASCHT(void);
   virtual void set_DocTIDBASE_DRG_VSRASCHT(TFIBLargeIntField * DocTIDBASE_DRG_VSRASCHT);
...
#define CLSID_TDMDocRegVsRaschImpl __uuidof(TDMDocRegVsRaschImpl)
#endif
