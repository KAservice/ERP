#ifndef UREM_DMDocVZipVosvratPostImplH
#define UREM_DMDocVZipVosvratPostImplH
#include "IREM_DMDocVZipVosvratPost.h"
#include "UREM_DMDocVZipVosvratPost.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocVZipVosvratPostImpl)) TREM_DMDocVZipVosvratPostImpl : public IREM_DMDocVZipVosvratPost
{
public:
   TREM_DMDocVZipVosvratPostImpl();
   ~TREM_DMDocVZipVosvratPostImpl();
   TREM_DMDocVZipVosvratPost * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocVZipVosvratPost
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DVZVPO(void);
   virtual void set_DocID_REM_DVZVPO(TFIBLargeIntField * DocID_REM_DVZVPO);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DVZVPO(void);
   virtual void set_DocIDBASE_REM_DVZVPO(TFIBLargeIntField * DocIDBASE_REM_DVZVPO);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DVZVPO(void);
   virtual void set_DocIDDOC_REM_DVZVPO(TFIBLargeIntField * DocIDDOC_REM_DVZVPO);

   virtual TFIBWideStringField * get_DocDESCR_REM_DVZVPO(void);
   virtual void set_DocDESCR_REM_DVZVPO(TFIBWideStringField * DocDESCR_REM_DVZVPO);

   virtual TFIBIntegerField * get_DocOPER_REM_DVZVPO(void);
   virtual void set_DocOPER_REM_DVZVPO(TFIBIntegerField * DocOPER_REM_DVZVPO);

   virtual TFIBLargeIntField * get_DocTID_REM_DVZVPOT(void);
   virtual void set_DocTID_REM_DVZVPOT(TFIBLargeIntField * DocTID_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DVZVPOT(void);
   virtual void set_DocTIDBASE_REM_DVZVPOT(TFIBLargeIntField * DocTIDBASE_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DVZVPOT(void);
   virtual void set_DocTIDDOC_REM_DVZVPOT(TFIBLargeIntField * DocTIDDOC_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDTNOM_REM_DVZVPOT(void);
   virtual void set_DocTIDTNOM_REM_DVZVPOT(TFIBLargeIntField * DocTIDTNOM_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDNOM_REM_DVZVPOT(void);
   virtual void set_DocTIDNOM_REM_DVZVPOT(TFIBLargeIntField * DocTIDNOM_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DVZVPOT(void);
   virtual void set_DocTIDZ_REM_DVZVPOT(TFIBLargeIntField * DocTIDZ_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDHW_REM_DVZVPOT(void);
   virtual void set_DocTIDHW_REM_DVZVPOT(TFIBLargeIntField * DocTIDHW_REM_DVZVPOT);

   virtual TFIBLargeIntField * get_DocTIDTVZIP_REM_DVZVPOT(void);
   virtual void set_DocTIDTVZIP_REM_DVZVPOT(TFIBLargeIntField * DocTIDTVZIP_REM_DVZVPOT);

   virtual TFIBBCDField * get_DocTKOL_REM_DVZVPOT(void);
   virtual void set_DocTKOL_REM_DVZVPOT(TFIBBCDField * DocTKOL_REM_DVZVPOT);
   ...
   virtual TFIBLargeIntField * get_DocTIDMHRAN_REM_DVZVPOT(void);
   virtual void set_DocTIDMHRAN_REM_DVZVPOT(TFIBLargeIntField * DocTIDMHRAN_REM_DVZVPOT);
...
#define CLSID_TREM_DMDocVZipVosvratPostImpl __uuidof(TREM_DMDocVZipVosvratPostImpl)
#endif
