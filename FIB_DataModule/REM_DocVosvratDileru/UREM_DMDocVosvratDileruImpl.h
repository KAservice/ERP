#ifndef UREM_DMDocVosvratDileruImplH
#define UREM_DMDocVosvratDileruImplH
#include "IREM_DMDocVosvratDileru.h"
#include "UREM_DMDocVosvratDileru.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocVosvratDileruImpl)) TREM_DMDocVosvratDileruImpl : public IREM_DMDocVosvratDileru
{
public:
   TREM_DMDocVosvratDileruImpl();
   ~TREM_DMDocVosvratDileruImpl();
   TREM_DMDocVosvratDileru * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocVosvratDileru
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DDILRET(void);
   virtual void set_DocID_REM_DDILRET(TFIBLargeIntField * DocID_REM_DDILRET);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DDILRET(void);
   virtual void set_DocIDBASE_REM_DDILRET(TFIBLargeIntField * DocIDBASE_REM_DDILRET);

   virtual TFIBWideStringField * get_DocGID_REM_DDILRET(void);
   virtual void set_DocGID_REM_DDILRET(TFIBWideStringField * DocGID_REM_DDILRET);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DDILRET(void);
   virtual void set_DocIDDOC_REM_DDILRET(TFIBLargeIntField * DocIDDOC_REM_DDILRET);

   virtual TFIBWideStringField * get_DocNUMDOCDIL_REM_DDILRET(void);
   virtual void set_DocNUMDOCDIL_REM_DDILRET(TFIBWideStringField * DocNUMDOCDIL_REM_DDILRET);

   virtual TFIBDateTimeField * get_DocPOSDOCDIL_REM_DDILRET(void);
   virtual void set_DocPOSDOCDIL_REM_DDILRET(TFIBDateTimeField * DocPOSDOCDIL_REM_DDILRET);

   virtual TFIBWideStringField * get_DocPRIM_REM_DDILRET(void);
   virtual void set_DocPRIM_REM_DDILRET(TFIBWideStringField * DocPRIM_REM_DDILRET);

   virtual TFIBLargeIntField * get_DocTID_REM_DDILRETT(void);
   virtual void set_DocTID_REM_DDILRETT(TFIBLargeIntField * DocTID_REM_DDILRETT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DDILRETT(void);
   virtual void set_DocTIDBASE_REM_DDILRETT(TFIBLargeIntField * DocTIDBASE_REM_DDILRETT);

   virtual TFIBWideStringField * get_DocTGID_REM_DDILRETT(void);
   virtual void set_DocTGID_REM_DDILRETT(TFIBWideStringField * DocTGID_REM_DDILRETT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DDILRETT(void);
   virtual void set_DocTIDDOC_REM_DDILRETT(TFIBLargeIntField * DocTIDDOC_REM_DDILRETT);

   virtual TFIBLargeIntField * get_DocTIDZ_REM_DDILRETT(void);
   virtual void set_DocTIDZ_REM_DDILRETT(TFIBLargeIntField * DocTIDZ_REM_DDILRETT);

   virtual TFIBBCDField * get_DocTKOL_REM_DDILRETT(void);
   virtual void set_DocTKOL_REM_DDILRETT(TFIBBCDField * DocTKOL_REM_DDILRETT);
...
#define CLSID_TREM_DMDocVosvratDileruImpl __uuidof(TREM_DMDocVosvratDileruImpl)
#endif
