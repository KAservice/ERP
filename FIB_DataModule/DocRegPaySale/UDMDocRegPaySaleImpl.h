#ifndef UDMDocRegPaySaleImplH
#define UDMDocRegPaySaleImplH
#include "IDMDocRegPaySale.h"
#include "UDMDocRegPaySale.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMDocRegPaySaleImpl)) TDMDocRegPaySaleImpl : public IDMDocRegPaySale
{
public:
   TDMDocRegPaySaleImpl();
   ~TDMDocRegPaySaleImpl();
   TDMDocRegPaySale * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMDocRegPaySale
   ...
   virtual TFIBSmallIntField * get_DocTTDV_DRG_PAYSALET(void);
   virtual void set_DocTTDV_DRG_PAYSALET(TFIBSmallIntField * DocTTDV_DRG_PAYSALET);

   virtual TFIBDateField * get_DocTDATE_DRG_PAYSALET(void);
   virtual void set_DocTDATE_DRG_PAYSALET(TFIBDateField * DocTDATE_DRG_PAYSALET);

   virtual TFIBBCDField * get_DocTSUM_DRG_PAYSALET(void);
   virtual void set_DocTSUM_DRG_PAYSALET(TFIBBCDField * DocTSUM_DRG_PAYSALET);
   ...
   virtual TFIBLargeIntField * get_DocID_DRG_PAYSALE(void);
   virtual void set_DocID_DRG_PAYSALE(TFIBLargeIntField * DocID_DRG_PAYSALE);

   virtual TFIBLargeIntField * get_DocIDDOC_DRG_PAYSALE(void);
   virtual void set_DocIDDOC_DRG_PAYSALE(TFIBLargeIntField * DocIDDOC_DRG_PAYSALE);

   virtual TFIBWideStringField * get_DocDESCR_DRG_PAYSALE(void);
   virtual void set_DocDESCR_DRG_PAYSALE(TFIBWideStringField * DocDESCR_DRG_PAYSALE);

   virtual TFIBLargeIntField * get_DocIDBASE_DRG_PAYSALE(void);
   virtual void set_DocIDBASE_DRG_PAYSALE(TFIBLargeIntField * DocIDBASE_DRG_PAYSALE);

   virtual TFIBLargeIntField * get_DocTID_DRG_PAYSALET(void);
   virtual void set_DocTID_DRG_PAYSALET(TFIBLargeIntField * DocTID_DRG_PAYSALET);

   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_PAYSALET(void);
   virtual void set_DocTIDDOC_DRG_PAYSALET(TFIBLargeIntField * DocTIDDOC_DRG_PAYSALET);

   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_PAYSALET(void);
   virtual void set_DocTIDFIRM_DRG_PAYSALET(TFIBLargeIntField * DocTIDFIRM_DRG_PAYSALET);

   virtual TFIBLargeIntField * get_DocTIDKLIENT_DRG_PAYSALET(void);
   virtual void set_DocTIDKLIENT_DRG_PAYSALET(TFIBLargeIntField * DocTIDKLIENT_DRG_PAYSALET);

   virtual TFIBLargeIntField * get_DocTIDDOG_DRG_PAYSALET(void);
   virtual void set_DocTIDDOG_DRG_PAYSALET(TFIBLargeIntField * DocTIDDOG_DRG_PAYSALET);

   virtual TFIBLargeIntField * get_DocTIDDOCSALE_DRG_PAYSALET(void);
   virtual void set_DocTIDDOCSALE_DRG_PAYSALET(TFIBLargeIntField * DocTIDDOCSALE_DRG_PAYSALET);

   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_PAYSALET(void);
   virtual void set_DocTIDBASE_DRG_PAYSALET(TFIBLargeIntField * DocTIDBASE_DRG_PAYSALET);

   virtual TFIBIntegerField * get_DocTOPER_DRG_PAYSALET(void);
   virtual void set_DocTOPER_DRG_PAYSALET(TFIBIntegerField * DocTOPER_DRG_PAYSALET);
   ...
   virtual TFIBWideStringField * get_DocTNAME_SDOG(void);
   virtual void set_DocTNAME_SDOG(TFIBWideStringField * DocTNAME_SDOG);

   virtual TFIBWideStringField * get_DocTTDOC(void);
   virtual void set_DocTTDOC(TFIBWideStringField * DocTTDOC);
...
#define CLSID_TDMDocRegPaySaleImpl __uuidof(TDMDocRegPaySaleImpl)
#endif
