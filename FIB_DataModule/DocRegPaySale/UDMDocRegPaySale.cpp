...
//---------------------------------------------------------------------------
__fastcall TDMDocRegPaySale::TDMDocRegPaySale(TComponent* Owner)
        : TDataModule(Owner)
{
...
void __fastcall TDMDocRegPaySale::DataModuleCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
bool TDMDocRegPaySale::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TDMDocRegPaySale::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TDMDocRegPaySale::DataModuleDestroy(TObject *Sender)
{
...
bool TDMDocRegPaySale::NewDoc(void)
{
bool result=false;
...
try
	...
	DocAllTDOC->AsString="RG_PAYSALE";
...
//---------------------------------------------------------------------------
int TDMDocRegPaySale::GetNumberNewDoc(void)
{
int result=0;
...
//----------------------------------------------------------------------------
bool TDMDocRegPaySale::OpenDoc(__int64 id)
{
bool result=false;
try
	{
...
//-----------------------------------------------------------------------------
void TDMDocRegPaySale::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TDMDocRegPaySale::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TDMDocRegPaySale::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TDMDocRegPaySale::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TDMDocRegPaySale::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
void __fastcall TDMDocRegPaySale::DocT1CalcFields(TDataSet *DataSet)
{
...
bool TDMDocRegPaySale::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TDMDocRegPaySale::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_DRG_PAYSALE->AsString=DocAllIDDOC->AsString;
if (glStrToInt64(DocAllIDBASE_GALLDOC->AsString)!=0)
	{
	DocIDBASE_DRG_PAYSALE->AsString=DocAllIDBASE_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TDMDocRegPaySale::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_DRG_PAYSALET->AsString=DocAllIDDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_DRG_PAYSALET->AsString=DocAllIDBASE_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TDMDocRegPaySale::DocAllPOSDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TDMDocRegPaySale::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------

void __fastcall TDMDocRegPaySale::DocAllIDBASE_GALLDOCChange(TField *Sender)
{
