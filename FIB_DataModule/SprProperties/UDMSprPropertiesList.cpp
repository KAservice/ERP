...
#include "UDMSprPropertiesList.h"
...
//---------------------------------------------------------------------------
__fastcall TDMSprPropertiesList::TDMSprPropertiesList(TComponent* Owner)
        : TDataModule(Owner)
{
...
//---------------------------------------------------------------------------
bool TDMSprPropertiesList::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TDMSprPropertiesList::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TDMSprPropertiesList::DataModuleDestroy(TObject *Sender)
{
Table->Active=false;
...
void TDMSprPropertiesList::OpenTable(__int64 IdNom)
{
...
int TDMSprPropertiesList::OpenElement(__int64 Id)  //возвращает количество элементов
{
Element->Active=false;
...
bool TDMSprPropertiesList::NewElement(__int64 IdNom)
{
bool result=false;
Element->Active=false;
...
//-----------------------------------------------------------------------------
void TDMSprPropertiesList::NewShtrihCod(void)
{
Element->Edit();
	//получим штрих код
	IObjectBarCode * ob_bar;
...
//-----------------------------------------------------------------------------
bool  TDMSprPropertiesList::SaveElement(void)
{
bool result=false;
...
bool TDMSprPropertiesList::DeleteElement(__int64 Id)
{
bool result=false;
Element->Active=false;
Element->ParamByName("ID")->AsInt64=Id;
...
//----------------------------------------------------------------------------
__int64 TDMSprPropertiesList::FindEdPoSh(String ShtrihCod)
{
__int64 res;
res=0;
pFIBQ->Close();
...
//----------------------------------------------------------------------------
__int64 TDMSprPropertiesList::FindEdPoCodu(int code)
{
__int64 result;
result=0;
pFIBQ->Close();
...
__int64 TDMSprPropertiesList::GetIDElement(String gid)
{
__int64 res=0;
...
//---------------------------------------------------------------------------
AnsiString TDMSprPropertiesList::GetGIDElement(__int64 id)
{
AnsiString res=0;
...
//---------------------------------------------------------------------------
__int64 TDMSprPropertiesList::GetIdNomPoShtrihCodu(AnsiString shtrih_cod)
{
__int64 result=0;
pFIBQ->Close();
pFIBQ->SQL->Clear();
...
void __fastcall TDMSprPropertiesList::TableCalcFields(TDataSet *DataSet)
{
TableRECNO->AsInteger=Table->RecNo;	
}
//---------------------------------------------------------------------------

bool TDMSprPropertiesList::CheckBarCode(__int64 id_ed, AnsiString sh)
{
...
//-----------------------------------------------------------------------------
bool TDMSprPropertiesList::CheckCode(__int64 id_ed, int code)
{
//возвращает true если штрих код не уникальный
bool result=false;
pFIBQ->Close();
...
//---------------------------------------------------------------------------
int TDMSprPropertiesList::GetCodeEd(void)
{
int result=0;
int max_code_ed=0;
pFIBQ->Close();
...
void __fastcall TDMSprPropertiesList::ElementSHEDSetText(TField *Sender, const UnicodeString Text)
