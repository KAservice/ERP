#ifndef UDMSprCustomerAccountKLientImplH
#define UDMSprCustomerAccountKLientImplH
#include "IDMSprCustomerAccountKLient.h"
#include "UDMSprCustomerAccountKLient.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMSprCustomerAccountKLientImpl)) TDMSprCustomerAccountKLientImpl : public IDMSprCustomerAccountKLient
{
public:
   TDMSprCustomerAccountKLientImpl();
   ~TDMSprCustomerAccountKLientImpl();
   TDMSprCustomerAccountKLient * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_TDMSprCustomerAccountKLientImpl __uuidof(TDMSprCustomerAccountKLientImpl)
#endif
