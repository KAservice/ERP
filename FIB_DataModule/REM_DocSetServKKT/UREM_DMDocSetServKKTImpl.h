#ifndef UREM_DMDocSetServKKTImplH
#define UREM_DMDocSetServKKTImplH
#include "IREM_DMDocSetServKKT.h"
#include "UREM_DMDocSetServKKT.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TREM_DMDocSetServKKTImpl)) TREM_DMDocSetServKKTImpl : public IREM_DMDocSetServKKT
{
public:
   TREM_DMDocSetServKKTImpl();
   ~TREM_DMDocSetServKKTImpl();
   TREM_DMDocSetServKKT * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IREM_DMDocSetServKKT
   ...
   virtual TFIBLargeIntField * get_DocID_REM_DSETSERVKKT(void);
   virtual void set_DocID_REM_DSETSERVKKT(TFIBLargeIntField * DocID_REM_DSETSERVKKT);

   virtual TFIBLargeIntField * get_DocIDBASE_REM_DSETSERVKKT(void);
   virtual void set_DocIDBASE_REM_DSETSERVKKT(TFIBLargeIntField * DocIDBASE_REM_DSETSERVKKT);

   virtual TFIBLargeIntField * get_DocIDDOC_REM_DSETSERVKKT(void);
   virtual void set_DocIDDOC_REM_DSETSERVKKT(TFIBLargeIntField * DocIDDOC_REM_DSETSERVKKT);

   virtual TFIBIntegerField * get_DocTDOC_REM_DSETSERVKKT(void);
   virtual void set_DocTDOC_REM_DSETSERVKKT(TFIBIntegerField * DocTDOC_REM_DSETSERVKKT);

   virtual TFIBWideStringField * get_DocPRIM_REM_DSETSERVKKT(void);
   virtual void set_DocPRIM_REM_DSETSERVKKT(TFIBWideStringField * DocPRIM_REM_DSETSERVKKT);

   virtual TFIBLargeIntField * get_DocTID_REM_DSETSERVKKTT(void);
   virtual void set_DocTID_REM_DSETSERVKKTT(TFIBLargeIntField * DocTID_REM_DSETSERVKKTT);

   virtual TFIBLargeIntField * get_DocTIDBASE_REM_DSETSERVKKTT(void);
   virtual void set_DocTIDBASE_REM_DSETSERVKKTT(TFIBLargeIntField * DocTIDBASE_REM_DSETSERVKKTT);

   virtual TFIBLargeIntField * get_DocTIDDOC_REM_DSETSERVKKTT(void);
   virtual void set_DocTIDDOC_REM_DSETSERVKKTT(TFIBLargeIntField * DocTIDDOC_REM_DSETSERVKKTT);

   virtual TFIBLargeIntField * get_DocTIDKKT_REM_DSETSERVKKTT(void);
   virtual void set_DocTIDKKT_REM_DSETSERVKKTT(TFIBLargeIntField * DocTIDKKT_REM_DSETSERVKKTT);

   virtual TFIBBCDField * get_DocTSUM_REM_DSETSERVKKTT(void);
   virtual void set_DocTSUM_REM_DSETSERVKKTT(TFIBBCDField * DocTSUM_REM_DSETSERVKKTT);

   virtual TFIBWideStringField * get_DocTNAME_REM_SKKT(void);
   virtual void set_DocTNAME_REM_SKKT(TFIBWideStringField * DocTNAME_REM_SKKT);
...
#define CLSID_TREM_DMDocSetServKKTImpl __uuidof(TREM_DMDocSetServKKTImpl)
#endif
