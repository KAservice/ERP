...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocRegOtchetPost::TREM_DMDocRegOtchetPost(TComponent* Owner)
        : TDataModule(Owner)
{
...
void __fastcall TREM_DMDocRegOtchetPost::DataModuleCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
bool TREM_DMDocRegOtchetPost::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocRegOtchetPost::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocRegOtchetPost::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocRegOtchetPost::NewDoc(void)
{
bool result=false;
...
try
	...
	DocAllTDOC_REM_GALLDOC->AsString="REM_RGOTCHPOST";
...
//---------------------------------------------------------------------------
int TREM_DMDocRegOtchetPost::GetNumberNewDoc(void)
{
int result=0;
...
//----------------------------------------------------------------------------
bool TREM_DMDocRegOtchetPost::OpenDoc(__int64 id)
{
bool result=false;
try
	{
...
//-----------------------------------------------------------------------------
void TREM_DMDocRegOtchetPost::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocRegOtchetPost::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocRegOtchetPost::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocRegOtchetPost::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocRegOtchetPost::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocRegOtchetPost::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocRegOtchetPost::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DRG_OTCHPOST->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DRG_OTCHPOST->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocRegOtchetPost::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DRG_OTCHPOSTT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DRG_OTCHPOSTT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}
...
void __fastcall TREM_DMDocRegOtchetPost::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocRegOtchetPost::DocAllPOS_REM_GALLDOCChange(TField *Sender)
...
void __fastcall TREM_DMDocRegOtchetPost::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
