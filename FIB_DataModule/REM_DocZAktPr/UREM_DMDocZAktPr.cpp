...
//---------------------------------------------------------------------------
__fastcall TREM_DMDocZAktPr::TREM_DMDocZAktPr(TComponent* Owner)
        : TDataModule(Owner)
{
...
bool TREM_DMDocZAktPr::Init(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TREM_DMDocZAktPr::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocZAktPr::DataModuleDestroy(TObject *Sender)
{
...
bool TREM_DMDocZAktPr::NewDoc(void)
{
bool result=false;
try
	{
	...
	NumDoc->ParamByName("PARAM_POS")->AsDateTime=dm_num->GetPosNachNumDoc("REMZAKTPR");
	NumDoc->Open();
	...
	DocAllTDOC_REM_GALLDOC->AsString="REMZAKTPR";
	...
	if (glStrToInt64(DM_Connection->UserInfoIDTPRICE_USER->AsString)!=0)
		{
		DocIDTPRICE_REM_DZAKTPR->AsString=DM_Connection->UserInfoIDTPRICE_USER->AsString;
		}
	DocFL_PRIG_KREM_REM_DZAKTPR->AsInteger=1;
	Doc->Post();
...
//---------------------------------------------------------------------------
bool TREM_DMDocZAktPr::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TREM_DMDocZAktPr::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TREM_DMDocZAktPr::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TREM_DMDocZAktPr::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TREM_DMDocZAktPr::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TREM_DMDocZAktPr::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TREM_DMDocZAktPr::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TREM_DMDocZAktPr::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_REM_DZAKTPR->AsString=DocAllID_REM_GALLDOC->AsString;
if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
	{
	DocIDBASE_REM_DZAKTPR->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TREM_DMDocZAktPr::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_REM_DZAKTPRT->AsString=DocAllID_REM_GALLDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_REM_DZAKTPRT->AsString=DocAllIDBASE_REM_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocZAktPr::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------

void __fastcall TREM_DMDocZAktPr::DocTAfterDelete(TDataSet *DataSet)
{
NewSummaStr=0;
NewSummaStr=0;
NewSummaMexStr=0;
...
void __fastcall TREM_DMDocZAktPr::DocTBeforeDelete(TDataSet *DataSet)
{
OldSummaStr=DocTSUM_REM_DZAKTPRT->AsFloat;
}
//---------------------------------------------------------------------------


void __fastcall TREM_DMDocZAktPr::DocAllPOS_REM_GALLDOCChange(TField *Sender)
{
IDMSetup * DMSetup;
InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TREM_DMDocZAktPr::DocAllIDBASE_REM_GALLDOCChange(TField *Sender)
{
	if (glStrToInt64(DocAllIDBASE_REM_GALLDOC->AsString)!=0)
		{
		Doc->Edit();
...
void __fastcall TREM_DMDocZAktPr::DocTKOL_REM_DZAKTPRTChange(TField *Sender)
{
OldSummaStr=DocTSUM_REM_DZAKTPRT->AsFloat;

DocTSUM_REM_DZAKTPRT->AsFloat=NewSummaStr=DocTKOL_REM_DZAKTPRT->AsFloat*
											DocTPRICE_REM_DZAKTPRT->AsFloat;
...
void __fastcall TREM_DMDocZAktPr::DocTPRICE_REM_DZAKTPRTChange(TField *Sender)
{
OldSummaStr=DocTSUM_REM_DZAKTPRT->AsFloat;
...
void __fastcall TREM_DMDocZAktPr::DocTNAME_REM_SPRNEISPRGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
if (Trim(Sender->AsString)=="")
	{
	Text="Неисправность:";
	}
else
...
void __fastcall TREM_DMDocZAktPr::DocTNAME_REM_SPRCONDITIONGetText(TField *Sender,
...
void __fastcall TREM_DMDocZAktPr::DocTNAME_REM_SPRSECTIONGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
if (Trim(Sender->AsString)=="")
	{
	Text="Место возникновения:";
	}
else
	{
	Text=Sender->AsString;
...
void __fastcall TREM_DMDocZAktPr::DocTNAME_REM_SPRDEFECTGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
if (Trim(Sender->AsString)=="")
	{
...
void __fastcall TREM_DMDocZAktPr::DocTNAME_REM_SPRRABOTAGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
if (Trim(Sender->AsString)=="")
	{
...
void __fastcall TREM_DMDocZAktPr::DocTNAMENOMGetText(TField *Sender, UnicodeString &Text,
          bool DisplayText)
{
if (Trim(Sender->AsString)=="")
	{
