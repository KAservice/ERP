...
//---------------------------------------------------------------------------
__fastcall TDMDocRegBank::TDMDocRegBank(TComponent* Owner)
        : TDataModule(Owner)
{
...
void __fastcall TDMDocRegBank::DataModuleCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
int TDMDocRegBank::Done(void)
{

return -1;
}
//---------------------------------------------------------------------------
void __fastcall TDMDocRegBank::DataModuleDestroy(TObject *Sender)
{
...
bool TDMDocRegBank::NewDoc(void)
{
bool result=false;
...
//---------------------------------------------------------------------------
int TDMDocRegBank::GetNumberNewDoc(void)
{
int result=0;
...
//----------------------------------------------------------------------------
bool TDMDocRegBank::OpenDoc(__int64 id)
{
bool result=false;
...
//-----------------------------------------------------------------------------
void TDMDocRegBank::TableAppend()
{
DocT->Append();
}
//---------------------------------------------------------------------------
void TDMDocRegBank::TableDelete(void)
{
DocT->Delete();
}
//---------------------------------------------------------------------------
bool TDMDocRegBank::SaveDoc(void)
{
bool Res=false;
...
//---------------------------------------------------------------------------
bool TDMDocRegBank::DvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
//---------------------------------------------------------------------------
bool TDMDocRegBank::CancelDvRegDoc(void)
{
bool result=false;
if (Prosmotr==true)
		{
...
bool TDMDocRegBank::DeleteDoc(__int64 id)
{
bool res=false;
...
//---------------------------------------------------------------------------
void __fastcall TDMDocRegBank::DocNewRecord(TDataSet *DataSet)
{
DocIDDOC_DRG_BANK->AsString=DocAllIDDOC->AsString;
if (glStrToInt64(DocAllIDBASE_GALLDOC->AsString)!=0)
	{
	DocIDBASE_DRG_BANK->AsString=DocAllIDBASE_GALLDOC->AsString;
	}
}
//-----------------------------------------------------------------------------
void __fastcall TDMDocRegBank::DocTNewRecord(TDataSet *DataSet)
{
DocTIDDOC_DRG_BANKT->AsString=DocAllIDDOC->AsString;

	if (glStrToInt64(DocAllIDBASE_GALLDOC->AsString)!=0)
		{
		DocTIDBASE_DRG_BANKT->AsString=DocAllIDBASE_GALLDOC->AsString;
		}

}
//---------------------------------------------------------------------------

void __fastcall TDMDocRegBank::DocAllPOSDOCChange(TField *Sender)
{
	IDMSetup * DMSetup;
	InterfaceGlobalCom->kanCreateObject("Oberon.DMSetup.1",IID_IDMSetup,
													(void**)&DMSetup);
...
void __fastcall TDMDocRegBank::DocTCalcFields(TDataSet *DataSet)
{
DocTRECNO->AsInteger=DocT->RecNo;	
}
//---------------------------------------------------------------------------

void __fastcall TDMDocRegBank::DocAllIDBASE_GALLDOCChange(TField *Sender)
{
...
void __fastcall TDMDocRegBank::DocAllIDFIRMDOCChange(TField *Sender)
{
GetNumberNewDoc();
}
//---------------------------------------------------------------------------
