#ifndef UDMDocRegBankImplH
#define UDMDocRegBankImplH
#include "IDMDocRegBank.h"
#include "UDMDocRegBank.h"
#include "UGlobalConstant.h"
//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_TDMDocRegBankImpl)) TDMDocRegBankImpl : public IDMDocRegBank
{
public:
   TDMDocRegBankImpl();
   ~TDMDocRegBankImpl();
   TDMDocRegBank * Object;
   int NumRefs;
   bool flDeleteObject;
...
//IDMDocRegBank
   ...
   virtual TFIBSmallIntField * get_DocTTDV_DRG_BANKT(void);
   virtual void set_DocTTDV_DRG_BANKT(TFIBSmallIntField * DocTTDV_DRG_BANKT);

   virtual TFIBSmallIntField * get_DocTOPER_DRG_BANKT(void);
   virtual void set_DocTOPER_DRG_BANKT(TFIBSmallIntField * DocTOPER_DRG_BANKT);

   virtual TFIBBCDField * get_DocTSUM_DRG_BANKT(void);
   virtual void set_DocTSUM_DRG_BANKT(TFIBBCDField * DocTSUM_DRG_BANKT);
   ...
   virtual TFIBLargeIntField * get_DocID_DRG_BANK(void);
   virtual void set_DocID_DRG_BANK(TFIBLargeIntField * DocID_DRG_BANK);

   virtual TFIBLargeIntField * get_DocIDBASE_DRG_BANK(void);
   virtual void set_DocIDBASE_DRG_BANK(TFIBLargeIntField * DocIDBASE_DRG_BANK);

   virtual TFIBWideStringField * get_DocDESCR_DRG_BANK(void);
   virtual void set_DocDESCR_DRG_BANK(TFIBWideStringField * DocDESCR_DRG_BANK);

   virtual TFIBLargeIntField * get_DocIDDOC_DRG_BANK(void);
   virtual void set_DocIDDOC_DRG_BANK(TFIBLargeIntField * DocIDDOC_DRG_BANK);

   virtual TFIBLargeIntField * get_DocTID_DRG_BANKT(void);
   virtual void set_DocTID_DRG_BANKT(TFIBLargeIntField * DocTID_DRG_BANKT);

   virtual TFIBLargeIntField * get_DocTIDDOC_DRG_BANKT(void);
   virtual void set_DocTIDDOC_DRG_BANKT(TFIBLargeIntField * DocTIDDOC_DRG_BANKT);

   virtual TFIBLargeIntField * get_DocTIDFIRM_DRG_BANKT(void);
   virtual void set_DocTIDFIRM_DRG_BANKT(TFIBLargeIntField * DocTIDFIRM_DRG_BANKT);

   virtual TFIBLargeIntField * get_DocTIDBSCHET_DRG_BANKT(void);
   virtual void set_DocTIDBSCHET_DRG_BANKT(TFIBLargeIntField * DocTIDBSCHET_DRG_BANKT);

   virtual TFIBLargeIntField * get_DocTIDBASE_DRG_BANKT(void);
   virtual void set_DocTIDBASE_DRG_BANKT(TFIBLargeIntField * DocTIDBASE_DRG_BANKT);

   virtual TFIBWideStringField * get_DocTNAMEFIRM(void);
   virtual void set_DocTNAMEFIRM(TFIBWideStringField * DocTNAMEFIRM);

   virtual TFIBWideStringField * get_DocTNAMEBSCHET(void);
   virtual void set_DocTNAMEBSCHET(TFIBWideStringField * DocTNAMEBSCHET);
...
#define CLSID_TDMDocRegBankImpl __uuidof(TDMDocRegBankImpl)
#endif
