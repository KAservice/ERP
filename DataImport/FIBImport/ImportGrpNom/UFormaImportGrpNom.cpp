...
//---------------------------------------------------------------------------
__fastcall TFormaImportGrpNom::TFormaImportGrpNom(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFormaImportGrpNom::FormCreate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormaImportGrpNom::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void TFormaImportGrpNom::UpdateForm(void)
{


}
//---------------------------------------------------------------------------
void __fastcall TFormaImportGrpNom::cxButtonCloseClick(TObject *Sender)
{
Close();	
}
//---------------------------------------------------------------------------
void __fastcall TFormaImportGrpNom::FileNamecxButtonEditPropertiesButtonClick(
...
//---------------------------------------------------------------------------
void TFormaImportGrpNom::UpdateSetup(void)
{

}
//----------------------------------------------------------------------------
void TFormaImportGrpNom::SaveSetup(void)
{
...
void __fastcall TFormaImportGrpNom::cxButtonImportClick(TObject *Sender)
{
...
try
	...
	if(name_grp!="")
		...
		DataSetGrp->Insert();
		DataSetGrpNAMEGN->AsString=name_grp;
		...
		if (name_owner_grp=="")
			...
			if (QueryOwnerGrp->FieldByName("IDGN")->AsInt64!=0)
				{
				DataSetGrpIDGRPGN->AsInt64=QueryOwnerGrp->FieldByName("IDGN")->AsInt64;
				}
			}
		try
			{
