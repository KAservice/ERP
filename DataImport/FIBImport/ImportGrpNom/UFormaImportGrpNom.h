...
#ifndef UFormaImportGrpNomH
#define UFormaImportGrpNomH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaImportGrpNom : public TForm
{
__published:	// IDE-managed Components
	...
	TFIBBCDField *DataSetGrpIDGN;
	TFIBBCDField *DataSetGrpIDGRPGN;
	TcxSpinEdit *ConStringcxSpinEdit;
	TLabel *Label5;
	TFIBWideStringField *DataSetGrpNAMEGN;
...
public:		// User declarations
	__fastcall TFormaImportGrpNom(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaImportGrpNom *FormaImportGrpNom;
//---------------------------------------------------------------------------
#endif
