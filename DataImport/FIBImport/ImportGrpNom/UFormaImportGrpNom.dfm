object FormaImportGrpNom: TFormaImportGrpNom
  Left = 0
  Top = 0
  ...
  object DataSetGrp: TpFIBDataSet
    ...
    Left = 400
    Top = 88
    object DataSetGrpIDGN: TFIBBCDField
      FieldName = 'IDGN'
      Size = 0
      RoundByScale = True
    end
    object DataSetGrpIDGRPGN: TFIBBCDField
      FieldName = 'IDGRPGN'
      Size = 0
      RoundByScale = True
    end
    object DataSetGrpNAMEGN: TFIBWideStringField
      FieldName = 'NAMEGN'
      Size = 100
    end
  end
  ...
  object QueryOwnerGrp: TpFIBQuery
    ...
    SQL.Strings = (
      'select sgrpnom.idgn'
      'from sgrpnom'
      'where sgrpnom.namegn=:PARAM_NAME')
    Left = 560
    Top = 48
