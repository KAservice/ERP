...
#ifndef UFormaImportGrpKKTH
#define UFormaImportGrpKKTH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormaImportGrpKKT : public TForm
{
__published:	// IDE-managed Components
	...
	TLabel *Label5;
	TFIBBCDField *DataSetGrpID_REM_SGRPKKT;
	TFIBBCDField *DataSetGrpIDGRP_REM_SGRPKKT;
	TFIBWideStringField *DataSetGrpNAME_REM_SGRPKKT;
...
public:		// User declarations
	__fastcall TFormaImportGrpKKT(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormaImportGrpKKT *FormaImportGrpKKT;
//---------------------------------------------------------------------------
#endif
