...
if (icom->kanAddClass(CLSID_TFormaDialogaImpl,"Kas.ReportAnalisNomPoPost.1","RepAnalisNomPoPost.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - Kas.ReportAnalisNomPoPost.1 !");
	}
