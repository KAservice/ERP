...
if (cxPageControl1->ActivePage->PageIndex==0)
	{
	SaveDialog1->FileName="Customers_"+FormatDateTime("ddmmyy",Date())+"_"+
...
void __fastcall TFormaReport::SprKlientCalcFields(TDataSet *DataSet)
{
SprKlientRECNO->AsInteger=SprKlient->RecNo;
}
//---------------------------------------------------------------------------
