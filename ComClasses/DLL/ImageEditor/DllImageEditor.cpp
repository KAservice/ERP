...
{
int result=0;
if (id_class==CLSID_TFormaImageEditorImpl)
	{
	TFormaImageEditorCF * ob=new TFormaImageEditorCF();
...
if (icom->kanAddClass(CLSID_TFormaImageEditorImpl,ProgId_FormaImageEditor,"DllImageEditor.dll")!=-1)
	{
	ShowMessage("Error! Falid register class -"+UnicodeString(ProgId_FormaImageEditor)+"  !");
	}
