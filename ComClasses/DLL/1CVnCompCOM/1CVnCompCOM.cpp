...
{
int result=0;
if (id_class==CLSID_TObject1CVnCompCOMImpl)
	{
	TObject1CVnCompCOMCF * ob=new TObject1CVnCompCOMCF();
...
if (icom->kanAddClass(CLSID_TObject1CVnCompCOMImpl,ProgId_Object1CVnCompCOM,"1CVnCompCOM.dll")!=-1)
	{
