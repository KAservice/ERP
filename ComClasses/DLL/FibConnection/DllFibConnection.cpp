...
if (icom->kanAddClass(CLSID_TDMFibConnectionImpl,ProgId_DMFibConnection,"DllFibConnection.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - ProgId_DMFibConnection !");
	}
