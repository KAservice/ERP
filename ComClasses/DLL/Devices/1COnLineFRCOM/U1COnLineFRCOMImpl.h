...
#ifndef U1COnLineFRCOMImplH
#define U1COnLineFRCOMImplH
//---------------------------------------------------------------------------
#include "IFiskReg.h"
#include "U1COnLineFRCOM.h"

//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_T1COnLineFRCOMImpl)) T1COnLineFRCOMImpl : public IFiskReg
{
public:
   T1COnLineFRCOMImpl();
   ~T1COnLineFRCOMImpl();
   T1COnLineFRCOM * Object;
   int NumRefs;
   bool flDeleteObject;
...
#define CLSID_T1COnLineFRCOMImpl __uuidof(T1COnLineFRCOMImpl)
#endif
