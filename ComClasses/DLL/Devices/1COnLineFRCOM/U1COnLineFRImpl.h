...
#ifndef U1COnLineFRImplH
#define U1COnLineFRImplH
//---------------------------------------------------------------------------
#include "IFiskReg.h"
#include "U1COnLineFR.h"

//---------------------------------------------------------------
class __declspec(uuid(Global_CLSID_T1COnLineFRImpl)) T1COnLineFRImpl : public IFiskReg
{
public:
   T1COnLineFRImpl();
   ~T1COnLineFRImpl();
...
#define CLSID_T1COnLineFRImpl __uuidof(T1COnLineFRImpl)
#endif
