...
{
int result=0;
if (id_class==CLSID_THOT_FormaGurAllDocImpl)
	{
	THOT_FormaGurAllDocCF * ob=new THOT_FormaGurAllDocCF();
...
if (icom->kanAddClass(CLSID_THOT_FormaGurAllDocImpl,"Oberon.HOT_FormaGurAllDoc.1","HotFormsGur.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - Oberon.HOT_FormaGurAllDoc.1  !");
	}
