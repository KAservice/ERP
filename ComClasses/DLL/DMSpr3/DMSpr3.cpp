...
{
int result=0;
if (id_class==CLSID_TDMSprDepartmentImpl)
	{
	TDMSprDepartmentCF * ob=new TDMSprDepartmentCF();
...
if (icom->kanAddClass(CLSID_TDMSprDepartmentImpl,ProgId_DMSprDepartment,"DMSpr3.dll")!=-1)
	{
	ShowMessage("Error! Falid register class -"+UnicodeString(ProgId_DMSprDepartment)+"!");
	}
return result;
}
//-----------------------------------------------------------------------------
