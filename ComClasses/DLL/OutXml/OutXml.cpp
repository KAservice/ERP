...
{
int result=0;
if (id_class==CLSID_TFormaExportDocImpl)
	{
	TFormaExportDocCF * ob=new TFormaExportDocCF();
...
if (icom->kanAddClass(CLSID_TFormaExportDocImpl,ProgId_FormaExportDoc,"OutXml.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - "+UnicodeString(ProgId_FormaExportDoc)+" !");
	}
