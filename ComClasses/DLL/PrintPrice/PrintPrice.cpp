...
{
int result=0;
if (id_class==CLSID_TFormaPrintPriceAImpl)
	{
	TFormaPrintPriceACF * ob=new TFormaPrintPriceACF();
...
if (icom->kanAddClass(CLSID_TFormaPrintPriceAImpl,ProgId_FormaPrintPriceA,"PrintPrice.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - "+UnicodeString(ProgId_FormaPrintPriceA)+"  !");
	}
