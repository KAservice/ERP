...
if (id_class==CLSID_TFormaUnReportImpl)
	{
	TFormaUnReportCF * ob=new TFormaUnReportCF();
...
if (icom->kanAddClass(CLSID_TFormaUnReportImpl,ProgId_FormaUnReport,"ReportForms.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - "+UnicodeString(ProgId_FormaUnReport)+"  !");
	}
