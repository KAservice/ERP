...
{
int result=0;
if (id_class==CLSID_THOT_RaschetStoimProgImpl)
	{
	THOT_RaschetStoimProgCF * ob=new THOT_RaschetStoimProgCF();
...
if (icom->kanAddClass(CLSID_THOT_RaschetStoimProgImpl,"Oberon.HOT_RaschetStoimProg.1","HotRaschet.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - Oberon.HOT_RaschetStoimProg.1  !");
	}
