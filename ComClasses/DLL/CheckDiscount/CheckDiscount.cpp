...
{
int result=0;
if (id_class==CLSID_TObjectCheckDiscountImpl)
	{
	TObjectCheckDiscountCF * ob=new TObjectCheckDiscountCF();
...
if (icom->kanAddClass(CLSID_TObjectCheckDiscountImpl,ProgId_ObjectCheckDiscount,"CheckDiscount.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - "+UnicodeString(ProgId_ObjectCheckDiscount)+" !");
	}
