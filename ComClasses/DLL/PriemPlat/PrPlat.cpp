...
{
int result=0;
if (id_class==CLSID_TFormaPriemPlatImpl)
	{
	TFormaPriemPlatCF * ob=new TFormaPriemPlatCF();
...
if (icom->kanAddClass(CLSID_TFormaPriemPlatImpl,ProgId_FormaPriemPlat,"PrPlat.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - "+UnicodeString(ProgId_FormaPriemPlat)+" !");
	}
