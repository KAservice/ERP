...
{
int result=0;
if (id_class==CLSID_TFormaArmKassirImpl)
	{
	TFormaArmKassirCF * ob=new TFormaArmKassirCF();
...
if (icom->kanAddClass(CLSID_TFormaArmKassirImpl,ProgId_FormaArmKassir,"DllArmKas1.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - "+UnicodeString(ProgId_FormaArmKassir)+" !");
	}
