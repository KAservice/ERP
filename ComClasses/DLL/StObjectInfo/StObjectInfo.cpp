...
{
int result=0;
if (id_class==CLSID_TClassCopyDocImpl)
	{
	TClassCopyDocCF * ob=new TClassCopyDocCF();
...
if (icom->kanAddClass(CLSID_TClassCopyDocImpl,ProgId_ClassCopyDoc,"CopyDoc.dll")!=-1)
	{
	ShowMessage("Error! Falid register class -"+UnicodeString(ProgId_ClassCopyDoc)+" !");
	}
