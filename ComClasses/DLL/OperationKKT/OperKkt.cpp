...
{
int result=0;
if (id_class==CLSID_TFormaKKTOperationImpl)
	{
	TFormaKKTOperationCF * ob=new TFormaKKTOperationCF();
...
if (icom->kanAddClass(CLSID_TFormaKKTOperationImpl,ProgId_HOT_FormaKKTOperation,"OperKkt.dll")!=-1)
	{
	ShowMessage("Error! Falid register class -"+UnicodeString(ProgId_HOT_FormaKKTOperation)+"  !");
	}
