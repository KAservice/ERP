...
{
int result=0;
if (id_class==CLSID_TObjectBarCodeImpl)
	{
	TObjectBarCodeCF * ob=new TObjectBarCodeCF();
...
if (icom->kanAddClass(CLSID_TObjectBarCodeImpl,"Oberon.ObjectBarCode.1","ObBarCode.dll")!=-1)
	{
	ShowMessage("Error! Falid register class - Oberon.ObjectBarCode.1  !");
	}
