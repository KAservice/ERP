...
#ifndef USheetEditor2H
#define USheetEditor2H
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TSheetEditor2 : public TForm
{
__published:	// IDE-managed Components
  ...
  TAction *actUndo;
  TAction *actRedo;
        TcxSpreadSheetBook *SS;
        TMenuItem *mnuPreView;
        TAction *actPreeView;
        TAction *actPrint;
        TMenuItem *N2;
        TMenuItem *N8;
	...
	TdxSpreadSheetBookReportLink *dxComponentPrinter1Link1;
	TToolButton *ToolButtonPrinrAll;
	TAction *actPrintNoDialog;
	TToolButton *ToolButtonPageSetup;
  ...
  void __fastcall IsEditorMode(TObject *Sender);
        void __fastcall SSSheetPopupMenu(TObject *Sender,
          int X, int Y);
        void __fastcall SSContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall FormClose(TObject *Sender, TCloseAction &Action);
        void __fastcall FormActivate(TObject *Sender);
        void __fastcall actPreeViewExecute(TObject *Sender);
        void __fastcall actPrintExecute(TObject *Sender);
        void __fastcall actPageSetupExecute(TObject *Sender);
	void __fastcall ToolButtonPrinrAllClick(TObject *Sender);
	void __fastcall actPrintNoDialogExecute(TObject *Sender);
	void __fastcall ToolButtonPageSetupClick(TObject *Sender);
...
protected:
  cxSpreadSheetBook __fastcall GetSpreadSheet() { return SS;};
  cxSpreadSheet  __fastcall GetActiveSpreadSheet() {return ( SS->ActiveSheet);};
...
public:		// User declarations
  ...
  __fastcall TSheetEditor2(TComponent* Owner);
  ...
  void SetRowsHeightAuto(int y, int x1, int x2, int x_max, AnsiString s);
...
//---------------------------------------------------------------------------
extern PACKAGE TSheetEditor2 *SheetEditor2;
//---------------------------------------------------------------------------
#endif
