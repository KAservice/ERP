...
#ifndef USheetEditorH
#define USheetEditorH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TSheetEditor : public TForm
{
...
public:		// User declarations
  ...
  __fastcall TSheetEditor(TComponent* Owner);
  ...
  void SetRowsHeightAuto(int y, int x1, int x2, int x_max, UnicodeString s);

};


//---------------------------------------------------------------------------
extern PACKAGE TSheetEditor *SheetEditor;
//---------------------------------------------------------------------------
#endif
