...
//---------------------------------------------------------------------------
__fastcall TSheetEditor2::TSheetEditor2(TComponent* Owner)
  : TForm(Owner)
{
  TForm::TForm(Owner);
...
//---------------------------------------------------------------------------
void __fastcall TSheetEditor2::NewSheet(String SheetName)
{
...
void __fastcall TSheetEditor2::actCloseWorkBookExecute(TObject *Sender)
{
  ActiveMDIChild->Close();
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actExitExecute(TObject *Sender)
{
  Close();
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::SaveSpreadSheet1Click(TObject *Sender)
{
  String FileName;
...
void __fastcall TSheetEditor2::actAutomaticCalcExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actRecalcFormulasExecute(TObject *Sender)
{
  CheckMenuItem(Sender); 
  SheetBook->Recalc();
}
...
void __fastcall TSheetEditor2::actCopyExecute(TObject *Sender)
{
  TRect rec;
...
void __fastcall TSheetEditor2::AlwaysEnabled(TObject *Sender)
{
  ((TCustomAction*)Sender)->Enabled = true;
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actCutExecute(TObject *Sender)
{
  TRect rec;
...
void __fastcall TSheetEditor2::actPasteExecute(TObject *Sender)
{
  TRect rec;
  rec = SheetBook->SelectionRect;
...
void __fastcall TSheetEditor2::edtCellEditChange(TObject *Sender)
{
  if (FIsUpdate) return;
...
void __fastcall TSheetEditor2::edtCellEditExit(TObject *Sender)
{
  TcxSSCellObject *CellObject = ActiveSpreadSheet->GetCellObject(ActiveSpreadSheet->SelectionRect.Left,
    ActiveSpreadSheet->SelectionRect.Top);
  try {
...
void __fastcall TSheetEditor2::SetStates()
{
  TFontStyles AStyle;
  TcxSSCellObject *CellObject = ActiveSpreadSheet->GetCellObject(ActiveSpreadSheet->SelectionRect.Left,
    ActiveSpreadSheet->SelectionRect.Top);
...
String __fastcall TSheetEditor2::GetCellText(TRect SelectionRect, bool R1C1)
{
  return SheetBook->CellsNameByRef(SheetBook->ActivePage, SelectionRect, true);
}

void __fastcall TSheetEditor2::cxSpreadBookSetSelection(TObject *Sender, TcxSSBookSheet *ASheet)
{
  try {
    FIsUpdate = true;
    SetStates();
...
void __fastcall TSheetEditor2::cbxSizeKeyPress(TObject *Sender, char &Key)
{
  if (Key == 13)
...
void __fastcall TSheetEditor2::actBeveledLookandFeelExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::actBufferedpaintExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::actShowcaptionsExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::actShowgridExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::actShowheadersExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::actShowformulasExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::actR1C1ReferencestyleExecute(TObject *Sender)
{
  if (IsUpdate) return;
  CheckMenuItem(Sender);
...
void __fastcall TSheetEditor2::SetValue(TStyleValues AValueSet, TFontStyles AStyles, TStyleValue AFlag, TFontStyle ANeedStyle,
...
void __fastcall TSheetEditor2::SetCellsStyle(TStyleValues AValuesSet, TcxHorzTextAlign AAlign,
...
void __fastcall TSheetEditor2::actCellLeftAlignExecute(TObject *Sender)
{
  SetCellsStyle(TStyleValues() << svAlign, haLEFT, 0, cbxFont->Text, TFontStyles());
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actCellRightAlignExecute(TObject *Sender)
{
  SetCellsStyle(TStyleValues() << svAlign, haRIGHT, 0, cbxFont->Text, TFontStyles());
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actBoldExecute(TObject *Sender)
{
  if (tbBold->Down){
...
void __fastcall TSheetEditor2::actFontSizeExecute(TObject *Sender)
{
  int ASize;
...
void __fastcall TSheetEditor2::actCellCenterAlignExecute(TObject *Sender)
{
  SetCellsStyle(TStyleValues() << svAlign, haCENTER, 0, cbxFont->Text, TFontStyles());
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actMergeCellsExecute(TObject *Sender)
{
  ActiveSpreadSheet->SetMergedState(ActiveSpreadSheet->SelectionRect, true);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actSplitCellsExecute(TObject *Sender)
{
  ActiveSpreadSheet->SetMergedState(ActiveSpreadSheet->SelectionRect, false);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::CalculateSummary(int AType)
{
  String S;
  TRect ARect;
...
void __fastcall TSheetEditor2::actSummaryExecute(TObject *Sender)
{
  CalculateSummary(((TComponent*)Sender)->Tag);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actRowExecute(TObject *Sender)
{
   ActiveSpreadSheet->InsertCells(ActiveSpreadSheet->SelectionRect, msAllRow);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actColumnExecute(TObject *Sender)
{
   ActiveSpreadSheet->InsertCells(ActiveSpreadSheet->SelectionRect, msAllCol);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actSheetExecute(TObject *Sender)
{
  SheetBook->PageCount++;
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actFontExecute(TObject *Sender)
{
  SetCellsStyle(TStyleValues() << svFontName, haGENERAL, 0, cbxFont->Text, TFontStyles());
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actSortAscendingExecute(TObject *Sender)
{
...
void __fastcall TSheetEditor2::actStrikeOutExecute(TObject *Sender)
{
  if (tbStrikeOut->Down){
...
void __fastcall TSheetEditor2::actUnderlineExecute(TObject *Sender)
{
  if (tbUnderline->Down){
...
void __fastcall TSheetEditor2::actItalicExecute(TObject *Sender)
{
  if (tbItalic->Down){
...
void __fastcall TSheetEditor2::actShowRowExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actHideRowExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actHideColExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actShowColExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actFormatCellsExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actHideCellsExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actShowCellsExecute(TObject *Sender)
{
  if (IsUpdate) return;
...
void __fastcall TSheetEditor2::actCellsExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TSheetEditor2::actOpenSpreadSheetExecute(TObject *Sender)
{
  if (OpenDialog->Execute())
  {
...
//---------------------------------------------------------------------------
void __fastcall TSheetEditor2::actSaveSpeadSheetExecute(TObject *Sender)
{
  String AFileName;
...
void __fastcall TSheetEditor2::edtCellEditKeyPress(TObject *Sender, char &Key)
{
  if (Key == 13)
  {
    _WINUSER_::SetFocus(SheetBook->Handle);
...
void __fastcall TSheetEditor2::SetHorzStyle(TRect ARect, int ARow, TcxSSEdgeLineStyle AStyle)
{
  if (AStyle != lsNone)
  {
...
void __fastcall TSheetEditor2::SetVertStyle(TRect ARect, int ACol, TcxSSEdgeLineStyle AStyle)
{
    if (AStyle != lsNone)
...
void __fastcall TSheetEditor2::MeasureItem(TObject *Sender, TCanvas *ACanvas,
...
void __fastcall TSheetEditor2::DrawItem(TObject *Sender, TCanvas *ACanvas,
...
void __fastcall TSheetEditor2::BordersClick(TObject *Sender)
{
...
void __fastcall TSheetEditor2::actSaveAsExecute(TObject *Sender)
{
  if (SaveDialog->Execute()) {
...
//---------------------------------------------------------------------------
void __fastcall TSheetEditor2::tbBorderStyleClick(TObject *Sender)
{
  TRect ARect;
  TPoint APoint;
...
void __fastcall TSheetEditor2::cbxFontKeyPress(TObject *Sender, char &Key)
{
  if (Key == 13)
    _WINUSER_::SetFocus(SheetBook->Handle);
}
...
void __fastcall TSheetEditor2::pmUndoPopup(TObject *Sender)
{
...
void __fastcall TSheetEditor2::pmRedoPopup(TObject *Sender)
{
  while (((TPopupMenu*)Sender)->Items->Count > 0)
    ((TPopupMenu*)Sender)->Items->Delete(0);
...
void __fastcall TSheetEditor2::URMeasureItem(TObject *Sender,
...
void __fastcall TSheetEditor2::URDrawItem(TObject *Sender,
...
void __fastcall TSheetEditor2::UndoItemClick(TObject *Sender)
{
...
void __fastcall TSheetEditor2::RedoItemClick(TObject *Sender)
{
  if (((TMenuItem*)Sender)->MenuIndex < ((TPopupMenu*)((TMenuItem*)Sender)->Owner)->Items->Count - 1)
...
void __fastcall TSheetEditor2::DrawActionsCount(TPopupMenu *APopupMenu, TCanvas *ACanvas, TMenuItem *ASender, const TRect ARect, String AInfoStr)
{
  TRect Rec;
...
void __fastcall TSheetEditor2::DrawUndoRedoItem(TPopupMenu *APopupMenu, TMenuItem *ASender, TCanvas *ACanvas, const TRect ARect, bool Selected, String AInfoStr)
{
...
void __fastcall TSheetEditor2::actHistory(TObject *Sender)
{
  ((TCustomAction*)(Sender))->Enabled = (SheetBook->History->UndoActions->Count > 0);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actRedoUpdate(TObject *Sender)
{
  ((TCustomAction*)(Sender))->Enabled = (SheetBook->History->RedoActions->Count > 0);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actUndoExecute(TObject *Sender)
{
  SheetBook->History->Undo(1);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actRedoExecute(TObject *Sender)
{
  SheetBook->History->Redo(1);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::IsEditorMode(TObject *Sender)
{
...
void __fastcall TSheetEditor2::SSSheetPopupMenu(
      TObject *Sender, int X, int Y)
{
pmSheetPopup->Popup(X, Y);
}
//---------------------------------------------------------------------------
void __fastcall TSheetEditor2::SSContextPopup(
...
//---------------------------------------------------------------------------
void __fastcall TSheetEditor2::FormClose(TObject *Sender,
      TCloseAction &Action)
{
//delete SS;
Action=caFree;
...
void __fastcall TSheetEditor2::FormActivate(TObject *Sender)
{
SS->SetFocus();          
}
//---------------------------------------------------------------------------
...
void __fastcall TSheetEditor2::actPreeViewExecute(TObject *Sender)
{
dxComponentPrinter1->ReportLink[0]->Preview(true);         
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actPrintExecute(TObject *Sender)
{
dxComponentPrinter1->ReportLink[0]->Print(true, NULL);
}
//---------------------------------------------------------------------------

void __fastcall TSheetEditor2::actPageSetupExecute(TObject *Sender)
{
...
void __fastcall TSheetEditor2::ToolButtonPrinrAllClick(TObject *Sender)
{
//печать всех страниц
...
void __fastcall TSheetEditor2::actPrintNoDialogExecute(TObject *Sender)
{
dxComponentPrinter1->ReportLink[0]->Print(false, NULL);
}
//---------------------------------------------------------------------------
void TSheetEditor2::SetRowsHeightAuto(int y, int x1, int x2,  int x_max, AnsiString s)
{
...
//----------------------------------------------------------------------------
void __fastcall TSheetEditor2::ToolButtonPageSetupClick(TObject *Sender)
{
dxComponentPrinter1->ReportLink[0]->PageSetup(); 	
}
//---------------------------------------------------------------------------
